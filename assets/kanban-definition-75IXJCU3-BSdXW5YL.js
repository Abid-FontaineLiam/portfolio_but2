...
import { C as at, G as n, T as c, Z as qo, j as eo, t as Ao, y as T } from "./chunk-67TQ5CYL-BGuir8Be.js";
...
import { a as Rr, i as Kg, o as Ug } from "./chunk-KGFNY3KK-CuDVV7Uv.js";
import { n as gr, t as Ar } from "./chunk-7FYTHRHK-BF0iKxpy.js";
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/kanban-definition-75IXJCU3.mjs
var ie = (function() {
	var e = m$1(function(v, i, n, s) {
		for (n = n || {}, s = v.length; s--; n[v[s]] = i);
		return n;
	}, "o"), g = [1, 4], p = [1, 13], r = [1, 12], d = [1, 15], k = [1, 16], y = [1, 20], l = [1, 19], L = [
		6,
		7,
		8
	], C = [1, 26], u = [1, 24], w = [1, 25], E = [
		6,
		7,
		11
	], K = [1, 31], N = [
		...
		parse: m$1(function(i) {
			var n = this, s = [0], a = [], h = [null], t = [], R = this.table, c = "", z = 0, ae = 0, ce = 0, xe = 2, le = 1, Le = t.slice.call(arguments, 1), b = Object.create(this.lexer), P = { yy: {} };
			...
			function ve() {
				var S;
				return S = a.pop() || b.lex() || le, typeof S != "number" && (S instanceof Array && (a = S, S = a.pop()), S = n.symbols_[S] || S), S;
			}
			m$1(ve, "lex");
			for (var _, Z, j, D, $, G = {}, X, I, he, Y;;) {
...
` + b.showPosition() + `
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : ee = "Parse error on line " + (z + 1) + ": Unexpected " + (_ == le ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(ee, {
						text: b.match,
				...
				switch (D[0]) {
					case 1:
						s.push(_), h.push(b.yytext), t.push(b.yylloc), s.push(D[1]), _ = null, Z ? (_ = Z, Z = null) : (ae = b.yyleng, c = b.yytext, z = b.yylineno, Q = b.yylloc, ce > 0 && ce--);
						break;
					case 2:
						...
						}, Oe && (G._$.range = [t[t.length - (I || 1)].range[0], t[t.length - 1].range[1]]), $ = this.performAction.apply(G, [
							c,
							ae,
							z,
							P.yy,
...
` + n + "^";
			...
			test_match: m$1(function(i, n) {
				...
				}, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(i[0].length), this.matched += i[0], s = this.performAction.call(this, this.yy, this, n, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), s) return s;
				if (this._backtrack) {
...
` + this.showPosition(), {
			...
			performAction: m$1(function(n, s, a, h) {
				switch (a) {
					case 0: return this.pushState("shapeData"), s.yytext = "", 24;
					case 1: return this.pushState("shapeDataStr"), 24;
					case 2: return this.popState(), 24;
					case 3: return s.yytext = s.yytext.replace(/\n\s*/g, "<br/>"), 24;
					case 4: return 24;
					case 5:
						this.popState();
						break;
					case 6: return n.getLogger().trace("Found comment", s.yytext), 6;
					case 7: return 8;
					case 8:
						this.begin("CLASS");
						break;
					...
					case 11:
						...
						break;
					case 12: return n.getLogger().trace("SPACELINE"), 6;
					case 13: return 7;
					case 14: return 16;
					case 15:
						n.getLogger().trace("end icon"), this.popState();
						break;
					case 16: return n.getLogger().trace("Exploding node"), this.begin("NODE"), 20;
					case 17: return n.getLogger().trace("Cloud"), this.begin("NODE"), 20;
					case 18: return n.getLogger().trace("Explosion Bang"), this.begin("NODE"), 20;
					case 19: return n.getLogger().trace("Cloud Bang"), this.begin("NODE"), 20;
					...
					case 30:
						...
						break;
					case 31: return n.getLogger().trace("description:", s.yytext), "NODE_DESCR";
					case 32:
						this.popState();
						break;
					...
					case 35: return this.popState(), n.getLogger().trace("node end ...", s.yytext), "NODE_DEND";
					case 36: return this.popState(), n.getLogger().trace("node end (("), "NODE_DEND";
					case 37: return this.popState(), n.getLogger().trace("node end (-"), "NODE_DEND";
					case 38: return this.popState(), n.getLogger().trace("node end (-"), "NODE_DEND";
					case 39: return this.popState(), n.getLogger().trace("node end (("), "NODE_DEND";
					case 40: return this.popState(), n.getLogger().trace("node end (("), "NODE_DEND";
					case 41: return n.getLogger().trace("Long description:", s.yytext), 21;
					case 42: return n.getLogger().trace("Long description:", s.yytext), 21;
				}
			}, "anonymous"),
			rules: [
				/^(?:@\{)/i,
...
var x = [], se = [], re = 0, oe = {}, Ce = m$1(() => {
...
}, "getSection"), _e = m$1(function() {
	return se;
}, "getSections"), we = m$1(function() {
	let e = [], g = [], p = _e(), r = qo();
	for (let d of p) {
		let k = {
			id: d.id,
		...
		g.push(k);
		let y = x.filter((l) => l.parentId === d.id);
		for (let l of y) {
			let L = {
				id: l.id,
				parentId: d.id,
...
}, "getData"), Ae = m$1((e, g, p, r, d) => {
	let k = qo(), y = k.mindmap?.padding ?? eo.mindmap.padding;
	switch (r) {
		case m.ROUNDED_RECT:
		case m.RECT:
		case m.HEXAGON: y *= 2;
	...
	let l = {
		...
		level: e,
		label: at(p, k),
		width: k.mindmap?.maxNodeWidth ?? eo.mindmap.maxNodeWidth,
		padding: y,
		isGroup: !1
	};
	if (d !== void 0) {
...
` + d + `
	...
	getType: m$1((e, g) => {
		switch (pt.debug("In get type", e, g), e) {
			case "[": return m.RECT;
			case "(": return g === ")" ? m.ROUNDED_RECT : m.CLOUD;
			case "((": return m.CIRCLE;
			case ")": return m.CLOUD;
			case "))": return m.BANG;
			case "{{": return m.HEXAGON;
			default: return m.DEFAULT;
		}
	}, "getType"),
	setElementForId: m$1((e, g) => {
		oe[e] = g;
	}, "setElementForId"),
	decorateNode: m$1((e) => {
		if (!e) return;
		let g = qo(), p = x[x.length - 1];
		e.icon && (p.icon = at(e.icon, g)), e.class && (p.cssClasses = at(e.class, g));
	}, "decorateNode"),
	type2Str: m$1((e) => {
		switch (e) {
			case m.DEFAULT: return "no-border";
			case m.RECT: return "rect";
			case m.ROUNDED_RECT: return "rounded-rect";
			case m.CIRCLE: return "circle";
			case m.CLOUD: return "cloud";
			case m.BANG: return "bang";
			case m.HEXAGON: return "hexgon";
			default: return "no-border";
		}
	}, "type2Str"),
	getLogger: m$1(() => pt, "getLogger"),
	getElementById: m$1((e) => oe[e], "getElementById")
};
var Ne = { draw: m$1(async (e, g, p, r) => {
	pt.debug(`Rendering kanban diagram
` + e);
	let k = r.db.getData(), y = qo();
	y.htmlLabels = !1;
	let l = d(g);
	for (let f of k.nodes) f.domId = `${g}-${f.id}`;
	let L = l.append("g");
	L.attr("class", "sections");
	let C = l.append("g");
	C.attr("class", "items");
	let u = k.nodes.filter((f) => f.isGroup), w = 0, E = 10, K = [], N = 25;
	for (let f of u) {
		let A = y?.kanban?.sectionWidth || 200;
	...
	for (let f of u) {
		let A = K[M];
		M = M + 1;
		let O = y?.kanban?.sectionWidth || 200, U = -O * 3 / 2 + N, T = U, J = k.nodes.filter((i) => i.parentId === f.id);
		for (let i of J) {
			if (i.isGroup) throw new Error("Groups within groups are not allowed in Kanban diagrams");
			i.x = f.x, i.width = O - 1.5 * E;
			let s = (await Ug(C, i, { config: y })).node().getBBox();
			i.y = T + s.height / 2, await Kg(i), T = i.y + s.height / 2 + E / 2;
		}
		let H = A.cluster.select("rect"), v = Math.max(T - U + 3 * E, 50) + (N - 25);
		H.attr("height", v);
	}
	Ao(void 0, l, y.mindmap?.padding ?? eo.kanban.padding, y.mindmap?.useMaxWidth ?? eo.kanban.useMaxWidth);
}, "draw") };
var Fe = m$1((e) => {
	let g = "";
	for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], T(e["lineColor" + r]) ? e["lineColor" + r] = n(e["lineColor" + r], 20) : e["lineColor" + r] = c(e["lineColor" + r], 20);
	let p = m$1((r, d) => e.darkMode ? c(r, d) : n(r, d), "adjuster");
