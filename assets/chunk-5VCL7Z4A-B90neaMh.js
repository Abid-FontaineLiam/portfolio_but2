...
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-5VCL7Z4A.mjs
var d = m((t, r) => {
...
var n = m((t) => Array.isArray(t) ? {
	x: t[0],
	y: t[1]
} : t, "pointTransformer"), E = m((t) => ({
	x: m(function(r, c, e) {
		let o = 0, i = n(e[0]).x < n(e[e.length - 1]).x ? "left" : "right";
		if (c === 0 && Object.hasOwn(s, t.arrowTypeStart)) {
			let { angle: a, deltaX: m } = b(e[0], e[1]);
			o = s[t.arrowTypeStart] * Math.cos(a) * (m >= 0 ? 1 : -1);
		} else if (c === e.length - 1 && Object.hasOwn(s, t.arrowTypeEnd)) {
			let { angle: a, deltaX: m } = b(e[e.length - 1], e[e.length - 2]);
			o = s[t.arrowTypeEnd] * Math.cos(a) * (m >= 0 ? 1 : -1);
		}
	...
	y: m(function(r, c, e) {
		...
		if (c === 0 && Object.hasOwn(s, t.arrowTypeStart)) {
			let { angle: a, deltaY: m } = b(e[0], e[1]);
			o = s[t.arrowTypeStart] * Math.abs(Math.sin(a)) * (m >= 0 ? 1 : -1);
		} else if (c === e.length - 1 && Object.hasOwn(s, t.arrowTypeEnd)) {
			let { angle: a, deltaY: m } = b(e[e.length - 1], e[e.length - 2]);
			o = s[t.arrowTypeEnd] * Math.abs(Math.sin(a)) * (m >= 0 ? 1 : -1);
		}
...
//#endregion
export { s as i, T as n, d as r, E as t };
