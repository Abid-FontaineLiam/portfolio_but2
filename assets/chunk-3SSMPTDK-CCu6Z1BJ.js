...
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-3SSMPTDK.mjs
function Ps(r, e) {
	(e == null || e > r.length) && (e = r.length);
	for (var t = 0, a = Array(e); t < e; t++) a[t] = r[t];
	return a;
}
m(Ps, "_arrayLikeToArray");
function rc(r) {
	if (Array.isArray(r)) return r;
}
m(rc, "_arrayWithHoles");
function tc(r) {
	if (Array.isArray(r)) return Ps(r);
}
m(tc, "_arrayWithoutHoles");
function gt(r, e) {
	if (!(r instanceof e)) throw new TypeError("Cannot call a class as a function");
}
m(gt, "_classCallCheck");
function ac(r, e) {
...
m(ac, "_defineProperties");
function pt(r, e, t) {
	return e && ac(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r;
}
m(pt, "_createClass");
function Dr(r, e) {
	var t = typeof Symbol < "u" && r[Symbol.iterator] || r["@@iterator"];
	if (!t) {
		if (Array.isArray(r) || (t = Ys(r)) || e) {
			t && (r = t);
			var a = 0, n = m(function() {}, "F");
			return {
				s: n,
				n: m(function() {
					return a >= r.length ? { done: !0 } : {
						done: !1,
						value: r[a++]
					};
				}, "n"),
...
m(Dr, "_createForOfIteratorHelper");
function jl(r, e, t) {
...
m(jl, "_defineProperty$1");
function nc(r) {
	if (typeof Symbol < "u" && r[Symbol.iterator] != null || r["@@iterator"] != null) return Array.from(r);
}
m(nc, "_iterableToArray");
function ic(r, e) {
...
m(ic, "_iterableToArrayLimit");
function sc() {
	throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
}
m(sc, "_nonIterableRest");
function oc() {
	throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
}
m(oc, "_nonIterableSpread");
function je(r, e) {
...
var lc = nr(""), rv = nr({}), vc = nr(function() {}), fc = typeof HTMLElement > "u" ? "undefined" : nr(HTMLElement), Ia = m(function(e) {
...
}, "capitalize"), nt = m(function(e, t) {
	return e.slice(-1 * t.length) === t;
}, "endsWith"), ar = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", bc = "rgb[a]?\\((" + ar + "[%]?)\\s*,\\s*(" + ar + "[%]?)\\s*,\\s*(" + ar + "[%]?)(?:\\s*,\\s*(" + ar + "))?\\)", wc = "rgb[a]?\\((?:" + ar + "[%]?)\\s*,\\s*(?:" + ar + "[%]?)\\s*,\\s*(?:" + ar + "[%]?)(?:\\s*,\\s*(?:" + ar + "))?\\)", xc = "hsl[a]?\\((" + ar + ")\\s*,\\s*(" + ar + "[%])\\s*,\\s*(" + ar + "[%])(?:\\s*,\\s*(" + ar + "))?\\)", Ec = "hsl[a]?\\((?:" + ar + ")\\s*,\\s*(?:" + ar + "[%])\\s*,\\s*(?:" + ar + "[%])(?:\\s*,\\s*(?:" + ar + "))?\\)", Cc = "\\#[0-9a-fA-F]{3}", Tc = "\\#[0-9a-fA-F]{6}", iv = m(function(e, t) {
	return e < t ? -1 : e > t ? 1 : 0;
}, "ascending"), Sc = m(function(e, t) {
	return -1 * iv(e, t);
	...
	if (!(!(e.length === 4 || e.length === 7) || e[0] !== "#")) {
		...
		return t ? (a = parseInt(e[1] + e[1], s), n = parseInt(e[2] + e[2], s), i = parseInt(e[3] + e[3], s)) : (a = parseInt(e[1] + e[2], s), n = parseInt(e[3] + e[4], s), i = parseInt(e[5] + e[6], s)), [
			a,
			n,
			i
		];
	}
}, "hex2tuple"), Dc = m(function(e) {
	var t, a, n, i, s, o, l, u;
	function f(h, m, p) {
		return p < 0 && (p += 1), p > 1 && (p -= 1), p < 1 / 6 ? h + (m - h) * 6 * p : p < 1 / 2 ? m : p < 2 / 3 ? h + (m - h) * (2 / 3 - p) * 6 : h;
	}
	m(f, "hue2rgb");
	var c = new RegExp("^" + xc + "$").exec(e);
	if (c) {
	...
	return t;
}, "hsl2tuple"), Bc = m(function(e) {
	var t, a = new RegExp("^" + bc + "$").exec(e);
	if (a) {
		t = [];
		for (var n = [], i = 1; i <= 3; i++) {
			var s = a[i];
			if (s[s.length - 1] === "%" && (n[i] = !0), s = parseFloat(s), n[i] && (s = s / 100 * 255), s < 0 || s > 255) return;
			t.push(Math.floor(s));
		}
	...
	return t;
}, "rgb2tuple"), Pc = m(function(e) {
	return Ac[e.toLowerCase()];
}, "colorname2tuple"), sv = m(function(e) {
	...
	for (var t = e.map, a = e.keys, n = a.length, i = 0; i < n; i++) {
		...
		i < a.length - 1 ? (t[s] ?? (t[s] = {}), t = t[s]) : t[s] = e.value;
	}
}, "setMap"), uv = m(function(e) {
	for (var t = e.map, a = e.keys, n = a.length, i = 0; i < n; i++) {
		var s = a[i];
...
function za() {
	...
	return m(r, "isObject"), jn = r, jn;
}
m(za, "requireIsObject");
var ei, Bo;
function Rc() {
	if (Bo) return ei;
	Bo = 1;
	return ei = typeof Xa == "object" && Xa && Xa.Object === Object && Xa, ei;
}
m(Rc, "require_freeGlobal");
var ri, Po;
function In() {
	if (Po) return ri;
	Po = 1;
	var r = Rc(), e = typeof self == "object" && self && self.Object === Object && self;
	return ri = r || e || Function("return this")(), ri;
}
m(In, "require_root");
var ti, Ao;
function Mc() {
...
function Lc() {
	...
	return m(e, "trimmedEndIndex"), ai = e, ai;
}
m(Lc, "require_trimmedEndIndex");
var ni, Mo;
function Ic() {
	if (Mo) return ni;
	Mo = 1;
	...
	return m(t, "baseTrim"), ni = t, ni;
}
m(Ic, "require_baseTrim");
var ii, Lo;
function Js() {
	if (Lo) return ii;
	Lo = 1;
	return ii = In().Symbol, ii;
}
m(Js, "require_Symbol");
var si, Io;
function Oc() {
	if (Io) return si;
	Io = 1;
	var r = Js(), e = Object.prototype, t = e.hasOwnProperty, a = e.toString, n = r ? r.toStringTag : void 0;
	function i(s) {
	...
	return m(i, "getRawTag"), si = i, si;
}
m(Oc, "require_getRawTag");
var oi, Oo;
function Nc() {
	if (Oo) return oi;
	Oo = 1;
	...
	return m(t, "objectToString"), oi = t, oi;
}
m(Nc, "require_objectToString");
var ui, No;
function lv() {
	if (No) return ui;
	No = 1;
	var r = Js(), e = Oc(), t = Nc(), a = "[object Null]", n = "[object Undefined]", i = r ? r.toStringTag : void 0;
	function s(o) {
		return o == null ? o === void 0 ? n : a : i && i in Object(o) ? e(o) : t(o);
	}
	return m(s, "baseGetTag"), ui = s, ui;
}
m(lv, "require_baseGetTag");
var li, zo;
function zc() {
	if (zo) return li;
	zo = 1;
	...
	return m(r, "isObjectLike"), li = r, li;
}
m(zc, "requireIsObjectLike");
var vi, Fo;
function Fa() {
	if (Fo) return vi;
	Fo = 1;
	var r = lv(), e = zc(), t = "[object Symbol]";
	function a(n) {
		return typeof n == "symbol" || e(n) && r(n) == t;
	}
	return m(a, "isSymbol"), vi = a, vi;
}
m(Fa, "requireIsSymbol");
var fi, Vo;
function Fc() {
	if (Vo) return fi;
	Vo = 1;
	var r = Ic(), e = za(), t = Fa(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
	function l(u) {
		...
		u = r(u);
		var c = i.test(u);
		return c || s.test(u) ? o(u.slice(2), c ? 2 : 8) : n.test(u) ? a : +u;
	}
	return m(l, "toNumber"), fi = l, fi;
}
m(Fc, "requireToNumber");
var ci, qo;
function Vc() {
	if (qo) return ci;
	qo = 1;
	var r = za(), e = Mc(), t = Fc(), a = "Expected a function", n = Math.max, i = Math.min;
	function s(o, l, u) {
		var f, c, d, g, h, m$1, p = 0, y = !1, b = !1, w = !0;
		if (typeof o != "function") throw new TypeError(a);
		l = t(l) || 0, r(u) && (y = !!u.leading, b = "maxWait" in u, d = b ? n(t(u.maxWait) || 0, l) : d, w = "trailing" in u ? !!u.trailing : w);
		function x(R) {
			var M = f, I = c;
			return f = c = void 0, p = R, g = o.apply(I, M), g;
		}
		m(x, "invokeFunc");
		function C(R) {
			return p = R, h = setTimeout(S, l), y ? x(R) : g;
		}
		m(C, "leadingEdge");
		function T(R) {
			var M = R - m$1, I = R - p, O = l - M;
			return b ? i(O, d - I) : O;
		}
		m(T, "remainingWait");
		function E(R) {
			var M = R - m$1, I = R - p;
			return m$1 === void 0 || M >= l || M < 0 || b && I >= d;
		}
		m(E, "shouldInvoke");
		function S() {
			var R = e();
		...
		m(D, "trailingEdge");
		function B() {
			h !== void 0 && clearTimeout(h), p = 0, f = m$1 = c = h = void 0;
		}
		m(B, "cancel");
		function P() {
			return h === void 0 ? g : D(e());
		}
		m(P, "flush");
		function A() {
			var R = e(), M = E(R);
			if (f = arguments, c = this, m$1 = R, M) {
				if (h === void 0) return C(m$1);
				if (b) return clearTimeout(h), h = setTimeout(S, l), x(m$1);
			}
			return h === void 0 && (h = setTimeout(S, l)), g;
		}
		return m(A, "debounced"), A.cancel = B, A.flush = P, A;
	}
	return m(s, "debounce"), ci = s, ci;
}
m(Vc, "requireDebounce");
var Va = Na(Vc()), di = tr ? tr.performance : null, vv = di && di.now ? function() {
	return di.now();
} : function() {
	return Date.now();
}, _c = (function() {
	...
	return _c(e);
}, "requestAnimationFrame"), Zr = vv, kt = 9261, fv = 65599, Wt = 5381, cv = m(function(e) {
	for (var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : kt, n; n = e.next(), !n.done;) a = a * fv + n.value | 0;
	return a;
}, "hashIterableInts"), Ta = m(function(e) {
	return (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : kt) * fv + e | 0;
}, "hashInt"), Sa = m(function(e) {
	var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Wt;
	return (t << 5) + t + e | 0;
}, "hashIntAlt"), Gc = m(function(e, t) {
	return e * 2097152 + t;
}, "combineHashes"), rt = m(function(e) {
	return e[0] * 2097152 + e[1];
}, "combineHashesArray"), Ya = m(function(e, t) {
	return [Ta(e[0], t[0]), Sa(e[1], t[1])];
}, "hashArrays"), _o = m(function(e, t) {
	var a = {
		value: 0,
		done: !1
	}, n = 0, i = e.length;
	return cv({ next: m(function() {
		return n < i ? a.value = e[n++] : a.done = !0, a;
	}, "next") }, t);
}, "hashIntsArray"), Pt = m(function(e, t) {
	var a = {
		value: 0,
		done: !1
	}, n = 0, i = e.length;
...
}, "hashString"), dv = m(function() {
	return Hc(arguments);
}, "hashStrings"), Hc = m(function(e) {
...
function Wc(r, e, t, a, n) {
	var i = n * Math.PI / 180;
	return {
		x: Math.cos(i) * (r - t) - Math.sin(i) * (e - a) + t,
		y: Math.sin(i) * (r - t) + Math.cos(i) * (e - a) + a
	};
}
m(Wc, "rotatePoint");
var $c = m(function(e, t, a, n, i, s) {
	return {
		x: (e - a) * i + a,
		y: (t - n) * s + n
	};
...
function Uc(r, e, t) {
	if (t === 0) return r;
	var a = (e.x1 + e.x2) / 2, n = (e.y1 + e.y2) / 2, i = e.w / e.h, s = 1 / i, o = Wc(r.x, r.y, a, n, t), l = $c(o.x, o.y, a, n, i, s);
	return {
		x: l.x,
		y: l.y
	};
}
m(Uc, "rotatePosAndSkewByBox");
var Go = !0, Kc = console.warn != null, Xc = console.trace != null, js = Number.MAX_SAFE_INTEGER || 9007199254740991, hv = m(function() {
	return !0;
}, "trueify"), En = m(function() {
	return !1;
}, "falsify"), Ho = m(function() {
	return 0;
}, "zeroify"), eo = m(function() {}, "noop"), Ue = m(function(e) {
	throw new Error(e);
}, "error"), gv = m(function(e) {
	if (e !== void 0) Go = !!e;
	else return Go;
}, "warnings"), qe = m(function(e) {
	gv() && (Kc ? console.warn(e) : (console.log(e), Xc && console.trace()));
}, "warn"), Yc = m(function(e) {
	return we({}, e);
}, "clone"), _r = m(function(e) {
	return e == null ? e : Ge(e) ? e.slice() : Ie(e) ? Yc(e) : e;
}, "copy"), Zc = m(function(e) {
	return e.slice();
}, "copyArray"), pv = m(function(e, t) {
	for (t = e = ""; e++ < 36; t += e * 51 & 52 ? (e ^ 15 ? 8 ^ Math.random() * (e ^ 20 ? 16 : 4) : 4).toString(16) : "-");
	return t;
}, "uuid"), Qc = {}, yv = m(function() {
	return Qc;
}, "staticEmptyObject"), dr = m(function(e) {
	var t = Object.keys(e);
	return function(a) {
...
}, "defaults"), vt = m(function(e, t, a) {
	for (var n = e.length - 1; n >= 0; n--) e[n] === t && e.splice(n, 1);
}, "removeFromArray"), ro = m(function(e) {
	e.splice(0, e.length);
}, "clearArray"), Jc = m(function(e, t) {
	for (var a = 0; a < t.length; a++) {
		var n = t[a];
		e.push(n);
	}
}, "push"), Sr = m(function(e, t, a) {
	return a && (t = nv(a, t)), e[t];
}, "getPrefixedProperty"), Xr = m(function(e, t, a, n) {
	a && (t = nv(a, t)), e[t] = n;
}, "setPrefixedProperty"), jc = (function() {
	function r() {
		gt(this, r), this._obj = {};
	}
	return m(r, "ObjectMap"), pt(r, [
		{
			key: "set",
			value: m(function(t, a) {
...
})(), Yr = typeof Map < "u" ? Map : jc, ed = "undefined", rd = (function() {
	function r(e) {
		if (gt(this, r), this._obj = Object.create(null), this.size = 0, e != null) {
			var t;
			e.instanceString != null && e.instanceString() === this.instanceString() ? t = e.toArray() : t = e;
			for (var a = 0; a < t.length; a++) this.add(t[a]);
		}
	}
	return m(r, "ObjectSet"), pt(r, [
		{
			key: "instanceString",
			value: m(function() {
				return "set";
...
})(), ta = (typeof Set > "u" ? "undefined" : nr(Set)) !== ed ? Set : rd, On = m(function(e, t) {
	...
	var n = t.group;
	if (n ?? (t.data && t.data.source != null && t.data.target != null ? n = "edges" : n = "nodes"), n !== "nodes" && n !== "edges") {
	...
	if (i.position.x ?? (i.position.x = 0), i.position.y ?? (i.position.y = 0), t.renderedPosition) {
	...
	var u = [];
	Ge(t.classes) ? u = t.classes : pe(t.classes) && (u = t.classes.split(/\s+/));
	...
	return e = {
		...
		for (var o = this._private.cy, l = a = pe(a) ? this.filter(a) : a, u = [], f = [], c = {}, d = {}, g = {}, h = 0, m$2, p = this.byGroup(), y = p.nodes, b = p.edges, w = 0; w < l.length; w++) {
			var x = l[w], C = x.id();
			x.isNode() && (u.unshift(x), e.bfs && (g[C] = !0, f.push(x)), d[C] = 0);
		}
		for (var T = m(function() {
			var R = e.bfs ? u.shift() : u.pop(), M = R.id();
			if (e.dfs) {
				if (g[M]) return 0;
				g[M] = !0, f.push(R);
			}
			var I = d[M], O = c[M], L = O != null ? O.source() : null, N = O != null ? O.target() : null, q = O == null ? void 0 : R.same(L) ? N[0] : L[0], H;
			if (H = n(R, O, q, h++, I), H === !0) return m$2 = R, 1;
			if (H === !1) return 1;
			for (var z = R.connectedEdges().filter(function(ee) {
				return (!i || ee.source().same(R)) && b.has(ee);
			}), V = 0; V < z.length; V++) {
				var K = z[V], J = K.connectedNodes().filter(function(ee) {
					return !ee.same(R) && y.has(ee);
				}), X = J.id();
				J.length !== 0 && !g[X] && (J = J[0], u.push(J), e.bfs && (g[X] = !0, f.push(J)), c[X] = K, d[X] = d[M] + 1);
			}
		}, "_loop"), E; u.length !== 0 && (E = T(), !(E !== 0 && E === 1)););
		...
		return {
			path: o.collection(S),
			found: o.collection(m$2)
		};
	}, "searchFn");
}, "defineSearch"), ka = {
	breadthFirstSearch: Wo({ bfs: !0 }),
	depthFirstSearch: Wo({ dfs: !0 })
};
ka.bfs = ka.breadthFirstSearch;
ka.dfs = ka.depthFirstSearch;
var un = { exports: {} }, td = un.exports, $o;
function ad() {
	return $o || ($o = 1, (function(r, e) {
		(function() {
			var t, a, n = Math.floor, i, s, o, l, u, f, c = Math.min, d, g, h, m$3, p;
			a = m(function(y, b) {
				return y < b ? -1 : y > b ? 1 : 0;
			}, "defaultCmp"), f = m(function(y, b, w, x, C) {
				var T;
				if (w ??= 0, C ??= a, w < 0) throw new Error("lo must be non-negative");
				for (x ??= y.length; w < x;) T = n((w + x) / 2), C(b, y[T]) < 0 ? x = T : w = T + 1;
				return [].splice.apply(y, [w, w - w].concat(b)), b;
			}, "insort"), o = m(function(y, b, w) {
				return w ??= a, y.push(b), m$3(y, 0, y.length - 1, w);
			}, "heappush"), s = m(function(y, b) {
				var w, x;
				return b ??= a, w = y.pop(), y.length ? (x = y[0], y[0] = w, p(y, 0, b)) : x = w, x;
			}, "heappop"), u = m(function(y, b, w) {
				var x;
				return w ??= a, x = y[0], y[0] = b, p(y, 0, w), x;
			}, "heapreplace"), l = m(function(y, b, w) {
				var x;
				return w ??= a, y.length && w(y[0], b) < 0 && (x = [y[0], b], b = x[0], y[0] = x[1], p(y, 0, w)), b;
			}, "heappushpop"), i = m(function(y, b) {
				var w, x, C, T, E, S;
				for (b ??= a, T = (function() {
					S = [];
					for (var D = 0, B = n(y.length / 2); 0 <= B ? D < B : D > B; 0 <= B ? D++ : D--) S.push(D);
					return S;
				}).apply(this).reverse(), E = [], x = 0, C = T.length; x < C; x++) w = T[x], E.push(p(y, w, b));
				return E;
			}, "heapify"), h = m(function(y, b, w) {
				var x;
				if (w ??= a, x = y.indexOf(b), x !== -1) return m$3(y, 0, x, w), p(y, x, w);
			}, "updateItem"), d = m(function(y, b, w) {
				var x, C, T, E, S;
				if (w ??= a, C = y.slice(0, b), !C.length) return C;
				for (i(C, w), S = y.slice(b), T = 0, E = S.length; T < E; T++) x = S[T], l(C, x, w);
				return C.sort(w).reverse();
			}, "nlargest"), g = m(function(y, b, w) {
				var x, C, T, E, S, D, B, P, A;
				if (w ??= a, b * 10 <= y.length) {
					if (T = y.slice(0, b).sort(w), !T.length) return T;
					for (C = T[T.length - 1], B = y.slice(b), E = 0, D = B.length; E < D; E++) x = B[E], w(x, C) < 0 && (f(T, x, 0, null, w), T.pop(), C = T[T.length - 1]);
					return T;
				}
				for (i(y, w), A = [], S = 0, P = c(b, y.length); 0 <= P ? S < P : S > P; 0 <= P ? ++S : --S) A.push(s(y, w));
				return A;
			}, "nsmallest"), m$3 = m(function(y, b, w, x) {
				var C, T, E;
				for (x ??= a, C = y[w]; w > b;) {
				...
				return y[w] = C;
			}, "_siftdown"), p = m(function(y, b, w) {
				var x, C, T, E, S;
				for (w ??= a, C = y.length, S = b, T = y[b], x = 2 * b + 1; x < C;) E = x + 1, E < C && !(w(y[x], y[E]) < 0) && (x = E), y[b] = y[x], b = x, x = 2 * b + 1;
				return y[b] = T, m$3(y, S, b, w);
			}, "_siftup"), t = (function() {
				y.push = o, y.pop = s, y.replace = u, y.pushpop = l, y.heapify = i, y.updateItem = h, y.nlargest = d, y.nsmallest = g;
				function y(b) {
					this.cmp = b ?? a, this.nodes = [];
				}
				return m(y, "Heap"), y.prototype.push = function(b) {
...
var qa = Na(nd()), sd = dr({
	...
	var a = sd(e), n = a.root, i = a.weight, s = a.directed, o = this, l = i, u = pe(n) ? this.filter(n)[0] : n[0], f = {}, c = {}, d = {}, g = this.byGroup(), h = g.nodes, m$4 = g.edges;
	m$4.unmergeBy(function(I) {
		return I.isLoop();
	});
	for (var p = m(function(O) {
		return f[O.id()];
	}, "getDist"), y = m(function(O, L) {
		f[O.id()] = L, b.updateItem(O);
	}, "setDist"), b = new qa(function(I, O) {
		return p(I) - p(O);
	}), w = 0; w < h.length; w++) {
		var x = h[w];
		f[x.id()] = x.same(u) ? 0 : Infinity, b.push(x);
	}
	for (var C = m(function(O, L) {
		for (var N = (s ? O.edgesTo(L) : O.edgesWith(L)).intersect(m$4), q = Infinity, H, z = 0; z < N.length; z++) {
			var V = N[z], K = l(V);
			(K < q || !H) && (q = K, H = V);
		}
		return {
	...
	}, "distBetween"); b.size() > 0;) {
		var T = b.pop(), E = p(T), S = T.id();
		if (d[S] = E, E !== Infinity) for (var D = T.neighborhood().intersect(h), B = 0; B < D.length; B++) {
			var P = D[B], A = P.id(), R = C(T, P), M = E + R.dist;
			M < p(P) && (y(P, M), c[A] = {
				node: T,
				edge: R.edge
			});
	...
	return {
		distanceTo: m(function(O) {
			return d[(pe(O) ? h.filter(O)[0] : O[0]).id()];
		}, "distanceTo"),
		pathTo: m(function(O) {
			var L = pe(O) ? h.filter(O)[0] : O[0], N = [], q = L, H = q.id();
			if (L.length > 0) for (N.unshift(L); c[H];) {
				var z = c[H];
				N.unshift(z.edge), N.unshift(z.node), q = z.node, H = q.id();
			}
			return o.spawn(N);
		}, "pathTo")
	};
}, "dijkstra") }, ud = { kruskal: m(function(e) {
	e = e || function(w) {
		return 1;
	};
	for (var t = this.byGroup(), a = t.nodes, n = t.edges, i = a.length, s = new Array(i), o = a, l = m(function(x) {
		for (var C = 0; C < s.length; C++) if (s[C].has(x)) return C;
	}, "findSetIndex"), u = 0; u < i; u++) s[u] = this.spawn(a[u]);
	for (var f = n.sort(function(w, x) {
		return e(w) - e(x);
	}), c = 0; c < f.length; c++) {
		var d = f[c], g = d.source()[0], h = d.target()[0], m$5 = l(g), p = l(h), y = s[m$5], b = s[p];
		m$5 !== p && (o.merge(d), y.merge(b), s.splice(p, 1));
	}
	return o;
}, "kruskal") }, ld = dr({
	root: null,
	...
	heuristic: m(function(e) {
		return 0;
	}, "heuristic"),
	directed: !1
}), vd = { aStar: m(function(e) {
	var t = this.cy(), a = ld(e), n = a.root, i = a.goal, s = a.heuristic, o = a.directed, l = a.weight;
	n = t.collection(n)[0], i = t.collection(i)[0];
	var u = n.id(), f = i.id(), c = {}, d = {}, g = {}, h = new qa(function(H, z) {
		return d[H.id()] - d[z.id()];
	}), m$6 = new ta(), p = {}, y = {}, b = m(function(z, V) {
		h.push(z), m$6.add(V);
	}, "addToOpenSet"), w, x, C = m(function() {
		w = h.pop(), x = w.id(), m$6.delete(x);
	}, "popFromOpenSet"), T = m(function(z) {
		return m$6.has(z);
	}, "isInOpenSet");
	b(n, u), c[u] = 0, d[u] = s(n);
	for (var E = 0; h.size() > 0;) {
		if (C(), E++, x === f) {
			for (var S = [], D = i, B = f, P = y[B]; S.unshift(D), P != null && S.unshift(P), D = p[B], D != null;) B = D.id(), P = y[B];
			return {
				found: !0,
				distance: c[x],
				path: this.spawn(S),
		...
		for (var A = w._private.edges, R = 0; R < A.length; R++) {
			...
			if (this.hasElementWithId(M.id()) && !(o && M.data("source") !== x)) {
				var I = M.source(), O = M.target(), L = I.id() !== x ? I : O, N = L.id();
				if (this.hasElementWithId(N) && !g[N]) {
					var q = c[x] + l(M);
					if (!T(N)) {
						c[N] = q, d[N] = q + s(L), b(L, N), p[N] = w, y[N] = M;
						continue;
					}
	...
	directed: !1
}), cd = { floydWarshall: m(function(e) {
	for (var t = this.cy(), a = fd(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), l = o.nodes, u = o.edges, f = l.length, c = f * f, d = m(function(K) {
		return l.indexOf(K);
	}, "indexOf"), g = m(function(K) {
		return l[K];
	}, "atIndex"), h = new Array(c), m$7 = 0; m$7 < c; m$7++) {
		var p = m$7 % f;
		(m$7 - p) / f === p ? h[m$7] = 0 : h[m$7] = Infinity;
	}
	for (var b = new Array(c), w = new Array(c), x = 0; x < u.length; x++) {
		var C = u[x], T = C.source()[0], E = C.target()[0];
		if (T !== E) {
			var S = d(T), D = d(E), B = S * f + D, P = s(C);
			if (h[B] > P && (h[B] = P, b[B] = D, w[B] = C), !i) {
				var A = D * f + S;
				!i && h[A] > P && (h[A] = P, b[A] = S, w[A] = C);
			}
		}
	}
	for (var R = 0; R < f; R++) for (var M = 0; M < f; M++) for (var I = M * f + R, O = 0; O < f; O++) {
		var L = M * f + O, N = R * f + O;
		h[I] + h[N] < h[L] && (h[L] = h[I] + h[N], b[L] = b[I]);
	}
	var q = m(function(K) {
		return (pe(K) ? t.filter(K) : K)[0];
	}, "getArgEle"), H = m(function(K) {
		return d(q(K));
	}, "indexOfArgEle");
	return {
		distance: m(function(K, J) {
			var X = H(K), ee = H(J);
			return h[X * f + ee];
		}, "distance"),
		path: m(function(K, J) {
			var X = H(K), ee = H(J), te = g(X);
			if (X === ee) return te.collection();
			if (b[X * f + ee] == null) return t.collection();
			var ie = t.collection(), j = X, F;
			for (ie.merge(te); X !== ee;) j = X, X = b[X * f + ee], F = w[j * f + X], ie.merge(F), ie.merge(g(X));
			return ie;
		}, "path")
	};
}, "floydWarshall") }, dd = dr({
	...
	directed: !1,
	root: null
}), hd = { bellmanFord: m(function(e) {
	var t = this, a = dd(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), f = this.byGroup(), c = f.edges, d = f.nodes, g = d.length, h = new Yr(), m$8 = !1, p = [];
	s = u.collection(s)[0], c.unmergeBy(function(Te) {
		return Te.isLoop();
	});
	for (var y = c.length, b = m(function(xe) {
		var me = h.get(xe.id());
		return me || (me = {}, h.set(xe.id(), me)), me;
	}, "getInfo"), w = m(function(xe) {
		return (pe(xe) ? u.$(xe) : xe)[0];
	}, "getNodeFromTo"), x = m(function(xe) {
		return b(w(xe)).dist;
	}, "distanceTo"), C = m(function(xe) {
		for (var me = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s, se = w(xe), he = [], ge = se;;) {
			if (ge == null) return t.spawn();
			var Ce = b(ge), ye = Ce.edge, ke = Ce.pred;
		...
		var E = d[T], S = b(E);
		E.same(s) ? S.dist = 0 : S.dist = Infinity, S.pred = null, S.edge = null;
	}
	for (var D = !1, B = m(function(xe, me, se, he, ge, Ce) {
		var ye = he.dist + Ce;
		ye < ge.dist && !se.same(he.edge) && (ge.dist = ye, ge.pred = xe, ge.edge = se, D = !0);
	}, "checkForEdgeReplacement"), P = 1; P < g; P++) {
		D = !1;
		for (var A = 0; A < y; A++) {
			var R = c[A], M = R.source(), I = R.target(), O = o(R), L = b(M), N = b(I);
			B(M, I, R, L, N, O), i || B(I, M, R, N, L, O);
		}
		if (!D) break;
	}
	if (D) for (var q = [], H = 0; H < y; H++) {
		var z = c[H], V = z.source(), K = z.target(), J = o(z), X = b(V).dist, ee = b(K).dist;
		if (X + J < ee || !i && ee + J < X) if (m$8 || (qe("Graph contains a negative weight cycle for Bellman-Ford"), m$8 = !0), e.findNegativeWeightCycles !== !1) {
			var te = [];
			X + J < ee && te.push(V), !i && ee + J < X && te.push(K);
			for (var ie = te.length, j = 0; j < ie; j++) {
				var F = te[j], _ = [F];
				_.push(b(F).edge);
				for (var W = b(F).pred; _.indexOf(W) === -1;) _.push(W), _.push(b(W).edge), W = b(W).pred;
				_ = _.slice(_.indexOf(W));
				for (var Z = _[0].id(), ae = 0, de = 2; de < _.length; de += 2) _[de].id() < Z && (Z = _[de].id(), ae = de);
				_ = _.slice(ae).concat(_.slice(0, ae)), _.push(_[0]);
				var Re = _.map(function(Te) {
					return Te.id();
				}).join(",");
				q.indexOf(Re) === -1 && (p.push(l.spawn(_)), q.push(Re));
			}
		} else break;
	}
	return {
		distanceTo: x,
		pathTo: C,
		hasNegativeWeightCycle: m$8,
		negativeWeightCycles: p
	};
}, "bellmanFord") }, gd = Math.sqrt(2), pd = m(function(e, t, a) {
	...
	return u;
}, "collapse"), gi = m(function(e, t, a, n) {
	for (; a > n;) t = pd(Math.floor(Math.random() * t.length), e, t), a--;
	return t;
}, "contractUntil"), yd = { kargerStein: m(function() {
	var e = this, t = this.byGroup(), a = t.nodes, n = t.edges;
	n.unmergeBy(function(N) {
		return N.isLoop();
	});
	var i = a.length, s = n.length, o = Math.ceil(Math.pow(Math.log(i) / Math.LN2, 2)), l = Math.floor(i / gd);
	if (i < 2) {
	...
	for (var d = Infinity, g = [], h = new Array(i), m$9 = new Array(i), p = new Array(i), y = m(function(q, H) {
		for (var z = 0; z < i; z++) H[z] = q[z];
	}, "copyNodesMap"), b = 0; b <= o; b++) {
		for (var w = 0; w < i; w++) m$9[w] = w;
		var x = gi(m$9, u.slice(), i, l), C = x.slice();
		y(m$9, p);
		var T = gi(m$9, x, l, 2), E = gi(p, C, l, 2);
		T.length <= E.length && T.length < d ? (d = T.length, g = T, y(m$9, h)) : E.length <= T.length && E.length < d && (d = E.length, g = E, y(p, h));
	}
	for (var S = this.spawn(g.map(function(N) {
		return n[N[0]];
	})), D = this.spawn(), B = this.spawn(), P = h[0], A = 0; A < h.length; A++) {
		var R = h[A], M = a[A];
...
}, "kargerStein") }, pi, md = m(function(e) {
	return {
		x: e.x,
		y: e.y
	};
}, "copyPosition"), Nn = m(function(e, t, a) {
	return {
		x: e.x * t + a.x,
		y: e.y * t + a.y
	};
}, "modelToRenderedPosition"), mv = m(function(e, t, a) {
	return {
		x: (e.x - a.x) / t,
		y: (e.y - a.y) / t
	};
}, "renderedToModelPosition"), $t = m(function(e) {
	return {
		x: e[0],
		y: e[1]
	};
}, "array2point"), bd = m(function(e) {
	for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : e.length, n = Infinity, i = t; i < a; i++) {
		var s = e[i];
	...
	for (var o = 0, l = e.length - 1; l >= 0; l--) {
		var u = e[l];
		s ? isFinite(u) || (e[l] = -Infinity, o++) : e.splice(l, 1);
	}
...
}, "median"), Cd = m(function(e) {
	return Math.PI * e / 180;
}, "deg2rad"), Za = m(function(e, t) {
	return Math.atan2(t, e) - Math.PI / 2;
}, "getAngleFromDisp"), to = Math.log2 || function(r) {
	return Math.log(r) / Math.log(2);
}, ao = m(function(e) {
	return e > 0 ? 1 : e < 0 ? -1 : 0;
}, "signum"), At = m(function(e, t) {
	return Math.sqrt(Tt(e, t));
}, "dist"), Tt = m(function(e, t) {
	var a = t.x - e.x, n = t.y - e.y;
	return a * a + n * n;
}, "sqdist"), Td = m(function(e) {
	for (var t = e.length, a = 0, n = 0; n < t; n++) a += e[n];
	for (var i = 0; i < t; i++) e[i] = e[i] / a;
	return e;
}, "inPlaceSumNormalize"), or = m(function(e, t, a, n) {
	return (1 - n) * (1 - n) * e + 2 * (1 - n) * n * t + n * n * a;
}, "qbezierAt"), Xt = m(function(e, t, a, n) {
	return {
		x: or(e.x, t.x, a.x, n),
		y: or(e.y, t.y, a.y, n)
	};
}, "qbezierPtAt"), Sd = m(function(e, t, a, n) {
	var i = {
		x: t.x - e.x,
		y: t.y - e.y
	}, s = At(e, t), o = {
...
}, "lineAt"), Da = m(function(e, t, a) {
	return Math.max(e, Math.min(a, t));
}, "bound"), xr = m(function(e) {
	if (e == null) return {
		x1: Infinity,
		y1: Infinity,
		x2: -Infinity,
...
}, "makeBoundingBox"), kd = m(function(e) {
	return {
		x1: e.x1,
		x2: e.x2,
		w: e.w,
...
function Ad(r, e) {
	...
	var t = m(function(S, D) {
		return {
			x: S.x + D.x,
			y: S.y + D.y
		};
	}, "add"), a = m(function(S, D) {
		return {
			x: S.x - D.x,
			y: S.y - D.y
		};
	}, "sub"), n = m(function(S, D) {
		return {
			x: S.x * D,
			y: S.y * D
		};
	}, "scale"), i = m(function(S, D) {
		return S.x * D.y - S.y * D.x;
	}, "cross"), s = m(function(S) {
		var D = Pd(S.x, S.y);
		return D === 0 ? {
			x: 0,
			y: 0
	...
	}, "normalize"), o = m(function(S) {
		for (var D = 0, B = 0; B < S.length; B++) {
			var P = S[B], A = S[(B + 1) % S.length];
			D += P.x * A.y - A.x * P.y;
		}
		return D / 2;
	}, "signedArea"), l = m(function(S, D, B, P) {
		var A = a(D, S), R = a(P, B), M = i(A, R);
		if (Math.abs(M) < 1e-9) return t(S, n(A, .5));
		return t(S, n(A, i(a(B, S), R) / M));
	}, "intersectLines"), u = r.map(function(E) {
		return {
			x: E.x,
			y: E.y
		};
	...
	for (var f = u.length, c = [], d = 0; d < f; d++) {
		var g = u[d], h = u[(d + 1) % f], m$10 = a(h, g), p = s({
			x: m$10.y,
			y: -m$10.x
		});
		c.push(p);
	}
	for (var y = c.map(function(E, S) {
		return {
			p1: t(u[S], n(E, e)),
			p2: t(u[(S + 1) % f], n(E, e))
		};
	}), b = [], w = 0; w < f; w++) {
		var x = y[(w - 1 + f) % f], C = y[w], T = l(x.p1, x.p2, C.p1, C.p2);
		b.push(T);
	}
	return b;
}
...
function Rd(r, e, t, a, n, i) {
	var o = Ad(qd(r, e, t, a, n), i), l = xr();
	return o.forEach(function(u) {
		return bv(l, u.x, u.y);
	}), l;
}
m(Rd, "miterBox");
var xv = m(function(e, t, a, n, i, s, o) {
	var l = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto", u = l === "auto" ? ft(i, s) : l, f = i / 2, c = s / 2;
	u = Math.min(u, f, c);
	var d = u !== f, g = u !== c, h;
	if (d) {
		var m = a - f + u - o, p = n - c - o;
		if (h = st(e, t, a, n, m, p, a + f - u + o, p, !1), h.length > 0) return h;
	}
	if (g) {
		var w = a + f + o;
		if (h = st(e, t, a, n, w, n - c + u - o, w, n + c - u + o, !1), h.length > 0) return h;
	}
	if (d) {
		var E = a - f + u - o, S = n + c + o;
		if (h = st(e, t, a, n, E, S, a + f - u + o, S, !1), h.length > 0) return h;
	}
	if (g) {
		var P = a - f - o;
		if (h = st(e, t, a, n, P, n - c + u - o, P, n + c - u + o, !1), h.length > 0) return h;
	}
	var I;
	var O = a - f + u, L = n - c + u;
	if (I = ma(e, t, a, n, O, L, u + o), I.length > 0 && I[0] <= O && I[1] <= L) return [I[0], I[1]];
	var N = a + f - u, q = n - c + u;
	if (I = ma(e, t, a, n, N, q, u + o), I.length > 0 && I[0] >= N && I[1] <= q) return [I[0], I[1]];
	var H = a + f - u, z = n + c - u;
	if (I = ma(e, t, a, n, H, z, u + o), I.length > 0 && I[0] >= H && I[1] >= z) return [I[0], I[1]];
	var V = a - f + u, K = n + c - u;
	if (I = ma(e, t, a, n, V, K, u + o), I.length > 0 && I[0] <= V && I[1] >= K) return [I[0], I[1]];
	return [];
}, "roundRectangleIntersectLine"), Md = m(function(e, t, a, n, i, s, o) {
	var l = o, u = Math.min(a, i), f = Math.max(a, i), c = Math.min(n, s), d = Math.max(n, s);
	return u - l <= e && e <= f + l && c - l <= t && t <= d + l;
}, "inLineVicinity"), Ld = m(function(e, t, a, n, i, s, o, l, u) {
	var f = {
		x1: Math.min(a, o, i) - u,
		x2: Math.max(a, o, i) + u,
		y1: Math.min(n, l, s) - u,
...
}, "inBezierVicinity"), Id = m(function(e, t, a, n) {
	a -= n;
	var i = t * t - 4 * e * a;
	if (i < 0) return [];
	var s = Math.sqrt(i), o = 2 * e;
	return [(-t + s) / o, (-t - s) / o];
}, "solveQuadratic"), Od = m(function(e, t, a, n, i) {
	e === 0 && (e = 1e-5), t /= e, a /= e, n /= e;
	var o, l, u, f, c, d, g, h;
...
}, "solveCubic"), Nd = m(function(e, t, a, n, i, s, o, l) {
	...
	m.push(1), m.push(0);
	for (var y = -1, b, w, x, C = 0; C < m.length; C++) b = Math.pow(1 - m[C], 2) * a + 2 * (1 - m[C]) * m[C] * i + m[C] * m[C] * o, w = Math.pow(1 - m[C], 2) * n + 2 * (1 - m[C]) * m[C] * s + m[C] * m[C] * l, x = Math.pow(b - e, 2) + Math.pow(w - t, 2), y >= 0 ? x < y && (y = x) : y = x;
	return y;
}, "sqdistToQuadraticBezier"), zd = m(function(e, t, a, n, i, s) {
	var o = [e - a, t - n], l = [i - a, s - n], u = l[0] * l[0] + l[1] * l[1], f = o[0] * o[0] + o[1] * o[1], c = o[0] * l[0] + o[1] * l[1], d = c * c / u;
	return c < 0 ? f : d > u ? (e - i) * (e - i) + (t - s) * (t - s) : f - d;
}, "sqdistToFiniteLine"), kr = m(function(e, t, a) {
	...
	return u % 2 !== 0;
}, "pointInsidePolygonPoints"), Qr = m(function(e, t, a, n, i, s, o, l, u) {
	...
	return kr(e, t, m);
}, "pointInsidePolygon"), Fd = m(function(e, t, a, n, i, s, o, l) {
	for (var u = new Array(a.length * 2), f = 0; f < l.length; f++) {
		var c = l[f];
		u[f * 4 + 0] = c.startX, u[f * 4 + 1] = c.startY, u[f * 4 + 2] = c.stopX, u[f * 4 + 3] = c.stopY;
		if (Math.pow(c.cx - e, 2) + Math.pow(c.cy - t, 2) <= Math.pow(c.radius, 2)) return !0;
	}
	return kr(e, t, u);
}, "pointInsideRoundPolygon"), Cn = m(function(e) {
	for (var t = new Array(e.length / 2), a, n, i, s, o, l, u, f, c = 0; c < e.length / 4; c++) {
		...
		var d = st(a, n, i, s, o, l, u, f, !0);
		t[c * 2] = d[0], t[c * 2 + 1] = d[1];
	}
	return t;
}, "joinLines"), Tn = m(function(e, t) {
	...
	return a;
}, "expandPolygon"), Vd = m(function(e, t, a, n, i, s) {
	var o = a - e, l = n - t;
	o /= i, l /= s;
	var u = Math.sqrt(o * o + l * l), f = u - 1;
	if (f < 0) return [];
	var c = f / u;
	return [(a - e) * c + e, (n - t) * c + t];
}, "intersectLineEllipse"), Bt = m(function(e, t, a, n, i, s, o) {
	return e -= i, t -= s, e /= a / 2 + o, t /= n / 2 + o, e * e + t * t <= 1;
}, "checkInEllipse"), ma = m(function(e, t, a, n, i, s, o) {
	var l = [a - e, n - t], u = [e - i, t - s], f = l[0] * l[0] + l[1] * l[1], c = 2 * (u[0] * l[0] + u[1] * l[1]), d = u[0] * u[0] + u[1] * u[1] - o * o, g = c * c - 4 * f * d;
	if (g < 0) return [];
	var h = (-c + Math.sqrt(g)) / (2 * f), m = (-c - Math.sqrt(g)) / (2 * f), p = Math.min(h, m), y = Math.max(h, m), b = [];
	if (p >= 0 && p <= 1 && b.push(p), y >= 0 && y <= 1 && b.push(y), b.length === 0) return [];
	var w = b[0] * l[0] + e, x = b[0] * l[1] + t;
	if (b.length > 1) {
		if (b[0] == b[1]) return [w, x];
		return [
			w,
			x,
			b[1] * l[0] + e,
...
}, "intersectLineCircle"), yi = m(function(e, t, a) {
	return t <= e && e <= a || a <= e && e <= t ? e : e <= t && t <= a || a <= t && t <= e ? t : a;
}, "midOfThree"), st = m(function(e, t, a, n, i, s, o, l, u) {
	var f = e - i, c = a - e, d = o - i, g = t - s, h = n - t, m = l - s, p = d * g - m * f, y = c * g - h * f, b = m * c - d * h;
	if (b !== 0) {
		var w = p / b, x = y / b, C = .001, T = 0 - C, E = 1 + C;
		return T <= w && w <= E && T <= x && x <= E ? [e + w * c, t + w * h] : u ? [e + w * c, t + w * h] : [];
	} else return p === 0 || y === 0 ? yi(e, a, o) === o ? [o, l] : yi(e, a, i) === i ? [i, s] : yi(i, o, a) === a ? [a, n] : [] : [];
}, "finiteLinesIntersect"), qd = m(function(e, t, a, n, i) {
	...
	return s;
}, "transformPoints"), Ba = m(function(e, t, a, n, i, s, o, l) {
	var u = [], f, c = new Array(a.length), d = !0;
	s ?? (d = !1);
	var g;
	if (d) {
	...
	for (var p, y, b, w, x = 0; x < g.length / 2; x++) p = g[x * 2], y = g[x * 2 + 1], x < g.length / 2 - 1 ? (b = g[(x + 1) * 2], w = g[(x + 1) * 2 + 1]) : (b = g[0], w = g[1]), f = st(e, t, n, i, p, y, b, w), f.length !== 0 && u.push(f[0], f[1]);
	return u;
}, "polygonIntersectLine"), _d = m(function(e, t, a, n, i, s, o, l, u) {
	var f = [], c, d = new Array(a.length * 2);
	u.forEach(function(b, w) {
		w === 0 ? (d[d.length - 2] = b.startX, d[d.length - 1] = b.startY) : (d[w * 4 - 2] = b.startX, d[w * 4 - 1] = b.startY), d[w * 4] = b.stopX, d[w * 4 + 1] = b.stopY, c = ma(e, t, n, i, b.cx, b.cy, b.radius), c.length !== 0 && f.push(c[0], c[1]);
	});
	for (var g = 0; g < d.length / 4; g++) c = st(e, t, n, i, d[g * 4], d[g * 4 + 1], d[g * 4 + 2], d[g * 4 + 3], !1), c.length !== 0 && f.push(c[0], c[1]);
	if (f.length > 2) {
		for (var h = [f[0], f[1]], m = Math.pow(h[0] - e, 2) + Math.pow(h[1] - t, 2), p = 1; p < f.length / 2; p++) {
	...
	return f;
}, "roundPolygonIntersectLine"), Qa = m(function(e, t, a) {
	var n = [e[0] - t[0], e[1] - t[1]], i = Math.sqrt(n[0] * n[0] + n[1] * n[1]), s = (i - a) / i;
	return s < 0 && (s = 1e-5), [t[0] + s * n[0], t[1] + s * n[1]];
}, "shortenIntersection"), wr = m(function(e, t) {
	var a = As(e, t);
	return a = Ev(a), a;
}, "generateUnitNgonPointsFitToSquare"), Ev = m(function(e) {
	for (var t, a, n = e.length / 2, i = Infinity, s = Infinity, o = -Infinity, l = -Infinity, u = 0; u < n; u++) t = e[2 * u], a = e[2 * u + 1], i = Math.min(i, t), o = Math.max(o, t), s = Math.min(s, a), l = Math.max(l, a);
	for (var f = 2 / (o - i), c = 2 / (l - s), d = 0; d < n; d++) t = e[2 * d] = e[2 * d] * f, a = e[2 * d + 1] = e[2 * d + 1] * c, i = Math.min(i, t), o = Math.max(o, t), s = Math.min(s, a), l = Math.max(l, a);
	if (s < -1) for (var g = 0; g < n; g++) a = e[2 * g + 1] = e[2 * g + 1] + (-1 - s);
	return e;
}, "fitPolygonToSquare"), As = m(function(e, t) {
	...
	return i;
}, "generateUnitNgonPoints"), ft = m(function(e, t) {
	return Math.min(e / 4, t / 4, 8);
}, "getRoundRectangleRadius"), Cv = m(function(e, t) {
	return Math.min(e / 10, t / 10, 8);
}, "getRoundPolygonRadius"), io = m(function() {
	return 8;
}, "getCutRectangleCornerLength"), Gd = m(function(e, t, a) {
	return [
		e - 2 * t + a,
		2 * (t - e),
		e
	];
}, "bezierPtsToQuadCoeff"), Rs = m(function(e, t) {
	return {
...
function mi(r, e) {
	...
	m(t, "getAxes");
	function a(c, d) {
		var g = Infinity, h = -Infinity, m = Dr(c), p;
		try {
			for (m.s(); !(p = m.n()).done;) {
				var y = p.value, b = y.x * d.x + y.y * d.y;
				g = Math.min(g, b), h = Math.max(h, b);
			}
		} catch (w) {
			m.e(w);
		} finally {
	...
	m(n, "overlaps");
	var s = Dr([].concat(bn(t(r)), bn(t(e)))), o;
	try {
		for (s.s(); !(o = s.n()).done;) {
			var l = o.value;
			if (!n(a(r, l), a(e, l))) return !1;
		}
	} catch (c) {
		s.e(c);
	} finally {
...
var Hd = dr({
...
}), Wd = { pageRank: m(function(e) {
	for (var t = Hd(e), a = t.dampingFactor, n = t.precision, i = t.iterations, s = t.weight, o = this._private.cy, l = this.byGroup(), u = l.nodes, f = l.edges, c = u.length, d = c * c, g = f.length, h = new Array(d), m$11 = new Array(c), p = (1 - a) / c, y = 0; y < c; y++) {
		for (var b = 0; b < c; b++) {
			var w = y * c + b;
			h[w] = 0;
		}
	...
	for (var x = 0; x < g; x++) {
		var C = f[x], T = C.data("source"), E = C.data("target");
		if (T !== E) {
			var S = u.indexOfId(T), D = u.indexOfId(E), B = s(C), P = D * c + S;
			h[P] += B, m$11[S] += B;
		}
	}
	for (var A = 1 / c + p, R = 0; R < c; R++) if (m$11[R] === 0) for (var M = 0; M < c; M++) {
		var I = M * c + R;
		h[I] = A;
	}
	...
	degreeCentralityNormalized: m(function(e) {
		e = Yo(e);
		var t = this.cy(), a = this.nodes(), n = a.length;
		if (e.directed) {
			for (var f = {}, c = {}, d = 0, g = 0, h = 0; h < n; h++) {
				var m$12 = a[h], p = m$12.id();
				e.root = m$12;
				var y = this.degreeCentrality(e);
				d < y.indegree && (d = y.indegree), g < y.outdegree && (g = y.outdegree), f[p] = y.indegree, c[p] = y.outdegree;
			}
			return {
				indegree: m(function(w) {
					return d == 0 ? 0 : (pe(w) && (w = t.filter(w)), f[w.id()] / d);
				}, "indegree"),
				outdegree: m(function(w) {
					return g === 0 ? 0 : (pe(w) && (w = t.filter(w)), c[w.id()] / g);
				}, "outdegree")
			};
		} else {
			...
			return { degree: m(function(w) {
				return s === 0 ? 0 : (pe(w) && (w = t.filter(w)), i[w.id()] / s);
			}, "degree") };
		}
	}, "degreeCentralityNormalized"),
	degreeCentrality: m(function(e) {
		e = Yo(e);
		...
		if (i = t.collection(i)[0], o) {
			...
			}), p = h.length, y = m.length, b = 0, w = 0, x = 0; x < h.length; x++) b += s(h[x]);
			for (var C = 0; C < m.length; C++) w += s(m[C]);
			return {
				indegree: Math.pow(p, 1 - l) * Math.pow(b, l),
				outdegree: Math.pow(y, 1 - l) * Math.pow(w, l)
			};
		} else {
			for (var u = i.connectedEdges().intersection(a), f = u.length, c = 0, d = 0; d < u.length; d++) c += s(u[d]);
			return { degree: Math.pow(f, 1 - l) * Math.pow(c, l) };
		}
	}, "degreeCentrality")
};
...
var Zo = dr({
	...
	closenessCentralityNormalized: m(function(e) {
		for (var t = Zo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, l = 0, u = this.nodes(), f = this.floydWarshall({
			weight: n,
			directed: i
		}), c = 0; c < u.length; c++) {
			for (var d = 0, g = u[c], h = 0; h < u.length; h++) if (c !== h) {
				var m$13 = f.distance(g, u[h]);
				a ? d += 1 / m$13 : d += m$13;
			}
			a || (d = 1 / d), l < d && (l = d), o[g.id()] = d;
		}
		return { closeness: m(function(y) {
			return l == 0 ? 0 : (pe(y) ? y = s.filter(y)[0].id() : y = y.id(), o[y] / l);
		}, "closeness") };
	}, "closenessCentralityNormalized"),
	closenessCentrality: m(function(e) {
		var t = Zo(e), a = t.root, n = t.weight, i = t.directed, s = t.harmonic;
		a = this.filter(a)[0];
...
var $d = dr({
	weight: null,
	directed: !1
}), Ms = { betweennessCentrality: m(function(e) {
	for (var t = $d(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), l = {}, u = {}, f = 0, c = {
		set: m(function(w, x) {
			u[w] = x, x > f && (f = x);
		}, "set"),
		get: m(function(w) {
	...
	for (var m$14 = m(function() {
		for (var w = o[p].id(), x = [], C = {}, T = {}, E = {}, S = new qa(function(J, X) {
			return E[J] - E[X];
		}), D = 0; D < o.length; D++) {
			var B = o[D].id();
			C[B] = [], T[B] = 0, E[B] = Infinity;
		}
		for (T[w] = 1, E[w] = 0, S.push(w); !S.empty();) {
			var P = S.pop();
			if (x.push(P), i) for (var A = 0; A < l[P].length; A++) {
				var R = l[P][A], M = s.getElementById(P), I = void 0;
				M.edgesTo(R).length > 0 ? I = M.edgesTo(R)[0] : I = R.edgesTo(M)[0];
				var O = n(I);
				R = R.id(), E[R] > E[P] + O && (E[R] = E[P] + O, S.nodes.indexOf(R) < 0 ? S.push(R) : S.updateItem(R), T[R] = 0, C[R] = []), E[R] == E[P] + O && (T[R] = T[R] + T[P], C[R].push(P));
			}
			else for (var L = 0; L < l[P].length; L++) {
				var N = l[P][L].id();
				E[N] == Infinity && (S.push(N), E[N] = E[P] + 1), E[N] == E[P] + 1 && (T[N] = T[N] + T[P], C[N].push(P));
			}
		}
		for (var q = {}, H = 0; H < o.length; H++) q[o[H].id()] = 0;
		for (; x.length > 0;) {
			for (var z = x.pop(), V = 0; V < C[z].length; V++) {
				var K = C[z][V];
				q[K] = q[K] + T[K] / T[z] * (1 + q[z]);
			}
			z != o[p].id() && c.set(z, c.get(z) + q[z]);
		}
	}, "_loop"), p = 0; p < o.length; p++) m$14();
	var y = {
		betweenness: m(function(w) {
			var x = s.collection(w).id();
			return c.get(x);
		}, "betweenness"),
		betweennessNormalized: m(function(w) {
			if (f == 0) return 0;
			var x = s.collection(w).id();
			return c.get(x) / f;
...
var Ud = dr({
	...
	return Ud(e);
}, "setOptions"), Xd = m(function(e, t) {
	for (var a = 0, n = 0; n < t.length; n++) a += t[n](e);
	return a;
}, "getSimilarity"), Yd = m(function(e, t, a) {
	for (var n = 0; n < t; n++) e[n * t + n] = a;
}, "addLoops"), Tv = m(function(e, t) {
	for (var a, n = 0; n < t; n++) {
		a = 0;
		for (var i = 0; i < t; i++) a += e[i * t + n];
		for (var s = 0; s < t; s++) e[s * t + n] = e[s * t + n] / a;
	}
}, "normalize"), Zd = m(function(e, t, a) {
	for (var n = new Array(a * a), i = 0; i < a; i++) {
		for (var s = 0; s < a; s++) n[i * a + s] = 0;
		for (var o = 0; o < a; o++) for (var l = 0; l < a; l++) n[i * a + l] += e[i * a + o] * t[o * a + l];
	}
	return n;
}, "mmult"), Qd = m(function(e, t, a) {
	for (var n = e.slice(0), i = 1; i < a; i++) e = Zd(e, n, t);
	return e;
}, "expand"), Jd = m(function(e, t, a) {
	for (var n = new Array(t * t), i = 0; i < t * t; i++) n[i] = Math.pow(e[i], a);
	return Tv(n, t), n;
}, "inflate"), jd = m(function(e, t, a, n) {
	for (var i = 0; i < a; i++) if (Math.round(e[i] * Math.pow(10, n)) / Math.pow(10, n) !== Math.round(t[i] * Math.pow(10, n)) / Math.pow(10, n)) return !1;
	return !0;
}, "hasConverged"), eh = m(function(e, t, a, n) {
	for (var i = [], s = 0; s < t; s++) {
		for (var o = [], l = 0; l < t; l++) Math.round(e[s * t + l] * 1e3) / 1e3 > 0 && o.push(a[l]);
		o.length !== 0 && i.push(n.collection(o));
	}
	return i;
}, "assign"), rh = m(function(e, t) {
	for (var a = 0; a < e.length; a++) if (!t[a] || e[a].id() !== t[a].id()) return !1;
	return !0;
}, "isDuplicate"), th = m(function(e) {
	for (var t = 0; t < e.length; t++) for (var a = 0; a < e.length; a++) t != a && rh(e[t], e[a]) && e.splice(a, 1);
	return e;
}, "removeDuplicates"), Qo = m(function(e) {
	for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = Kd(e), s = {}, o = 0; o < t.length; o++) s[t[o].id()] = o;
	for (var l = t.length, u = l * l, f = new Array(u), c, d = 0; d < u; d++) f[d] = 0;
	for (var g = 0; g < a.length; g++) {
		var h = a[g], m = s[h.source().id()], p = s[h.target().id()], y = Xd(h, i.attributes);
		f[m * l + p] += y, f[p * l + m] += y;
	}
	Yd(f, l, i.multFactor), Tv(f, l);
	for (var b = !0, w = 0; b && w < i.maxIterations;) b = !1, c = Qd(f, l, i.expandFactor), f = Jd(c, l, i.inflateFactor), jd(f, c, u, 4) || (b = !0), w++;
	var x = eh(f, l, t, n);
	return x = th(x), x;
}, "markovClustering"), ah = {
	markovClustering: Qo,
	...
	return e;
}, "identity"), Sv = m(function(e, t) {
	return Math.abs(t - e);
}, "absDiff"), Jo = m(function(e, t, a) {
	return e + Sv(t, a);
}, "addAbsDiff"), jo = m(function(e, t, a) {
	return e + Math.pow(a - t, 2);
}, "addSquaredDiff"), ih = m(function(e) {
	return Math.sqrt(e);
}, "sqrt"), sh = m(function(e, t, a) {
	return Math.max(e, Sv(t, a));
}, "maxAbsDiff"), fa = m(function(e, t, a, n, i) {
	for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : nh, o = n, l, u, f = 0; f < e; f++) l = t(f), u = a(f), o = i(o, l, u);
	return s(o);
}, "getDistance"), jt = {
	euclidean: m(function(e, t, a) {
		return e >= 2 ? fa(e, t, a, 0, jo, ih) : fa(e, t, a, 0, Jo);
	}, "euclidean"),
	squaredEuclidean: m(function(e, t, a) {
		return fa(e, t, a, 0, jo);
	}, "squaredEuclidean"),
	manhattan: m(function(e, t, a) {
		return fa(e, t, a, 0, Jo);
	}, "manhattan"),
	max: m(function(e, t, a) {
		return fa(e, t, a, -Infinity, sh);
	}, "max")
};
...
var oh = dr({
	...
	return oh(e);
}, "setOptions"), Sn = m(function(e, t, a, n, i) {
	var o = i !== "kMedoids" ? function(c) {
		return a[c];
	} : function(c) {
		return n[c](a);
	}, l = m(function(d) {
	...
	return o;
}, "randomCentroids"), kv = m(function(e, t, a, n, i) {
	for (var s = Infinity, o = 0, l = 0; l < t.length; l++) {
		var u = Sn(a, e, t[l], n, i);
		u < s && (s = u, o = l);
	}
	return o;
}, "classify"), Dv = m(function(e, t, a) {
	for (var n = [], i = null, s = 0; s < t.length; s++) i = t[s], a[i.id()] === e && n.push(i);
	return n;
}, "buildCluster"), uh = m(function(e, t, a) {
	return Math.abs(t - e) <= a;
}, "haveValuesConverged"), lh = m(function(e, t, a) {
	for (var n = 0; n < e.length; n++) for (var i = 0; i < e[n].length; i++) if (Math.abs(e[n][i] - t[n][i]) > a) return !1;
	return !0;
}, "haveMatricesConverged"), vh = m(function(e, t, a) {
	for (var n = 0; n < a; n++) if (e === t[n]) return !0;
	return !1;
}, "seenBefore"), eu = m(function(e, t) {
	var a = new Array(t);
	...
	return a;
}, "randomMedoids"), ru = m(function(e, t, a) {
	for (var n = 0, i = 0; i < t.length; i++) n += Sn("manhattan", t[i], e, a, "kMedoids");
	return n;
}, "findCost"), fh = m(function(e) {
	var t = this.cy(), a = this.nodes(), n = null, i = so(e), s = new Array(i.k), o = {}, l;
	i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, l = bi(a, i.k, i.attributes)) : nr(i.testCentroids) === "object" ? l = i.testCentroids : l = bi(a, i.k, i.attributes) : l = bi(a, i.k, i.attributes);
	for (var u = !0, f = 0; u && f < i.maxIterations;) {
		for (var c = 0; c < a.length; c++) n = a[c], o[n.id()] = kv(n, l, i.distance, i.attributes, "kMeans");
		u = !1;
		for (var d = 0; d < i.k; d++) {
			var g = Dv(d, a, o);
			if (g.length !== 0) {
				for (var h = i.attributes.length, m = l[d], p = new Array(h), y = new Array(h), b = 0; b < h; b++) {
					y[b] = 0;
					for (var w = 0; w < g.length; w++) n = g[w], y[b] += i.attributes[b](n);
					p[b] = y[b] / g.length, uh(p[b], m[b], i.sensitivityThreshold) || (u = !0);
				}
				l[d] = p, s[d] = t.collection(g);
			}
		}
		f++;
	}
	return s;
}, "kMeans"), ch = m(function(e) {
	var t = this.cy(), a = this.nodes(), n = null, i = so(e), s = new Array(i.k), o, l = {}, u, f = new Array(i.k);
	i.testMode ? typeof i.testCentroids == "number" || (nr(i.testCentroids) === "object" ? o = i.testCentroids : o = eu(a, i.k)) : o = eu(a, i.k);
	for (var c = !0, d = 0; c && d < i.maxIterations;) {
		for (var g = 0; g < a.length; g++) n = a[g], l[n.id()] = kv(n, o, i.distance, i.attributes, "kMedoids");
		c = !1;
		for (var h = 0; h < o.length; h++) {
			var m = Dv(h, a, l);
			if (m.length !== 0) {
				f[h] = ru(o[h], m, i.attributes);
				for (var p = 0; p < m.length; p++) u = ru(m[p], m, i.attributes), u < f[h] && (f[h] = u, o[h] = m[p], c = !0);
				s[h] = t.collection(m);
			}
		}
		d++;
	...
	return s;
}, "kMedoids"), dh = m(function(e, t, a, n, i) {
...
}, "updateCentroids"), hh = m(function(e, t, a, n, i) {
	for (var s = 0; s < e.length; s++) t[s] = e[s].slice();
	for (var o, l, u, f = 2 / (i.m - 1), c = 0; c < a.length; c++) for (var d = 0; d < n.length; d++) {
		o = 0;
		for (var g = 0; g < a.length; g++) l = Sn(i.distance, n[d], a[c], i.attributes, "cmeans"), u = Sn(i.distance, n[d], a[g], i.attributes, "cmeans"), o += Math.pow(l / u, f);
		e[d][c] = 1 / o;
	}
}, "updateMembership"), gh = m(function(e, t, a, n) {
	...
	return i;
}, "assign"), tu = m(function(e) {
	var t = this.cy(), a = this.nodes(), n = so(e), i, s, o, l = new Array(a.length), u;
	...
	for (var b = !0, w = 0; b && w < n.maxIterations;) b = !1, dh(s, a, o, u, n), hh(o, l, s, a, n), lh(o, l, n.sensitivityThreshold) || (b = !0), w++;
	return i = gh(a, o, n, t), {
		clusters: i,
	...
	var t = yh(e), a = mh[t.linkage];
	return a != null && (t.linkage = a), t;
}, "setOptions"), au = m(function(e, t, a, n, i) {
	for (var s = 0, o = Infinity, l, u = i.attributes, f = m(function(D, B) {
	...
	var h = t[s], m$15 = t[n[s]], p;
	i.mode === "dendrogram" ? p = {
		left: h,
		right: m$15,
		key: h.key
	} : p = {
		value: h.value.concat(m$15.value),
		key: h.key
	}, e[h.index] = p, e.splice(m$15.index, 1), t[h.key] = p;
	for (var y = 0; y < e.length; y++) {
		var b = e[y];
		h.key === b.key ? l = Infinity : i.linkage === "min" ? (l = a[h.key][b.key], a[h.key][b.key] > a[m$15.key][b.key] && (l = a[m$15.key][b.key])) : i.linkage === "max" ? (l = a[h.key][b.key], a[h.key][b.key] < a[m$15.key][b.key] && (l = a[m$15.key][b.key])) : i.linkage === "mean" ? l = (a[h.key][b.key] * h.size + a[m$15.key][b.key] * m$15.size) / (h.size + m$15.size) : i.mode === "dendrogram" ? l = f(b.value, h.value) : l = f(b.value[0], h.value[0]), a[h.key][b.key] = a[b.key][h.key] = l;
	}
	for (var w = 0; w < e.length; w++) {
		var x = e[w].key;
		if (n[x] === h.key || n[x] === m$15.key) {
	...
	return h.key = m$15.key = h.index = m$15.index = null, !0;
}, "mergeClosest"), Ut = m(function(e, t, a) {
	e && (e.value ? t.push(e.value) : (e.left && Ut(e.left, t), e.right && Ut(e.right, t)));
}, "getAllChildren"), Ls = m(function(e, t) {
	if (!e) return "";
	if (e.left && e.right) {
		var a = Ls(e.left, t), n = Ls(e.right, t), i = t.add({
			group: "nodes",
			data: { id: a + "," + n }
		});
		return t.add({
...
}, "buildDendrogram"), Is = m(function(e, t, a) {
	if (!e) return [];
	var n = [], i = [], s = [];
	return t === 0 ? (e.left && Ut(e.left, n), e.right && Ut(e.right, i), s = n.concat(i), [a.collection(s)]) : t === 1 ? e.value ? [a.collection(e.value)] : (e.left && Ut(e.left, n), e.right && Ut(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = Is(e.left, t - 1, a)), e.right && (i = Is(e.right, t - 1, a)), n.concat(i));
}, "buildClustersFromTree"), nu = m(function(e) {
	for (var t = this.cy(), a = this.nodes(), n = bh(e), i = n.attributes, s = m(function(w, x) {
	...
	for (var g = 0; g < o.length; g++) for (var h = 0; h <= g; h++) {
		var m$16 = void 0;
		n.mode === "dendrogram" ? m$16 = g === h ? Infinity : s(o[g].value, o[h].value) : m$16 = g === h ? Infinity : s(o[g].value[0], o[h].value[0]), l[g][h] = m$16, l[h][g] = m$16, m$16 < l[g][u[g]] && (u[g] = h);
	}
	for (var p = au(o, f, l, u, n); p;) p = au(o, f, l, u, n);
	var y;
	return n.mode === "dendrogram" ? (y = Is(o[0], n.dendrogramDepth, t), n.addDendrogram && Ls(o[0], t)) : (y = new Array(o.length), o.forEach(function(b, w) {
		b.key = b.index = null, y[w] = t.collection(b.value);
	})), y;
	...
	.5 <= t && t < 1 || Ue("Damping must range on [0.5, 1).  Got: ".concat(t));
	var n = [
		"median",
		"mean",
		"min",
	...
	return n.some(function(i) {
		return i === a;
	}) || ne(a) || Ue("Preference must be one of [".concat(n.map(function(i) {
		return "'".concat(i, "'");
	}).join(", "), "] or a number.  Got: ").concat(a)), xh(e);
}, "setOptions"), Ch = m(function(e, t, a, n) {
	var i = m(function(o, l) {
		return n[l](o);
	}, "attr");
...
}, "getSimilarity"), Th = m(function(e, t) {
	var a = null;
	return t === "median" ? a = Ed(e) : t === "mean" ? a = xd(e) : t === "min" ? a = bd(e) : t === "max" ? a = wd(e) : a = t, a;
}, "getPreference"), Sh = m(function(e, t, a) {
	for (var n = [], i = 0; i < e; i++) t[i * e + i] + a[i * e + i] > 0 && n.push(i);
	return n;
}, "findExemplars"), iu = m(function(e, t, a) {
	for (var n = [], i = 0; i < e; i++) {
		for (var s = -1, o = -Infinity, l = 0; l < a.length; l++) {
			var u = a[l];
	...
	return n;
}, "assignClusters"), kh = m(function(e, t, a) {
	for (var n = iu(e, t, a), i = 0; i < a.length; i++) {
		for (var s = [], o = 0; o < n.length; o++) n[o] === a[i] && s.push(o);
		for (var l = -1, u = -Infinity, f = 0; f < s.length; f++) {
	...
	return n = iu(e, t, a), n;
}, "assign"), su = m(function(e) {
	for (var t = this.cy(), a = this.nodes(), n = Eh(e), i = {}, s = 0; s < a.length; s++) i[a[s].id()] = s;
	var o = a.length, l = o * o, u = new Array(l), f, c, d;
	for (var g = 0; g < l; g++) u[g] = -Infinity;
	for (var h = 0; h < o; h++) for (var m = 0; m < o; m++) h !== m && (u[h * o + m] = Ch(n.distance, a[h], a[m], n.attributes));
	f = Th(u, n.preference);
	for (var p = 0; p < o; p++) u[p * o + p] = f;
	c = new Array(l);
	for (var y = 0; y < l; y++) c[y] = 0;
	d = new Array(l);
	for (var b = 0; b < l; b++) d[b] = 0;
	...
	for (D = 0; D < n.maxIterations; D++) {
		for (var B = 0; B < o; B++) {
			for (var P = -Infinity, A = -Infinity, R = -1, M = 0, I = 0; I < o; I++) w[I] = c[B * o + I], M = d[B * o + I] + u[B * o + I], M >= P ? (A = P, P = M, R = I) : M > A && (A = M);
			for (var O = 0; O < o; O++) c[B * o + O] = (1 - n.damping) * (u[B * o + O] - P) + n.damping * w[O];
			c[B * o + R] = (1 - n.damping) * (u[B * o + R] - A) + n.damping * w[R];
		}
		for (var L = 0; L < o; L++) {
			for (var N = 0, q = 0; q < o; q++) w[q] = d[q * o + L], x[q] = Math.max(0, c[q * o + L]), N += x[q];
	...
	for (var te = Sh(o, c, d), ie = kh(o, u, te), j = {}, F = 0; F < te.length; F++) j[te[F]] = [];
	for (var _ = 0; _ < a.length; _++) {
		var Z = ie[i[a[_].id()]];
		Z != null && j[Z].push(a[_]);
	}
	for (var ae = new Array(te.length), de = 0; de < te.length; de++) ae[de] = t.collection(j[te[de]]);
	return ae;
	...
	var a = Bh(e), n = a.root, i = a.directed, s = this, o = !1, l, u, f;
	n && (f = pe(n) ? this.filter(n)[0].id() : n[0].id());
	var c = {}, d = {};
	i ? s.forEach(function(b) {
		var w = b.id();
		if (b.isNode()) {
			var x = b.indegree(!0), C = b.outdegree(!0), T = x - C, E = C - x;
			T == 1 ? l ? o = !0 : l = w : E == 1 ? u ? o = !0 : u = w : (E > 1 || T > 1) && (o = !0), c[w] = [], b.outgoers().forEach(function(S) {
				S.isEdge() && c[w].push(S.id());
			});
		} else d[w] = [void 0, b.target().id()];
	}) : s.forEach(function(b) {
		var w = b.id();
		if (b.isNode()) b.degree(!0) % 2 && (l ? u ? o = !0 : u = w : l = w), c[w] = [], b.connectedEdges().forEach(function(C) {
			return c[w].push(C.id());
		});
		else d[w] = [b.source().id(), b.target().id()];
	});
	var g = {
		found: !1,
		trail: void 0
	...
	var h = m(function(w) {
		for (var x = w, C = [w], T, E, S; c[x].length;) T = c[x].shift(), E = d[T][0], S = d[T][1], x != S ? (c[S] = c[S].filter(function(D) {
			return D != T;
		}), x = S) : !i && x != E && (c[E] = c[E].filter(function(D) {
			return D != T;
		}), x = E), C.unshift(T), C.unshift(x);
		return C;
	}, "walk"), m$17 = [], p = [];
	for (p = h(f); p.length != 1;) c[p[0]].length == 0 ? (m$17.unshift(s.getElementById(p.shift())), m$17.unshift(s.getElementById(p.shift()))) : p = h(p.shift()).concat(p);
	m$17.unshift(s.getElementById(p.shift()));
	for (var y in c) if (c[y].length) return g;
	return g.found = !0, g.trail = this.spawn(m$17, !0), g;
}, "hierholzer") }, Ja = m(function() {
	var e = this, t = {}, a = 0, n = 0, i = [], s = [], o = {}, l = m(function(d, g) {
		for (var h = s.length - 1, m = [], p = e.spawn(); s[h].x != d || s[h].y != g;) m.push(s.pop().edge), h--;
		m.push(s.pop().edge), m.forEach(function(y) {
			var b = y.connectedNodes().intersection(e);
			p.merge(y), b.forEach(function(w) {
				var x = w.id(), C = w.connectedEdges().intersection(e);
				p.merge(w), t[x].cutVertex ? p.merge(C.filter(function(T) {
					return T.isLoop();
				})) : p.merge(C);
			});
		}), i.push(p);
	}, "buildComponent"), u = m(function(d, g, h) {
		d === h && (n += 1), t[g] = {
			id: a,
			low: a++,
			cutVertex: !1
		...
		if (m.size() === 0) i.push(e.spawn(e.getElementById(g)));
			...
			m.forEach(function(x) {
				p = x.source().id(), y = x.target().id(), b = p === g ? y : p, b !== h && (w = x.id(), o[w] || (o[w] = !0, s.push({
					x: g,
					y: b,
					edge: x
				})), b in t ? t[g].low = Math.min(t[g].low, t[b].id) : (u(d, b, g), t[g].low = Math.min(t[g].low, t[b].low), t[g].id <= t[b].low && (t[g].cutVertex = !0, l(g, b))));
			});
		}
	}, "biconnectedSearch");
	...
	var f = Object.keys(t).filter(function(c) {
	...
	var e = this, t = {}, a = 0, n = [], i = [], s = e.spawn(e), o = m(function(u) {
		i.push(u), t[u] = {
			index: a,
			low: a++,
			explored: !1
		};
		if (e.getElementById(u).connectedEdges().intersection(e).forEach(function(m) {
			var p = m.target().id();
			p !== u && (p in t || o(p), t[p].explored || (t[u].low = Math.min(t[u].low, t[p].low)));
		}), t[u].index === t[u].low) {
			for (var c = e.spawn();;) {
				var d = i.pop();
				if (c.merge(e.getElementById(d)), t[d].low = t[u].index, t[d].explored = !0, d === u) break;
			}
...
var Pv = 0, Av = 1, Rv = 2, zr = m(function(e) {
	if (!(this instanceof zr)) return new zr(e);
	this.id = "Thenable/1.0.7", this.state = Pv, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = { then: this.then.bind(this) }, typeof e == "function" && e.call(this, this.fulfill.bind(this), this.reject.bind(this));
}, "api");
zr.prototype = {
	fulfill: m(function(e) {
	...
	then: m(function(e, t) {
		var a = this, n = new zr();
		return a.onFulfilled.push(lu(e, n, "fulfill")), a.onRejected.push(lu(t, n, "reject")), Mv(a), n.proxy;
	}, "then")
};
var ou = m(function(e, t, a, n) {
	return e.state === Pv && (e.state = t, e[a] = n, Mv(e)), e;
}, "deliver"), Mv = m(function(e) {
	e.state === Av ? uu(e, "onFulfilled", e.fulfillValue) : e.state === Rv && uu(e, "onRejected", e.rejectReason);
}, "execute"), uu = m(function(e, t, a) {
	if (e[t].length !== 0) {
		var n = e[t];
		e[t] = [];
		var i = m(function() {
...
}, "execute_handlers"), lu = m(function(e, t, a) {
	return function(n) {
...
}, "resolver"), Lv = m(function(e, t) {
	if (e === t || e.proxy === t) {
		e.reject(/* @__PURE__ */ new TypeError("cannot resolve promise with itself"));
		return;
	}
	var a;
	...
	if (typeof a == "function") {
		...
		try {
			a.call(t, function(i) {
				n || (n = !0, i === t ? e.reject(/* @__PURE__ */ new TypeError("circular thenable chain")) : Lv(e, i));
			}, function(i) {
				n || (n = !0, e.reject(i));
			});
		} catch (i) {
...
zr.all = function(r) {
	return new zr(function(e, t) {
		for (var a = new Array(r.length), n = 0, i = m(function(l, u) {
			a[l] = u, n++, n === r.length && e(a);
		}, "fulfill"), s = 0; s < r.length; s++) (function(o) {
			var l = r[o];
			if (l != null && l.then != null) l.then(function(c) {
				i(o, c);
			}, function(c) {
				t(c);
			});
...
var aa = typeof Promise < "u" ? Promise : zr, Os = m(function(e, t, a) {
	var n = Zs(e), i = !n, s = this._private = we({ duration: 1e3 }, t, a);
...
we(Rt, {
	...
	hook: m(function() {
		...
		if (!e.hooked) {
			...
			e.queue ? t = a.queue : t = a.current, t.push(this), Br(e.target) && e.target.cy().addToAnimationPool(e.target), e.hooked = !0;
		}
		return this;
	}, "hook"),
	play: m(function() {
...
var Mh = {
	...
	animation: m(function() {
		return m(function(t, a) {
			...
			var f = o.style();
			t = we({}, t, a);
			if (Object.keys(t).length === 0) return new Os(s[0], t);
			...
			if (u && (t.style = f.getPropsList(t.style || t.css), t.css = void 0), u && t.renderedPosition != null) {
				var d = t.renderedPosition, g = o.pan(), h = o.zoom();
				t.position = mv(d, h, g);
			}
			if (l && t.panBy != null) {
				var m = t.panBy, p = o.pan();
				t.pan = {
					x: p.x + m.x,
					y: p.y + m.y
				};
			...
			if (l && y != null) {
				var b = o.getCenterPan(y.eles, t.zoom);
				b != null && (t.pan = b);
			}
			if (l && t.fit != null) {
				var w = t.fit, x = o.getFitViewport(w.eles || w.boundingBox, w.padding);
	...
	animate: m(function() {
		return m(function(t, a) {
			var n = this, s = n.length !== void 0 ? n : [n];
			if (!(this._private.cy || this).styleEnabled()) return this;
			a && (t = we({}, t, a));
			for (var l = 0; l < s.length; l++) {
				var u = s[l], f = u.animated() && (t.queue === void 0 || t.queue);
				u.animation(t, f ? { queue: !0 } : void 0).play();
			}
			return this;
		}, "animateImpl");
	}, "animate"),
	stop: m(function() {
		return m(function(t, a) {
			var n = this, s = n.length !== void 0 ? n : [n], o = this._private.cy || this;
			if (!o.styleEnabled()) return this;
			for (var l = 0; l < s.length; l++) {
				for (var f = s[l]._private, c = f.animation.current, d = 0; d < c.length; d++) {
					var h = c[d]._private;
					a && (h.duration = 0);
				}
...
function Ih() {
	if (cu) return Ei;
	cu = 1;
	var r = lv(), e = za(), t = "[object AsyncFunction]", a = "[object Function]", n = "[object GeneratorFunction]", i = "[object Proxy]";
	function s(o) {
		if (!e(o)) return !1;
		var l = r(o);
		return l == a || l == n || l == t || l == i;
	}
	return m(s, "isFunction"), Ei = s, Ei;
}
m(Ih, "requireIsFunction");
var Ci, du;
function Oh() {
	if (du) return Ci;
	du = 1;
	return Ci = In()["__core-js_shared__"], Ci;
}
m(Oh, "require_coreJsData");
var Ti, hu;
function Nh() {
	if (hu) return Ti;
	hu = 1;
	...
	return m(t, "isMasked"), Ti = t, Ti;
}
m(Nh, "require_isMasked");
var Si, gu;
function zh() {
	if (gu) return Si;
	gu = 1;
	...
	return m(t, "toSource"), Si = t, Si;
}
m(zh, "require_toSource");
var ki, pu;
function Fh() {
	if (pu) return ki;
	pu = 1;
	var r = Ih(), e = Nh(), t = za(), a = zh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, l = s.toString, u = o.hasOwnProperty, f = RegExp("^" + l.call(u).replace(n, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
	function c(d) {
		if (!t(d) || e(d)) return !1;
		return (r(d) ? f : i).test(a(d));
	}
	return m(c, "baseIsNative"), ki = c, ki;
}
m(Fh, "require_baseIsNative");
var Di, yu;
function Vh() {
	if (yu) return Di;
	yu = 1;
	...
	return m(r, "getValue"), Di = r, Di;
}
m(Vh, "require_getValue");
var Bi, mu;
function oo() {
	if (mu) return Bi;
	mu = 1;
	...
	return m(t, "getNative"), Bi = t, Bi;
}
m(oo, "require_getNative");
var Pi, bu;
function Vn() {
	if (bu) return Pi;
	bu = 1;
	return Pi = oo()(Object, "create"), Pi;
}
m(Vn, "require_nativeCreate");
var Ai, wu;
function qh() {
	if (wu) return Ai;
	wu = 1;
	...
	return m(e, "hashClear"), Ai = e, Ai;
}
m(qh, "require_hashClear");
var Ri, xu;
function _h() {
	if (xu) return Ri;
	xu = 1;
	...
	return m(r, "hashDelete"), Ri = r, Ri;
}
m(_h, "require_hashDelete");
var Mi, Eu;
function Gh() {
	if (Eu) return Mi;
	Eu = 1;
	var r = Vn(), e = "__lodash_hash_undefined__", a = Object.prototype.hasOwnProperty;
	function n(i) {
		var s = this.__data__;
		if (r) {
			var o = s[i];
	...
	return m(n, "hashGet"), Mi = n, Mi;
}
m(Gh, "require_hashGet");
var Li, Cu;
function Hh() {
	if (Cu) return Li;
	Cu = 1;
	var r = Vn(), t = Object.prototype.hasOwnProperty;
	function a(n) {
		var i = this.__data__;
		return r ? i[n] !== void 0 : t.call(i, n);
	}
	return m(a, "hashHas"), Li = a, Li;
}
m(Hh, "require_hashHas");
var Ii, Tu;
function Wh() {
	if (Tu) return Ii;
	Tu = 1;
	var r = Vn(), e = "__lodash_hash_undefined__";
	function t(a, n) {
		var i = this.__data__;
		return this.size += this.has(a) ? 0 : 1, i[a] = r && n === void 0 ? e : n, this;
	}
	return m(t, "hashSet"), Ii = t, Ii;
}
m(Wh, "require_hashSet");
var Oi, Su;
function $h() {
	if (Su) return Oi;
	Su = 1;
	var r = qh(), e = _h(), t = Gh(), a = Hh(), n = Wh();
	function i(s) {
	...
	return m(i, "Hash"), i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Oi = i, Oi;
}
m($h, "require_Hash");
var Ni, ku;
function Uh() {
	...
	return m(r, "listCacheClear"), Ni = r, Ni;
}
m(Uh, "require_listCacheClear");
var zi, Du;
function Iv() {
	if (Du) return zi;
	Du = 1;
...
function qn() {
	...
	return m(e, "assocIndexOf"), Fi = e, Fi;
}
m(qn, "require_assocIndexOf");
var Vi, Pu;
function Kh() {
	if (Pu) return Vi;
	Pu = 1;
	var r = qn(), t = Array.prototype.splice;
	function a(n) {
		var i = this.__data__, s = r(i, n);
		if (s < 0) return !1;
		return s == i.length - 1 ? i.pop() : t.call(i, s, 1), --this.size, !0;
	}
	return m(a, "listCacheDelete"), Vi = a, Vi;
}
m(Kh, "require_listCacheDelete");
var qi, Au;
function Xh() {
	if (Au) return qi;
	Au = 1;
	...
	return m(e, "listCacheGet"), qi = e, qi;
}
m(Xh, "require_listCacheGet");
var _i, Ru;
function Yh() {
	if (Ru) return _i;
	Ru = 1;
	...
	return m(e, "listCacheHas"), _i = e, _i;
}
m(Yh, "require_listCacheHas");
var Gi, Mu;
function Zh() {
	if (Mu) return Gi;
	Mu = 1;
	...
	return m(e, "listCacheSet"), Gi = e, Gi;
}
m(Zh, "require_listCacheSet");
var Hi, Lu;
function Qh() {
	if (Lu) return Hi;
	Lu = 1;
	var r = Uh(), e = Kh(), t = Xh(), a = Yh(), n = Zh();
	function i(s) {
		var o = -1, l = s == null ? 0 : s.length;
		for (this.clear(); ++o < l;) {
			var u = s[o];
	...
	return m(i, "ListCache"), i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Hi = i, Hi;
}
m(Qh, "require_ListCache");
var Wi, Iu;
function Jh() {
	if (Iu) return Wi;
	Iu = 1;
	return Wi = oo()(In(), "Map"), Wi;
}
m(Jh, "require_Map");
var $i, Ou;
function jh() {
	...
	return m(a, "mapCacheClear"), $i = a, $i;
}
m(jh, "require_mapCacheClear");
var Ui, Nu;
function eg() {
	if (Nu) return Ui;
	Nu = 1;
	...
	return m(r, "isKeyable"), Ui = r, Ui;
}
m(eg, "require_isKeyable");
var Ki, zu;
function _n() {
	if (zu) return Ki;
	zu = 1;
	...
	return m(e, "getMapData"), Ki = e, Ki;
}
m(_n, "require_getMapData");
var Xi, Fu;
function rg() {
	if (Fu) return Xi;
	Fu = 1;
	...
	return m(e, "mapCacheDelete"), Xi = e, Xi;
}
m(rg, "require_mapCacheDelete");
var Yi, Vu;
function tg() {
	if (Vu) return Yi;
	Vu = 1;
	...
	return m(e, "mapCacheGet"), Yi = e, Yi;
}
m(tg, "require_mapCacheGet");
var Zi, qu;
function ag() {
	if (qu) return Zi;
	qu = 1;
	...
	return m(e, "mapCacheHas"), Zi = e, Zi;
}
m(ag, "require_mapCacheHas");
var Qi, _u;
function ng() {
	if (_u) return Qi;
	_u = 1;
	...
	return m(e, "mapCacheSet"), Qi = e, Qi;
}
m(ng, "require_mapCacheSet");
var Ji, Gu;
function ig() {
	if (Gu) return Ji;
	Gu = 1;
	var r = jh(), e = rg(), t = tg(), a = ag(), n = ng();
	function i(s) {
		var o = -1, l = s == null ? 0 : s.length;
		for (this.clear(); ++o < l;) {
			var u = s[o];
	...
	return m(i, "MapCache"), i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Ji = i, Ji;
}
m(ig, "require_MapCache");
var ji, Hu;
function sg() {
	if (Hu) return ji;
	Hu = 1;
	var r = ig(), e = "Expected a function";
	function t(a, n) {
	...
	return m(t, "memoize"), t.Cache = r, ji = t, ji;
}
m(sg, "requireMemoize");
var es, Wu;
function og() {
	...
	return m(t, "memoizeCapped"), es = t, es;
}
m(og, "require_memoizeCapped");
var rs, $u;
function Ov() {
	if ($u) return rs;
	$u = 1;
	var r = og(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g;
	return rs = r(function(n) {
		var i = [];
...
function Nv() {
	...
	return m(r, "arrayMap"), ts = r, ts;
}
m(Nv, "require_arrayMap");
var as, Ku;
function ug() {
	if (Ku) return as;
	Ku = 1;
	var r = Js(), e = Nv(), t = Fn(), a = Fa(), n = r ? r.prototype : void 0, i = n ? n.toString : void 0;
	function s(o) {
		if (typeof o == "string") return o;
		if (t(o)) return e(o, s) + "";
		if (a(o)) return i ? i.call(o) : "";
		var l = o + "";
		return l == "0" && 1 / o == -Infinity ? "-0" : l;
	}
	return m(s, "baseToString"), as = s, as;
}
m(ug, "require_baseToString");
var ns, Xu;
function zv() {
	if (Xu) return ns;
	Xu = 1;
	...
	return m(e, "toString"), ns = e, ns;
}
m(zv, "requireToString");
var is, Yu;
function Fv() {
	if (Yu) return is;
	Yu = 1;
	var r = Fn(), e = Lh(), t = Ov(), a = zv();
	function n(i, s) {
		return r(i) ? i : e(i, s) ? [i] : t(a(i));
	}
	return m(n, "castPath"), is = n, is;
}
m(Fv, "require_castPath");
var ss, Zu;
function uo() {
	if (Zu) return ss;
	Zu = 1;
	...
	function e(t) {
		...
		var a = t + "";
		return a == "0" && 1 / t == -Infinity ? "-0" : a;
	}
	return m(e, "toKey"), ss = e, ss;
}
m(uo, "require_toKey");
var os, Qu;
function lg() {
	...
	return m(t, "baseGet"), os = t, os;
}
m(lg, "require_baseGet");
var us, Ju;
function vg() {
	if (Ju) return us;
	Ju = 1;
...
function hg() {
	...
	return m(e, "baseAssignValue"), vs = e, vs;
}
m(hg, "require_baseAssignValue");
var fs, rl;
function gg() {
	if (rl) return fs;
	rl = 1;
	var r = hg(), e = Iv(), a = Object.prototype.hasOwnProperty;
	function n(i, s, o) {
		var l = i[s];
		(!(a.call(i, s) && e(l, o)) || o === void 0 && !(s in i)) && r(i, s, o);
	}
	return m(n, "assignValue"), fs = n, fs;
}
m(gg, "require_assignValue");
var cs, tl;
function pg() {
	if (tl) return cs;
	tl = 1;
	...
	return m(t, "isIndex"), cs = t, cs;
}
m(pg, "require_isIndex");
var ds, al;
function yg() {
	if (al) return ds;
	al = 1;
	var r = gg(), e = Fv(), t = pg(), a = za(), n = uo();
	function i(s, o, l, u) {
		if (!a(s)) return s;
		o = e(o, s);
	...
	return m(i, "baseSet"), ds = i, ds;
}
m(yg, "require_baseSet");
var hs, nl;
function mg() {
	if (nl) return hs;
	nl = 1;
...
function xg() {
	...
	return m(r, "copyArray"), gs = r, gs;
}
m(xg, "require_copyArray");
var ps, sl;
function Eg() {
	if (sl) return ps;
	sl = 1;
	var r = Nv(), e = xg(), t = Fn(), a = Fa(), n = Ov(), i = uo(), s = zv();
	function o(l) {
		return t(l) ? r(l, i) : a(l) ? [l] : e(n(s(l)));
	}
	return m(o, "toPath"), ps = o, ps;
}
m(Eg, "requireToPath");
var Tg = Na(Eg()), Sg = {
	data: m(function(e) {
		return e = we({}, {
			...
			immutableKeys: {},
			updateStyle: !1,
			beforeGet: m(function(n) {}, "beforeGet"),
			beforeSet: m(function(n, i) {}, "beforeSet"),
			onSet: m(function(n) {}, "onSet"),
			canSet: m(function(n) {
				return !0;
			}, "canSet")
		}, e), m(function(n, i) {
			...
			if (pe(n)) {
				var d = n.indexOf(".") !== -1 && Tg(n);
				if (s.allowGetting && i === void 0) {
					var g;
					return f && (s.beforeGet(f), d && f._private[s.field][n] === void 0 ? g = cg(f._private[s.field], d) : g = f._private[s.field][n]), g;
				} else if (s.allowSetting && i !== void 0) {
					if (!s.immutableKeys[n]) {
						var m = jl({}, n, i);
						s.beforeSet(o, m);
						for (var p = 0, y = u.length; p < y; p++) {
							var b = u[p];
							s.canSet(b) && (d && f._private[s.field][n] === void 0 ? wg(b._private[s.field], d, i) : b._private[s.field][n] = i);
						}
						s.updateStyle && o.updateStyle(), s.onSet(o), s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent);
					}
				}
			} else if (s.allowSetting && Ie(n)) {
				var w = n, x, C, T = Object.keys(w);
				s.beforeSet(o, w);
				for (var E = 0; E < T.length; E++) {
					x = T[E], C = w[x];
					if (!s.immutableKeys[x]) for (var D = 0; D < u.length; D++) {
						var B = u[D];
	...
	removeData: m(function(e) {
		return e = we({}, {
			...
			var i = e, s = this, l = s.length !== void 0 ? s : [s];
			if (pe(n)) {
				for (var u = n.split(/\s+/), f = u.length, c = 0; c < f; c++) {
					var d = u[c];
					if (!lt(d)) {
						if (!i.immutableKeys[d]) for (var h = 0, m = l.length; h < m; h++) l[h]._private[i.field][d] = void 0;
					}
				}
				i.triggerEvent && s[i.triggerFnName](i.event);
			} else if (n === void 0) {
				for (var p = 0, y = l.length; p < y; p++) for (var b = l[p]._private[i.field], w = Object.keys(b), x = 0; x < w.length; x++) {
					var C = w[x];
					!i.immutableKeys[C] && (b[C] = void 0);
				}
				i.triggerEvent && s[i.triggerFnName](i.event);
			}
			return s;
...
}, kg = { eventAliasesOn: m(function(e) {
	var t = e;
	t.addListener = t.listen = t.bind = t.on, t.unlisten = t.unbind = t.off = t.removeListener, t.trigger = t.emit, t.pon = t.promiseOn = function(a, n) {
		...
		return new aa(function(o, l) {
			var u = m(function(g) {
				i.off.apply(i, c), o(g);
			}, "callback"), f = s.concat([u]), c = f.concat([]);
			i.on.apply(i, f);
		});
	};
}, "eventAliasesOn") }, Ve = {};
...
var Dg = {
	animate: Ve.animate(),
	animation: Ve.animation(),
	animated: Ve.animated(),
	clearQueue: Ve.clearQueue(),
	delay: Ve.delay(),
	delayAnimation: Ve.delayAnimation(),
	stop: Ve.stop()
}, fn = {
	classes: m(function(e) {
		var t = this;
		if (e === void 0) {
			var a = [];
		...
		for (var n = [], i = new ta(e), s = 0; s < t.length; s++) {
			for (var o = t[s], l = o._private, u = l.classes, f = !1, c = 0; c < e.length; c++) {
				var d = e[c];
				if (!u.has(d)) {
					f = !0;
					break;
	...
	addClass: m(function(e) {
		return this.toggleClass(e, !0);
	}, "addClass"),
	hasClass: m(function(e) {
		var t = this[0];
		return t != null && t._private.classes.has(e);
	}, "hasClass"),
	toggleClass: m(function(e, t) {
		Ge(e) || (e = e.match(/\S+/g) || []);
		for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++) for (var l = a[s], u = l._private.classes, f = !1, c = 0; c < e.length; c++) {
			var d = e[c], g = u.has(d), h = !1;
			t || n && !g ? (u.add(d), h = !0) : (!t || n && g) && (u.delete(d), h = !0), !f && h && (i.push(l), f = !0);
		}
		return i.length > 0 && this.spawn(i).updateStyle().emit("class"), a;
	}, "toggleClass"),
	removeClass: m(function(e) {
		return this.toggleClass(e, !1);
	}, "removeClass"),
	flashClass: m(function(e, t) {
		var a = this;
		if (t == null) t = 250;
...
(function() {
	var r, e, t;
	for (r = Le.comparatorOp.split("|"), t = 0; t < r.length; t++) e = r[t], Le.comparatorOp += "|@" + e;
	for (r = Le.comparatorOp.split("|"), t = 0; t < r.length; t++) e = r[t], !(e.indexOf("!") >= 0) && e !== "=" && (Le.comparatorOp += "|\\!" + e);
})();
var _e = m(function() {
	return { checks: [] };
}, "newQuery"), oe = {
	...
	return r.selector;
}).join("|") + ")", zt = m(function(e) {
	return e.replace(new RegExp("\\\\(" + Le.metaChar + ")", "g"), function(t, a) {
		return a;
	});
}, "cleanMetaChars"), tt = m(function(e, t, a) {
	e[e.length - 1] = a;
}, "replaceLastQuery"), zs = [
	{
		name: "group",
	...
	},
	{
		...
		populate: m(function(e, t, a) {
			...
			new RegExp("^" + Le.string + "$").exec(o) != null ? o = o.substring(1, o.length - 1) : o = parseFloat(o), t.checks.push({
	...
	},
	{
		...
		populate: m(function(e, t) {
			if (e.currentSubject == null) {
				...
				var s = _e(), o = e[e.length - 1], l = _e(), u = _e(), f = _e(), c = _e();
				return s.checks.push({
					type: oe.COMPOUND_SPLIT,
					left: o,
					right: l,
					subject: u
				}), u.checks = t.checks, t.checks = [{ type: oe.TRUE }], c.checks.push({ type: oe.TRUE }), l.checks.push({
					type: oe.PARENT,
					parent: c,
					child: f
	...
	},
	{
		...
		regex: Le.subject,
		populate: m(function(e, t) {
			if (e.currentSubject != null && e.currentSubject !== t) return qe("Redefinition of subject in selector `" + e.toString() + "`"), !1;
			e.currentSubject = t;
			var n = e[e.length - 1].checks[0], i = n == null ? null : n.type;
...
var Rg = m(function(e) {
	for (var t, a, n, i = 0; i < zs.length; i++) {
		var s = zs[i], o = s.name, l = e.match(s.regexObj);
		if (l != null) {
			a = l, t = s, n = o;
			var u = l[0];
	...
	return e;
}, "consumeWhitespace"), Og = {
	parse: m(function(e) {
		var t = this, a = t.inputText = e, n = t[0] = _e();
		for (t.length = 1, a = Mg(a);;) {
			var i = Rg(a);
			if (i.expr == null) return qe("The selector `" + e + "`is invalid"), !1;
		...
		for (var u = 0; u < t.length; u++) {
			var f = t[u];
			if (f.compoundCount > 0 && f.edgeCount > 0) return qe("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), !1;
			if (f.edgeCount > 1) return qe("The selector `" + e + "` is invalid because it uses multiple edge selectors"), !1;
	...
	toString: m(function() {
		...
		for (var e = m(function(f) {
			return f ?? "";
		}, "clean"), t = m(function(f) {
			return pe(f) ? "\"" + f + "\"" : e(f);
		}, "cleanVal"), a = m(function(f) {
			return " " + f + " ";
		}, "space"), n = m(function(f, c) {
			...
			switch (d) {
				...
				case oe.DATA_BOOL:
					...
					return "[" + e(y) + b + "]";
				case oe.DATA_EXIST: return "[" + f.field + "]";
				case oe.META_COMPARE:
					var x = f.operator;
					return "[[" + f.field + a(e(x)) + t(g) + "]]";
				case oe.STATE: return g;
				case oe.ID: return "#" + g;
				case oe.CLASS: return "." + g;
				case oe.PARENT:
				case oe.CHILD: return i(f.parent, c) + a(">") + i(f.child, c);
				case oe.ANCESTOR:
				case oe.DESCENDANT: return i(f.ancestor, c) + " " + i(f.descendant, c);
				case oe.COMPOUND_SPLIT:
					var T = i(f.left, c), E = i(f.subject, c), S = i(f.right, c);
					return T + (T.length > 0 ? " " : "") + E + S;
				case oe.TRUE: return "";
			}
		}, "checkToString"), i = m(function(f, c) {
	...
	var n, i = pe(e), s = ne(e), o = pe(a), l, u, f = !1, c = !1, d = !1;
	switch (t.indexOf("!") >= 0 && (t = t.replace("!", ""), c = !0), t.indexOf("@") >= 0 && (t = t.replace("@", ""), f = !0), (i || o || f) && (l = !i && !s ? "" : "" + e, u = "" + a), f && (e = l = l.toLowerCase(), a = u = u.toLowerCase()), t) {
		case "*=":
			n = l.indexOf(u) >= 0;
			break;
		case "$=":
...
}, "valCmp"), Ng = m(function(e, t) {
	switch (t) {
		case "?": return !!e;
		case "!": return !e;
		case "^": return e === void 0;
	}
}, "boolCmp"), zg = m(function(e) {
	return e !== void 0;
}, "existCmp"), lo = m(function(e, t) {
	return e.data(t);
}, "data"), Fg = m(function(e, t) {
	return e[t]();
}, "meta"), Ye = [], $e = m(function(e, t) {
...
Ye[oe.META_COMPARE] = function(r, e) {
	...
	return Vv(Fg(e, t), a, n);
};
Ye[oe.DATA_COMPARE] = function(r, e) {
	var t = r.field, a = r.operator, n = r.value;
	return Vv(lo(e, t), a, n);
};
...
var Vg = m(function(e) {
	...
	this.inputText = e, this.currentSubject = null, this.compoundCount = 0, this.edgeCount = 0, this.length = 0, e == null || pe(e) && e.match(/^\s*$/) || (Br(e) ? this.addQuery({ checks: [{
		type: oe.COLLECTION,
		value: e.collection()
	}] }) : Ke(e) ? this.addQuery({ checks: [{
		type: oe.FILTER,
		value: e
	}] }) : pe(e) ? this.parse(e) || (this.invalid = !0) : Ue("A selector must be created from a string; found "));
}, "Selector"), dt = ct.prototype;
[Og, _g].forEach(function(r) {
	return we(dt, r);
});
dt.text = function() {
...
var ot = {
	...
	some: m(function(e, t) {
		for (var a = 0; a < this.length; a++) if (t ? e.apply(t, [
			this[a],
			a,
			this
		]) : e(this[a], a, this)) return !0;
		return !1;
	}, "some"),
	every: m(function(e, t) {
		for (var a = 0; a < this.length; a++) if (!(t ? e.apply(t, [
			this[a],
			a,
			this
		]) : e(this[a], a, this))) return !1;
		return !0;
	}, "every"),
	same: m(function(e) {
		if (this === e) return !0;
...
var Mr = m(function(e, t) {
	return m(function(n, i, s, o) {
		var l = n, u = this, f;
		if (l == null ? f = "" : Br(l) && l.length === 1 && (f = l.id()), u.length === 1 && f) {
			var c = u[0]._private, d = c.traversalCache = c.traversalCache || {}, g = d[t] = d[t] || [], h = Pt(f);
			return g[h] || (g[h] = e.call(u, n, i, s, o));
	...
	parent: m(function(e) {
		...
		for (var n = 0; n < this.length; n++) {
			var s = this[n]._private.parent;
			s && t.push(s);
		}
		return this.spawn(t, !0).filter(e);
	}, "parent"),
	parents: m(function(e) {
	...
	commonAncestors: m(function(e) {
		for (var t, a = 0; a < this.length; a++) {
			var i = this[a].parents();
			t = t || i, t = t.intersect(i);
		}
		return t.filter(e);
	}, "commonAncestors"),
	orphans: m(function(e) {
		return this.stdFilter(function(t) {
			return t.isOrphan();
		}).filter(e);
	}, "orphans"),
	nonorphans: m(function(e) {
		return this.stdFilter(function(t) {
			return t.isChild();
		}).filter(e);
	}, "nonorphans"),
	children: Mr(function(r) {
	...
	descendants: m(function(e) {
		...
		return m(a, "add"), a(this.children()), this.spawn(t, !0).filter(e);
	}, "descendants")
};
function vo(r, e, t, a) {
	for (var n = [], i = new ta(), o = r.cy().hasCompoundNodes(), l = 0; l < r.length; l++) {
		var u = r[l];
...
function ys(r) {
	return function(e) {
		var t = this;
		if (e === void 0 && (e = !0), t.length !== 0) if (t.isNode() && !t.removed()) {
...
m(Ft, "defineDegreeBoundsFunction");
we(Gn, {
	minDegree: Ft("degree", function(r, e) {
		return r < e;
	}),
	maxDegree: Ft("degree", function(r, e) {
		return r > e;
	}),
	minIndegree: Ft("indegree", function(r, e) {
		return r < e;
	}),
	maxIndegree: Ft("indegree", function(r, e) {
		return r > e;
	}),
	minOutdegree: Ft("outdegree", function(r, e) {
		return r < e;
	}),
	maxOutdegree: Ft("outdegree", function(r, e) {
		return r > e;
	})
});
we(Gn, { totalDegree: m(function(e) {
	for (var t = 0, a = this.nodes(), n = 0; n < a.length; n++) t += a[n].degree(e);
	return t;
}, "totalDegree") });
var Nr, Hv, Wv = m(function(e, t, a) {
	...
	allowGetting: !0,
	validKeys: ["x", "y"],
	beforeGet: m(function(e) {
		e.updateCompoundBounds();
	}, "beforeGet"),
	beforeSet: m(function(e, t) {
		Wv(e, t, !1);
	}, "beforeSet"),
	onSet: m(function(e) {
...
Nr = Hv = {
	...
	silentPositions: m(function(e) {
		return this.positions(e, !0);
	}, "silentPositions"),
	shift: m(function(e, t, a) {
		var n;
		if (Ie(e) ? (n = {
			x: ne(e.x) ? e.x : 0,
			y: ne(e.y) ? e.y : 0
	...
	silentShift: m(function(e, t) {
		return Ie(e) ? this.shift(e, !0) : pe(e) && ne(t) && this.shift(e, t, !0), this;
	}, "silentShift"),
	renderedPosition: m(function(e, t) {
		var a = this[0], n = this.cy(), i = n.zoom(), s = n.pan(), o = Ie(e) ? e : void 0, l = o !== void 0 || t !== void 0 && pe(e);
		if (a && a.isNode()) if (l) for (var u = 0; u < this.length; u++) {
			var f = this[u];
			t !== void 0 ? f.position(e, (t - s[e]) / i) : o !== void 0 && f.position(mv(o, i, s));
		}
		else return o = Nn(a.position(), i, s), e === void 0 ? o : o[e];
		else if (!l) return;
		return this;
	}, "renderedPosition"),
	relativePosition: m(function(e, t) {
		var a = this[0], n = this.cy(), i = Ie(e) ? e : void 0, s = i !== void 0 || t !== void 0 && pe(e), o = n.hasCompoundNodes();
		if (a && a.isNode()) if (s) for (var l = 0; l < this.length; l++) {
			...
			var h = a.position(), m = o ? a.parent() : null, p = m && m.length > 0, y = p;
			p && (m = m[0]);
			var b = y ? m.position() : {
				x: 0,
				y: 0
...
yt.updateCompoundBounds = function() {
	...
	function t(s) {
		...
		m(g, "computeBiasValues");
		function h(D, B, P, A) {
			if (P.units === "%") switch (A) {
				case "width": return D > 0 ? P.pfValue * D : 0;
				case "height": return B > 0 ? P.pfValue * B : 0;
				case "average": return D > 0 && B > 0 ? P.pfValue * (D + B) / 2 : 0;
				case "min": return D > 0 && B > 0 ? D > B ? P.pfValue * B : P.pfValue * D : 0;
				case "max": return D > 0 && B > 0 ? D > B ? P.pfValue * D : P.pfValue * B : 0;
				default: return 0;
			}
			else return P.units === "px" ? P.pfValue : 0;
		}
		m(h, "computePaddingValues");
		var m$18 = f.width.left.value;
		f.width.left.units === "px" && f.width.val > 0 && (m$18 = m$18 * 100 / f.width.val);
		...
		var w = g(f.width.val - c.w, m$18, p), x = w.biasDiff, C = w.biasComplementDiff, T = g(f.height.val - c.h, y, b), E = T.biasDiff, S = T.biasComplementDiff;
		o.autoPadding = h(c.w, c.h, s.pstyle("padding"), s.pstyle("padding-relative-to").value), o.autoWidth = Math.max(c.w, f.width.val), d.x = (-x + c.x1 + c.x2 + C) / 2, o.autoHeight = Math.max(c.h, f.height.val), d.y = (-E + c.y1 + c.y2 + S) / 2;
	}
	m(t, "update");
...
var Rr = m(function(e) {
...
}, "noninf"), Or = m(function(e, t, a, n, i) {
...
}, "updateBounds"), at = m(function(e, t) {
	return t == null ? e : Or(e, t.x1, t.y1, t.x2, t.y2);
}, "updateBoundsFromBox"), ca = m(function(e, t, a) {
	return Sr(e, t, a);
}, "prefixedProperty"), en = m(function(e, t, a) {
	if (!t.cy().headless()) {
...
}, "updateBoundsFromArrow"), ms = m(function(e, t, a) {
	if (!t.cy().headless()) {
		var n;
		a ? n = a + "-" : n = "";
		var i = t._private, s = i.rstyle;
		if (t.pstyle(n + "label").strValue) {
			var l = t.pstyle("text-halign"), u = t.pstyle("text-valign"), f = ca(s, "labelWidth", a), c = ca(s, "labelHeight", a), d = ca(s, "labelX", a), g = ca(s, "labelY", a), h = t.pstyle(n + "text-margin-x").pfValue, m$19 = t.pstyle(n + "text-margin-y").pfValue, p = t.isEdge(), y = t.pstyle(n + "text-rotation"), b = t.pstyle("text-outline-width").pfValue, x = t.pstyle("text-border-width").pfValue / 2, C = t.pstyle("text-background-padding").pfValue, T = 2, E = c, S = f, D = S / 2, B = E / 2, P, A, R, M;
			...
			var I = h - Math.max(b, x) - C - T, O = h + Math.max(b, x) + C + T, L = m$19 - Math.max(b, x) - C - T, N = m$19 + Math.max(b, x) + C + T;
			P += I, A += O, R += L, M += N;
			...
			if (V || K) {
				var J = V ? ca(i.rstyle, "labelAngle", a) : y.pfValue, X = Math.cos(J), ee = Math.sin(J), te = (P + A) / 2, ie = (R + M) / 2;
				if (!p) {
					switch (l.value) {
						case "left":
							te = A;
				...
				var j = m(function(Te, xe) {
					return Te = Te - te, xe = xe - ie, {
						x: Te * X - xe * ee + te,
						y: Te * ee + xe * X + ie
					};
				}, "rotate"), F = j(P, R), _ = j(P, M), W = j(A, R), Z = j(A, M);
				P = Math.min(F.x, _.x, W.x, Z.x), A = Math.max(F.x, _.x, W.x, Z.x), R = Math.min(F.y, _.y, W.y, Z.y), M = Math.max(F.y, _.y, W.y, Z.y);
			}
...
}, "updateBoundsFromLabel"), ul = m(function(e, t) {
	if (!t.cy().headless()) {
		var a = t.pstyle("outline-opacity").value, s = t.pstyle("outline-width").value + t.pstyle("outline-offset").value;
		$v(e, t, a, s, "outside", s / 2);
	}
}, "updateBoundsFromOutline"), $v = m(function(e, t, a, n, i, s) {
	if (!(a === 0 || n <= 0 || i === "inside")) {
		var o = t.cy(), l = t.pstyle("shape").value, u = o.renderer().nodeShapes[l], f = t.position(), c = f.x, d = f.y, g = t.width(), h = t.height();
		if (u.hasMiterBounds) {
			i === "center" && (n /= 2);
			at(e, u.miterBounds(c, d, g, h, n));
...
}, "updateBoundsFromMiter"), $g = m(function(e, t) {
	if (!t.cy().headless()) {
		var a = t.pstyle("border-opacity").value, n = t.pstyle("border-width").pfValue, i = t.pstyle("border-position").value;
		$v(e, t, a, n, i);
	}
}, "updateBoundsFromMiterBorder"), Ug = m(function(e, t) {
	var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = xr(), o = e._private, l = e.isNode(), u = e.isEdge(), f, c, d, g, h, m$20, p = o.rstyle, y = l && n ? e.pstyle("bounds-expansion").pfValue : [0], b = m(function(Re) {
		return Re.pstyle("display").value !== "none";
	}, "isDisplayed"), w = !n || b(e) && (!u || b(e.source()) && b(e.target()));
	if (w) {
		var x = 0, C = 0;
		...
		var S = Math.max(C, E), D = 0, B = 0;
		if (n && (D = e.pstyle("width").pfValue, B = D / 2), l && t.includeNodes) {
			var P = e.position();
			h = P.x, m$20 = P.y;
			var R = e.outerWidth() / 2, I = e.outerHeight() / 2;
			f = h - R, c = h + R, d = m$20 - I, g = m$20 + I, Or(s, f, d, c, g), n && ul(s, e), n && t.includeOutlines && !i && ul(s, e), n && $g(s, e);
		} else if (u && t.includeEdges) if (n && !i) {
			var O = e.pstyle("curve-style").strValue;
			if (f = Math.min(p.srcX, p.midX, p.tgtX), c = Math.max(p.srcX, p.midX, p.tgtX), d = Math.min(p.srcY, p.midY, p.tgtY), g = Math.max(p.srcY, p.midY, p.tgtY), f -= B, c += B, d -= B, g += B, Or(s, f, d, c, g), O === "haystack") {
				var L = p.haystackPts;
				if (L && L.length === 2) {
			...
			var J = e.source().position(), ee = e.target().position();
		...
		ae.all != null ? Dd(ae.all) : ae.all = xr(), n && t.includeLabels && (t.includeMainLabels && ms(s, e, null), u && (t.includeSourceLabels && ms(s, e, "source"), t.includeTargetLabels && ms(s, e, "target")));
	}
	return s.x1 = Rr(s.x1), s.y1 = Rr(s.y1), s.x2 = Rr(s.x2), s.y2 = Rr(s.y2), s.w = Rr(s.x2 - s.x1), s.h = Rr(s.y2 - s.y1), s.w > 0 && s.h > 0 && w && (vn(s, y), ln(s, 1)), s;
}, "boundingBoxImpl"), Uv = m(function(e) {
	var t = 0, a = m(function(s) {
		return (s ? 1 : 0) << t++;
	}, "tf"), n = 0;
	...
	if (e.isEdge()) {
		...
		var i = e.position();
		return _o([t(i.x), t(i.y)]);
	}
}, "getBoundingBoxPosKey"), ll = m(function(e, t) {
	var a = e._private, n, i = e.isEdge(), o = (t == null ? vl : Uv(t)) === vl;
	if (a.bbCache == null ? (n = Ug(e, Aa), a.bbCache = n, a.bbCachePosKey = Kv(e)) : n = a.bbCache, !o) {
		var l = e.isNode();
		n = xr(), (t.includeNodes && l || t.includeEdges && !l) && (t.includeOverlays ? at(n, a.overlayBounds) : at(n, a.bodyBounds)), t.includeLabels && (t.includeMainLabels && (!i || t.includeSourceLabels && t.includeTargetLabels) ? at(n, a.labelBounds.all) : (t.includeMainLabels && at(n, a.labelBounds.mainRot), t.includeSourceLabels && at(n, a.labelBounds.sourceRot), t.includeTargetLabels && at(n, a.labelBounds.targetRot))), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1;
	}
	return n;
...
yt.boundingBox = function(r) {
	var e, t = r === void 0 || r.useCache === void 0 || r.useCache === !0, a = Jt(function(f) {
		var c = f._private;
		return c.bbCache == null || c.styleDirty || c.bbCachePosKey !== Kv(f);
	}, function(f) {
		return f.id();
	});
	if (t && this.length === 1 && !a(this[0])) r === void 0 ? r = Aa : r = fl(r), e = ll(this[0], r);
	else {
		e = xr(), r = r || Aa;
		var n = fl(r), i = this, o = i.cy().styleEnabled();
		this.edges().forEach(a), this.nodes().forEach(a), o && this.recalculateRenderedStyle(t), this.updateCompoundBounds(!t);
		for (var l = 0; l < i.length; l++) {
			var u = i[l];
			a(u) && u.dirtyBoundingBoxCache(), at(e, ll(u, n));
		}
	}
	return e.x1 = Rr(e.x1), e.y1 = Rr(e.y1), e.x2 = Rr(e.x2), e.y2 = Rr(e.y2), e.w = Rr(e.x2 - e.x1), e.h = Rr(e.y2 - e.y1), e;
};
...
yt.boundingBoxAt = function(r) {
	...
	var s = m(function(f, c) {
		return f._private.bbAtOldPos = r(f, c);
	}, "storeOldPos"), o = m(function(f) {
	...
	var l = kd(this.boundingBox({ useCache: !1 }));
...
var Kg = yt, ba = _a = {}, _a;
var Xv = m(function(e) {
	e.uppercaseName = ko(e.name), e.autoName = "auto" + e.uppercaseName, e.labelName = "label" + e.uppercaseName, e.outerName = "outer" + e.uppercaseName, e.uppercaseOuterName = ko(e.outerName), ba[e.name] = m(function() {
		var a = this[0], n = a._private, s = n.cy._private.styleEnabled;
		if (a) if (s) {
			if (a.isParent()) return a.updateCompoundBounds(), n[e.autoName] || 0;
			var o = a.pstyle(e.name);
			switch (o.strValue) {
				case "label": return a.recalculateRenderedStyle(), n.rstyle[e.labelName] || 0;
				default: return o.pfValue;
			}
		} else return 1;
	}, "dimImpl"), ba["outer" + e.uppercaseName] = m(function() {
		var a = this[0], s = a._private.cy._private.styleEnabled;
		if (a) if (s) {
	...
	}, "outerDimImpl"), ba["rendered" + e.uppercaseName] = m(function() {
		var a = this[0];
		if (a) return a[e.name]() * this.cy().zoom();
	}, "renderedDimImpl"), ba["rendered" + e.uppercaseOuterName] = m(function() {
		var a = this[0];
...
var Xg = _a, Yg = m(function(e, t) {
	if (e.isEdge() && e.takesUpSpace()) return t(e);
}, "ifEdge"), Zg = m(function(e, t) {
	if (e.isEdge() && e.takesUpSpace()) {
		var a = e.cy();
		return Nn(t(e), a.zoom(), a.pan());
	}
}, "ifEdgeRenderedPosition"), Qg = m(function(e, t) {
	if (e.isEdge() && e.takesUpSpace()) {
...
}, "ifEdgeRenderedPositions"), Jg = m(function(e) {
	return e.renderer().getControlPoints(e);
}, "controlPoints"), jg = m(function(e) {
	return e.renderer().getSegmentPoints(e);
}, "segmentPoints"), ep = m(function(e) {
	return e.renderer().getSourceEndpoint(e);
}, "sourceEndpoint"), rp = m(function(e) {
	return e.renderer().getTargetEndpoint(e);
}, "targetEndpoint"), tp = m(function(e) {
	...
	sourceEndpoint: { get: ep },
	targetEndpoint: { get: rp },
	midpoint: { get: tp }
}, ap = m(function(e) {
	return "rendered" + e[0].toUpperCase() + e.substr(1);
}, "renderedName"), ip = we({}, Wg, Kg, Xg, Object.keys(cl).reduce(function(r, e) {
	var t = cl[e], a = ap(e);
	return r[e] = function() {
...
Yv.prototype = {
	...
	preventDefault: m(function() {
		this.isDefaultPrevented = rn;
		var e = this.originalEvent;
		e && e.preventDefault && e.preventDefault();
	}, "preventDefault"),
	stopPropagation: m(function() {
...
var Zv = /^([^.]+)(\.(?:[^.]+))?$/, sp = ".*", Qv = {
	qualifierCompare: m(function(e, t) {
		return e === t;
	}, "qualifierCompare"),
	eventMatches: m(function() {
		return !0;
	}, "eventMatches"),
	addEventFields: m(function() {}, "addEventFields"),
	callbackContext: m(function(e) {
		return e;
	}, "callbackContext"),
	beforeEmit: m(function() {}, "beforeEmit"),
	afterEmit: m(function() {}, "afterEmit"),
	bubble: m(function() {
		return !1;
	}, "bubble"),
	parent: m(function() {
...
m(Hn, "Emitter");
var ht = Hn.prototype, Jv = m(function(e, t, a, n, i, s, o) {
	Ke(n) && (i = n, n = null), o && (s == null ? s = o : s = we({}, s, o));
	for (var l = Ge(a) ? a : a.split(/\s+/), u = 0; u < l.length; u++) {
		...
		if (!lt(f)) {
			...
			if (c) {
				var d = c[1];
				if (t(e, f, d, c[2] ? c[2] : null, n, i, s) === !1) break;
			}
		}
	}
}, "forEachEvent"), hl = m(function(e, t) {
	return e.addEventFields(e.context, t), new Yv(t.type, t);
}, "makeEventObj"), up = m(function(e, t, a) {
	if (hc(a)) {
		t(e, a);
		return;
	} else if (Ie(a)) {
...
ht.removeListener = ht.off = function(r, e, t, a) {
	...
	for (var i = this.listeners, s = m(function(u) {
		var f = i[u];
		Jv(n, function(c, d, g, h, m, p) {
			if ((f.type === g || r === "*") && (!h && f.namespace !== ".*" || f.namespace === h) && (!m || c.qualifierCompare(f.qualifier, m)) && (!p || f.callback === p)) return i.splice(u, 1), !1;
		}, r, e, t, a);
...
ht.emit = ht.trigger = function(r, e, t) {
	...
	return this.emitting++, Ge(e) || (e = [e]), up(this, function(i, s) {
		t != null && (a = [{
			event: s.event,
			type: s.type,
		...
		for (var o = m(function() {
			...
			if (f.type === s.type && (!f.namespace || f.namespace === s.namespace || f.namespace === sp) && i.eventMatches(i.context, f, s)) {
				var c = [s];
				e != null && Jc(c, e), i.beforeEmit(i.context, f, s), f.conf && f.conf.one && (i.listeners = i.listeners.filter(function(h) {
					return h !== f;
				}));
				var d = i.callbackContext(i.context, f, s), g = f.callback.apply(d, c);
				i.afterEmit(i.context, f, s), g === !1 && (s.stopPropagation(), s.preventDefault());
			}
		}, "_loop2"), l = 0; l < n; l++) o();
...
var lp = {
	...
	eventMatches: m(function(e, t, a) {
		var n = t.qualifier;
		return n != null ? e !== a.target && Oa(a.target) && n.matches(a.target) : !0;
	}, "eventMatches"),
	addEventFields: m(function(e, t) {
		t.cy = e.cy(), t.target = e;
	}, "addEventFields"),
	callbackContext: m(function(e, t, a) {
		return t.qualifier != null ? a.target : e;
	}, "callbackContext"),
	beforeEmit: m(function(e, t) {
	...
	on: m(function(e, t, a) {
		for (var n = tn(t), i = 0; i < this.length; i++) this[i].emitter().on(e, n, a);
		return this;
	}, "on"),
	removeListener: m(function(e, t, a) {
		for (var n = tn(t), i = 0; i < this.length; i++) this[i].emitter().removeListener(e, n, a);
		return this;
	}, "removeListener"),
	removeAllListeners: m(function() {
		for (var e = 0; e < this.length; e++) this[e].emitter().removeAllListeners();
		return this;
	}, "removeAllListeners"),
	one: m(function(e, t, a) {
		for (var n = tn(t), i = 0; i < this.length; i++) this[i].emitter().one(e, n, a);
		return this;
	}, "one"),
	once: m(function(e, t, a) {
		for (var n = tn(t), i = 0; i < this.length; i++) this[i].emitter().on(e, n, a, {
			once: !0,
			onceCollection: this
		});
	...
	emit: m(function(e, t) {
		for (var a = 0; a < this.length; a++) this[a].emitter().emit(e, t);
		return this;
	}, "emit"),
	emitAndNotify: m(function(e, t) {
...
var ef = {
	...
	absoluteComplement: m(function() {
		return this.cy().mutableElements().not(this);
	}, "absoluteComplement"),
	intersect: m(function(e) {
		if (pe(e)) {
			var t = e;
	...
	xor: m(function(e) {
		...
		pe(e) && (e = t.$(e));
		var a = this.spawn(), n = this, i = e, s = m(function(l, u) {
			for (var f = 0; f < l.length; f++) {
				var c = l[f], d = c._private.data.id;
				u.hasElementWithId(d) || a.push(c);
			}
		}, "add");
	...
	diff: m(function(e) {
		var t = this._private.cy;
		pe(e) && (e = t.$(e));
		var a = this.spawn(), n = this.spawn(), i = this.spawn(), s = this, o = e, l = m(function(f, c, d) {
			for (var g = 0; g < f.length; g++) {
				var h = f[g], m = h._private.data.id;
				c.hasElementWithId(m) ? i.merge(h) : d.push(h);
			}
		}, "add");
	...
	merge: m(function(e) {
		...
		for (var i = t.map, s = 0; s < e.length; s++) {
			var o = e[s], l = o._private.data.id;
			if (!i.has(l)) {
				var f = this.length++;
				this[f] = o, i.set(l, {
					ele: o,
	...
	unmergeAt: m(function(e) {
		var a = this[e].id(), i = this._private.map;
	...
	unmergeOne: m(function(e) {
		e = e[0];
		var t = this._private, a = e._private.data.id, i = t.map.get(a);
		if (!i) return this;
		var s = i.index;
		return this.unmergeAt(s), this;
	}, "unmergeOne"),
	unmerge: m(function(e) {
		var t = this._private.cy;
		if (!e) return this;
		if (e && pe(e)) {
			var a = e;
	...
	reduce: m(function(e, t) {
		for (var a = t, n = this, i = 0; i < n.length; i++) a = e(a, n[i], i, n);
		return a;
	}, "reduce"),
	max: m(function(e, t) {
		for (var a = -Infinity, n, i = this, s = 0; s < i.length; s++) {
...
var vp = {
	...
	if (s !== 0) return s;
	function o(f) {
		return f.pstyle("z-index-compare").value === "auto" && f.isNode() ? 1 : 0;
	}
	m(o, "getEleDepth");
	var l = o(e) - o(t);
	if (l !== 0) return l;
	...
	slice: m(function(e, t) {
		var a = [], n = this.length;
		t ??= n, e ??= 0, e < 0 && (e = n + e), t < 0 && (t = n + t);
...
m(function() {
	var e = "undefined";
	(typeof Symbol > "u" ? "undefined" : nr(Symbol)) != e && nr(Symbol.iterator) != e && (kn[Symbol.iterator] = function() {
		var a = this, n = {
			value: void 0,
			done: !1
		}, i = 0, s = this.length;
		return jl({ next: m(function() {
...
var cp = dr({ nodeDimensionsIncludeLabels: !1 }), cn = {
	layoutDimensions: m(function(e) {
		e = cp(e);
		var t;
	...
	layoutPositions: m(function(e, t, a) {
		var n = this.nodes().filter(function(C) {
			return !C.isParent();
		}), i = this.cy(), s = t.eles, o = m(function(T) {
			return T.id();
		}, "getMemoizeKey"), l = Jt(a, o);
		e.emit({
			type: "layoutstart",
			layout: e
		}), e.animations = [];
		var u = m(function(T, E, S) {
			var D = {
				x: E.x1 + E.w / 2,
				y: E.y1 + E.h / 2
			}, B = {
		...
		}, "calculateSpacing"), f = t.spacingFactor && t.spacingFactor !== 1, d = m(function() {
			if (!f) return null;
			for (var T = xr(), E = 0; E < n.length; E++) {
				var S = n[E], D = l(S, E);
				bv(T, D.x, D.y);
			}
			return T;
		}, "spacingBb")(), g = Jt(function(C, T) {
			var E = l(C, T);
			if (f) E = u(Math.abs(t.spacingFactor), d, E);
			return t.transform != null && (E = t.transform(C, E)), E;
		}, o);
		if (t.animate) {
			for (var h = 0; h < n.length; h++) {
				var m$21 = n[h], p = g(m$21, h);
				if (t.animateFilter == null || t.animateFilter(m$21, h)) {
					var b = m$21.animation({
						position: p,
						duration: t.animationDuration,
						easing: t.animationEasing
					});
					e.animations.push(b);
				} else m$21.position(p);
			}
			if (t.fit) {
				var w = i.animation({
					fit: {
	...
	layout: m(function(e) {
		return this.cy().makeLayout(we({}, e, { eles: this }));
	}, "layout")
};
cn.createLayout = cn.makeLayout = cn.layout;
function tf(r, e, t) {
	var a = t._private, n = a.styleCache = a.styleCache || [], i;
	return (i = n[r]) ?? (i = n[r] = e(t)), i;
}
m(tf, "styleCache");
function Wn(r, e) {
	return r = Pt(r), m(function(a) {
		return tf(r, e, a);
	}, "cachedStyleFunction");
}
m(Wn, "cacheStyleFunction");
function $n(r, e) {
	r = Pt(r);
	var t = m(function(n) {
		return e.call(n);
...
m($n, "cachePrototypeStyleFunction");
var fr = {
	recalculateRenderedStyle: m(function(e) {
		var t = this.cy(), a = t.renderer(), n = t.styleEnabled();
		return a && n && a.recalculateRenderedStyle(this, e), this;
	}, "recalculateRenderedStyle"),
	dirtyStyleCache: m(function() {
		var e = this.cy(), t = m(function(i) {
			return i._private.styleCache = null;
		}, "dirty");
		if (e.hasCompoundNodes()) {
			var a = this.spawnSelf().merge(this.descendants()).merge(this.parents());
			a.merge(a.connectedEdges()), a.forEach(t);
		} else this.forEach(function(n) {
			t(n), n.connectedEdges().forEach(t);
		});
		return this;
	}, "dirtyStyleCache"),
	updateStyle: m(function(e) {
		var t = this._private.cy;
	...
	parsedStyle: m(function(e) {
		...
		if (n.styleEnabled() && a) {
			...
			return a._private.style[e] ?? (t ? n.style().getDefaultProperty(e) : null);
		}
	}, "parsedStyle"),
	numericStyle: m(function(e) {
		var t = this[0];
	...
	effectiveOpacity: m(function() {
		...
		if (a) {
			...
			if (s) for (var o = 0; o < s.length; o++) i = s[o].pstyle("opacity").value * i;
			return i;
		}
	}, "effectiveOpacity"),
	transparent: m(function() {
	...
	backgrounding: m(function() {
		if (!this.cy().styleEnabled()) return !1;
		return !!this[0]._private.backgrounding;
	}, "backgrounding")
};
function bs(r, e) {
	var a = r._private.data.parent ? r.parents() : null;
...
m(fo, "defineDerivedStateFunction");
var na = Wn("eleTakesUpSpace", function(r) {
	return r.pstyle("display").value === "element" && r.width() !== 0 && (r.isNode() ? r.height() !== 0 : !0);
});
fr.takesUpSpace = $n("takesUpSpace", fo({ ok: na }));
fr.interactive = $n("interactive", fo({
	ok: Wn("eleInteractive", function(r) {
		return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && na(r);
	}),
	parentOk: Wn("parentInteractive", function(r) {
...
fr.visible = $n("visible", fo({
	ok: Wn("eleVisible", function(r) {
...
fr.isBundledBezier = $n("isBundledBezier", function() {
...
m(ia, "defineSwitchSet");
ia({
	field: "locked",
	overrideField: m(function(e) {
...
}, "defineDagExtremity"), yl = m(function(e) {
	return function(t) {
...
}, "defineDagOneHop"), ml = m(function(e) {
	return function(t) {
		for (var a = this, n = [], i = {};;) {
...
we(pr, {
	roots: pl({ noIncomingEdges: !0 }),
	leaves: pl({ noOutgoingEdges: !0 }),
	outgoers: Mr(yl({ outgoing: !0 }), "outgoers"),
	successors: ml({ outgoing: !0 }),
	incomers: Mr(yl({ incoming: !0 }), "incomers"),
	predecessors: ml({})
});
we(pr, {
	neighborhood: Mr(function(r) {
		for (var e = [], t = this.nodes(), a = 0; a < t.length; a++) for (var n = t[a], i = n.connectedEdges(), s = 0; s < i.length; s++) {
			var o = i[s], l = o.source(), u = o.target(), f = n === l ? u : l;
			f.length > 0 && e.push(f[0]), e.push(o[0]);
		}
		return this.spawn(e, !0).filter(r);
	}, "neighborhood"),
	closedNeighborhood: m(function(e) {
		return this.neighborhood().add(this).filter(e);
	}, "closedNeighborhood"),
	openNeighborhood: m(function(e) {
...
we(pr, {
	source: Mr(m(function(e) {
		var t = this[0], a;
		return t && (a = t._private.source || t.cy().collection()), a && e ? a.filter(e) : a;
	}, "sourceImpl"), "source"),
	target: Mr(m(function(e) {
		var t = this[0], a;
		return t && (a = t._private.target || t.cy().collection()), a && e ? a.filter(e) : a;
	}, "targetImpl"), "target"),
	sources: bl({ attr: "source" }),
	targets: bl({ attr: "target" })
});
function bl(r) {
	return m(function(t) {
		for (var a = [], n = 0; n < this.length; n++) {
			var s = this[n]._private[r.attr];
			s && a.push(s);
		}
		return this.spawn(a, !0).filter(t);
	}, "sourceImpl");
}
m(bl, "defineSourceFunction");
we(pr, {
	edgesWith: Mr(wl(), "edgesWith"),
	edgesTo: Mr(wl({ thisIsSrc: !0 }), "edgesTo")
});
function wl(r) {
	return m(function(t) {
		...
		for (var s = 0; s < t.length; s++) for (var o = t[s]._private.edges, l = 0; l < o.length; l++) {
			var u = o[l], f = u._private.data, c = this.hasElementWithId(f.source) && t.hasElementWithId(f.target), d = t.hasElementWithId(f.source) && this.hasElementWithId(f.target);
			(c || d) && ((i.thisIsSrc || i.thisIsTgt) && (i.thisIsSrc && !c || i.thisIsTgt && !d) || a.push(u));
		}
		return this.spawn(a, !0);
	}, "edgesWithImpl");
}
m(wl, "defineEdgesWithFunction");
we(pr, {
	connectedEdges: Mr(function(r) {
	...
	parallelEdges: Mr(xl(), "parallelEdges"),
	codirectedEdges: Mr(xl({ codirected: !0 }), "codirectedEdges")
});
function xl(r) {
	return r = we({}, { codirected: !1 }, r), m(function(a) {
		for (var n = [], i = this.edges(), s = r, o = 0; o < i.length; o++) for (var l = i[o], u = l._private, f = u.source, c = f._private.data.id, d = u.data.target, g = f._private.edges, h = 0; h < g.length; h++) {
			var m = g[h], p = m._private.data, y = p.target, b = p.source, w = y === d && b === c, x = c === y && d === b;
			(s.codirected && w || !s.codirected && (w || x)) && n.push(m);
		}
		return this.spawn(n, !0).filter(a);
	}, "parallelEdgesImpl");
}
m(xl, "defineParallelEdgesFunction");
we(pr, {
	components: m(function(e) {
		var t = this, a = t.cy(), n = a.collection(), i = e == null ? t.nodes() : e.nodes(), s = [];
		e != null && i.empty() && (i = e.sources());
		var o = m(function(f, c) {
		...
		var l = m(function() {
			...
			o(c, f), t.bfs({
				...
				d.connectedEdges().forEach(function(g) {
					t.has(g) && f.has(g.source()) && f.has(g.target()) && f.merge(g);
				});
			});
		}, "_loop");
		do
...
var cr = m(function(e, t) {
	...
	this.length = 0;
	for (var h = 0, m$22 = t.length; h < m$22; h++) {
		var p = t[h][0];
		if (p != null) {
...
}, "Collection"), We = On.prototype = cr.prototype = Object.create(Array.prototype);
...
We.collection = function() {
	return tv(this) ? this : new cr(this._private.cy, [this]);
};
We.unique = function() {
	return new cr(this._private.cy, this, !0);
};
		...
		if (Ie(r)) {
			if (t.startBatch(), r.data) {
				...
				if (e.isEdge()) {
					...
					u && (f != null || n.parent != null) && f != n.parent && (f === void 0 && (f = null), f != null && (f = "" + f), e = e.move({ parent: f }));
				}
			}
			r.position && e.position(r.position);
			var c = m(function(m, p, y) {
				var b = r[m];
				b != null && b !== a[m] && (b ? e[p]() : e[y]());
			}, "checkSwitch");
...
We.restore = function() {
	...
	for (c = 0; c < o.length; c++) {
		var g = o[c], h = g._private, m$23 = h.data;
		if (g.clearTraversalCache(), !(!e && !h.removed)) {
			if (m$23.id === void 0) m$23.id = pv();
			else if (ne(m$23.id)) m$23.id = "" + m$23.id;
			else if (lt(m$23.id) || !pe(m$23.id)) {
				Ue("Can not create element with invalid string ID `" + m$23.id + "`"), d();
				continue;
			} else if (a.hasElementWithId(m$23.id)) {
				Ue("Can not create second element with ID `" + m$23.id + "`"), d();
				continue;
			}
		}
		var p = m$23.id;
		...
		if (g.isEdge()) {
			for (var b = g, w = ["source", "target"], x = w.length, C = !1, T = 0; T < x; T++) {
				var E = w[T], S = m$23[E];
				ne(S) && (S = m$23[E] = "" + m$23[E]), S == null || S === "" ? (Ue("Can not create edge `" + p + "` with unspecified " + E), C = !0) : a.hasElementWithId(S) || (Ue("Can not create edge `" + p + "` with nonexistant " + E + " `" + S + "`"), C = !0);
			}
			if (C) {
				d();
				continue;
			}
			var D = a.getElementById(m$23.source), B = a.getElementById(m$23.target);
			D.same(B) ? D._private.edges.push(b) : (D._private.edges.push(b), B._private.edges.push(b)), b._private.source = D, b._private.target = B;
		}
		h.map = new Yr(), h.map.set(p, {
			ele: g,
			index: 0
		}), h.removed = !1, e && a.addToPool(g);
	}
	for (var P = 0; P < i.length; P++) {
		var A = i[P], R = A._private.data;
		ne(R.parent) && (R.parent = "" + R.parent);
		var M = R.parent;
		if (M != null || A._private.parent) {
			...
			if (O.empty()) R.parent = void 0;
				...
				L || (O[0]._private.children.push(A), A._private.parent = O[0], n.hasCompoundNodes = !0);
			}
		}
	}
	if (o.length > 0) {
		...
		var V;
		n.hasCompoundNodes ? V = a.collection().merge(q).merge(q.connectedNodes()).merge(q.parent()) : V = q, V.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(r), r ? q.emitAndNotify("add") : e && q.emit("add");
	}
	return t;
};
We.removed = function() {
...
We.remove = function() {
	...
	function l(M) {
		var I = n[M.id()];
		e && M.removed() || I || (n[M.id()] = !0, M.isNode() ? (a.push(M), s(M), o(M)) : a.unshift(M));
	}
	m(l, "add");
	...
	m(g, "removeParallelRef");
	var h = [];
	h.ids = {};
	function m$24(M, I) {
		I = I[0], M = M[0];
		var O = M._private.children, L = M.id();
		vt(O, I), I._private.parent = null, h.ids[L] || (h.ids[L] = !0, h.push(M));
	}
	m(m$24, "removeChildRef"), t.dirtyCompoundBoundsCache(), e && i.removeFromPool(a);
	for (var p = 0; p < a.length; p++) {
		var y = a[p];
		if (y.isEdge()) {
			var b = y.source()[0], w = y.target()[0];
			d(b, y), d(w, y);
			for (var x = y.parallelEdges(), C = 0; C < x.length; C++) {
				var T = x[C];
	...
	for (var D = 0; D < S.length; D++) if (S[D].isParent()) {
...
We.move = function(r) {
	var e = this._private.cy, t = this, a = !1, n = !1, i = m(function(h) {
		return h == null ? h : "" + h;
	}, "toString");
	if (r.source !== void 0 || r.target !== void 0) {
		...
		var f = i(r.parent);
		if (f === null || e.hasElementWithId(f)) {
...
var yp = {
	add: m(function(e) {
		...
		} else if (Ge(e)) t = new cr(a, e);
		else if (Ie(e) && (Ge(e.nodes) || Ge(e.edges))) {
			for (var u = e, f = [], c = ["nodes", "edges"], d = 0, g = c.length; d < g; d++) {
				var h = c[d], m = u[h];
				if (Ge(m)) for (var p = 0, y = m.length; p < y; p++) {
					var b = we({ group: h }, m[p]);
					f.push(b);
				}
			}
			t = new cr(a, f);
		} else t = new On(a, e).collection();
		return t;
	}, "add"),
	remove: m(function(e) {
		if (!Br(e)) {
...
function mp(r, e, t, a) {
	...
	for (var c = 0; c < 4; ++c) if (typeof arguments[c] != "number" || isNaN(arguments[c]) || !isFinite(arguments[c])) return !1;
	...
	m(m$25, "C");
	function p(B, P, A) {
		return ((g(P, A) * B + h(P, A)) * B + m$25(P)) * B;
	}
	m(p, "calcBezier");
	function y(B, P, A) {
		return 3 * g(P, A) * B * B + 2 * h(P, A) * B + m$25(P);
	}
	m(y, "getSlope");
	function b(B, P) {
		for (var A = 0; A < n; ++A) {
	...
	m(b, "newtonRaphsonIterate");
	function w() {
		for (var B = 0; B < l; ++B) d[B] = p(B * u, r, t);
	}
	m(w, "calcSampleValues");
	function x(B, P, A) {
		var R, M, I = 0;
		do
			M = P + (A - P) / 2, R = p(M, r, t) - B, R > 0 ? A = M : P = M;
	...
	function C(B) {
		...
		--A;
		var M = (B - d[A]) / (d[A + 1] - d[A]), I = P + M * u, O = y(I, r, t);
		return O >= i ? b(B, I) : O === 0 ? I : x(B, P, P + u);
	}
	m(C, "getTForX");
	var T = !1;
	function E() {
	...
	m(E, "precompute");
	var S = m(function(P) {
		return T || E(), r === e && t === a ? P : P === 0 ? 0 : P === 1 ? 1 : p(C(P), e, a);
	}, "f");
...
m(mp, "generateCubicBezier");
var bp = (function() {
	function r(a) {
		return -a.tension * a.x - a.friction * a.v;
	}
	m(r, "springAccelerationForState");
	function e(a, n, i) {
		var s = {
			x: a.x + i.dx * n,
			v: a.v + i.dv * n,
	...
	m(e, "springEvaluateStateWithDerivative");
	function t(a, n) {
		var i = {
			dx: a.v,
			dv: r(a)
		}, s = e(a, n * .5, i), o = e(a, n * .5, s), l = e(a, n, o), u = 1 / 6 * (i.dx + 2 * (s.dx + o.dx) + l.dx), f = 1 / 6 * (i.dv + 2 * (s.dv + o.dv) + l.dv);
		return a.x = a.x + u * n, a.v = a.v + f * n, a;
	}
	return m(t, "springIntegrateState"), m(function a(n, i, s) {
		var o = {
			x: -1,
			v: 0,
			tension: null,
			friction: null
		}, l = [0], u = 0, f = 1 / 1e4, c = 16 / 1e3, d, g, h;
		for (n = parseFloat(n) || 500, i = parseFloat(i) || 20, s = s || null, o.tension = n, o.friction = i, d = s !== null, d ? (u = a(n, i), g = u / s * c) : g = c; h = t(h || o, g), l.push(1 + h.x), u += 16, Math.abs(h.x) > f && Math.abs(h.v) > f;);
		return d ? function(m) {
			return l[m * (l.length - 1) | 0];
		} : u;
	}, "springRK4Factory");
})(), He = m(function(e, t, a, n) {
	var i = mp(e, t, a, n);
	return function(s, o, l) {
		return s + (o - s) * i(l);
	};
}, "cubicBezier"), dn = {
	linear: m(function(e, t, a) {
		return e + (t - e) * a;
	}, "linear"),
	ease: He(.25, .1, .25, 1),
	"ease-in": He(.42, 0, 1, 1),
	"ease-out": He(0, 0, .58, 1),
	"ease-in-out": He(.42, 0, .58, 1),
	"ease-in-sine": He(.47, 0, .745, .715),
	"ease-out-sine": He(.39, .575, .565, 1),
	"ease-in-out-sine": He(.445, .05, .55, .95),
	"ease-in-quad": He(.55, .085, .68, .53),
	"ease-out-quad": He(.25, .46, .45, .94),
	"ease-in-out-quad": He(.455, .03, .515, .955),
	"ease-in-cubic": He(.55, .055, .675, .19),
	"ease-out-cubic": He(.215, .61, .355, 1),
	"ease-in-out-cubic": He(.645, .045, .355, 1),
	"ease-in-quart": He(.895, .03, .685, .22),
	"ease-out-quart": He(.165, .84, .44, 1),
	"ease-in-out-quart": He(.77, 0, .175, 1),
	"ease-in-quint": He(.755, .05, .855, .06),
	"ease-out-quint": He(.23, 1, .32, 1),
	"ease-in-out-quint": He(.86, 0, .07, 1),
	"ease-in-expo": He(.95, .05, .795, .035),
	"ease-out-expo": He(.19, 1, .22, 1),
	"ease-in-out-expo": He(1, 0, 0, 1),
	"ease-in-circ": He(.6, .04, .98, .335),
	"ease-out-circ": He(.075, .82, .165, 1),
	"ease-in-out-circ": He(.785, .135, .15, .86),
	spring: m(function(e, t, a) {
...
m(Vt, "ease");
function wp(r, e, t, a) {
	var n = !a, i = r._private, s = e._private, o = s.easing, l = s.startTime, f = (a ? r : r.cy()).style();
	if (!s.easingImpl) if (o == null) s.easingImpl = dn.linear;
	else {
		var c;
		if (pe(o)) c = f.parse("transition-timing-function", o).value;
		else c = o;
		var g, h;
		pe(c) ? (g = c, h = []) : (g = c[1], h = c.slice(2).map(function(q) {
			return +q;
		})), h.length > 0 ? (g === "spring" && h.push(s.duration), s.easingImpl = dn[g].apply(null, h)) : s.easingImpl = dn[g];
	}
	...
	if (s.duration === 0 ? p = 1 : p = (t - l) / s.duration, s.applying && (p = s.progress), p < 0 ? p = 0 : p > 1 && (p = 1), s.delay == null) {
		...
		if (b && n && !r.locked()) {
			var w = {};
			ha(y.x, b.x) && (w.x = Vt(y.x, b.x, p, m)), ha(y.y, b.y) && (w.y = Vt(y.y, b.y, p, m)), r.position(w);
		}
		var x = s.startPan, C = s.pan, T = i.pan, E = C != null && a;
		E && (ha(x.x, C.x) && (T.x = Vt(x.x, C.x, p, m)), ha(x.y, C.y) && (T.y = Vt(x.y, C.y, p, m)), r.emit("pan"));
		var S = s.startZoom, D = s.zoom, B = D != null && a;
		B && (ha(S, D) && (i.zoom = Da(i.minZoom, Vt(S, D, p, m), i.maxZoom)), r.emit("zoom")), (E || B) && r.emit("viewport");
		var P = s.style;
		if (P && P.length > 0 && n) {
			for (var A = 0; A < P.length; A++) {
				var R = P[A], M = R.name, I = R, O = s.startStyle[M], L = f.properties[O.name], N = Vt(O, I, p, m, L);
...
function Tl(r, e) {
	...
	function n(f, c) {
		var d = f._private, g = d.animation.current, h = d.animation.queue, m$26 = !1;
		if (g.length === 0) {
			var p = h.shift();
			p && g.push(p);
		}
		for (var y = m(function(T) {
			...
			T.splice(0, T.length);
		}, "callbacks"), b = g.length - 1; b >= 0; b--) {
			var w = g[b], x = w._private;
			if (x.stopped) {
				g.splice(b, 1), x.hooked = !1, x.playing = !1, x.started = !1, y(x.frames);
				continue;
			}
			!x.playing && !x.applying || (x.playing && x.applying && (x.applying = !1), x.started || xp(f, w, r), wp(f, w, r, c), x.applying && (x.applying = !1), y(x.frames), x.step != null && x.step(r), w.completed() && (g.splice(b, 1), x.hooked = !1, x.playing = !1, x.started = !1, y(x.completes)), m$26 = !0);
		}
		return !c && g.length === 0 && h.length === 0 && a.push(f), m$26;
	}
	m(n, "stepOne");
...
var Ep = {
	...
	delayAnimation: Ve.delayAnimation(),
	stop: Ve.stop(),
	addToAnimationPool: m(function(e) {
		var t = this;
		t.styleEnabled() && t._private.aniEles.merge(e);
	}, "addToAnimationPool"),
	stopAnimationLoop: m(function() {
		this._private.animationsRunning = !1;
	}, "stopAnimationLoop"),
	startAnimationLoop: m(function() {
		var e = this;
		if (e._private.animationsRunning = !0, !e.styleEnabled()) return;
		function t() {
			e._private.animationsRunning && xn(m(function(i) {
				Tl(i, e), t();
			}, "animationStep"));
		}
		m(t, "headlessStep");
		var a = e.renderer();
		a && a.beforeRender ? a.beforeRender(m(function(i, s) {
			Tl(s, e);
	...
	on: m(function(e, t, a) {
		return this.emitter().on(e, an(t), a), this;
	}, "on"),
	removeListener: m(function(e, t, a) {
		return this.emitter().removeListener(e, an(t), a), this;
	}, "removeListener"),
	removeAllListeners: m(function() {
		return this.emitter().removeAllListeners(), this;
	}, "removeAllListeners"),
	one: m(function(e, t, a) {
		return this.emitter().one(e, an(t), a), this;
	}, "one"),
	once: m(function(e, t, a) {
		return this.emitter().one(e, an(t), a), this;
	}, "once"),
...
var hn = { layout: m(function(e) {
	...
	var i;
	pe(e.eles) ? i = t.$(e.eles) : i = e.eles != null ? e.eles : t.$();
	return new n(we({}, e, {
		cy: t,
		eles: i
	}));
...
var Tp = {
	...
	batchData: m(function(e) {
		var t = this;
		return this.batch(function() {
			for (var a = Object.keys(e), n = 0; n < a.length; n++) {
				var i = a[n], s = e[i];
				t.getElementById(i).data(s);
			}
		});
	}, "batchData")
}, Sp = dr({
	...
	renderTo: m(function(e, t, a, n) {
		return this._private.renderer.renderTo(e, t, a, n), this;
	}, "renderTo"),
	renderer: m(function() {
		return this._private.renderer;
	}, "renderer"),
	forceRender: m(function() {
		return this.notify("draw"), this;
	}, "forceRender"),
	resize: m(function() {
		return this.invalidateSize(), this.emitAndNotify("resize"), this;
	}, "resize"),
	initRenderer: m(function(e) {
		var t = this, a = t.extension("renderer", e.name);
		if (a == null) {
			Ue("Can not initialise: No such renderer `".concat(e.name, "` found. Did you forget to import it and `cytoscape.use()` it?"));
			return;
		}
	...
	onRender: m(function(e) {
		return this.on("render", e);
	}, "onRender"),
	offRender: m(function(e) {
		return this.off("render", e);
	}, "offRender")
};
Vs.invalidateDimensions = Vs.resize;
var gn = {
	collection: m(function(e, t) {
...
var lr = {}, xa = "t", kp = "f";
lr.apply = function(r) {
	for (var e = this, n = e._private.cy.collection(), i = 0; i < r.length; i++) {
	...
	for (var s = [], o = {}, l = 0; l < t.length; l++) {
		...
		if (d || c && g) {
			...
			for (var m = 0; m < h.length; m++) {
				for (var p = h[m], y = p.name, b = !1, w = l + 1; w < t.length; w++) {
					var x = t[w];
					if (e[w] === xa && (b = x.properties[p.name] != null, b)) break;
				}
...
lr.getContextMeta = function(r) {
	for (var e = this, t = "", a, n = r._private.styleCxtKey || "", i = 0; i < e.length; i++) {
		var s = e[i];
		s.selector && s.selector.matches(r) ? t += xa : t += kp;
	}
...
lr.getContextStyle = function(r) {
	...
	for (var n = { _private: { key: e } }, i = 0; i < t.length; i++) {
		var s = t[i];
		if (e[i] === xa) for (var l = 0; l < s.properties.length; l++) {
	...
	for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
		...
		if (f !== u) {
			if (u.mapped === s.fn && f != null && f.mapping != null && f.mapping.value === u.value) {
				var c = f.mapping;
				if ((c.fnValue = u.value(t)) === c.prevFnValue) continue;
			}
			var g = i[l] = { prev: f };
			a.applyParsedProperty(t, u), g.next = t.pstyle(l), g.next && g.next.bypass && (g.next = g.next.bypassed);
		}
	}
	return { diffProps: i };
};
lr.updateStyleHints = function(r) {
	var e = r._private, t = this, a = t.propertyGroupNames, n = t.propertyGroupKeys, i = m(function(W, Z, ae) {
	...
	for (var c = m(function(W, Z) {
		return e.styleKeys[Z][0] = Ta(W, e.styleKeys[Z][0]);
	}, "updateGrKey1"), d = m(function(W, Z) {
		return e.styleKeys[Z][1] = Sa(W, e.styleKeys[Z][1]);
	}, "updateGrKey2"), g = m(function(W, Z) {
		c(W, Z), d(W, Z);
	}, "updateGrKey"), h = m(function(W, Z) {
		for (var ae = 0; ae < W.length; ae++) {
			var de = W.charCodeAt(ae);
			c(de, Z), d(de, Z);
		}
	}, "updateGrKeyWStr"), m$27 = 2e9, p = m(function(W) {
		return -128 < W && W < 128 && Math.floor(W) !== W ? m$27 - (W * 1024 | 0) : W;
	}, "cleanNum"), y = 0; y < a.length; y++) {
		var b = a[y], w = l[b];
		if (w != null) {
			var x = this.properties[b], C = x.type, T = x.groupKey, E = void 0;
			x.hashOverride != null ? E = x.hashOverride(r, w) : w.pfValue != null && (E = w.pfValue);
			var S = x.enums == null ? w.value : null, D = E != null, P = D || S != null, A = w.units;
			if (C.number && P && !C.multiple) g(p(D ? E : S), T), !D && A != null && h(A, T);
			else h(w.strValue, T);
		}
	}
	for (var M = [kt, Wt], I = 0; I < n.length; I++) {
		var O = n[I], L = e.styleKeys[O];
		M[0] = Ta(L[0], M[0]), M[1] = Sa(L[1], M[1]);
	}
	e.styleKey = Gc(M[0], M[1]);
	var N = e.styleKeys;
	e.labelDimsKey = rt(N.labelDimensions);
	var q = i(r, ["label"], N.labelDimensions);
	if (e.labelKey = rt(q), e.labelStyleKey = rt(Ya(N.commonLabel, q)), !o) {
		var H = i(r, ["source-label"], N.labelDimensions);
		e.sourceLabelKey = rt(H), e.sourceLabelStyleKey = rt(Ya(N.commonLabel, H));
		var z = i(r, ["target-label"], N.labelDimensions);
		e.targetLabelKey = rt(z), e.targetLabelStyleKey = rt(Ya(N.commonLabel, z));
	}
	if (o) {
		var V = e.styleKeys, K = V.nodeBody, J = V.nodeBorder, X = V.nodeOutline, ee = V.backgroundImage, te = V.compound, ie = V.pie, j = V.stripe;
		e.nodeKey = rt([
			K,
			J,
			X,
			...
			return _ != null;
		}).reduce(Ya, [kt, Wt])), e.hasPie = ie != null && ie[0] !== kt && ie[1] !== Wt, e.hasStripe = j != null && j[0] !== kt && j[1] !== Wt;
	}
	return s !== e.styleKey;
};
...
lr.applyParsedProperty = function(r, e) {
	var t = this, a = e, n = r._private.style, i, s = t.types, o = t.properties[a.name].type, l = a.bypass, u = n[a.name], f = u && u.bypass, c = r._private, d = "mapping", g = m(function(K) {
		return K == null ? null : K.pfValue != null ? K.pfValue : K.value;
	}, "getVal"), h = m(function() {
		var K = g(u), J = g(a);
		t.checkTriggers(r, a.name, K, J);
	}, "checkTriggers");
	if (e.name === "curve-style" && r.isEdge() && (e.value !== "bezier" && r.isLoop() || e.value === "haystack" && (r.source().isParent() || r.target().isParent())) && (a = e = this.parse(e.name, "bezier", l)), a.delete) return n[a.name] = void 0, h(), !0;
	if (a.deleteBypassed) return u ? u.bypass ? (u.bypassed = void 0, h(), !0) : !1 : (h(), !0);
	if (a.deleteBypass) return u ? u.bypass ? (n[a.name] = u.bypassed, h(), !0) : !1 : (h(), !0);
	var m$28 = m(function() {
	...
	switch (a.mapped) {
		case s.mapData:
			for (var p = a.field.split("."), y = c.data, b = 0; b < p.length && y; b++) {
				var w = p[b];
				y = y[w];
			}
			if (y == null) return m$28(), !1;
			var x;
			if (ne(y)) {
				var C = a.fieldMax - a.fieldMin;
				C === 0 ? x = 0 : x = (y - a.fieldMin) / C;
			} else return qe("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + y + "` for `" + r.id() + "` is non-numeric)"), !1;
			...
			break;
		case s.data:
			for (var O = a.field.split("."), L = c.data, N = 0; N < O.length && L; N++) {
				var q = O[N];
				L = L[q];
			}
			if (L != null && (i = this.parse(a.name, L, a.bypass, d)), !i) return m$28(), !1;
			i.mapping = a, a = i;
			break;
		case s.fn:
			var H = a.value, z = a.fnValue != null ? a.fnValue : H(r);
			if (a.prevFnValue = z, z == null) return qe("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), !1;
			if (i = this.parse(a.name, z, a.bypass, d), !i) return qe("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), !1;
			i.mapping = _r(a), a = i;
			break;
		case void 0: break;
		default: return !1;
	}
	return l ? (f ? a.bypassed = u.bypassed : a.bypassed = u, n[a.name] = a) : f ? u.bypassed = a : n[a.name] = a, h(), !0;
};
...
lr.updateTransitions = function(r, e) {
	...
	if (n.length > 0 && i > 0) {
		for (var o = {}, l = !1, u = 0; u < n.length; u++) {
			var f = n[u], c = r.pstyle(f), d = e[f];
			if (d) {
				var h = d.prev, m = d.next != null ? d.next : c, p = !1, y = void 0, b = 1e-6;
				h && (ne(h.pfValue) && ne(m.pfValue) ? (p = m.pfValue - h.pfValue, y = h.pfValue + b * p) : ne(h.value) && ne(m.value) ? (p = m.value - h.value, y = h.value + b * p) : Ge(h.value) && Ge(m.value) && (p = h.value[0] !== m.value[0] || h.value[1] !== m.value[1] || h.value[2] !== m.value[2], y = h.strValue), p && (o[f] = m.strValue, this.applyBypass(r, f, y), l = !0));
			}
		}
		if (!l) return;
		a.transitioning = !0, new aa(function(w) {
...
Ga.applyBypass = function(r, e, t, a) {
	...
	if (e === "*" || e === "**") {
		if (t !== void 0) for (var o = 0; o < n.properties.length; o++) {
			var u = n.properties[o].name, f = this.parse(u, t, !0);
			f && i.push(f);
		}
	} else if (pe(e)) {
		var c = this.parse(e, t, !0);
		c && i.push(c);
	} else if (Ie(e)) {
		var d = e;
		a = t;
		for (var g = Object.keys(d), h = 0; h < g.length; h++) {
			...
			if (p === void 0 && (p = d[Ln(m)]), p !== void 0) {
				var y = this.parse(m, p, !0);
				y && i.push(y);
			}
		}
	} else return !1;
	if (i.length === 0) return !1;
	for (var b = !1, w = 0; w < r.length; w++) {
		for (var x = r[w], C = {}, T = void 0, E = 0; E < i.length; E++) {
			var S = i[E];
			if (a) {
				var D = x.pstyle(S.name);
				T = C[S.name] = { prev: D };
			}
			b = this.applyParsedProperty(x, _r(S)) || b, a && (T.next = x.pstyle(S.name));
		}
		b && this.updateStyleHints(x), a && this.updateTransitions(x, C, s);
	}
	return b;
};
...
Ga.removeBypasses = function(r, e, t) {
	for (var a = !0, n = 0; n < r.length; n++) {
		for (var i = r[n], s = {}, o = 0; o < e.length; o++) {
			...
			if (!(!f || !f.bypass)) {
				var d = this.parse(l, "", !0), g = s[u.name] = { prev: f };
...
Gr.getIndexedStyle = function(r, e, t, a) {
	return r.pstyle(e)[t][a] ?? r.cy().style().getDefaultProperty(e)[t][0];
};
	...
	if (r = r[0], r) {
		...
		if (s) {
			...
			if (t && i.number && o != null && ne(o)) {
				var f = r.cy().zoom(), c = m(function(p) {
					return p * f;
				}, "getRenderedValue"), d = m(function(p, y) {
					return c(p) + y;
				}, "getValueStringWithUnits"), g = Ge(o);
				return (g ? l.every(function(m) {
					return m != null;
				}) : l != null) ? g ? o.map(function(m, p) {
					return d(m, l[p]);
...
Gr.getAnimationStartStyle = function(r, e) {
	for (var t = {}, a = 0; a < e.length; a++) {
		var i = e[a].name, s = r.pstyle(i);
		s !== void 0 && (Ie(s) ? s = this.parse(i, s.strValue) : s = this.parse(i, s)), s && (t[i] = s);
	}
	return t;
};
Gr.getPropsList = function(r) {
	...
	if (a) for (var i = Object.keys(a), s = 0; s < i.length; s++) {
		var o = i[s], l = a[o], u = n[o] || n[Qs(o)], f = this.parse(u.name, l);
		f && t.push(f);
	}
	return t;
};
Gr.getNonDefaultPropertiesHash = function(r, e, t) {
	...
	for (l = 0; l < e.length; l++) if (n = e[l], i = r.pstyle(n, !1), i != null) if (i.pfValue != null) a[0] = Ta(o, a[0]), a[1] = Sa(o, a[1]);
	else for (s = i.strValue, u = 0; u < s.length; u++) o = s.charCodeAt(u), a[0] = Ta(o, a[0]), a[1] = Sa(o, a[1]);
	return a;
};
...
ho.appendFromString = function(r) {
	...
	m(o, "removeSelAndBlockFromRemaining");
	function l() {
		i.length > s.length ? i = i.substr(s.length) : i = "";
	}
	for (m(l, "removePropAndValFromRem");;) {
		if (a.match(/^\s*$/)) break;
		...
		for (var m$29 = [];;) {
			...
			if (!y) {
				qe("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + g), h = !0;
				break;
			}
			s = y[0];
			var b = y[1], w = y[2];
...
var Je = {};
(function() {
	var r = ar, e = wc, t = Ec, a = Cc, n = Tc, i = m(function(_) {
		return "^" + _ + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
	}, "data"), s = m(function(_) {
		var W = r + "|\\w+|" + e + "|" + t + "|" + a + "|" + n;
	...
	Je.types = {
		...
		edgeEndpoint: {
			...
			singleEnum: !0,
			validate: m(function(_, W) {
				switch (_.length) {
					case 2: return W[0] !== "deg" && W[0] !== "rad" && W[1] !== "deg" && W[1] !== "rad";
					case 1: return pe(_[0]) || W[0] === "deg" || W[0] === "rad";
					default: return !1;
				}
			}, "validate")
		},
	...
	var l = {
		zeroNonZero: m(function(_, W) {
			return (_ == null || W == null) && _ !== W || _ == 0 && W != 0 ? !0 : _ != 0 && W == 0;
		}, "zeroNonZero"),
		any: m(function(_, W) {
			return _ != W;
		}, "any"),
		emptyNonEmpty: m(function(_, W) {
			var Z = lt(_), ae = lt(W);
			return Z && !ae || !Z && ae;
		}, "emptyNonEmpty")
	}, u = Je.types, f = [
	...
	], p = [
		{
			...
			triggersBoundsOfParallelEdges: m(function(_, W, Z) {
				return _ === W ? !1 : Z.pstyle("curve-style").value === "bezier";
		...
		},
		{
			...
			type: u.curveStyle,
			triggersBounds: l.any,
			triggersBoundsOfParallelEdges: m(function(_, W) {
				return _ === W ? !1 : _ === "bezier" || W === "bezier";
			}, "triggersBoundsOfParallelEdges")
		},
		{
	...
	var q = Je.properties = [].concat(m$30, w, p, y, b, P, h, g, f, c, d, C, T, E, S, R, I, D, B, L, A), H = Je.propertyGroups = {
		behavior: m$30,
		transition: w,
		visibility: p,
		overlay: y,
		...
		edgeArrow: L,
		core: A
	}, z = Je.propertyGroupNames = {};
	(Je.propertyGroupKeys = Object.keys(H)).forEach(function(F) {
		z[F] = H[F].map(function(_) {
			return _.name;
	...
	Je.propertyNames = q.map(function(F) {
		return F.name;
	});
...
Kn.parse = function(r, e, t, a) {
	...
	var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = t ? "t" : "f", l = dv(r, "" + e, s, i), u = n.propCache = n.propCache || [], f;
	return (f = u[l]) || (f = u[l] = n.parseImplWarn(r, e, t, a)), (t || a === "mapping") && (f = _r(f), f && (f.value = _r(f.value))), f;
};
Kn.parseImplWarn = function(r, e, t, a) {
	var n = this.parseImpl(r, e, t, a);
	return !n && e != null && qe("The style property `".concat(r, ": ").concat(e, "` is invalid")), n && (n.name === "width" || n.name === "height") && e === "label" && qe("The style value of `label` is deprecated for `" + n.name + "`"), n;
};
Kn.parseImpl = function(r, e, t, a) {
	...
	if (!(!l || a || e.length < 7 || e[1] !== "a")) {
		if (e.length >= 7 && e[0] === "d" && (f = new RegExp(o.data.regex).exec(e))) {
			...
			var h = this.parse(r, c[4]);
			if (!h || h.mapped) return !1;
			var m$31 = this.parse(r, c[5]);
			if (!m$31 || m$31.mapped) return !1;
			if (h.pfValue === m$31.pfValue || h.strValue === m$31.strValue) return qe("`" + r + ": " + e + "` is not a valid mapper because the output range is zero; converting to `" + r + ": " + h.strValue + "`"), this.parse(r, h.strValue);
			if (u.color) {
				var p = h.value, y = m$31.value;
				if (p[0] === y[0] && p[1] === y[1] && p[2] === y[2] && (p[3] === y[3] || (p[3] == null || p[3] === 1) && (y[3] == null || y[3] === 1))) return !1;
			}
			return {
				name: r,
				value: c,
	...
	if (u.multiple && a !== "multiple") {
		var w;
		if (l ? w = e.split(/\s+/) : Ge(e) ? w = e : w = [e], u.evenMultiple && w.length % 2 !== 0) return null;
		for (var x = [], C = [], T = [], E = "", S = !1, D = 0; D < w.length; D++) {
			var B = n.parse(r, w[D], t, "multiple");
	...
	var P = m(function() {
		for (var j = 0; j < u.enums.length; j++) if (u.enums[j] === e) return {
			name: r,
			value: e,
			strValue: "" + e,
			bypass: t
	...
	if (u.number) {
		...
		var L = [], N = "" + e;
		if (N !== "none") {
			for (var q = N.split(/\s*,\s*|\s+/), H = 0; H < q.length; H++) {
				var z = q[H].trim();
		...
		for (var J = u.regexes ? u.regexes : [u.regex], X = 0; X < J.length; X++) {
			var te = new RegExp(J[X]).exec(e);
			if (te) return {
				name: r,
...
yr.clear = function() {
	for (var r = this._private, t = r.cy.elements(), a = 0; a < this.length; a++) this[a] = void 0;
...
yr.cssRule = function(r, e) {
	...
	if (t) {
		...
		!this[a].selector && (this._private.coreStyle[t.name] = t);
	}
	return this;
};
...
var Dp = {
	...
	getFitViewport: m(function(e, t) {
		if (ne(e) && t === void 0 && (t = e, e = void 0), !(!this._private.panningEnabled || !this._private.zoomingEnabled)) {
			...
			} else Br(e) || (e = this.mutableElements());
			if (!(Br(e) && e.empty())) {
				a = a || e.boundingBox();
	...
	minZoom: m(function(e) {
		return e === void 0 ? this._private.minZoom : this.zoomRange({ min: e });
	}, "minZoom"),
	maxZoom: m(function(e) {
		return e === void 0 ? this._private.maxZoom : this.zoomRange({ max: e });
	}, "maxZoom"),
	getZoomedViewport: m(function(e) {
		var t = this._private, a = t.pan, n = t.zoom, i, s, o = !1;
		if (t.zoomingEnabled || (o = !0), ne(e) ? s = e : Ie(e) && (s = e.level, e.position != null ? i = Nn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ne(s) || s === n || i != null && (!ne(i.x) || !ne(i.y))) return null;
		if (i != null) {
			var l = a, u = n, f = s;
			return {
				zoomed: !0,
	...
	viewport: m(function(e) {
		var t = this._private, a = !0, n = !0, i = [], s = !1, o = !1;
		if (!e) return this;
		if (ne(e.zoom) || (a = !1), Ie(e.pan) || (n = !1), !a && !n) return this;
		if (a) {
			var l = e.zoom;
		...
		if (n && (!s || !e.cancelOnFailedZoom) && t.panningEnabled) {
			var u = e.pan;
			ne(u.x) && (t.pan.x = u.x, o = !1), ne(u.y) && (t.pan.y = u.y, o = !1), o || i.push("pan");
		}
	...
	multiClickDebounceTime: m(function(e) {
...
var Ma = m(function(e) {
	...
	o.layout = we({ name: s ? "grid" : "null" }, o.layout), o.renderer = we({ name: s ? "canvas" : "null" }, o.renderer);
	var l = m(function(h, m, p) {
	...
	var f = m(function(h, m) {
		if (h.some(yc)) return aa.all(h).then(m);
		m(h);
	}, "loadExtData");
	u.styleEnabled && t.setStyle([]);
	var c = we({}, o, o.renderer);
	t.initRenderer(c);
	var d = m(function(h, m, p) {
		t.notifications(!1);
		var y = t.mutableElements();
		y.length > 0 && y.remove(), h != null && (Ie(h) || Ge(h)) && t.add(h), t.one("layoutready", function(w) {
			t.notifications(!0), t.emit(w), t.one("load", m), t.emitAndNotify("load");
		}).one("layoutstop", function() {
			t.one("done", p), t.emit("done");
		});
		var b = we({}, t._private.options.layout);
		b.eles = t.elements(), t.layout(b).run();
	}, "setElesAndLayout");
	f([o.style, o.elements], function(g) {
		var h = g[0], m = g[1];
		u.styleEnabled && t.style().append(h), d(m, function() {
			t.startAnimationLoop(), u.ready = !0, Ke(o.ready) && t.on("ready", o.ready);
			for (var p = 0; p < i.length; p++) {
				var y = i[p];
				t.on("ready", y);
			}
...
we(Dn, {
	...
	hasElementWithId: m(function(e) {
		return this._private.elements.hasElementWithId(e);
	}, "hasElementWithId"),
	getElementById: m(function(e) {
		return this._private.elements.getElementById(e);
	}, "getElementById"),
	hasCompoundNodes: m(function() {
		return this._private.hasCompoundNodes;
	}, "hasCompoundNodes"),
	headless: m(function() {
		return this._private.renderer.isHeadless();
	}, "headless"),
	styleEnabled: m(function() {
		return this._private.styleEnabled;
	}, "styleEnabled"),
	addToPool: m(function(e) {
		return this._private.elements.merge(e), this;
	}, "addToPool"),
	removeFromPool: m(function(e) {
		return this._private.elements.unmerge(e), this;
	}, "removeFromPool"),
	container: m(function() {
		return this._private.container || null;
	}, "container"),
	window: m(function() {
		if (this._private.container == null) return tr;
	...
	mount: m(function(e) {
		if (e != null) {
			...
			return !wn(e) && wn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(we({}, n, n.renderer, { name: n.renderer.name === "null" ? "canvas" : n.renderer.name })), t.startAnimationLoop(), t.style(n.style), t.emit("mount"), t;
		}
	}, "mount"),
	unmount: m(function() {
		var e = this;
	...
	json: m(function(e) {
		var t = this, a = t._private, n = t.mutableElements(), i = m(function(x) {
			return t.getElementById(x.id());
		}, "getFreshRef");
		if (Ie(e)) {
			if (t.startBatch(), e.elements) {
				var s = {}, o = m(function(x, C) {
					for (var T = [], E = [], S = 0; S < x.length; S++) {
						...
						var B = "" + D.data.id, P = t.getElementById(B);
						s[B] = !0, P.length !== 0 ? E.push({
							ele: P,
							json: D
				...
				n.filter(function(w) {
					...
					return w.children().move({ parent: null });
				}), d.forEach(function(w) {
					return i(w).remove();
				});
			}
			...
			for (var g = [
				...
				var m$32 = g[h];
				e[m$32] != null && t[m$32](e[m$32]);
			}
			return t.endBatch(), this;
		} else {
			var p = !!e, y = {};
			p ? y.elements = this.elements().map(function(w) {
				return w.json();
			}) : (y.elements = {}, n.forEach(function(w) {
				var x = w.group();
				y.elements[x] || (y.elements[x] = []), y.elements[x].push(w.json());
			})), this._private.styleEnabled && (y.style = t.style().json()), y.data = _r(t.data());
			var b = a.options;
...
var Pp = {
	...
	animateFilter: m(function(e, t) {
		return !0;
	}, "animateFilter"),
	ready: void 0,
	stop: void 0,
	transform: m(function(e, t) {
		return t;
	}, "transform")
}, Ap = {
	maximal: !1,
...
}, "getInfo"), Sl = m(function(e, t) {
	return e.scratch("breadthfirst", t);
}, "setInfo");
function nf(r) {
	this.options = we({}, Pp, Ap, r);
}
m(nf, "BreadthFirstLayout");
nf.prototype.run = function() {
	var r = this.options, e = r.cy, t = r.eles, a = t.nodes().filter(function(me) {
		return me.isChildless();
	}), n = t, i = r.directed, s = r.acyclic || r.maximal || r.maximalAdjustments > 0, o = !!r.boundingBox, l = xr(o ? r.boundingBox : structuredClone(e.extent())), u;
	if (Br(r.roots)) u = r.roots;
	else if (Ge(r.roots)) {
		for (var f = [], c = 0; c < r.roots.length; c++) {
			var d = r.roots[c], g = e.getElementById(d);
			f.push(g);
		}
		u = e.collection(f);
	} else if (pe(r.roots)) u = e.$(r.roots);
	else if (i) u = a.roots();
	else {
		var h = t.components();
		u = e.collection();
		for (var m$33 = m(function() {
			var se = h[p], he = se.maxDegree(!1), ge = se.filter(function(Ce) {
				return Ce.degree(!1) === he;
			});
			u = u.add(ge);
		}, "_loop"), p = 0; p < h.length; p++) m$33();
	}
	var y = [], b = {}, w = m(function(se, he) {
		y[he] ?? (y[he] = []);
		var ge = y[he].length;
		y[he].push(se), Sl(se, {
			index: ge,
	...
	}, "addToDepth"), x = m(function(se, he) {
		var ge = qt(se), Ce = ge.depth, ye = ge.index;
		y[Ce][ye] = null, se.isChildless() && w(se, he);
	}, "changeDepth");
	n.bfs({
		roots: u,
		directed: r.directed,
		visit: m(function(se, he, ge, Ce, ye) {
			var ke = se[0], Me = ke.id();
			ke.isChildless() && w(ke, ye), b[Me] = !0;
		}, "visit")
	});
	...
	}, "assignDepthsAt"), D = m(function(se, he) {
		for (var ge = qt(se), Ce = se.incomers().filter(function(Ee) {
			return Ee.isNode() && t.has(Ee);
		}), ye = -1, ke = se.id(), Me = 0; Me < Ce.length; Me++) {
			var Ne = Ce[Me], ze = qt(Ne);
			ye = Math.max(ye, ze.depth);
		}
		if (ge.depth <= ye) {
			if (!r.acyclic && he[ke]) return null;
			var Fe = ye + 1;
			return x(se, Fe), he[ke] = Fe, !0;
		}
		return !1;
	}, "adjustMaximally");
	if (i && s) {
		var B = [], P = {}, A = m(function(se) {
			return B.push(se);
		}, "enqueue"), R = m(function() {
			return B.shift();
		}, "dequeue");
	...
	if (r.avoidOverlap) for (var L = 0; L < a.length; L++) {
		var q = a[L].layoutDimensions(r), H = q.w, z = q.h;
		O = Math.max(O, H, z);
	}
	var V = {}, K = m(function(se) {
		if (V[se.id()]) return V[se.id()];
		for (var he = qt(se).depth, ge = se.neighborhood(), Ce = 0, ye = 0, ke = 0; ke < ge.length; ke++) {
			var Me = ge[ke];
		...
		return ye = Math.max(1, ye), Ce = Ce / ye, ye === 0 && (Ce = 0), V[se.id()] = Ce, Ce;
	}, "getWeightedPercent"), J = m(function(se, he) {
		var ye = K(se) - K(he);
		return ye === 0 ? iv(se.id(), he.id()) : ye;
	}, "sortFn");
	...
	for (var F = 0, _ = 0; _ < X; _++) F = Math.max(y[_].length, F);
	var W = {
		x: l.x1 + l.w / 2,
		y: l.y1 + l.h / 2
	}, Z = a.reduce(function(me, se) {
		return (function(he) {
			return {
				w: me.w === -1 ? he.w : (me.w + he.w) / 2,
				h: me.h === -1 ? he.h : (me.h + he.h) / 2
			};
		})(se.boundingBox({ includeLabels: r.nodeDimensionsIncludeLabels }));
	}, {
		w: -1,
		h: -1
	}), ae = Math.max(X === 1 ? 0 : o ? (l.h - r.padding * 2 - Z.h) / (X - 1) : (l.h - r.padding * 2 - Z.h) / (X + 1), O), de = y.reduce(function(me, se) {
		return Math.max(me, se.length);
	}, 0), Re = m(function(se) {
		var he = qt(se), ge = he.depth, Ce = he.index;
		if (r.circle) {
			var ye = Math.min(l.w / 2 / X, l.h / 2 / X);
			ye = Math.max(ye, O);
			...
			var Ne = y[ge].length, ze = Math.max(Ne === 1 ? 0 : o ? (l.w - r.padding * 2 - Z.w) / ((r.grid ? de : Ne) - 1) : (l.w - r.padding * 2 - Z.w) / ((r.grid ? de : Ne) + 1), O);
			return {
	...
	Object.keys(Te).indexOf(r.direction) === -1 && Ue("Invalid direction '".concat(r.direction, "' specified for breadthfirst layout. Valid values are: ").concat(Object.keys(Te).join(", ")));
	var xe = m(function(se) {
		return Uc(Re(se), l, Te[r.direction]);
	}, "getPosition");
...
sf.prototype.run = function() {
	...
	for (var s = xr(e.boundingBox ? e.boundingBox : {
		x1: 0,
		y1: 0,
		w: t.width(),
		h: t.height()
		...
		x: s.x1 + s.w / 2,
		y: s.y1 + s.h / 2
	}, u = (e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / i.length : e.sweep) / Math.max(1, i.length - 1), f, c = 0, d = 0; d < i.length; d++) {
		var h = i[d].layoutDimensions(e), m$34 = h.w, p = h.h;
		c = Math.max(c, m$34, p);
	}
	if (ne(e.radius) ? f = e.radius : i.length <= 1 ? f = 0 : f = Math.min(s.h, s.w) / 2 - c, i.length > 1 && e.avoidOverlap) {
		c *= 1.75;
		var y = Math.cos(u) - Math.cos(0), b = Math.sin(u) - Math.sin(0), w = Math.sqrt(c * c / (y * y + b * b));
		f = Math.max(w, f);
	}
	var x = m(function(T, E) {
		var S = e.startAngle + E * u * (n ? 1 : -1), D = f * Math.cos(S), B = f * Math.sin(S);
		return {
			x: o.x + D,
			y: o.y + B
		};
...
var Mp = {
	...
	width: void 0,
	spacingFactor: void 0,
	concentric: m(function(e) {
		return e.degree();
	}, "concentric"),
	levelWidth: m(function(e) {
...
function of(r) {
	this.options = we({}, Mp, r);
}
m(of, "ConcentricLayout");
of.prototype.run = function() {
	for (var r = this.options, e = r, t = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = r.cy, n = e.eles, i = n.nodes().not(":parent"), s = xr(e.boundingBox ? e.boundingBox : {
		x1: 0,
		y1: 0,
		w: a.width(),
		h: a.height()
	...
	for (var g = 0; g < i.length; g++) {
		var m = i[g].layoutDimensions(e);
		u = Math.max(u, m.w, m.h);
	}
	l.sort(function(ae, de) {
		return de.value - ae.value;
	});
	for (var p = e.levelWidth(i), y = [[]], b = y[0], w = 0; w < l.length; w++) {
		var x = l[w];
		if (b.length > 0) Math.abs(b[0].value - x.value) >= p && (b = [], y.push(b));
		b.push(x);
	}
	var T = u + e.minNodeSpacing;
	if (!e.avoidOverlap) {
		var E = y.length > 0 && y[0].length > 1, D = (Math.min(s.w, s.h) / 2 - T) / (y.length + E ? 1 : 0);
		T = Math.min(T, D);
	}
	for (var B = 0, P = 0; P < y.length; P++) {
		var A = y[P], M = A.dTheta = (e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / A.length : e.sweep) / Math.max(1, A.length - 1);
		if (A.length > 1 && e.avoidOverlap) {
			var I = Math.cos(M) - Math.cos(0), O = Math.sin(M) - Math.sin(0), L = Math.sqrt(T * T / (I * I + O * O));
			B = Math.max(L, B);
		}
		A.r = B, B += T;
	}
...
var ws, Lp = {
	ready: m(function() {}, "ready"),
	stop: m(function() {}, "stop"),
	animate: !0,
	animationEasing: void 0,
	...
	randomize: !1,
	componentSpacing: 40,
	nodeRepulsion: m(function(e) {
		return 2048;
	}, "nodeRepulsion"),
	nodeOverlap: 4,
	idealEdgeLength: m(function(e) {
		return 32;
	}, "idealEdgeLength"),
	edgeElasticity: m(function(e) {
		return 32;
	}, "edgeElasticity"),
	nestingFactor: 1.2,
	gravity: 1,
...
function Xn(r) {
	this.options = we({}, Lp, r), this.options.layout = this;
	var e = this.options.eles.nodes(), a = this.options.eles.edges().filter(function(n) {
...
Xn.prototype.run = function() {
	...
	var n = Zr(), i = m(function() {
		Fp(a, e, r), r.fit === !0 && e.fit(r.padding);
	}, "refresh"), s = m(function(d) {
		return !(t.stopped || d >= r.numIter || (Vp(a, r), a.temperature = a.temperature * r.coolingFactor, a.temperature < r.minTemp));
	}, "mainLoop"), o = m(function() {
		if (r.animate === !0 || r.animate === !1) i(), t.one("layoutstop", r.stop), t.emit({
			type: "layoutstop",
			layout: t
		});
		else {
			var d = r.eles.nodes(), g = lf(a, r, d);
			d.layoutPositions(t, r, g);
		}
	}, "done"), l = 0, u = !0;
	if (r.animate === !0) {
		var f = m(function() {
			for (var d = 0; u && d < r.refresh;) u = s(l), l++, d++;
			if (!u) Dl(a, r), o();
			else Zr() - n >= r.animationThreshold && i(), xn(f);
		}, "frame");
		f();
	} else {
		for (; u;) u = s(l), l++;
...
var Ip = m(function(e, t, a) {
	for (var n = a.eles.edges(), i = a.eles.nodes(), s = xr(a.boundingBox ? a.boundingBox : {
		x1: 0,
		y1: 0,
		w: e.width(),
		h: e.height()
	...
	for (var f = 0; f < o.nodeSize; f++) {
		var h = i[f], m = h.layoutDimensions(a), p = {};
		p.isLocked = h.locked(), p.id = h.data("id"), p.parentId = h.data("parent"), p.cmptId = u[h.id()], p.children = [], p.positionX = h.position("x"), p.positionY = h.position("y"), p.offsetX = 0, p.offsetY = 0, p.height = m.w, p.width = m.h, p.maxX = p.positionX + p.width / 2, p.minX = p.positionX - p.width / 2, p.maxY = p.positionY + p.height / 2, p.minY = p.positionY - p.height / 2, p.padLeft = parseFloat(h.style("padding")), p.padRight = parseFloat(h.style("padding")), p.padTop = parseFloat(h.style("padding")), p.padBottom = parseFloat(h.style("padding")), p.nodeRepulsion = Ke(a.nodeRepulsion) ? a.nodeRepulsion(h) : a.nodeRepulsion, o.layoutNodes.push(p), o.idToIndex[p.id] = f;
	}
	for (var y = [], b = 0, w = -1, x = [], f = 0; f < o.nodeSize; f++) {
		var h = o.layoutNodes[f], C = h.parentId;
		C != null ? o.layoutNodes[o.idToIndex[C]].children.push(h.id) : (y[++w] = h.id, x.push(h.id));
	}
	for (o.graphSet.push(x); b <= w;) {
		var T = y[b++], E = o.idToIndex[T], g = o.layoutNodes[E], S = g.children;
		if (S.length > 0) {
			o.graphSet.push(S);
	...
	for (var f = 0; f < o.edgeSize; f++) {
		var P = n[f], A = {};
		A.id = P.data("id"), A.sourceId = P.data("source"), A.targetId = P.data("target");
		var R = Ke(a.idealEdgeLength) ? a.idealEdgeLength(P) : a.idealEdgeLength, M = Ke(a.edgeElasticity) ? a.edgeElasticity(P) : a.edgeElasticity, I = o.idToIndex[A.sourceId], O = o.idToIndex[A.targetId];
		if (o.indexToGraph[I] != o.indexToGraph[O]) {
			for (var q = Op(A.sourceId, A.targetId, o), H = o.graphSet[q], z = 0, p = o.layoutNodes[I]; H.indexOf(p.id) === -1;) p = o.layoutNodes[o.idToIndex[p.parentId]], z++;
	...
	return o;
}, "createLayoutInfo"), Op = m(function(e, t, a) {
	var n = uf(e, t, 0, a);
	return 2 > n.count ? 0 : n.graph;
}, "findLCA"), uf = m(function(e, t, a, n) {
	var i = n.graphSet[a];
	...
	for (var s = 0, o = 0; o < i.length; o++) {
		...
		if (f.length !== 0) {
			var c = n.indexToGraph[n.idToIndex[f[0]]], d = uf(e, t, c, n);
...
}, "findLCA_aux"), Np, zp = m(function(e, t) {
...
}, "randomizePositions"), lf = m(function(e, t, a) {
...
}, "calculateNodeForces"), kl = m(function(e) {
	return -1 + 2 * e * Math.random();
}, "randomDistance"), _p = m(function(e, t, a, n) {
	if (!(e.cmptId !== t.cmptId && !a.isCompound)) {
		var o = t.positionX - e.positionX, l = t.positionY - e.positionY, u = 1;
		o === 0 && l === 0 && (o = kl(u), l = kl(u));
		var f = Gp(e, t, o, l);
		if (f > 0) var c = n.nodeOverlap * f, d = Math.sqrt(o * o + l * l), g = c * o / d, h = c * l / d;
		else var m = Bn(e, o, l), p = Bn(t, -1 * o, -1 * l), y = p.x - m.x, b = p.y - m.y, w = y * y + b * b, d = Math.sqrt(w), c = (e.nodeRepulsion + t.nodeRepulsion) / w, g = c * y / d, h = c * b / d;
		e.isLocked || (e.offsetX -= g, e.offsetY -= h), t.isLocked || (t.offsetX += g, t.offsetY += h);
	}
}, "nodeRepulsion"), Gp = m(function(e, t, a, n) {
...
}, "nodesOverlap"), Bn = m(function(e, t, a) {
...
}, "findClippingPoint"), Hp = m(function(e, t) {
	for (var a = 0; a < e.edgeSize; a++) {
		...
		if (!(u === 0 && f === 0)) {
			var c = Bn(s, u, f), d = Bn(l, -1 * u, -1 * f), g = d.x - c.x, h = d.y - c.y, m = Math.sqrt(g * g + h * h), p = Math.pow(n.idealLength - m, 2) / n.elasticity;
			if (m !== 0) var y = p * g / m, b = p * h / m;
			else var y = 0, b = 0;
			s.isLocked || (s.offsetX += y, s.offsetY += b), l.isLocked || (l.offsetX -= y, l.offsetY -= b);
		}
	}
}, "calculateEdgeForces"), Wp = m(function(e, t) {
...
}, "calculateGravityForces"), $p = m(function(e, t) {
	var a = [], n = 0, i = -1;
...
}, "propagateForces"), Up = m(function(e, t) {
	...
	for (var a = 0; a < e.nodeSize; a++) {
		...
		if (!(0 < n.children.length || n.isLocked)) {
			var i = Kp(n.offsetX, n.offsetY, e.temperature);
...
}, "updatePositions"), Kp = m(function(e, t, a) {
	...
	return i;
}, "limitForce"), vf = m(function(e, t) {
	var a = e.parentId;
	if (a != null) {
		var n = t.layoutNodes[t.idToIndex[a]], i = !1;
		if ((n.maxX == null || e.maxX + n.padRight > n.maxX) && (n.maxX = e.maxX + n.padRight, i = !0), (n.minX == null || e.minX - n.padLeft < n.minX) && (n.minX = e.minX - n.padLeft, i = !0), (n.maxY == null || e.maxY + n.padBottom > n.maxY) && (n.maxY = e.maxY + n.padBottom, i = !0), (n.minY == null || e.minY - n.padTop < n.minY) && (n.minY = e.minY - n.padTop, i = !0), i) return vf(n, t);
	}
}, "updateAncestryBoundaries"), Dl = m(function(e, t) {
	for (var a = e.layoutNodes, n = [], i = 0; i < a.length; i++) {
		var s = a[i], o = s.cmptId;
		(n[o] = n[o] || []).push(s);
	}
	for (var u = 0, i = 0; i < n.length; i++) {
		var f = n[i];
		if (f) {
			f.x1 = Infinity, f.x2 = -Infinity, f.y1 = Infinity, f.y2 = -Infinity;
	...
	for (var g = 0, h = 0, m = 0, p = 0, y = Math.sqrt(u) * e.clientWidth / e.clientHeight, i = 0; i < n.length; i++) {
		...
		if (f) {
			...
			g += f.w + t.componentSpacing, m += f.w + t.componentSpacing, p = Math.max(p, f.h), m > y && (h += p + t.componentSpacing, g = 0, m = 0, p = 0);
		}
	}
	...
	rows: void 0,
	cols: void 0,
	position: m(function(e) {}, "position"),
	sort: void 0,
	animate: !1,
	animationDuration: 500,
	animationEasing: void 0,
...
ff.prototype.run = function() {
	...
	if (i.h === 0 || i.w === 0) a.nodes().layoutPositions(this, e, function(K) {
		...
		var s = n.size(), o = Math.sqrt(s * i.h / i.w), l = Math.round(o), u = Math.round(i.w / i.h * o), f = m(function(J) {
			if (J == null) return Math.min(l, u);
			Math.min(l, u) == l ? l = J : u = J;
		}, "small"), c = m(function(J) {
			if (J == null) return Math.max(l, u);
			Math.max(l, u) == l ? l = J : u = J;
		...
		if (d != null && g != null) l = d, u = g;
			...
			var h = f(), m$35 = c();
			(h - 1) * m$35 >= s ? f(h - 1) : (m$35 - 1) * h >= s && c(m$35 - 1);
		} else for (; u * l < s;) {
			var p = f(), y = c();
			(y + 1) * p >= s ? c(y + 1) : f(p + 1);
		}
		var b = i.w / u, w = i.h / l;
		if (e.condense && (b = 0, w = 0), e.avoidOverlap) for (var x = 0; x < n.length; x++) {
			var C = n[x], T = C._private.position;
			(T.x == null || T.y == null) && (T.x = 0, T.y = 0);
			var E = C.layoutDimensions(e), S = e.avoidOverlapPadding, D = E.w + S, B = E.h + S;
			b = Math.max(b, D), w = Math.max(w, B);
		}
		for (var P = {}, A = m(function(J, X) {
			return !!P["c-" + J + "-" + X];
		}, "used"), R = m(function(J, X) {
			P["c-" + J + "-" + X] = !0;
		}, "use"), M = 0, I = 0, O = m(function() {
			I++, I >= u && (I = 0, M++);
		}, "moveToNextCell"), L = {}, N = 0; N < n.length; N++) {
			var q = n[N], H = e.position(q);
		...
		var V = m(function(J, X) {
			var ee, te;
			if (J.locked() || J.isParent()) return !1;
			var ie = L[J.id()];
			if (ie) ee = ie.col * b + b / 2 + i.x1, te = ie.row * w + w / 2 + i.y1;
			else {
				for (; A(M, I);) O();
				ee = I * b + b / 2 + i.x1, te = M * w + w / 2 + i.y1, R(M, I), O();
			}
			return {
				x: ee,
				y: te
...
function cf(r) {
	this.options = we({}, Zp, r);
}
m(cf, "PresetLayout");
cf.prototype.run = function() {
	var r = this.options, t = r.eles.nodes(), a = Ke(r.positions);
	function n(i) {
		if (r.positions == null) return md(i.position());
		if (a) return r.positions(i);
		return r.positions[i._private.data.id] ?? null;
	}
	return m(n, "getPosition"), t.layoutPositions(this, r, function(i, s) {
		var o = n(i);
...
function df(r) {
	this.options = we({}, Qp, r);
}
m(df, "RandomLayout");
df.prototype.run = function() {
	var r = this.options, e = r.cy, t = r.eles, a = xr(r.boundingBox ? r.boundingBox : {
		x1: 0,
		y1: 0,
		w: e.width(),
		h: e.height()
...
m(hf, "NullRenderer");
var Bl = m(function() {}, "noop"), Pl = m(function() {
...
po.registerArrowShapes = function() {
	var r = this.arrowShapes = {}, e = this, t = m(function(u, f, c, d, g, h, m) {
		var p = g.x - c / 2 - m, y = g.x + c / 2 + m, b = g.y - c / 2 - m, w = g.y + c / 2 + m;
		return p <= u && u <= y && b <= f && f <= w;
	}, "bbCollide"), a = m(function(u, f, c, d, g) {
		var h = u * Math.cos(d) - f * Math.sin(d), m = u * Math.sin(d) + f * Math.cos(d), p = h * c, y = m * c;
		return {
			x: p + g.x,
			y: y + g.y
		};
	}, "transform"), n = m(function(u, f, c, d) {
		for (var g = [], h = 0; h < u.length; h += 2) {
			var m = u[h], p = u[h + 1];
			g.push(a(m, p, f, c, d));
		}
		return g;
	}, "transformPoints"), i = m(function(u) {
		for (var f = [], c = 0; c < u.length; c++) {
			var d = u[c];
			f.push(d.x, d.y);
		}
		return f;
	}, "pointsToArr"), s = m(function(u) {
		return u.pstyle("width").pfValue * u.pstyle("arrow-scale").pfValue * 2;
	}, "standardGap"), o = m(function(u, f) {
		pe(f) && (f = r[f]), r[u] = we({
			name: u,
			points: [
				-.15,
			...
			collide: m(function(d, g, h, m, p, y) {
				return kr(d, g, i(n(this.points, h + 2 * y, m, p)));
			}, "collide"),
			roughCollide: t,
			draw: m(function(d, g, h, m) {
				var p = n(this.points, g, h, m);
				e.arrowShapeImpl("polygon")(d, p);
			}, "draw"),
			spacing: m(function(d) {
				return 0;
			}, "spacing"),
			gap: s
		}, f);
	...
	o("none", {
		...
		controlPoint: [0, -.15],
		roughCollide: t,
		draw: m(function(u, f, c, d, g) {
			var h = n(this.points, f, c, d), m = this.controlPoint, p = a(m[0], m[1], f, c, d);
		...
		collide: m(function(u, f, c, d, g, h, m) {
			var p = i(n(this.points, c + 2 * m, d, g)), y = i(n(this.pointsTee, c + 2 * m, d, g));
			return kr(u, f, p) || kr(u, f, y);
		}, "collide"),
		draw: m(function(u, f, c, d, g) {
		...
		crossLinePts: m(function(u, f) {
			var c = this.baseCrossLinePts.slice(), d = f / u, g = 3, h = 5;
			return c[g] = c[g] - d, c[h] = c[h] - d, c;
		}, "crossLinePts"),
		collide: m(function(u, f, c, d, g, h, m) {
			var p = i(n(this.points, c + 2 * m, d, g)), y = i(n(this.crossLinePts(c, h), c + 2 * m, d, g));
			return kr(u, f, p) || kr(u, f, y);
		}, "collide"),
		draw: m(function(u, f, c, d, g) {
		...
		collide: m(function(u, f, c, d, g, h, m) {
			var p = g;
			return Math.pow(p.x - u, 2) + Math.pow(p.y - f, 2) <= Math.pow((c + 2 * m) * this.radius, 2);
		}, "collide"),
		draw: m(function(u, f, c, d, g) {
...
It.projectIntoViewport = function(r, e) {
	var t = this.cy, a = this.findContainerClientCoords(), n = a[0], i = a[1], s = a[4], o = t.pan(), l = t.zoom();
	return [((r - n) / s - o.x) / l, ((e - i) / s - o.y) / l];
};
It.findContainerClientCoords = function() {
	if (this.containerBB) return this.containerBB;
	var r = this.container, e = r.getBoundingClientRect(), t = this.cy.window().getComputedStyle(r), a = m(function(y) {
		return parseFloat(t.getPropertyValue(y));
	}, "styleValue"), n = {
		left: a("padding-left"),
	...
	}, s = r.clientWidth, o = r.clientHeight, l = n.left + n.right, u = n.top + n.bottom, f = i.left + i.right, c = e.width / (s + f), d = s - l, g = o - u, h = e.left + n.left + i.left, m$36 = e.top + n.top + i.top;
...
It.findNearestElements = function(r, e, t, a) {
	var n = this, i = this, s = i.getCachedZSortedEles(), o = [], l = i.cy.zoom(), u = i.cy.hasCompoundNodes(), f = (a ? 24 : 8) / l, c = (a ? 8 : 2) / l, d = (a ? 8 : 2) / l, g = Infinity, h, m$37;
	t && (s = s.interactive);
	function p(E, S) {
		if (E.isNode()) {
			if (m$37) return;
	...
	m(p, "addEle");
	function y(E) {
		var S = E.outerWidth() + 2 * c, D = E.outerHeight() + 2 * c, B = S / 2, P = D / 2, A = E.position(), R = E.pstyle("corner-radius").value === "auto" ? "auto" : E.pstyle("corner-radius").pfValue, M = E._private.rscratch;
		if (A.x - B <= r && r <= A.x + B && A.y - P <= e && e <= A.y + P) {
			if (i.nodeShapes[n.getNodeShape(E)].checkPoint(r, e, 0, S, D, A.x, A.y, R, M)) return p(E, 0), !0;
		}
	}
	m(y, "checkNode");
	function b(E) {
		...
		if (D.edgeType === "segments" || D.edgeType === "straight" || D.edgeType === "haystack") {
			for (var O = D.allpts, L = 0; L + 3 < O.length; L += 2) if (Md(r, e, O[L], O[L + 1], O[L + 2], O[L + 3], M) && R > (I = zd(r, e, O[L], O[L + 1], O[L + 2], O[L + 3]))) return p(E, I), !0;
		} else if (D.edgeType === "bezier" || D.edgeType === "multibezier" || D.edgeType === "self" || D.edgeType === "compound") {
			for (var O = D.allpts, L = 0; L + 5 < D.allpts.length; L += 4) if (Ld(r, e, O[L], O[L + 1], O[L + 2], O[L + 3], O[L + 4], O[L + 5], M) && R > (I = Nd(r, e, O[L], O[L + 1], O[L + 2], O[L + 3], O[L + 4], O[L + 5]))) return p(E, I), !0;
		}
		for (var N = N || S.source, q = q || S.target, H = n.getArrowWidth(B, P), z = [
			{
				name: "source",
				x: D.arrowStartX,
				y: D.arrowStartY,
	...
	function x(E, S) {
		...
		var A = D.labelBounds[S || "main"], R = E.pstyle(P + "label").value;
		if (!(!(E.pstyle("text-events").strValue === "yes") || !R)) {
			var I = w(D.rscratch, "labelX", S), O = w(D.rscratch, "labelY", S), L = w(D.rscratch, "labelAngle", S), N = E.pstyle(P + "text-margin-x").pfValue, q = E.pstyle(P + "text-margin-y").pfValue, H = A.x1 - B - N, z = A.x2 + B - N, V = A.y1 - B - q, K = A.y2 + B - q;
			if (L) {
				var J = Math.cos(L), X = Math.sin(L), ee = m(function(Z, ae) {
					return Z = Z - I, ae = ae - O, {
						x: Z * J - ae * X + I,
						y: Z * X + ae * J + O
					};
				}, "rotate"), te = ee(H, V), ie = ee(H, K), j = ee(z, V), F = ee(z, K);
				if (kr(r, e, [
					te.x + N,
					te.y + q,
					j.x + N,
			...
			} else if (it(A, r, e)) return p(E), !0;
		}
	}
	m(x, "checkLabel");
	for (var C = s.length - 1; C >= 0; C--) {
		var T = s[C];
		T.isNode() ? y(T) || x(T) : b(T) || x(T) || x(T, "source") || x(T, "target");
	}
	return o;
};
It.getAllInBox = function(r, e, t, a) {
	var n = this.getCachedZSortedEles().interactive, s = 2 / this.cy.zoom(), o = [], l = Math.min(r, t), u = Math.max(r, t), f = Math.min(e, a), c = Math.max(e, a);
	r = l, t = u, e = f, a = c;
	var d = xr({
		x1: r,
		y1: e,
	...
	function p(Z, ae) {
		...
		if (!xe) return null;
		var me = m$38(de.rscratch, "labelX", ae), se = m$38(de.rscratch, "labelY", ae), he = m$38(de.rscratch, "labelAngle", ae), ge = Z.pstyle(Te + "text-margin-x").pfValue, Ce = Z.pstyle(Te + "text-margin-y").pfValue, ye = xe.x1 - Re - ge, ke = xe.x2 + Re - ge, Me = xe.y1 - Re - Ce, Ne = xe.y2 + Re - Ce;
		if (he) {
			var ze = Math.cos(he), Fe = Math.sin(he), Ee = m(function(Y, k) {
	...
	m(p, "getRotatedLabelBox");
	function y(Z, ae, de, Re) {
		function Te(xe, me, se) {
			return (se.y - xe.y) * (me.x - xe.x) > (me.y - xe.y) * (se.x - xe.x);
		}
		return m(Te, "ccw"), Te(Z, de, Re) !== Te(ae, de, Re) && Te(Z, ae, de) !== Te(Z, ae, Re);
	}
	m(y, "doLinesIntersect");
	for (var b = 0; b < n.length; b++) {
		...
		if (w.isNode()) {
			...
			if (T === "none") continue;
			var S = (T === "overlap" || E) && C, D = x.boundingBox({
				includeNodes: !0,
				includeEdges: !1,
				includeLabels: S
			});
			...
			if (N === "contain") {
				...
				if (L.edgeType === "bezier" || L.edgeType === "multibezier" || L.edgeType === "self" || L.edgeType === "compound" || L.edgeType === "segments" || L.edgeType === "haystack") {
					for (var q = O.rstyle.bezierPts || O.rstyle.linePts || O.rstyle.haystackPts, H = !0, z = 0; z < q.length; z++) if (!Xo(d, q[z])) {
						H = !1;
						break;
					}
					H && o.push(I);
				...
				var V = !1;
				if (L.startX != null && L.startY != null && L.endX != null && L.endY != null && (it(d, L.startX, L.startY) || it(d, L.endX, L.endY))) o.push(I), V = !0;
...
Pn.calculateArrowAngles = function(r) {
	var e = r._private.rscratch, t = e.edgeType === "haystack", a = e.edgeType === "bezier", n = e.edgeType === "multibezier", i = e.edgeType === "segments", s = e.edgeType === "compound", o = e.edgeType === "self", l, u, f, c, d, g, y, b;
	if (t ? (f = e.haystackPts[0], c = e.haystackPts[1], d = e.haystackPts[2], g = e.haystackPts[3]) : (f = e.arrowStartX, c = e.arrowStartY, d = e.arrowEndX, g = e.arrowEndY), y = e.midX, b = e.midY, i) l = f - e.segpts[0], u = c - e.segpts[1];
	else if (n || s || o || a) {
		var h = e.allpts, m = or(h[0], h[2], h[4], .1), p = or(h[1], h[3], h[5], .1);
		l = f - m, u = c - p;
	} else l = f - y, u = c - b;
	e.srcArrowAngle = Za(l, u);
	var y = e.midX, b = e.midY;
	if (t && (y = (f + d) / 2, b = (c + g) / 2), l = d - f, u = g - c, i) {
		var h = e.allpts;
		if (h.length / 2 % 2 === 0) {
		...
		if (C.length / 2 % 2 === 0) {
			...
			T = or(h[B], h[P], h[A], 0), E = or(h[B + 1], h[P + 1], h[A + 1], 0), S = or(h[B], h[P], h[A], 1e-4), D = or(h[B + 1], h[P + 1], h[A + 1], 1e-4);
		} else {
			var P = h.length / 2 - 1, B = P - 2, A = P + 2;
			T = or(h[B], h[P], h[A], .4999), E = or(h[B + 1], h[P + 1], h[A + 1], .4999), S = or(h[B], h[P], h[A], .5), D = or(h[B + 1], h[P + 1], h[A + 1], .5);
		}
		l = S - T, u = D - E;
	}
	if (e.midtgtArrowAngle = Za(l, u), e.midDispX = l, e.midDispY = u, l *= -1, u *= -1, i) {
		var h = e.allpts;
		if (h.length / 2 % 2 !== 0) {
			if (!e.isRound) {
...
m(yo, "getRoundCorner");
var La = .01, ry = Math.sqrt(2 * La), mr = {};
mr.findMidptPtsEtc = function(r, e) {
	var t = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = r.pstyle("source-endpoint"), o = r.pstyle("target-endpoint"), l = s.units != null && o.units != null, u = m(function(C, T, E, S) {
		var D = S - T, B = E - C, P = Math.sqrt(B * B + D * D);
		return {
			x: -D / P,
			y: B / P
		};
	}, "recalcVectorNormInverse");
	switch (r.pstyle("edge-distances").value) {
		case "node-position":
			i = t;
			break;
		case "intersection":
		...
		case "endpoints":
			if (l) {
				var d = je(this.manualEndptToPx(r.source()[0], s), 2), g = d[0], h = d[1], p = je(this.manualEndptToPx(r.target()[0], o), 2), y = p[0], b = p[1], w = {
					x1: g,
					y1: h,
					x2: y,
					y2: b
				...
				n = u(g, h, y, b), i = w;
			} else qe("Edge ".concat(r.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
			break;
	}
	return {
		midptPts: i,
...
mr.findHaystackPoints = function(r) {
	for (var e = 0; e < r.length; e++) {
		...
		var s = a.source, o = a.target, l = s.position(), u = o.position(), f = s.width(), c = o.width(), d = s.height(), g = o.height(), m = t.pstyle("haystack-radius").value / 2;
		n.haystackPts = n.allpts = [
			n.source.x * f * m + l.x,
			n.source.y * d * m + l.y,
			n.target.x * c * m + u.x,
			n.target.y * g * m + u.y
		], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = !0, this.storeEdgeProjections(t), this.calculateArrowAngles(t), this.recalculateEdgeLabelProjections(t), this.calculateLabelAngles(t);
	}
};
mr.findSegmentsPoints = function(r, e) {
	...
	for (var f = 0; f < o; f++) {
		var c = a.pfValue[f], d = n.pfValue[f], g = 1 - c, h = c, m = this.findMidptPtsEtc(r, e), p = m.midptPts, y = m.vectorNormInverse, b = {
			x: p.x1 * g + p.x2 * h,
			y: p.y1 * g + p.y2 * h
		};
		t.segpts.push(b.x + y.x * d, b.y + y.y * d), t.radii.push(i.pfValue[f] !== void 0 ? i.pfValue[f] : l), t.isArcRadius.push((s.pfValue[f] !== void 0 ? s.pfValue[f] : u) === "arc-radius");
	}
};
mr.findLoopPoints = function(r, e, t, a) {
	var n = r._private.rscratch, i = e.dirCounts, s = e.srcPos, o = r.pstyle("control-point-distances"), l = o ? o.pfValue[0] : void 0, u = r.pstyle("loop-direction").pfValue, f = r.pstyle("loop-sweep").pfValue, c = r.pstyle("control-point-step-size").pfValue;
	n.edgeType = "self";
	var d = t, g = c;
	a && (d = 0, g = l);
...
mr.findCompoundLoopPoints = function(r, e, t, a) {
	...
	n.edgeType = "compound";
	var i = e.srcPos, s = e.tgtPos, o = e.srcW, l = e.srcH, u = e.tgtW, f = e.tgtH, c = r.pstyle("control-point-step-size").pfValue, d = r.pstyle("control-point-distances"), g = d ? d.pfValue[0] : void 0, h = t, m = c;
	a && (h = 0, m = g);
	var p = 50, y = {
		x: i.x - o / 2,
		y: i.y - l / 2
		...
		x: Math.min(y.x, b.x),
		y: Math.min(y.y, b.y)
	}, x = .5, C = Math.max(x, Math.log(o * La)), T = Math.max(x, Math.log(u * La));
	n.ctrlpts = [
		w.x,
...
mr.findBezierPoints = function(r, e, t, a, n) {
	var i = r._private.rscratch, s = r.pstyle("control-point-step-size").pfValue, o = r.pstyle("control-point-distances"), l = r.pstyle("control-point-weights"), u = o && l ? Math.min(o.value.length, l.value.length) : 1, f = o ? o.pfValue[0] : void 0, c = l.value[0], d = a;
	i.edgeType = d ? "multibezier" : "bezier", i.ctrlpts = [];
	for (var g = 0; g < u; g++) {
		var h = (.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1), m = void 0, p = ao(h);
		d && (f = o ? o.pfValue[g] : s, c = l.value[g]), a ? m = f : m = f !== void 0 ? p * f : void 0;
		var y = m !== void 0 ? m : h, b = 1 - c, w = c, x = this.findMidptPtsEtc(r, e), C = x.midptPts, T = x.vectorNormInverse, E = {
			x: C.x1 * b + C.x2 * w,
			y: C.y1 * b + C.y2 * w
		};
...
mr.findTaxiPoints = function(r, e) {
	...
	t.edgeType = "segments";
	var a = "vertical", n = "horizontal", i = "leftward", s = "rightward", o = "downward", l = "upward", u = "auto", f = e.posPts, c = e.srcW, d = e.srcH, g = e.tgtW, h = e.tgtH, p = r.pstyle("edge-distances").value !== "node-position", y = r.pstyle("taxi-direction").value, b = y, w = r.pstyle("taxi-turn"), x = w.units === "%", C = w.pfValue, T = C < 0, E = r.pstyle("taxi-turn-min-distance").pfValue, S = p ? (c + g) / 2 : 0, D = p ? (d + h) / 2 : 0, B = f.x2 - f.x1, P = f.y2 - f.y1, A = m(function(k, G) {
		return k > 0 ? Math.max(k - G, 0) : Math.min(k + G, 0);
	}, "subDWH"), R = A(B, S), M = A(P, D), I = !1;
	b === u ? y = Math.abs(R) > Math.abs(M) ? n : a : b === l || b === o ? (y = a, I = !0) : (b === i || b === s) && (y = n, I = !0);
	var O = y === a, L = O ? M : R, N = O ? P : B, q = ao(N), H = !1;
	!(I && (x || T)) && (b === o && N < 0 || b === l && N > 0 || b === i && N > 0 || b === s && N < 0) && (q *= -1, L = q * Math.abs(L), H = !0);
	var z;
	if (x) z = (C < 0 ? 1 + C : C) * L;
	else z = (C < 0 ? L : 0) + C * q;
	var J = m(function(k) {
		return Math.abs(k) < E || Math.abs(k) >= Math.abs(L);
	}, "getIsTooClose"), X = J(z), ee = J(Math.abs(L) - Math.abs(z));
	if ((X || ee) && !H) if (O) {
		...
		} else t.segpts = [f.x2, f.y1];
	}
	else if (O) {
		var ye = f.y1 + z + (p ? d / 2 * q : 0);
		t.segpts = [
			f.x1,
			ye,
			f.x2,
...
mr.tryToCorrectInvalidPoints = function(r, e) {
	...
	if (t.edgeType === "bezier") {
		var a = e.srcPos, n = e.tgtPos, i = e.srcW, s = e.srcH, o = e.tgtW, l = e.tgtH, u = e.srcShape, f = e.tgtShape, c = e.srcCornerRadius, d = e.tgtCornerRadius, g = e.srcRs, h = e.tgtRs, m = !ne(t.startX) || !ne(t.startY), p = !ne(t.arrowStartX) || !ne(t.arrowStartY), y = !ne(t.endX) || !ne(t.endY), b = !ne(t.arrowEndX) || !ne(t.arrowEndY), C = 3 * (this.getArrowWidth(r.pstyle("width").pfValue, r.pstyle("arrow-scale").value) * this.arrowShapeWidth), T = At({
			x: t.ctrlpts[0],
			y: t.ctrlpts[1]
		}, {
			x: t.startX,
		...
		if (m || p || E) {
			...
			var P = {
				x: t.ctrlpts[0] - a.x,
				y: t.ctrlpts[1] - a.y
			}, A = Math.sqrt(P.x * P.x + P.y * P.y), R = {
				x: P.x / A,
				y: P.y / A
			}, M = Math.max(i, s), I = {
				x: t.ctrlpts[0] + R.x * 2 * M,
				y: t.ctrlpts[1] + R.y * 2 * M
			}, O = u.intersectLine(a.x, a.y, i, s, I.x, I.y, 0, c, g);
		...
		if (y || b || D) {
			...
			var L = {
				x: t.ctrlpts[0] - n.x,
				y: t.ctrlpts[1] - n.y
			}, N = Math.sqrt(L.x * L.x + L.y * L.y), q = {
				x: L.x / N,
				y: L.y / N
			}, H = Math.max(i, s), z = {
				x: t.ctrlpts[0] + q.x * 2 * H,
				y: t.ctrlpts[1] + q.y * 2 * H
			}, V = f.intersectLine(n.x, n.y, o, l, z.x, z.y, 0, d, h);
...
mr.storeAllpts = function(r) {
	...
	if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
		...
		var a, n;
		e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = .5, e.midX = or(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = or(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n));
		...
		if (e.segpts.length % 4 === 0) {
			...
			if (!e.isRound) e.midX = e.segpts[f], e.midY = e.segpts[f + 1];
				...
				if (d.radius === 0) {
					...
					e.midX = c.x, e.midY = c.y, e.midVector = [c.y - g.y, g.x - c.x];
				} else {
					var h = [c.x - d.cx, c.y - d.cy], m = d.radius / Math.sqrt(Math.pow(h[0], 2) + Math.pow(h[1], 2));
					h = h.map(function(p) {
						return p * m;
...
mr.checkForInvalidEdgeWarning = function(r) {
	...
	e.nodesOverlap || ne(e.startX) && ne(e.startY) && ne(e.endX) && ne(e.endY) ? e.loggedErr = !1 : e.loggedErr || (e.loggedErr = !0, qe("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
mr.findEdgeControlPoints = function(r) {
	var e = this;
	if (!(!r || r.length === 0)) {
		for (var t = this, n = t.cy.hasCompoundNodes(), i = new Yr(), s = m(function(D, B) {
			return [].concat(bn(D), [B ? 1 : 0]).join("-");
			...
			if (!(f.removed() || !f.takesUpSpace())) {
				...
				var g = d === "unbundled-bezier" || nt(d, "segments") || d === "straight" || d === "straight-triangle" || nt(d, "taxi"), h = d === "unbundled-bezier" || d === "bezier", m$39 = c.source, p = c.target, w = [m$39.poolIndex(), p.poolIndex()].sort(), x = s(w, g), C = i.get(x);
				C ?? (C = { eles: [] }, o.push({
					pairId: w,
					edgeIsUnbundled: g
				}), i.set(x, C)), C.eles.push(f), g && (C.hasUnbundled = !0), h && (C.hasBezier = !0);
			}
		}
		for (var T = m(function() {
			var D = o[E], B = D.pairId, P = D.edgeIsUnbundled, A = s(B, P), R = i.get(A), M;
			if (!R.hasUnbundled) {
				var I = R.eles[0].parallelEdges().filter(function(le) {
			...
			for (var W = 0; W < R.eles.length; W++) {
				var Z = R.eles[W], ae = Z[0]._private.rscratch, de = Z.pstyle("curve-style").value, Re = de === "unbundled-bezier" || nt(de, "segments") || nt(de, "taxi"), Te = !L.same(Z.source());
				if (!R.calculatedIntersection && L !== N && (R.hasBezier || R.hasUnbundled)) {
					R.calculatedIntersection = !0;
					var xe = ee.intersectLine(H.x, H.y, V, K, z.x, z.y, 0, ie, _), me = R.srcIntn = xe, se = te.intersectLine(z.x, z.y, J, X, H.x, H.y, 0, j, F), he = R.tgtIntn = se, ge = R.intersectionPts = {
						x1: xe[0],
						x2: se[0],
						y1: xe[1],
						y2: se[1]
						...
						y1: H.y,
						y2: z.y
					}, ye = se[1] - xe[1], ke = se[0] - xe[0], Me = Math.sqrt(ke * ke + ye * ye);
					ne(Me) && Me >= ry || (Me = Math.sqrt(Math.max(ke * ke, La) + Math.max(ye * ye, La)));
					var Ne = R.vector = {
						x: ke,
						y: ye
					}, ze = R.vectorNorm = {
...
mr.getSegmentPoints = function(r) {
	...
	if (e.edgeType === "segments") return mf(e.segpts);
};
...
Ha.findEndpoints = function(r) {
	var e, t, a, n, i = this, s, o = r.source()[0], l = r.target()[0], u = o.position(), f = l.position(), c = r.pstyle("target-arrow-shape").value, d = r.pstyle("source-arrow-shape").value, g = r.pstyle("target-distance-from-node").pfValue, h = r.pstyle("source-distance-from-node").pfValue, m = o._private.rscratch, p = l._private.rscratch, y = r.pstyle("curve-style").value, b = r._private.rscratch, w = b.edgeType, x = nt(y, "taxi"), C = w === "self" || w === "compound", T = w === "bezier" || w === "multibezier" || C, E = w !== "bezier", S = w === "straight" || w === "segments", D = w === "segments", B = T || E || S, P = C || x, A = r.pstyle("source-endpoint"), R = P ? "outside-to-node" : A.value, M = o.pstyle("corner-radius").value === "auto" ? "auto" : o.pstyle("corner-radius").pfValue, I = r.pstyle("target-endpoint"), O = P ? "outside-to-node" : I.value, L = l.pstyle("corner-radius").value === "auto" ? "auto" : l.pstyle("corner-radius").pfValue;
	b.srcManEndpt = A, b.tgtManEndpt = I;
	var N, q, H, z, V = (e = (I == null || (t = I.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? I.pfValue : null) !== null && e !== void 0 ? e : [0, 0], K = (a = (A == null || (n = A.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? A.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
	if (T) {
		var J = [b.ctrlpts[0], b.ctrlpts[1]];
		N = E ? [b.ctrlpts[b.ctrlpts.length - 2], b.ctrlpts[b.ctrlpts.length - 1]] : J, q = J;
	} else if (S) {
		var ee = D ? b.segpts.slice(0, 2) : [f.x + V[0], f.y + V[1]];
		N = D ? b.segpts.slice(b.segpts.length - 2) : [u.x + K[0], u.y + K[1]], q = ee;
	}
	if (O === "inside-to-node") s = [f.x, f.y];
	else if (I.units) s = this.manualEndptToPx(l, I);
	else if (O === "outside-to-line") s = b.tgtIntn;
	else if (O === "outside-to-node" || O === "outside-to-node-or-label" ? H = N : (O === "outside-to-line" || O === "outside-to-line-or-label") && (H = [u.x, u.y]), s = i.nodeShapes[this.getNodeShape(l)].intersectLine(f.x, f.y, l.outerWidth(), l.outerHeight(), H[0], H[1], 0, L, p), O === "outside-to-node-or-label" || O === "outside-to-line-or-label") {
		...
		if (Te.length > 0) {
			var xe = u, me = Tt(xe, $t(s)), se = Tt(xe, $t(Te)), he = me;
			if (se < me && (s = Te, he = se), Te.length > 2) Tt(xe, {
				x: Te[2],
				y: Te[3]
			}) < he && (s = [Te[2], Te[3]]);
		}
	}
	var Ce = Qa(s, N, i.arrowShapes[c].spacing(r) + g), ye = Qa(s, N, i.arrowShapes[c].gap(r) + g);
	if (b.endX = ye[0], b.endY = ye[1], b.arrowEndX = Ce[0], b.arrowEndY = Ce[1], R === "inside-to-node") s = [u.x, u.y];
	else if (A.units) s = this.manualEndptToPx(o, A);
	else if (R === "outside-to-line") s = b.srcIntn;
	else if (R === "outside-to-node" || R === "outside-to-node-or-label" ? z = q : (R === "outside-to-line" || R === "outside-to-line-or-label") && (z = [f.x, f.y]), s = i.nodeShapes[this.getNodeShape(o)].intersectLine(u.x, u.y, o.outerWidth(), o.outerHeight(), z[0], z[1], 0, M, m), R === "outside-to-node-or-label" || R === "outside-to-line-or-label") {
		...
		if (G.length > 0) {
			var $ = f, U = Tt($, $t(s)), Q = Tt($, $t(G)), ue = U;
			if (Q < U && (s = [G[0], G[1]], ue = Q), G.length > 2) Tt($, {
				x: G[2],
				y: G[3]
			}) < ue && (s = [G[2], G[3]]);
		}
	}
	var fe = Qa(s, q, i.arrowShapes[d].spacing(r) + h), ve = Qa(s, q, i.arrowShapes[d].gap(r) + h);
	b.startX = ve[0], b.startY = ve[1], b.arrowStartX = fe[0], b.arrowStartY = fe[1], B && (!ne(b.startX) || !ne(b.startY) || !ne(b.endX) || !ne(b.endY) ? b.badLine = !0 : b.badLine = !1);
};
...
var mo = {};
function ty(r, e, t) {
	for (var a = m(function(u, f, c, d) {
		return or(u, f, c, d);
	}, "qbezierAt$1"), i = e._private.rstyle.bezierPts, s = 0; s < r.bezierProjPcts.length; s++) {
...
mo.storeEdgeProjections = function(r) {
	...
	if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
		e.rstyle.bezierPts = [];
		for (var n = 0; n + 5 < t.allpts.length; n += 4) ty(this, r, t.allpts.slice(n, n + 6));
...
Hr.recalculateNodeLabelProjection = function(r) {
	...
	if (!lt(e)) {
		var t, a, n = r._private, i = r.width(), s = r.height(), o = r.padding(), l = r.position(), u = r.pstyle("text-halign").strValue, f = r.pstyle("text-valign").strValue, c = n.rscratch, d = n.rstyle;
		switch (u) {
			case "left":
				t = l.x - i / 2 - o;
				break;
...
var bf = m(function(e, t) {
	var a = Math.atan(t / e);
	return e === 0 && a < 0 && (a = a * -1), a;
}, "lineAngleFromDelta"), wf = m(function(e, t) {
	return bf(t.x - e.x, t.y - e.y);
}, "lineAngle"), ay = m(function(e, t, a, n) {
	var i = Da(0, n - .001, 1), s = Da(0, n + .001, 1);
	return wf(Xt(e, t, a, i), Xt(e, t, a, s));
}, "bezierAngle");
Hr.recalculateEdgeLabelProjections = function(r) {
	...
	if (i.mid || i.source || i.target) {
		...
		var l = m(function() {
			...
			function b(E, S, D, B, P) {
				var A = At(S, D), R = E.segments[E.segments.length - 1], M = {
					p0: S,
					p1: D,
					t0: B,
					t1: P,
			...
			for (var w = 0; w < c.length; w++) {
				var x = c[w], C = c[w - 1];
				C && (x.startDist = C.startDist + C.length), b(x, x.p0, p[w * y], 0, n.bezierProjPcts[0]);
				for (var T = 0; T < y - 1; T++) b(x, p[w * y + T], p[w * y + T + 1], n.bezierProjPcts[T], n.bezierProjPcts[T + 1]);
				b(x, p[w * y + y - 1], x.p2, n.bezierProjPcts[y - 1], 1);
			}
			return l.cache = c;
		}, "createControlPointInfo"), u = m(function(c) {
			var d, g = c === "source";
			if (i[c]) {
				...
				switch (a.edgeType) {
					...
					case "bezier":
					case "multibezier":
						for (var m = l(), p, y = 0, b = 0, w = 0; w < m.length; w++) {
						...
						A = Da(0, A, 1), e = Xt(S.p0, S.p1, S.p2, A), d = ay(S.p0, S.p1, S.p2, A);
						break;
					case "straight":
					case "segments":
					case "haystack":
						for (var R = 0, M, I, O, L, N = a.allpts.length, q = 0; q + 3 < N && (g ? (O = {
							...
							x: a.allpts[N - 4 - q],
							y: a.allpts[N - 3 - q]
						}), M = At(O, L), I = R, R += M, !(R >= h)); q += 2);
						var z = (h - I) / M;
						z = Da(0, z, 1), e = Sd(O, L, z), d = wf(O, L);
						break;
				}
...
Hr.applyPrefixedLabelDimensions = function(r, e) {
	var t = r._private, a = this.getLabelText(r, e), n = Pt(a, r._private.labelDimsKey);
	if (Sr(t.rscratch, "prefixedLabelDimsKey", e) !== n) {
		Xr(t.rscratch, "prefixedLabelDimsKey", e, n);
		var i = this.calculateLabelDimensions(r, a), s = r.pstyle("line-height").pfValue, o = r.pstyle("text-wrap").strValue, l = Sr(t.rscratch, "labelWrapCachedLines", e) || [], u = o !== "wrap" ? 1 : Math.max(l.length, 1), f = i.height / u, c = f * s, d = i.width, g = i.height + (u - 1) * (s - 1) * f;
...
Hr.getLabelText = function(r, e) {
	var t = r._private, a = e ? e + "-" : "", n = r.pstyle(a + "label").strValue, i = r.pstyle("text-transform").value, s = m(function(K, J) {
	...
	if (o === "wrap") {
		...
		for (var u = "​", f = n.split(`
`), c = r.pstyle("text-max-width").pfValue, g = r.pstyle("text-overflow-wrap").value === "anywhere", h = [], m$41 = /[\s\u200b]+|$/g, p = 0; p < f.length; p++) {
			var y = f[p], w = this.calculateLabelDimensions(r, y).width;
			if (g) y = y.split("").join(u);
			if (w > c) {
				var C = y.matchAll(m$41), T = "", E = 0, S = Dr(C), D;
				try {
					for (S.s(); !(D = S.n()).done;) {
						var B = D.value, P = B[0], A = y.substring(E, B.index);
						E = B.index + P.length;
						var R = T.length === 0 ? A : T + A + P;
						this.calculateLabelDimensions(r, R).width <= c ? T += A + P : (T && h.push(T), T = A + P);
					}
				} catch (V) {
					S.e(V);
				} finally {
...
`)), s("labelWrapKey", l);
		...
		var O = r.pstyle("text-max-width").pfValue, L = "", N = "…", q = !1;
		if (this.calculateLabelDimensions(r, n).width < O) return n;
		for (var H = 0; H < n.length; H++) {
			if (this.calculateLabelDimensions(r, L + n[H] + N).width > O) break;
			L += n[H], H === n.length - 1 && (q = !0);
		}
		return q || (L += N), L;
	}
	return n;
...
Hr.calculateLabelDimensions = function(r, e) {
	var n = this.cy.window().document, i = 0, s = r.pstyle("font-style").strValue, o = r.pstyle("font-size").pfValue, l = r.pstyle("font-family").strValue, u = r.pstyle("font-weight").strValue, f = this.labelCalcCanvas, c = this.labelCalcCanvasContext;
	if (!f) {
	...
	c.font = "".concat(s, " ").concat(u, " ").concat(o, "px ").concat(l);
	for (var g = 0, h = 0, m = e.split(`
`), p = 0; p < m.length; p++) {
		var y = m[p], b = c.measureText(y), w = Math.ceil(b.width), x = o;
		g = Math.max(w, g), h += x;
	}
	return g += i, h += i, {
		width: g,
...
Hr.calculateLabelAngle = function(r, e) {
	var a = r._private.rscratch, n = r.isEdge(), i = e ? e + "-" : "", s = r.pstyle(i + "text-rotation"), o = s.strValue;
	return o === "none" ? 0 : n && o === "autorotate" ? a.labelAutoAngle : o === "autorotate" ? 0 : s.pfValue;
};
Hr.calculateLabelAngles = function(r) {
	var e = this, t = r.isEdge(), n = r._private.rscratch;
...
xf.getNodeShape = function(r) {
	...
	if (t === "cutrectangle" && (r.width() < Il || r.height() < Il)) return Ol || (qe("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Ol = !0), "rectangle";
...
Yn.registerCalculationListeners = function() {
	var r = this.cy, e = r.collection(), t = this, a = m(function(s) {
		var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
		if (e.merge(s), o) for (var l = 0; l < s.length; l++) {
			var c = s[l]._private.rstyle;
			c.clean = !1, c.cleanConnected = !1;
		}
	}, "enqueue");
	t.binder(r).on("bounds.* dirty.*", m(function(s) {
		var o = s.target;
		a(o);
	}, "onDirtyBounds")).on("style.* background.*", m(function(s) {
		var o = s.target;
		a(o, !1);
	}, "onDirtyStyle"));
	var n = m(function(s) {
...
Yn.onUpdateEleCalcs = function(r) {
	(this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || []).push(r);
};
	...
	if (r.length !== 0) {
		...
		if (!this.destroyed) {
			...
			for (var i = 0; i < r.length; i++) {
				...
				s.isEdge() && (!t(s.source()) || !t(s.target())) && (l.clean = !1), s.isEdge() && s.isBundledBezier() && s.parallelEdges().some(function(w) {
			...
			for (var u = 0; u < n.length; u++) {
				var f = n[u], d = f._private.rstyle, g = f.position();
			...
			for (var h = 0; h < a.length; h++) {
				var p = a[h]._private, y = p.rstyle, b = p.rscratch;
...
Cf.getCachedImage = function(r, e, t) {
	...
	var o = "data:";
	return r.substring(0, o.length).toLowerCase() === o || (e = e === "null" ? null : e, s.crossOrigin = e), s.src = r, s;
};
var sa = {};
...
sa.binder = function(r) {
	...
	if (e.supportsPassiveEvents == null) {
		var n = !1;
		try {
			var i = Object.defineProperty({}, "passive", { get: m(function() {
				return n = !0, !0;
			}, "get") });
...
sa.load = function() {
	var r = this, e = r.cy.window(), t = m(function(k) {
		return k.selected();
	}, "isSelected"), a = m(function(k) {
		var G = k.getRootNode();
		if (G && G.nodeType === 11 && G.host !== void 0) return G;
	}, "getShadowRoot"), n = m(function(k, G, $, U) {
		k ??= r.cy;
	...
	}, "triggerEvents"), i = m(function(k) {
		return k.shiftKey || k.metaKey || k.ctrlKey;
	}, "isMultSelKeyDown"), s = m(function(k, G) {
		var $ = !0;
		...
		return $;
	}, "allowPanningPassthrough"), o = m(function(k) {
		k[0]._private.grabbed = !0;
	}, "setGrabbed"), l = m(function(k) {
		k[0]._private.grabbed = !1;
	}, "setFreed"), u = m(function(k) {
		k[0]._private.rscratch.inDragLayer = !0;
	}, "setInDragLayer"), f = m(function(k) {
		k[0]._private.rscratch.inDragLayer = !1;
	}, "setOutDragLayer"), c = m(function(k) {
		k[0]._private.rscratch.isGrabTarget = !0;
	}, "setGrabTarget"), d = m(function(k) {
		k[0]._private.rscratch.isGrabTarget = !1;
	}, "removeGrabTarget"), g = m(function(k, G) {
		var $ = G.addToList;
		!$.has(k) && k.grabbable() && !k.locked() && ($.merge(k), o(k));
	}, "addToDragList"), h = m(function(k, G) {
	...
	}, "addDescendantsToDrag"), m$42 = m(function(k, G) {
		G = G || {};
		var $ = k.cy().hasCompoundNodes();
		G.inDragLayer && (k.forEach(u), k.neighborhood().stdFilter(function(U) {
			return !$ || U.isEdge();
		}).forEach(u)), G.addToList && k.forEach(function(U) {
			g(U, G);
		}), h(k, G), b(k, { inDragLayer: G.inDragLayer }), r.updateCachedGrabbedEles();
	}, "addNodesToDrag"), p = m$42, y = m(function(k) {
		k && (r.getCachedZSortedEles().forEach(function(G) {
			l(G), f(G), d(G);
		}), r.updateCachedGrabbedEles());
	}, "freeDraggedElements"), b = m(function(k, G) {
		if (!(G.inDragLayer == null && G.addToList == null) && k.cy().hasCompoundNodes()) {
			var $ = k.ancestors().orphans();
			if (!$.same(k)) {
				var U = $.descendants().spawnSelf().merge($).unmerge(k).unmerge(k.descendants()), Q = U.connectedEdges();
				G.inDragLayer && (Q.forEach(u), U.forEach(u)), G.addToList && U.forEach(function(ue) {
					g(ue, G);
				});
			}
		}
	}, "updateAncestorsInDragLayer"), w = m(function() {
	...
	x ? (r.removeObserver = new MutationObserver(function(Y) {
		for (var k = 0; k < Y.length; k++) {
			var $ = Y[k].removedNodes;
			if ($) {
				for (var U = 0; U < $.length; U++) if ($[U] === r.container) {
					r.destroy();
					break;
				}
			}
		}
	}), r.container.parentNode && r.removeObserver.observe(r.container.parentNode, { childList: !0 })) : r.registerBinding(r.container, "DOMNodeRemoved", function(Y) {
		r.destroy();
	});
	var T = Va(function() {
		r.cy.resize();
	}, 100);
	x && (r.styleObserver = new MutationObserver(T), r.styleObserver.observe(r.container, { attributes: !0 })), r.registerBinding(e, "resize", T), C && (r.resizeObserver = new ResizeObserver(T), r.resizeObserver.observe(r.container));
	var E = m(function(k, G) {
		for (; k != null;) G(k), k = k.parentNode;
	}, "forEachUp"), S = m(function() {
	...
	var D = m(function() {
	...
	}, "inBoxSelection"), B = m(function(k) {
		for (var G = r.findContainerClientCoords(), $ = G[0], U = G[1], Q = G[2], ue = G[3], re = k.touches ? k.touches : [k], fe = !1, ve = 0; ve < re.length; ve++) {
			var be = re[ve];
		...
		if (!fe) return !1;
		for (var Be = r.container, ce = k.target.parentNode, Ae = !1; ce;) {
			if (ce === Be) {
				Ae = !0;
				break;
			}
	...
	r.registerBinding(r.container, "mousedown", m(function(k) {
		if (B(k) && !(r.hoverData.which === 1 && k.which !== 1)) {
			k.preventDefault(), w(), r.hoverData.capture = !0, r.hoverData.which = k.which;
			var G = r.cy, $ = [k.clientX, k.clientY], U = r.projectIntoViewport($[0], $[1]), Q = r.selection, ue = r.findNearestElements(U[0], U[1], !0, !1), re = ue[0], fe = r.dragData.possibleDragElements;
			r.hoverData.mdownPos = U, r.hoverData.mdownGPos = $;
			var ve = m(function(Pe) {
				return {
					originalEvent: k,
					type: Pe,
					position: {
				...
				r.hoverData.tapholdCancelled = !1, clearTimeout(r.hoverData.tapholdTimeout), r.hoverData.tapholdTimeout = setTimeout(function() {
					if (!r.hoverData.tapholdCancelled) {
						...
						Pe ? Pe.emit(ve("taphold")) : G.emit(ve("taphold"));
					}
				}, r.tapholdDuration);
			}, "checkForTaphold");
			if (k.which == 3) {
				...
				re ? (re.activate(), re.emit(Be), r.hoverData.down = re) : G.emit(Be), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = !1;
			} else if (k.which == 1) {
				re && re.activate();
				if (re != null && r.nodeIsGrabbable(re)) {
					var Se = m(function(Pe) {
						Pe.emit(ve("grab"));
					}, "triggerGrab");
					if (c(re), !re.selected()) fe = r.dragData.possibleDragElements = G.collection(), p(re, { addToList: fe }), re.emit(ve("grabon")).emit(ve("grab"));
					else {
						fe = r.dragData.possibleDragElements = G.collection();
						var ce = G.$(function(Ae) {
							return Ae.isNode() && Ae.selected() && r.nodeIsGrabbable(Ae);
						});
						m$42(ce, { addToList: fe }), re.emit(ve("grabon")), ce.forEach(Se);
					}
				...
				n(re, [
					...
					x: U[0],
					y: U[1]
				}, r.redrawHint("select", !0), r.redraw()) : re.pannable() && (Q[4] = 1), be();
			}
			Q[0] = Q[2] = U[0], Q[1] = Q[3] = U[1];
		}
	}, "mousedownHandler"), !1);
	var P = a(r.container);
	r.registerBinding([e, P], "mousemove", m(function(k) {
		if (!(!r.hoverData.capture && !B(k))) {
			var $ = !1, U = r.cy, Q = U.zoom(), ue = [k.clientX, k.clientY], re = r.projectIntoViewport(ue[0], ue[1]), fe = r.hoverData.mdownPos, ve = r.hoverData.mdownGPos, be = r.selection, Be = null;
			!r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (Be = r.findNearestElement(re[0], re[1], !0, !1));
			var Se = r.hoverData.last, ce = r.hoverData.down, Ae = [re[0] - be[2], re[1] - be[3]], Pe = r.dragData.possibleDragElements, er;
			if (ve) {
				var Xe = ue[0] - ve[0], br = Xe * Xe, Ze = ue[1] - ve[1], rr = br + Ze * Ze;
				r.hoverData.isOverThresholdDrag = er = rr >= r.desktopTapThreshold2;
			}
			var vr = i(k);
			er && (r.hoverData.tapholdCancelled = !0);
			var et = m(function() {
			...
			}, "makeEvent"), $r = m(function() {
				r.data.bgActivePosistion = void 0, r.hoverData.selecting || U.emit(Qe("boxstart")), be[4] = 1, r.hoverData.selecting = !0, r.redrawHint("select", !0), r.redraw();
			}, "goIntoBoxMode");
			if (r.hoverData.which === 3) {
				if (er) {
					var Ur = Qe("cxtdrag");
					ce ? ce.emit(Ur) : U.emit(Ur), r.hoverData.cxtDragged = !0, (!r.hoverData.cxtOver || Be !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(Qe("cxtdragout")), r.hoverData.cxtOver = Be, Be && Be.emit(Qe("cxtdragover")));
				}
			} else if (r.hoverData.dragging) {
				if ($ = !0, U.panningEnabled() && U.userPanningEnabled()) {
					var Nt;
					...
					U.panBy(Nt), U.emit(Qe("dragpan")), r.hoverData.dragged = !0;
				}
				re = r.projectIntoViewport(k.clientX, k.clientY);
				...
				if (er) {
					...
					else if (!r.hoverData.selecting && U.panningEnabled() && U.userPanningEnabled()) s(ce, r.hoverData.downs) && (r.hoverData.dragging = !0, r.hoverData.justStartedPan = !0, be[4] = 0, r.data.bgActivePosistion = $t(fe), r.redrawHint("select", !0), r.redraw());
					ce && ce.pannable() && ce.active() && ce.unactivate();
				}
			} else {
				if (ce && ce.pannable() && ce.active() && ce.unactivate(), (!ce || !ce.grabbed()) && Be != Se && (Se && n(Se, ["mouseout", "tapdragout"], k, {
					x: re[0],
					y: re[1]
				}), Be && n(Be, ["mouseover", "tapdragover"], k, {
					x: re[0],
					y: re[1]
				}), r.hoverData.last = Be), ce) if (er) {
					if (U.boxSelectionEnabled() && vr) ce && ce.grabbed() && (y(Pe), ce.emit(Qe("freeon")), Pe.emit(Qe("free")), r.dragData.didDrag && (ce.emit(Qe("dragfreeon")), Pe.emit(Qe("dragfree")))), $r();
					else if (ce && ce.grabbed() && r.nodeIsDraggable(ce)) {
						var Cr = !r.dragData.didDrag;
						Cr && r.redrawHint("eles", !0), r.dragData.didDrag = !0, r.hoverData.draggingEles || m$42(Pe, { inDragLayer: !0 });
						var gr = {
							x: 0,
							y: 0
						};
						...
						r.hoverData.draggingEles = !0, Pe.silentShift(gr).emit(Qe("position")).emit(Qe("drag")), r.redrawHint("drag", !0), r.redraw();
					}
				} else et();
				$ = !0;
			}
			if (be[2] = re[0], be[3] = re[1], $) return k.stopPropagation && k.stopPropagation(), k.preventDefault && k.preventDefault(), !1;
		}
	}, "mousemoveHandler"), !1);
	var A, R, M;
	r.registerBinding(e, "mouseup", m(function(k) {
		if (!(r.hoverData.which === 1 && k.which !== 1 && r.hoverData.capture)) {
			if (r.hoverData.capture) {
				r.hoverData.capture = !1;
				var $ = r.cy, U = r.projectIntoViewport(k.clientX, k.clientY), Q = r.selection, ue = r.findNearestElement(U[0], U[1], !0, !1), re = r.dragData.possibleDragElements, fe = r.hoverData.down, ve = i(k);
				...
				if (r.hoverData.which === 3) {
					...
					if (n(ue, [
						...
						x: U[0],
						y: U[1]
					}), R = !1, k.timeStamp - M <= $.multiClickDebounceTime() ? (A && clearTimeout(A), R = !0, M = null, n(fe, [
						"dblclick",
						"dbltap",
						"vdblclick"
					], k, {
					...
					}, $.multiClickDebounceTime()), M = k.timeStamp)), fe == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(k) && ($.$(t).unselect(["tapunselect"]), re.length > 0 && r.redrawHint("eles", !0), r.dragData.possibleDragElements = re = $.collection()), ue == fe && !r.dragData.didDrag && !r.hoverData.selecting && ue != null && ue._private.selectable && (r.hoverData.dragging || ($.selectionType() === "additive" || ve ? ue.selected() ? ue.unselect(["tapunselect"]) : ue.select(["tapselect"]) : ve || ($.$(t).unmerge(ue).unselect(["tapunselect"]), ue.select(["tapselect"]))), r.redrawHint("eles", !0)), r.hoverData.selecting) {
						var ce = $.collection(r.getAllInBox(Q[0], Q[1], Q[2], Q[3]));
						r.redrawHint("select", !0), ce.length > 0 && r.redrawHint("eles", !0), $.emit(be("boxend"));
						var Ae = m(function(Xe) {
							return Xe.selectable() && !Xe.selected();
						}, "eleWouldBeSelected");
						$.selectionType() === "additive" || ve || $.$(t).unmerge(ce).unselect(), ce.emit(be("box")).stdFilter(Ae).select().emit(be("boxselect")), r.redraw();
					}
					if (r.hoverData.dragging && (r.hoverData.dragging = !1, r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()), !Q[4]) {
						...
						y(re), Pe && (fe.emit(be("freeon")), re.emit(be("free")), r.dragData.didDrag && (fe.emit(be("dragfreeon")), re.emit(be("dragfree"))));
					}
				}
	...
	var I = [], O = 4, L, N = 1e5, q = m(function(k, G) {
		for (var $ = 0; $ < k.length; $++) if (k[$] % G !== 0) return !1;
		return !0;
	}, "allAreDivisibleBy"), H = m(function(k) {
		for (var G = Math.abs(k[0]), $ = 1; $ < k.length; $++) if (Math.abs(k[$]) !== G) return !1;
		return !0;
	}, "allAreSameMagnitude"), z = m(function(k) {
		var G = !1, $ = k.deltaY;
		if ($ ?? (k.wheelDeltaY != null ? $ = k.wheelDeltaY / 4 : k.wheelDelta != null && ($ = k.wheelDelta / 4)), $ !== 0) {
			if (L == null) if (I.length >= O) {
				...
				if (L) for (var ue = 0; ue < U.length; ue++) N = Math.min(Math.abs(U[ue]), N);
			} else I.push($), G = !0;
			else L && (N = Math.min(Math.abs($), N));
			if (!r.scrollingPage) {
				var re = r.cy, fe = re.zoom(), ve = re.pan(), be = r.projectIntoViewport(k.clientX, k.clientY), Be = [be[0] * fe + ve.x, be[1] * fe + ve.y];
	...
	r.registerBinding(r.container, "wheel", z, !0), r.registerBinding(e, "scroll", m(function(k) {
		r.scrollingPage = !0, clearTimeout(r.scrollingPageTimeout), r.scrollingPageTimeout = setTimeout(function() {
			r.scrollingPage = !1;
		}, 250);
	}, "scrollHandler"), !0), r.registerBinding(r.container, "gesturestart", m(function(k) {
		r.gestureStartZoom = r.cy.zoom(), r.hasTouchStarted || k.preventDefault();
	}, "gestureStartHandler"), !0), r.registerBinding(r.container, "gesturechange", function(Y) {
		r.hasTouchStarted || z(Y);
	}, !0), r.registerBinding(r.container, "mouseout", m(function(k) {
		var G = r.projectIntoViewport(k.clientX, k.clientY);
		r.cy.emit({
			originalEvent: k,
			type: "mouseout",
			position: {
	...
	}, "mouseOutHandler"), !1), r.registerBinding(r.container, "mouseover", m(function(k) {
		var G = r.projectIntoViewport(k.clientX, k.clientY);
		r.cy.emit({
			originalEvent: k,
			type: "mouseover",
	...
	var V, K, J, X, ee, te, ie, j, F, _, W, Z, ae, de = m(function(k, G, $, U) {
		return Math.sqrt(($ - k) * ($ - k) + (U - G) * (U - G));
	}, "distance"), Re = m(function(k, G, $, U) {
		return ($ - k) * ($ - k) + (U - G) * (U - G);
	}, "distanceSq"), Te;
	r.registerBinding(r.container, "touchstart", Te = m(function(k) {
		if (r.hasTouchStarted = !0, !!B(k)) {
			w(), r.touchData.capture = !0, r.data.bgActivePosistion = void 0;
			var G = r.cy, $ = r.touchData.now, U = r.touchData.earlier;
			if (k.touches[0]) {
				var Q = r.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
				$[0] = Q[0], $[1] = Q[1];
			}
			if (k.touches[1]) {
				var Q = r.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
				$[2] = Q[0], $[3] = Q[1];
			}
			if (k.touches[2]) {
				var Q = r.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
				$[4] = Q[0], $[5] = Q[1];
			}
			var ue = m(function(vr) {
				return {
					originalEvent: k,
					type: vr,
					position: {
			...
			if (k.touches[1]) {
				...
				var fe = G.pan(), ve = G.zoom();
				ee = de(V, K, J, X), te = Re(V, K, J, X), ie = [(V + J) / 2, (K + X) / 2], j = [(ie[0] - fe.x) / ve, (ie[1] - fe.y) / ve];
				var be = 200, Be = be * be;
				if (te < Be && !k.touches[2]) {
					var Se = r.findNearestElement($[0], $[1], !0, !0), ce = r.findNearestElement($[2], $[3], !0, !0);
					Se && Se.isNode() ? (Se.activate().emit(ue("cxttapstart")), r.touchData.start = Se) : ce && ce.isNode() ? (ce.activate().emit(ue("cxttapstart")), r.touchData.start = ce) : G.emit(ue("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !0, r.touchData.cxtDragged = !1, r.data.bgActivePosistion = void 0, r.redraw();
					return;
				}
			}
			if (k.touches[2]) G.boxSelectionEnabled() && k.preventDefault();
				...
				if (k.touches[0]) {
					var Ae = r.findNearestElements($[0], $[1], !0, !0), Pe = Ae[0];
					if (Pe != null && (Pe.activate(), r.touchData.start = Pe, r.touchData.starts = Ae, r.nodeIsGrabbable(Pe))) {
						var er = r.dragData.touchDragEles = G.collection(), Xe = null;
						r.redrawHint("eles", !0), r.redrawHint("drag", !0), Pe.selected() ? (Xe = G.$(function(rr) {
							return rr.selected() && r.nodeIsGrabbable(rr);
						}), m$42(Xe, { addToList: er })) : p(Pe, { addToList: er }), c(Pe), Pe.emit(ue("grabon")), Xe ? Xe.forEach(function(rr) {
							rr.emit(ue("grab"));
						}) : Pe.emit(ue("grab"));
					}
					n(Pe, [
			...
			if (k.touches.length >= 1) {
				...
				var sr = k.touches[0];
				r.touchData.startGPosition = [sr.clientX, sr.clientY];
			}
		}
	}, "touchstartHandler"), !1);
	var xe;
	r.registerBinding(e, "touchmove", xe = m(function(k) {
		var G = r.touchData.capture;
		if (!(!G && !B(k))) {
			var $ = r.selection, U = r.cy, Q = r.touchData.now, ue = r.touchData.earlier, re = U.zoom();
			if (k.touches[0]) {
			...
			if (G && k.touches[0] && be) {
				...
				var Ae = k.touches[0].clientX - be[0], Pe = Ae * Ae, er = k.touches[0].clientY - be[1];
				Be = Pe + er * er >= r.touchTapThreshold2;
			}
			if (G && r.touchData.cxt) {
				k.preventDefault();
				var Ze = k.touches[0].clientX - F, sr = k.touches[0].clientY - _, rr = k.touches[1].clientX - F, vr = k.touches[1].clientY - _, et = Re(Ze, sr, rr, vr), Qe = et / te, $r = 150, Ur = $r * $r, Nt = 1.5;
				if (Qe >= Nt * Nt || et >= Ur) {
			...
			if (G && r.touchData.cxt) {
				var wt = ve("cxtdrag");
				r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.touchData.start ? r.touchData.start.emit(wt) : U.emit(wt), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxtDragged = !0;
				var Cr = r.findNearestElement(Q[0], Q[1], !0, !0);
				(!r.touchData.cxtOver || Cr !== r.touchData.cxtOver) && (r.touchData.cxtOver && r.touchData.cxtOver.emit(ve("cxtdragout")), r.touchData.cxtOver = Cr, Cr && Cr.emit(ve("cxtdragover")));
			} else if (G && k.touches[2] && U.boxSelectionEnabled()) k.preventDefault(), r.data.bgActivePosistion = void 0, this.lastThreeTouch = +/* @__PURE__ */ new Date(), r.touchData.selecting || U.emit(ve("boxstart")), r.touchData.selecting = !0, r.touchData.didSelect = !0, $[4] = 1, !$ || $.length === 0 || $[0] === void 0 ? ($[0] = (Q[0] + Q[2] + Q[4]) / 3, $[1] = (Q[1] + Q[3] + Q[5]) / 3, $[2] = (Q[0] + Q[2] + Q[4]) / 3 + 1, $[3] = (Q[1] + Q[3] + Q[5]) / 3 + 1) : ($[2] = (Q[0] + Q[2] + Q[4]) / 3, $[3] = (Q[1] + Q[3] + Q[5]) / 3), r.redrawHint("select", !0), r.redraw();
				...
				if (gr) {
					...
					for (var Tr = 0; Tr < gr.length; Tr++) {
						...
						ua.grabbed = !1, ua.rscratch.inDragLayer = !1;
					}
				}
				var Pr = r.touchData.start, Ze = k.touches[0].clientX - F, sr = k.touches[0].clientY - _, rr = k.touches[1].clientX - F, vr = k.touches[1].clientY - _, xo = de(Ze, sr, rr, vr), $f = xo / ee;
				if (ae) {
					var Uf = Ze - V, Kf = sr - K, Xf = rr - J, Yf = vr - X, Zf = (Uf + Xf) / 2, Qf = (Kf + Yf) / 2, la = U.zoom(), Qn = la * $f, Ka = U.pan(), Eo = j[0] * la + Ka.x, Co = j[1] * la + Ka.y, Jf = {
						x: -Qn / la * (Eo - Ka.x - Zf) + Eo,
						y: -Qn / la * (Co - Ka.y - Qf) + Co
					};
					if (Pr && Pr.active()) {
						var gr = r.dragData.touchDragEles;
						y(gr), r.redrawHint("drag", !0), r.redrawHint("eles", !0), Pr.unactivate().emit(ve("freeon")), gr.emit(ve("free")), r.dragData.didDrag && (Pr.emit(ve("dragfreeon")), gr.emit(ve("dragfree")));
					}
					U.viewport({
						zoom: Qn,
						pan: Jf,
						cancelOnFailedZoom: !0
					}), U.emit(ve("pinchzoom")), ee = xo, V = Ze, K = sr, J = rr, X = vr, r.pinching = !0;
				}
				if (k.touches[0]) {
					var fe = r.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
					Q[0] = fe[0], Q[1] = fe[1];
				...
				if (!r.hoverData.draggingEles && !r.swipePanning && (Cr = r.findNearestElement(Q[0], Q[1], !0, !0)), G && Lr != null && k.preventDefault(), G && Lr != null && r.nodeIsDraggable(Lr)) if (Be) {
					var gr = r.dragData.touchDragEles, To = !r.dragData.didDrag;
					To && m$42(gr, { inDragLayer: !0 }), r.dragData.didDrag = !0;
					var va = {
						x: 0,
						y: 0
					};
					...
					r.hoverData.draggingEles = !0, gr.silentShift(va).emit(ve("position")).emit(ve("drag")), r.redrawHint("drag", !0), r.touchData.startPosition[0] == ue[0] && r.touchData.startPosition[1] == ue[1] && r.redrawHint("eles", !0), r.redraw();
				} else {
				...
				if (n(Lr || Cr, [
					...
					x: Q[0],
					y: Q[1]
				}), (!Lr || !Lr.grabbed()) && Cr != Jn && (Jn && Jn.emit(ve("tapdragout")), Cr && Cr.emit(ve("tapdragover"))), r.touchData.last = Cr, G) for (var Tr = 0; Tr < Q.length; Tr++) Q[Tr] && r.touchData.startPosition[Tr] && Be && (r.touchData.singleTouchMoved = !0);
				if (G && (Lr == null || Lr.pannable()) && U.panningEnabled() && U.userPanningEnabled()) {
					s(Lr, r.touchData.starts) && (k.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = $t(r.touchData.startPosition)), r.swipePanning ? (U.panBy({
						x: Se[0] * re,
						y: Se[1] * re
					}), U.emit(ve("dragpan"))) : Be && (r.swipePanning = !0, U.panBy({
						x: Ae * re,
						y: er * re
					}), U.emit(ve("dragpan")), Lr && (Lr.unactivate(), r.redrawHint("select", !0), r.touchData.start = null)));
					var fe = r.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
					Q[0] = fe[0], Q[1] = fe[1];
				}
			}
			for (var ce = 0; ce < Q.length; ce++) ue[ce] = Q[ce];
			G && k.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.redraw());
		}
	}, "touchmoveHandler"), !1);
	var me;
	r.registerBinding(e, "touchcancel", me = m(function(k) {
		var G = r.touchData.start;
		r.touchData.capture = !1, G && G.unactivate();
	}, "touchcancelHandler"));
	var se, he, ge, Ce;
	if (r.registerBinding(e, "touchend", se = m(function(k) {
		var G = r.touchData.start;
		if (r.touchData.capture) k.touches.length === 0 && (r.touchData.capture = !1), k.preventDefault();
		else return;
		var U = r.selection;
		r.swipePanning = !1, r.hoverData.draggingEles = !1;
		var Q = r.cy, ue = Q.zoom(), re = r.touchData.now, fe = r.touchData.earlier;
		if (k.touches[0]) {
			var ve = r.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
			re[0] = ve[0], re[1] = ve[1];
		}
		if (k.touches[1]) {
			var ve = r.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
			re[2] = ve[0], re[3] = ve[1];
		}
		if (k.touches[2]) {
			var ve = r.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
			re[4] = ve[0], re[5] = ve[1];
		}
		var be = m(function(Ur) {
			return {
				originalEvent: k,
				type: Ur,
				position: {
		...
		var Be;
		if (r.touchData.cxt) {
			if (Be = be("cxttapend"), G ? G.emit(Be) : Q.emit(Be), !r.touchData.cxtDragged) {
				var Se = be("cxttap");
		...
		if (!k.touches[2] && Q.boxSelectionEnabled() && r.touchData.selecting) {
			...
			var ce = Q.collection(r.getAllInBox(U[0], U[1], U[2], U[3]));
			U[0] = void 0, U[1] = void 0, U[2] = void 0, U[3] = void 0, U[4] = 0, r.redrawHint("select", !0), Q.emit(be("boxend"));
			var Ae = m(function(Ur) {
				return Ur.selectable() && !Ur.selected();
			}, "eleWouldBeSelected");
			ce.emit(be("box")).stdFilter(Ae).select().emit(be("boxselect")), ce.nonempty() && r.redrawHint("eles", !0), r.redraw();
		}
		if (G?.unactivate(), k.touches[2]) r.data.bgActivePosistion = void 0, r.redrawHint("select", !0);
		else if (!k.touches[1]) {
			if (!k.touches[0]) {
				if (!k.touches[0]) {
					...
					if (G != null) {
						...
						y(Pe), r.redrawHint("drag", !0), r.redrawHint("eles", !0), er && (G.emit(be("freeon")), Pe.emit(be("free")), r.dragData.didDrag && (G.emit(be("dragfreeon")), Pe.emit(be("dragfree")))), n(G, [
							"touchend",
							"tapend",
							"vmouseup",
							"tapdragout"
					...
					} else n(r.findNearestElement(re[0], re[1], !0, !0), [
						"touchend",
						"tapend",
						"vmouseup",
						"tapdragout"
					...
					var br = r.touchData.startPosition[0] - re[0], Ze = br * br, sr = r.touchData.startPosition[1] - re[1], et = (Ze + sr * sr) * ue * ue;
					r.touchData.singleTouchMoved || (G || Q.$(":selected").unselect(["tapunselect"]), n(G, ["tap", "vclick"], k, {
						x: re[0],
						y: re[1]
					}), he = !1, k.timeStamp - Ce <= Q.multiClickDebounceTime() ? (ge && clearTimeout(ge), he = !0, Ce = null, n(G, ["dbltap", "vdblclick"], k, {
						x: re[0],
						y: re[1]
					})) : (ge = setTimeout(function() {
						he || n(G, ["onetap", "voneclick"], k, {
							x: re[0],
							y: re[1]
						});
					}, Q.multiClickDebounceTime()), Ce = k.timeStamp)), G != null && !r.dragData.didDrag && G._private.selectable && et < r.touchTapThreshold2 && !r.pinching && (Q.selectionType() === "single" ? (Q.$(t).unmerge(G).unselect(["tapunselect"]), G.select(["tapselect"])) : G.selected() ? G.unselect(["tapunselect"]) : G.select(["tapselect"]), r.redrawHint("eles", !0)), r.touchData.singleTouchMoved = !0;
				}
			}
		}
		for (var Qe = 0; Qe < re.length; Qe++) fe[Qe] = re[Qe];
		r.dragData.didDrag = !1, k.touches.length === 0 && (r.touchData.dragDelta = [], r.touchData.startPosition = [
			null,
			null,
			null,
			null,
			null,
			null
		], r.touchData.startGPosition = null, r.touchData.didSelect = !1), k.touches.length < 2 && (k.touches.length === 1 && (r.touchData.startGPosition = [k.touches[0].clientX, k.touches[0].clientY]), r.pinching = !1, r.redrawHint("eles", !0), r.redraw());
	}, "touchendHandler"), !1), typeof TouchEvent > "u") {
		var ye = [], ke = m(function(k) {
			return {
				clientX: k.clientX,
				clientY: k.clientY,
				force: 1,
		...
		}, "makeTouch"), Me = m(function(k) {
			return {
				event: k,
				touch: ke(k)
			};
		}, "makePointer"), Ne = m(function(k) {
			ye.push(Me(k));
		}, "addPointer"), ze = m(function(k) {
			for (var G = 0; G < ye.length; G++) if (ye[G].event.pointerId === k.pointerId) {
				ye.splice(G, 1);
				return;
			}
		}, "removePointer"), Fe = m(function(k) {
			var G = ye.filter(function($) {
				return $.event.pointerId === k.pointerId;
			})[0];
			G.event = k, G.touch = ke(k);
		}, "updatePointer"), Ee = m(function(k) {
			k.touches = ye.map(function(G) {
				return G.touch;
			});
		}, "addTouchesToEvent"), le = m(function(k) {
...
Jr.generatePolygon = function(r, e) {
	return this.nodeShapes[r] = {
		...
		name: r,
		points: e,
		draw: m(function(a, n, i, s, o, l) {
			this.renderer.nodeShapeImpl("polygon", a, n, i, s, o, this.points);
		}, "draw"),
		intersectLine: m(function(a, n, i, s, o, l, u, f) {
			return Ba(o, l, this.points, a, n, i / 2, s / 2, u);
		}, "intersectLine"),
		checkPoint: m(function(a, n, i, s, o, l, u, f) {
			return Qr(a, n, this.points, l, u, s, o, [0, -1], i);
		}, "checkPoint"),
		hasMiterBounds: r !== "rectangle",
		miterBounds: m(function(a, n, i, s, o, l) {
...
Jr.generateEllipse = function() {
	return this.nodeShapes.ellipse = {
		renderer: this,
		name: "ellipse",
		draw: m(function(e, t, a, n, i, s) {
			this.renderer.nodeShapeImpl(this.name, e, t, a, n, i);
		}, "draw"),
		intersectLine: m(function(e, t, a, n, i, s, o, l) {
			return Vd(i, s, e, t, a / 2 + o, n / 2 + o);
		}, "intersectLine"),
		checkPoint: m(function(e, t, a, n, i, s, o, l) {
...
Jr.generateRoundPolygon = function(r, e) {
	return this.nodeShapes[r] = {
		...
		name: r,
		points: e,
		getOrCreateCorners: m(function(a, n, i, s, o, l, u) {
			...
			var h, m, p, y, b = d.length;
			for (m = d[b - 1], h = 0; h < b; h++) p = d[h % b], y = d[(h + 1) % b], l[u][h] = yo(m, p, y, o), m = p, p = y;
			return l[u];
		}, "getOrCreateCorners"),
		draw: m(function(a, n, i, s, o, l, u) {
			this.renderer.nodeShapeImpl("round-polygon", a, n, i, s, o, this.points, this.getOrCreateCorners(n, i, s, o, l, u, "drawCorners"));
		}, "draw"),
		intersectLine: m(function(a, n, i, s, o, l, u, f, c) {
			return _d(o, l, this.points, a, n, i, s, u, this.getOrCreateCorners(a, n, i, s, f, c, "corners"));
		}, "intersectLine"),
		checkPoint: m(function(a, n, i, s, o, l, u, f, c) {
			return Fd(a, n, this.points, l, u, s, o, this.getOrCreateCorners(l, u, s, o, f, c, "corners"));
		}, "checkPoint")
	};
};
Jr.generateRoundRectangle = function() {
	return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
		...
		checkPoint: m(function(e, t, a, n, i, s, o, l) {
			var u = n / 2, f = i / 2;
			l = l === "auto" ? ft(n, i) : l, l = Math.min(u, f, l);
			var c = l * 2;
			return !!(Qr(e, t, this.points, s, o, n, i - c, [0, -1], a) || Qr(e, t, this.points, s, o, n - c, i, [0, -1], a) || Bt(e, t, c, c, s - u + l, o - f + l, a) || Bt(e, t, c, c, s + u - l, o - f + l, a) || Bt(e, t, c, c, s + u - l, o + f - l, a) || Bt(e, t, c, c, s - u + l, o + f - l, a));
		}, "checkPoint")
	};
};
Jr.generateCutRectangle = function() {
	return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
		...
		generateCutTrianglePts: m(function(e, t, a, n, i) {
		...
		checkPoint: m(function(e, t, a, n, i, s, o, l) {
			...
			if (Qr(e, t, this.points, s, o, n, i - 2 * u, [0, -1], a) || Qr(e, t, this.points, s, o, n - 2 * u, i, [0, -1], a)) return !0;
...
Jr.generateBarrel = function() {
	return this.nodeShapes.barrel = {
		...
		intersectLine: m(function(e, t, a, n, i, s, o, l) {
			var u = .15, f = .5, c = .85, d = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, t), g = m(function(p) {
				var y = Xt({
					x: p[0],
					y: p[1]
				}, {
			...
			return Ba(i, s, [].concat(g(d.topLeft), g(d.topRight), g(d.bottomRight), g(d.bottomLeft)), e, t);
		}, "intersectLine"),
		generateBarrelBezierPts: m(function(e, t, a, n) {
			var i = t / 2, s = e / 2, o = a - s, l = a + s, u = n - i, f = n + i, c = Rs(e, t), d = c.heightOffset, g = c.widthOffset, h = c.ctrlPtOffsetPct * e, m = {
				topLeft: [
					o,
					u + d,
					o + h,
		...
		checkPoint: m(function(e, t, a, n, i, s, o, l) {
			var u = Rs(n, i), f = u.heightOffset, c = u.widthOffset;
			if (Qr(e, t, this.points, s, o, n, i - 2 * f, [0, -1], a) || Qr(e, t, this.points, s, o, n - 2 * c, i, [0, -1], a)) return !0;
			for (var d = this.generateBarrelBezierPts(n, i, s, o), g = m(function(S, D, B) {
				var P = B[4], A = B[2], R = B[0], M = B[5], I = B[1];
				if (Math.min(P, R) <= S && S <= Math.max(P, R) && Math.min(M, I) <= D && D <= Math.max(M, I)) {
					var H = Gd(P, A, R), V = Id(H[0], H[1], H[2], S).filter(function(K) {
						return 0 <= K && K <= 1;
					});
					if (V.length > 0) return V[0];
				}
				return null;
			}, "getCurveT"), h = Object.keys(d), m$43 = 0; m$43 < h.length; m$43++) {
				var y = d[h[m$43]], b = g(e, t, y);
				if (b != null) {
					var w = y[5], x = y[3], C = y[1], T = or(w, x, C, b);
					if (y.isTop && T <= t || y.isBottom && t <= T) return !0;
				}
			}
			return !1;
		}, "checkPoint")
...
Jr.generateBottomRoundrectangle = function() {
	return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
		...
		intersectLine: m(function(e, t, a, n, i, s, o, l) {
			var u = e - (a / 2 + o), f = t - (n / 2 + o), c = f, g = st(i, s, e, t, u, f, e + (a / 2 + o), c, !1);
			return g.length > 0 ? g : xv(i, s, e, t, a, n, o, l);
		}, "intersectLine"),
		checkPoint: m(function(e, t, a, n, i, s, o, l) {
			l = l === "auto" ? ft(n, i) : l;
			var u = 2 * l;
			if (Qr(e, t, this.points, s, o, n, i - u, [0, -1], a) || Qr(e, t, this.points, s, o, n - u, i, [0, -1], a)) return !0;
			var f = n / 2 + 2 * a, c = i / 2 + 2 * a;
			return !!(kr(e, t, [
				s - f,
				o - c,
				s - f,
				...
				s + f,
				o - c
			]) || Bt(e, t, u, u, s + n / 2 - l, o + i / 2 - l, a) || Bt(e, t, u, u, s - n / 2 + l, o + i / 2 - l, a));
		}, "checkPoint")
	};
};
Jr.registerNodeShapes = function() {
	var r = this.nodeShapes = {}, e = this;
	this.generateEllipse(), this.generatePolygon("triangle", wr(3, 0)), this.generateRoundPolygon("round-triangle", wr(3, 0)), this.generatePolygon("rectangle", wr(4, 0)), r.square = r.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
	var t = [
		0,
		1,
		1,
	...
	a = Ev(a), this.generatePolygon("star", a), this.generatePolygon("vee", [
		-1,
		-1,
		0,
		-.333,
...
Wa.beforeRender = function(r, e) {
	if (!this.destroyed) {
		e ?? Ue("Priority is not optional for beforeRender");
...
oa.init = function(r) {
	...
	if (a) {
		...
		a.getComputedStyle(t).getPropertyValue("position") === "static" && qe("A Cytoscape container has style position:static and so can not use UI extensions properly");
	}
	e.selection = [
		void 0,
		void 0,
		...
		capture: !1
	}, e.dragData = { possibleDragElements: [] }, e.touchData = {
		start: null,
		capture: !1,
		startPosition: [
			null,
...
var xs = 1e3 / 60, Sf = { setupDequeueing: m(function(e) {
	return m(function() {
		...
		if (!a.dequeueingSetup) {
			...
			}, e.deqRedrawThreshold), s = m(function(u, f) {
				var c = Zr(), d = n.averageRedrawTime, g = n.lastRedrawTime, h = [], m = n.cy.extent(), p = n.getPixelRatio();
				for (u || n.flushRenderedStyleQueue();;) {
					var y = Zr(), b = y - c, w = y - f;
					if (g < xs) {
						var x = xs - (u ? d : 0);
						if (w >= e.deqFastCost * x) break;
					} else if (u) {
						if (b >= e.deqCost * g || b >= e.deqAvgCost * d) break;
	...
	return m(r, "ElementTextureCacheLookup"), pt(r, [
		{
			key: "getIdsFor",
			value: m(function(t) {
				t ?? Ue("Can not get id list for null key");
		...
		},
		{
			...
			value: m(function(t) {
				var a = t.id();
				return this.keyForId.get(a) !== this.getKey(t);
			}, "keyHasChangedFor")
		},
		{
			key: "isInvalid",
...
ir.getRetiredTextureQueue = function(r) {
	var e = this, t = e.eleImgCaches.retired = e.eleImgCaches.retired || {};
	return t[r] = t[r] || [];
};
ir.getElementQueue = function() {
	var r = this;
	return r.eleCacheQueue = r.eleCacheQueue || new qa(function(t, a) {
		return a.reqs - t.reqs;
	});
};
ir.getElementKeyToQueue = function() {
	var r = this;
	return r.eleKeyToCacheQueue = r.eleKeyToCacheQueue || {};
};
ir.getElement = function(r, e, t, a, n) {
	...
	if (a ??= Math.ceil(to(o * t)), a < yn) a = yn;
	else if (o >= kf || a > Ws) return null;
	var u = Math.pow(2, a), f = e.h * u, c = e.w * u, d = s.eleTextBiggerThanMin(r, u);
	...
	var m$44 = i.getTextureQueue(h), p = m$44[m$44.length - 2], y = m(function() {
		return i.recycleTexture(h, c) || i.addTexture(h, c);
	}, "addNewTxr");
	p || (p = m$44[m$44.length - 1]), p || (p = y()), p.width - p.usedWidth < c && (p = y());
	for (var b = m(function(O) {
	...
	var D = T && T.level === a + 1 ? T : null, B = m(function() {
		p.context.drawImage(D.texture.canvas, D.x, 0, D.width, D.height, p.usedWidth, 0, c, f);
	}, "downscale");
	if (p.context.setTransform(1, 0, 0, 1, 0, 0), p.context.clearRect(p.usedWidth, 0, c, h), b(D)) B();
	else if (b(T)) if (x) {
		for (var P = T.level; P > a; P--) D = i.getElement(r, e, t, P, Kt.downscale);
		B();
		...
		if (b(A)) return i.queueElement(r, a), A;
		p.context.translate(p.usedWidth, 0), p.context.scale(u, u), this.drawElement(p.context, r, e, d, !1), p.context.scale(1 / u, 1 / u), p.context.translate(-p.usedWidth, 0);
	}
	return g = {
		x: p.usedWidth,
		texture: p,
		...
		height: f,
		scaledLabelShown: d
	}, p.usedWidth += Math.ceil(c + sy), p.eleCaches.push(g), l.set(r, a, g), i.checkTextureFullness(p), g;
};
ir.invalidateElements = function(r) {
	for (var e = 0; e < r.length; e++) this.invalidateElement(r[e]);
};
ir.invalidateElement = function(r) {
	var e = this, t = e.lookup, a = [];
	if (t.isInvalid(r)) {
		for (var i = yn; i <= Ws; i++) {
			var s = t.getForCachedKey(r, i);
			s && a.push(s);
		}
		if (t.invalidate(r)) for (var l = 0; l < a.length; l++) {
...
ir.checkTextureFullness = function(r) {
	var t = this.getTextureQueue(r.height);
...
ir.retireTexture = function(r) {
	...
	ro(i);
	e.getRetiredTextureQueue(t).push(r);
};
...
ir.recycleTexture = function(r, e) {
	for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
		var s = n[i];
		if (s.width >= e) return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, ro(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), vt(n, s), a.push(s), s;
	}
};
...
ir.dequeue = function(r) {
	for (var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < my && t.size() > 0; s++) {
		var o = t.pop(), l = o.key, u = o.eles[0], f = i.hasCache(u, o.level);
...
ir.setupDequeueing = Sf.setupDequeueing({
	deqRedrawThreshold: yy,
	deqCost: dy,
	deqAvgCost: hy,
	deqNoDrawCost: gy,
	deqFastCost: py,
	deq: m(function(e, t, a) {
		return e.dequeue(t, a);
	}, "deq"),
	onDeqd: m(function(e, t) {
		for (var a = 0; a < e.onDequeues.length; a++) {
			var n = e.onDequeues[a];
			n(t);
		}
	}, "onDeqd"),
	shouldRedraw: m(function(e, t, a, n) {
		for (var i = 0; i < t.length; i++) for (var s = t[i].eles, o = 0; o < s.length; o++) if (no(s[o].boundingBox(), n)) return !0;
		return !1;
	}, "shouldRedraw"),
	priority: m(function(e) {
		return e.renderer.beforeRenderPriorities.eleTxrDeq;
	}, "priority")
});
var wy = 1, Ea = -4, An = 2, xy = 3.99, Ey = 50, Cy = 50, Ty = .15, Sy = .1, ky = .9, Dy = .9, By = 1, Fl = 250, Py = 4e3 * 4e3, Vl = 32767, Ay = !0, Df = m(function(e) {
	var t = this, a = t.renderer = e, n = a.cy;
	t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = Zr() - 2 * Fl, t.skipping = !1, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Va(function() {
		t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
	}, Cy), a.beforeRender(function(s, o) {
		o - t.lastInvalidationTime <= Fl ? t.skipping = !0 : t.skipping = !1;
	}, a.beforeRenderPriorities.lyrTxrSkip);
	t.layersQueue = new qa(m(function(o, l) {
...
hr.getLayers = function(r, e, t) {
	var a = this, s = a.renderer.cy.zoom(), o = a.firstGet;
	if (a.firstGet = !1, t == null) {
		if (t = Math.ceil(to(s * e)), t < Ea) t = Ea;
		else if (s >= xy || t > An) return null;
	}
	a.validateLayersElesOrdering(t, r);
	var l = a.layersByLevel, u = Math.pow(2, t), f = l[t] = l[t] || [], c, d = a.levelIsComplete(t, r), g, h = m(function() {
		var B = m(function(I) {
			if (a.validateLayersElesOrdering(I, r), a.levelIsComplete(I, r)) return g = l[I], !0;
		}, "canUseAsTmpLvl"), P = m(function(I) {
	...
	var m$45 = m(function() {
		if (!c) {
			c = xr();
			for (var B = 0; B < r.length; B++) Bd(c, r[B].boundingBox());
		}
		return c;
	}, "getBb"), p = m(function(B) {
		B = B || {};
		var P = B.after;
		m$45();
		var A = Math.ceil(c.w * u), R = Math.ceil(c.h * u);
		if (A > Vl || R > Vl) return null;
		if (A * R > Py) return null;
		var I = a.makeLayer(c, t);
		if (P != null) {
			var O = f.indexOf(P) + 1;
			f.splice(O, 0, I);
	...
	for (var y = null, b = r.length / wy, w = !o, x = 0; x < r.length; x++) {
		var C = r[x], T = C._private.rscratch, E = T.imgLayerCaches = T.imgLayerCaches || {}, S = E[t];
		if (S) {
			y = S;
			continue;
		}
		if ((!y || y.eles.length >= b || !wv(y.bb, C.boundingBox())) && (y = p({
			insert: !0,
			after: y
		}), !y)) return null;
...
hr.updateElementsInLayers = function(r, e) {
	for (var t = this, a = Oa(r[0]), n = 0; n < r.length; n++) for (var i = a ? null : r[n], s = a ? r[n] : r[n].ele, o = s._private.rscratch, l = o.imgLayerCaches = o.imgLayerCaches || {}, u = Ea; u <= An; u++) {
		var f = l[u];
		f && (i && t.getEleLevelForLayerLevel(f.level) !== i.level || e(f, s, i));
	}
};
hr.haveLayers = function() {
	for (var r = this, e = !1, t = Ea; t <= An; t++) {
...
hr.invalidateElements = function(r) {
	var e = this;
	r.length !== 0 && (e.lastInvalidationTime = Zr(), !(r.length === 0 || !e.haveLayers()) && e.updateElementsInLayers(r, m(function(a, n, i) {
		e.invalidateLayer(a);
	}, "invalAssocLayers")));
};
hr.invalidateLayer = function(r) {
	if (this.lastInvalidationTime = Zr(), !r.invalid) {
		var e = r.level, t = r.eles, a = this.layersByLevel[e];
		vt(a, r), r.elesQueue = [], r.invalid = !0, r.replacement && (r.replacement.invalid = !0);
...
hr.refineElementTextures = function(r) {
	var e = this;
	e.updateElementsInLayers(r, m(function(a, n, i) {
		var s = a.replacement;
...
hr.queueLayer = function(r, e) {
	var a = this.layersQueue, n = r.elesQueue, i = n.hasId = n.hasId || {};
	if (!r.replacement) {
		if (e) {
			if (i[e.id()]) return;
			n.push(e), i[e.id()] = !0;
...
hr.requestRedraw = Va(function() {
	var r = this.renderer;
	r.redrawHint("eles", !0), r.redrawHint("drag", !0), r.redraw();
}, 100);
hr.setupDequeueing = Sf.setupDequeueing({
...
Wr.drawCachedElementPortion = function(r, e, t, a, n, i, s, o) {
	...
	if (!(u.w === 0 || u.h === 0)) {
		var f = t.getElement(e, u, a, n, i);
		if (f != null) {
			var c = o(l, e);
			if (c === 0) return;
			var d = s(l, e), g = u.x1, h = u.y1, m = u.w, p = u.h, y, b, w, x, C;
			if (d !== 0) {
				var T = t.getRotationPoint(e);
				w = T.x, x = T.y, r.translate(w, x), r.rotate(d), C = l.getImgSmoothing(r), C || l.setImgSmoothing(r, !0);
				var E = t.getRotationOffset(e);
				y = E.x, b = E.y;
			} else y = g, b = h;
			var S;
			c !== 1 && (S = r.globalAlpha, r.globalAlpha = S * c), r.drawImage(f.texture.canvas, f.x, 0, f.width, f.height, y, b, m, p), c !== 1 && (r.globalAlpha = S), d !== 0 && (r.rotate(-d), r.translate(-w, -x), C || l.setImgSmoothing(r, !1));
		} else t.drawElement(r, e);
	}
};
var Ny = m(function() {
	return 0;
}, "getZeroRotation"), zy = m(function(e, t) {
	return e.getTextAngle(t, null);
}, "getLabelRotation"), Fy = m(function(e, t) {
	return e.getTextAngle(t, "source");
}, "getSourceLabelRotation"), Vy = m(function(e, t) {
	return e.getTextAngle(t, "target");
}, "getTargetLabelRotation"), qy = m(function(e, t) {
	return t.effectiveOpacity();
}, "getOpacity"), Es = m(function(e, t) {
	return t.pstyle("text-opacity").pfValue * t.effectiveOpacity();
}, "getTextOpacity");
Wr.drawCachedElement = function(r, e, t, a, n, i) {
	var s = this, o = s.data, l = o.eleTxrCache, u = o.lblTxrCache, f = o.slbTxrCache, c = o.tlbTxrCache, d = e.boundingBox(), g = i === !0 ? l.reasons.highQuality : null;
...
jr.drawEdge = function(r, e, t) {
	...
	if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
		...
		var u = i ? e.pstyle("opacity").value : 1, f = i ? e.pstyle("line-opacity").value : 1, c = e.pstyle("curve-style").value, d = e.pstyle("line-style").value, g = e.pstyle("width").pfValue, h = e.pstyle("line-cap").value, m$46 = e.pstyle("line-outline-width").value, p = e.pstyle("line-outline-color").value, y = u * f, b = u * f, w = m(function() {
		...
		}, "drawLine"), x = m(function() {
			var I = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : y;
			if (r.lineWidth = g + m$46, r.lineCap = h, m$46 > 0) s.colorStrokeStyle(r, p[0], p[1], p[2], I);
			else {
				r.lineCap = "butt";
				return;
			}
			c === "straight-triangle" ? s.drawEdgeTrianglePath(e, r, o.allpts) : (s.drawEdgePath(e, r, o.allpts, d), r.lineCap = "butt");
		}, "drawLineOutline"), C = m(function() {
			n && s.drawEdgeOverlay(r, e);
		}, "drawOverlay"), T = m(function() {
			n && s.drawEdgeUnderlay(r, e);
		}, "drawUnderlay"), E = m(function() {
			var I = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : b;
			s.drawArrowheads(r, e, I);
		}, "drawArrows"), S = m(function() {
			s.drawElementText(r, e, null, a);
		}, "drawText");
		r.lineJoin = "round";
		if (e.pstyle("ghost").value === "yes") {
			var B = e.pstyle("ghost-offset-x").pfValue, P = e.pstyle("ghost-offset-y").pfValue, R = y * e.pstyle("ghost-opacity").value;
...
var Pf = m(function(e) {
	...
	return function(t, a) {
		if (a.visible()) {
			...
			if (n !== 0) {
				var i = this, s = i.usePaths(), o = a._private.rscratch, u = 2 * a.pstyle("".concat(e, "-padding")).pfValue, f = a.pstyle("".concat(e, "-color")).value;
...
jr.drawEdgeOverlay = Pf("overlay");
jr.drawEdgeUnderlay = Pf("underlay");
jr.drawEdgePath = function(r, e, t, a) {
	var n = r._private.rscratch, i = e, s, o = !1, l = this.usePaths(), u = r.pstyle("line-dash-pattern").pfValue, f = r.pstyle("line-dash-offset").pfValue;
	if (l) {
		var c = t.join("$");
		n.pathCacheKey && n.pathCacheKey === c ? (s = e = n.pathCache, o = !0) : (s = e = new Path2D(), n.pathCacheKey = c, n.pathCache = s);
	}
	...
	if (!o && !n.badLine) switch (e.beginPath && e.beginPath(), e.moveTo(t[0], t[1]), n.edgeType) {
		...
		case "segments":
			...
			} else for (var b = 2; b + 1 < t.length; b += 2) e.lineTo(t[b], t[b + 1]);
			break;
	}
...
jr.drawArrowhead = function(r, e, t, a, n, i, s) {
	if (!(isNaN(a) || a == null || isNaN(n) || n == null || isNaN(i) || i == null)) {
		...
		if (l !== "none") {
			var u = e.pstyle(t + "-arrow-fill").value === "hollow" ? "both" : "filled", f = e.pstyle(t + "-arrow-fill").value, c = e.pstyle("width").pfValue, d = e.pstyle(t + "-arrow-width"), g = d.value === "match-line" ? c : d.pfValue;
			d.units === "%" && (g *= c);
...
jr.drawArrowShape = function(r, e, t, a, n, i, s, o, l) {
	var u = this, f = this.usePaths() && n !== "triangle-cross", c = !1, d, g = e, h = {
		x: s,
		y: o
	}, m = r.pstyle("arrow-scale").value, p = this.getArrowWidth(a, m), y = u.arrowShapes[n];
	if (f) {
		var b = u.arrowPathCache = u.arrowPathCache || [], w = Pt(n), x = b[w];
		x != null ? (d = e = x, c = !0) : (d = e = new Path2D(), b[w] = d);
	}
...
bo.drawInscribedImage = function(r, e, t, a, n) {
	...
	var B = S, P = D;
	if (f(t, "background-width", "value", a) !== "auto" && (f(t, "background-width", "units", a) === "%" ? B = f(t, "background-width", "pfValue", a) * p : B = f(t, "background-width", "pfValue", a)), f(t, "background-height", "value", a) !== "auto" && (f(t, "background-height", "units", a) === "%" ? P = f(t, "background-height", "pfValue", a) * y : P = f(t, "background-height", "pfValue", a)), !(B === 0 || P === 0)) {
		if (c === "contain") {
			var A = Math.min(p / B, y / P);
			B *= A, P *= A;
		} else if (c === "cover") {
			var A = Math.max(p / B, y / P);
			B *= A, P *= A;
		}
		var R = o - p / 2, M = f(t, "background-position-x", "units", a), I = f(t, "background-position-x", "pfValue", a);
		M === "%" ? R += (p - B) * I : R += I;
		var O = f(t, "background-offset-x", "units", a), L = f(t, "background-offset-x", "pfValue", a);
		O === "%" ? R += (p - B) * L : R += L;
		var N = l - y / 2, q = f(t, "background-position-y", "units", a), H = f(t, "background-position-y", "pfValue", a);
		q === "%" ? N += (y - P) * H : N += H;
		var z = f(t, "background-offset-y", "units", a), V = f(t, "background-offset-y", "pfValue", a);
		z === "%" ? N += (y - P) * V : N += V, b.pathCache && (R -= o, N -= l, o = 0, l = 0);
		var K = r.globalAlpha;
		r.globalAlpha = C;
		var J = i.getImgSmoothing(r), X = !1;
		if (T === "no" && J ? (i.setImgSmoothing(r, !1), X = !0) : T === "yes" && !J && (i.setImgSmoothing(r, !0), X = !0), d === "no-repeat") x && (r.save(), b.pathCache ? r.clip(b.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, p, y, E, b), r.clip())), i.safeDrawImage(r, e, 0, 0, S, D, R, N, B, P), x && r.restore();
		else r.fillStyle = r.createPattern(e, d), i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, p, y, E, b), r.translate(R, N), r.fill(), r.translate(-R, -N);
...
Ot.eleTextBiggerThanMin = function(r, e) {
	if (!e) {
		var t = r.cy().zoom(), a = this.getPixelRatio(), n = Math.ceil(to(t * a));
		e = Math.pow(2, n);
	}
	return !(r.pstyle("font-size").pfValue * e < r.pstyle("min-zoomed-font-size").pfValue);
};
Ot.drawElementText = function(r, e, t, a, n) {
	...
	if (e.isNode()) {
		...
		if (!o || !o.value) return;
		r.textAlign = s.getLabelJustification(e), r.textBaseline = "bottom";
	} else {
...
Ot.setupTextStyle = function(r, e) {
	var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, a = e.pstyle("font-style").strValue, n = e.pstyle("font-size").pfValue + "px", i = e.pstyle("font-family").strValue, s = e.pstyle("font-weight").strValue, o = t ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1, l = e.pstyle("text-outline-opacity").value * o, u = e.pstyle("color").value, f = e.pstyle("text-outline-color").value;
...
function _y(r, e, t, a, n) {
	var s = Math.min(a, n) / 2, o = e + a / 2, l = t + n / 2;
...
Ot.getTextAngle = function(r, e) {
	var t, n = r._private.rscratch, i = e ? e + "-" : "", s = r.pstyle(i + "text-rotation");
	if (s.strValue === "autorotate") {
		var o = Sr(n, "labelAngle", e);
		t = r.isEdge() ? o : 0;
	} else s.strValue === "none" ? t = 0 : t = s.pfValue;
	return t;
};
Ot.drawText = function(r, e, t) {
	var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, s = e._private.rscratch, o = n ? e.effectiveOpacity() : 1;
	if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
		t === "main" && (t = null);
		var l = Sr(s, "labelX", t), u = Sr(s, "labelY", t), f, c, d = this.getLabelText(e, t);
		if (d != null && d !== "" && !isNaN(l) && !isNaN(u)) {
			this.setupTextStyle(r, e, n);
			var g = t ? t + "-" : "", h = Sr(s, "labelWidth", t), m = Sr(s, "labelHeight", t), p = e.pstyle(g + "text-margin-x").pfValue, y = e.pstyle(g + "text-margin-y").pfValue, b = e.isEdge(), w = e.pstyle("text-halign").value, x = e.pstyle("text-valign").value;
			b && (w = "center", x = "center"), l += p, u += y;
			var C;
			switch (a ? C = this.getTextAngle(e, t) : C = 0, C !== 0 && (f = l, c = u, r.translate(f, c), r.rotate(C), l = 0, u = 0), x) {
				case "top": break;
				case "center":
					u += m / 2;
					break;
			...
			if (T > 0 || S > 0 && E > 0) {
				...
				if (H && (r.fillStyle = "rgba(".concat(L[0], ",").concat(L[1], ",").concat(L[2], ",").concat(T * o, ")")), z && (r.strokeStyle = "rgba(".concat(N[0], ",").concat(N[1], ",").concat(N[2], ",").concat(E * o, ")"), r.lineWidth = S, r.setLineDash)) switch (q) {
					case "dotted":
						r.setLineDash([1, 1]);
						break;
					case "dashed":
			...
			if (te > 0 && (r.lineWidth = te), e.pstyle("text-wrap").value === "wrap") {
				var ie = Sr(s, "labelWrapCachedLines", t), j = Sr(s, "labelLineHeight", t), F = h / 2, _ = this.getLabelJustification(e);
...
mt.drawNode = function(r, e, t) {
	var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, s = this, o, l, u = e._private, f = u.rscratch, c = e.position();
	if (!(!ne(c.x) || !ne(c.y)) && !(i && !e.visible())) {
		var d = i ? e.effectiveOpacity() : 1, g = s.usePaths(), h, m$47 = !1, p = e.padding();
		o = e.width() + 2 * p, l = e.height() + 2 * p;
		var y;
		t && (y = t, r.translate(-y.x1, -y.y1));
		for (var w = e.pstyle("background-image").value, x = new Array(w.length), C = new Array(w.length), T = 0, E = 0; E < w.length; E++) {
			var S = w[E];
			if (x[E] = S != null && S !== "none") {
				var B = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", E);
				T++, C[E] = s.getCachedImage(S, B, function() {
		...
		}, "setupShapeColor"), j = m(function() {
			var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : z;
			s.colorStrokeStyle(r, M[0], M[1], M[2], le);
		}, "setupBorderColor"), F = m(function() {
			var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : X;
			s.colorStrokeStyle(r, K[0], K[1], K[2], le);
		}, "setupOutlineColor"), _ = m(function(le, Y, k, G) {
			var $ = s.nodePathCache = s.nodePathCache || [], U = dv(k === "polygon" ? k + "," + G.join(",") : k, "" + Y, "" + le, "" + te), Q = $[U], ue, re = !1;
			return Q != null ? (ue = Q, re = !0, f.pathCache = ue) : (ue = new Path2D(), $[U] = f.pathCache = ue), {
				path: ue,
				cacheHit: re
			};
		...
		var de = m(function() {
			...
			g ? r.fill(h) : r.fill();
		}, "drawShape"), Re = m(function() {
			for (var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : d, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, k = u.backgrounding, G = 0, $ = 0; $ < C.length; $++) {
				var U = e.cy().style().getIndexedStyle(e, "background-image-containment", "value", $);
			...
			u.backgrounding = G !== T, k !== u.backgrounding && e.updateStyle(!1);
		}, "drawImages"), Te = m(function() {
			var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : d;
			s.hasPie(e) && (s.drawPie(r, e, Y), le && (g || s.nodeShapes[s.getNodeShape(e)].draw(r, c.x, c.y, o, l, te, f)));
		}, "drawPie"), xe = m(function() {
			var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : d;
			...
			if (V > 0) {
				...
				if (Y === "ellipse") s.drawEllipsePath(re || r, le.x, le.y, U, Q);
					...
					for (Ze = Pe[vr - 1], br = 0; br < vr; br++) sr = Pe[br % vr], rr = Pe[(br + 1) % vr], er[br] = yo(Ze, sr, rr, Ae), Ze = sr, sr = rr;
					s.drawRoundPolygonPath(re || r, le.x + be, le.y + Be, o * G, l * $, ue, er);
				} else if (["roundrectangle", "round-rectangle"].includes(Y)) te = te === "auto" ? ft(U, Q) : te, s.drawRoundRectanglePath(re || r, le.x, le.y, U, Q, te + (k + V + ee) / 2);
				else if (["cutrectangle", "cut-rectangle"].includes(Y)) te = te === "auto" ? io() : te, s.drawCutRectanglePath(re || r, le.x, le.y, U, Q, null, te + (k + V + ee) / 4);
				else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(Y)) te = te === "auto" ? ft(U, Q) : te, s.drawBottomRoundRectanglePath(re || r, le.x, le.y, U, Q, te + (k + V + ee) / 2);
					...
					var et = (k + V + ee) / o;
					ue = Cn(Tn(ue, et)), s.drawPolygonPath(re || r, le.x, le.y, o, l, ue);
				} else {
					var Qe = (k + V + ee) / o;
					ue = Cn(Tn(ue, -Qe)), s.drawPolygonPath(re || r, le.x, le.y, o, l, ue);
				}
		...
		}, "drawOutline"), ge = m(function() {
			n && s.drawNodeOverlay(r, e, c, o, l);
		}, "drawOverlay"), Ce = m(function() {
			n && s.drawNodeUnderlay(r, e, c, o, l);
		}, "drawUnderlay"), ye = m(function() {
			s.drawElementText(r, e, null, a);
		}, "drawText");
		if (e.pstyle("ghost").value === "yes") {
			var Me = e.pstyle("ghost-offset-x").pfValue, Ne = e.pstyle("ghost-offset-y").pfValue, ze = e.pstyle("ghost-opacity").value, Fe = ze * d;
			r.translate(Me, Ne), F(), he(), ie(ze * R), de(), Re(Fe, !0), j(ze * z), se(), Te(P !== 0 || A !== 0), xe(P !== 0 || A !== 0), Re(Fe, !1), me(Fe), r.translate(-Me, -Ne);
		}
		g && r.translate(-c.x, -c.y), Ce(), g && r.translate(c.x, c.y), F(), he(), ie(), de(), Re(d, !0), j(), se(), Te(P !== 0 || A !== 0), xe(P !== 0 || A !== 0), Re(d, !1), me(), g && r.translate(-c.x, -c.y), ye(), ge(), t && r.translate(y.x1, y.y1);
	}
};
var Af = m(function(e) {
	if (!["overlay", "underlay"].includes(e)) throw new Error("Invalid state");
...
mt.drawNodeOverlay = Af("overlay");
mt.drawNodeUnderlay = Af("underlay");
...
mt.drawPie = function(r, e, t, a) {
	...
	var n = e.cy().style(), i = e.pstyle("pie-size"), s = e.pstyle("pie-hole"), o = e.pstyle("pie-start-angle").pfValue, l = a.x, u = a.y, f = e.width(), c = e.height(), d = Math.min(f, c) / 2, g, h = 0;
	if (this.usePaths() && (l = 0, u = 0), i.units === "%" ? d = d * i.pfValue : i.pfValue !== void 0 && (d = i.pfValue / 2), s.units === "%" ? g = d * s.pfValue : s.pfValue !== void 0 && (g = s.pfValue / 2), !(g >= d)) for (var p = 1; p <= n.pieBackgroundN; p++) {
		var y = e.pstyle("pie-" + p + "-background-size").value, b = e.pstyle("pie-" + p + "-background-color").value, w = e.pstyle("pie-" + p + "-background-opacity").value * t, x = y / 100;
		x + h > 1 && (x = 1 - h);
		var C = 1.5 * Math.PI + 2 * Math.PI * h;
		C += o;
		var T = 2 * Math.PI * x, E = C + T;
		y === 0 || h >= 1 || h + x > 1 || (g === 0 ? (r.beginPath(), r.moveTo(l, u), r.arc(l, u, d, C, E), r.closePath()) : (r.beginPath(), r.arc(l, u, d, C, E), r.arc(l, u, g, E, C, !0), r.closePath()), this.colorFillStyle(r, b[0], b[1], b[2], w), r.fill(), h += x);
	}
};
mt.drawStripe = function(r, e, t, a) {
	e = e[0], a = a || e.position();
	var n = e.cy().style(), i = a.x, s = a.y, o = e.width(), l = e.height(), u = 0, f = this.usePaths();
	r.save();
	var c = e.pstyle("stripe-direction").value, d = e.pstyle("stripe-size");
	switch (c) {
		case "vertical": break;
		case "righward":
			r.rotate(-Math.PI / 2);
	...
	for (var m = 1; m <= n.stripeBackgroundN; m++) {
		var p = e.pstyle("stripe-" + m + "-background-size").value, y = e.pstyle("stripe-" + m + "-background-color").value, b = e.pstyle("stripe-" + m + "-background-opacity").value * t, w = p / 100;
		w + u > 1 && (w = 1 - u), !(p === 0 || u >= 1 || u + w > 1) && (r.beginPath(), r.rect(i, s + h * u, g, h * w), r.closePath(), this.colorFillStyle(r, y[0], y[1], y[2], b), r.fill(), u += w);
	}
	r.restore();
};
var Er = {}, Gy = 100;
...
Er.paintCache = function(r) {
	for (var e = this.paintCaches = this.paintCaches || [], t = !0, a, n = 0; n < e.length; n++) if (a = e[n], a.context === r) {
		t = !1;
		break;
	}
...
Er.createGradientStyleFor = function(r, e, t, a, n) {
	...
	if (a === "radial-gradient") if (t.isEdge()) {
		var u = t.sourceEndpoint(), f = t.targetEndpoint(), c = t.midpoint(), d = At(u, c), g = At(f, c);
		i = r.createRadialGradient(c.x, c.y, 0, c.x, c.y, Math.max(d, g));
	} else {
		var h = s ? {
			x: 0,
			y: 0
		} : t.position(), m = t.paddedWidth(), p = t.paddedHeight();
		i = r.createRadialGradient(h.x, h.y, 0, h.x, h.y, Math.max(m, p));
	}
	else if (t.isEdge()) {
		var y = t.sourceEndpoint(), b = t.targetEndpoint();
		i = r.createLinearGradient(y.x, y.y, b.x, b.y);
	} else {
		var w = s ? {
			x: 0,
			y: 0
		} : t.position(), x = t.paddedWidth(), C = t.paddedHeight(), T = x / 2, E = C / 2;
		switch (t.pstyle("background-gradient-direction").value) {
			case "to-bottom":
				i = r.createLinearGradient(w.x, w.y - E, w.x, w.y + E);
				break;
			case "to-top":
				i = r.createLinearGradient(w.x, w.y + E, w.x, w.y - E);
				break;
			case "to-left":
				i = r.createLinearGradient(w.x + T, w.y, w.x - T, w.y);
				break;
			case "to-right":
				i = r.createLinearGradient(w.x - T, w.y, w.x + T, w.y);
				break;
			...
			case "to-right-bottom":
				i = r.createLinearGradient(w.x - T, w.y - E, w.x + T, w.y + E);
				break;
			case "to-top-right":
			case "to-right-top":
				i = r.createLinearGradient(w.x - T, w.y + E, w.x + T, w.y - E);
...
Er.clearCanvas = function() {
	...
	m(t, "clear"), t(e.contexts[r.NODE]), t(e.contexts[r.DRAG]);
};
Er.render = function(r) {
	var e = this;
	r = r || yv();
	var t = e.cy, a = r.forcedContext, n = r.drawAllLayers, i = r.drawOnlyNodeLayer, s = r.forcedZoom, o = r.forcedPan, l = r.forcedPxRatio === void 0 ? this.getPixelRatio() : r.forcedPxRatio, u = e.data, f = u.canvasNeedsRedraw, c = e.textureOnViewport && !a && (e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming), d = r.motionBlur !== void 0 ? r.motionBlur : e.motionBlur, g = e.motionBlurPxRatio, h = t.hasCompoundNodes(), m$48 = e.hoverData.draggingEles, p = !!(e.hoverData.selecting || e.touchData.selecting);
	d = d && !a && e.motionBlurEnabled && !p;
	var y = d;
	a || (e.prevPxRatio !== l && (e.invalidateContainerClientCoordsCache(), e.matchCanvasSize(e.container), e.redrawHint("eles", !0), e.redrawHint("drag", !0)), e.prevPxRatio = l), !a && e.motionBlurTimeout && clearTimeout(e.motionBlurTimeout), d && (e.mbFrames ??= 0, e.mbFrames++, e.mbFrames < 3 && (y = !1), e.mbFrames > e.minMbLowQualFrames && (e.motionBlurPxRatio = e.mbPxRBlurry)), e.clearingMotionBlur && (e.motionBlurPxRatio = 1), e.textureDrawLastFrame && !c && (f[e.NODE] = !0, f[e.SELECT_BOX] = !0);
	var b = t.style(), w = t.zoom(), x = s !== void 0 ? s : w, C = t.pan(), T = {
		x: C.x,
		y: C.y
	}, E = {
		zoom: w,
	...
	!(S === void 0 || E.zoom !== S.zoom || E.pan.x !== S.pan.x || E.pan.y !== S.pan.y) && !(m$48 && !h) && (e.motionBlurPxRatio = 1), o && (T = o), x *= l, T.x *= l, T.y *= l;
	...
	if (m(A, "setContextTransform"), c || (e.textureDrawLastFrame = !1), c) {
		...
		var O = b.core("outside-texture-bg-color").value, L = b.core("outside-texture-bg-opacity").value;
		e.colorFillStyle(M, O[0], O[1], O[2], L), M.fillRect(0, 0, E.width, E.height);
		var w = t.zoom();
		A(M, !1), M.clearRect(E.mpan.x, E.mpan.y, E.width / E.zoom / l, E.height / E.zoom / l), M.drawImage(I, E.mpan.x, E.mpan.y, E.width / E.zoom / l, E.height / E.zoom / l);
	} else e.textureOnViewport && !a && (e.textureCache = null);
	var N = t.extent(), q = e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming || e.hoverData.draggingEles || e.cy.animated(), H = e.hideEdgesOnViewport && q, z = [];
	if (z[e.NODE] = !f[e.NODE] && d && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, z[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), z[e.DRAG] = !f[e.DRAG] && d && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, z[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), f[e.NODE] || n || i || z[e.NODE]) {
		var V = d && !z[e.NODE] && g !== 1, M = a || (V ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : u.contexts[e.NODE]);
		A(M, d && !V ? "motionBlur" : void 0), H ? e.drawCachedNodes(M, B.nondrag, l, N) : e.drawLayeredElements(M, B.nondrag, l, N), e.debug && e.drawDebugPoints(M, B.nondrag), !n && !d && (f[e.NODE] = !1);
	}
	if (!i && (f[e.DRAG] || n || z[e.DRAG])) {
		var V = d && !z[e.DRAG] && g !== 1, M = a || (V ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
		A(M, d && !V ? "motionBlur" : void 0), H ? e.drawCachedNodes(M, B.drag, l, N) : e.drawCachedElements(M, B.drag, l, N), e.debug && e.drawDebugPoints(M, B.drag), !n && !d && (f[e.DRAG] = !1);
	}
	if (this.drawSelectionRectangle(r, A), d && g !== 1) {
		var J = u.contexts[e.NODE], X = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], ee = u.contexts[e.DRAG], te = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ie = m(function(F, _, W) {
		...
		(f[e.NODE] || z[e.NODE]) && (ie(J, X, z[e.NODE]), f[e.NODE] = !1), (f[e.DRAG] || z[e.DRAG]) && (ie(ee, te, z[e.DRAG]), f[e.DRAG] = !1);
	}
	e.prevViewport = E, e.clearingMotionBlur && (e.clearingMotionBlur = !1, e.motionBlurCleared = !0, e.motionBlur = !0), d && (e.motionBlurTimeout = setTimeout(function() {
...
Er.drawSelectionRectangle = function(r, e) {
	...
	if (t.showFps || !s && l[t.SELECT_BOX] && !o) {
		...
		if (e(f), t.selection[4] == 1 && (t.hoverData.selecting || t.touchData.selecting)) {
			var c = t.cy.zoom(), d = i.core("selection-box-border-width").value / c;
		...
		if (n.bgActivePosistion && !t.hoverData.selecting) {
			var c = t.cy.zoom(), g = n.bgActivePosistion;
		...
		if (t.showFps && h) {
			h = Math.round(h);
			var m = Math.round(1e3 / h), p = "1 frame = " + h + " ms = " + m + " fps";
			if (f.setTransform(1, 0, 0, 1, 0, 0), f.fillStyle = "rgba(255, 0, 0, 0.75)", f.strokeStyle = "rgba(255, 0, 0, 0.75)", f.font = "30px Arial", !ga) ga = f.measureText(p).actualBoundingBoxAscent;
			f.fillText(p, 0, ga);
			f.strokeRect(0, ga + 10, 250, 20), f.fillRect(0, ga + 10, 250 * Math.min(m / 60, 1), 20);
		}
		o || (l[t.SELECT_BOX] = !1);
	}
};
...
m(Wl, "compileShader");
function Hy(r, e, t) {
	var a = Wl(r, r.VERTEX_SHADER, e), n = Wl(r, r.FRAGMENT_SHADER, t), i = r.createProgram();
...
function Mf(r, e, t) {
	switch (e) {
		case r.FLOAT: return new Float32Array(t);
		case r.INT: return new Int32Array(t);
	}
}
m(Mf, "createTypedArray");
function Qy(r, e, t, a, n, i) {
	switch (e) {
		case r.FLOAT: return new Float32Array(t.buffer, i * a, n);
		case r.INT: return new Int32Array(t.buffer, i * a, n);
	}
}
m(Qy, "createTypedArrayView");
function Jy(r, e, t, a) {
	var i = je(Rf(r, e), 2), s = i[0], o = i[1], l = Mf(r, o, a), u = r.createBuffer();
...
m(Jy, "createBufferStaticDraw");
function Vr(r, e, t, a) {
	var i = je(Rf(r, t), 3), s = i[0], o = i[1], l = i[2], u = Mf(r, o, e * s), f = s * l, c = r.createBuffer();
	r.bindBuffer(r.ARRAY_BUFFER, c), r.bufferData(r.ARRAY_BUFFER, e * f, r.DYNAMIC_DRAW), r.enableVertexAttribArray(a), o === r.FLOAT ? r.vertexAttribPointer(a, s, o, !1, f, 0) : o === r.INT && r.vertexAttribIPointer(a, s, o, f, 0), r.vertexAttribDivisor(a, 1), r.bindBuffer(r.ARRAY_BUFFER, null);
	for (var d = new Array(e), g = 0; g < e; g++) d[g] = Qy(r, o, u, f, s, g);
...
function jy(r, e, t) {
	...
	for (var u = 0; u < 3; u++) {
		var f = t + u;
		r.enableVertexAttribArray(f), r.vertexAttribPointer(f, 3, r.FLOAT, !1, 36, u * 12), r.vertexAttribDivisor(f, 1);
	}
...
m(jy, "create3x3MatrixBufferDynamicDraw");
function em(r) {
...
m(Ul, "identity");
function rm(r, e, t) {
	var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], l = e[5], u = e[6], f = e[7], c = e[8], d = t[0], g = t[1], h = t[2], m = t[3], p = t[4], y = t[5], b = t[6], w = t[7], x = t[8];
	return r[0] = d * a + g * s + h * u, r[1] = d * n + g * o + h * f, r[2] = d * i + g * l + h * c, r[3] = m * a + p * s + y * u, r[4] = m * n + p * o + y * f, r[5] = m * i + p * l + y * c, r[6] = b * a + w * s + x * u, r[7] = b * n + w * o + x * f, r[8] = b * i + w * l + x * c, r;
}
m(rm, "multiply");
function mn(r, e, t) {
...
m(mn, "translate");
function Kl(r, e, t) {
	var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], l = e[5], u = e[6], f = e[7], c = e[8], d = Math.sin(t), g = Math.cos(t);
...
var am = (function() {
	function r(e, t, a, n) {
		gt(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = !0, this.locked = !1, this.texture = null, this.needsBuffer = !0, this.freePointer = {
			x: 0,
			row: 0
		}, this.keyToLocation = /* @__PURE__ */ new Map(), this.canvas = n(e, t, t), this.scratch = n(e, t, this.texHeight, "scratch");
	}
	return m(r, "Atlas"), pt(r, [
		{
			key: "lock",
			value: m(function() {
				this.locked = !0;
		...
		},
		{
			...
			value: m(function(t, a, n) {
				...
				var s = this.texSize, o = this.texRows, l = this.texHeight, u = this.getScale(a), f = u.scale, c = u.texW, d = u.texH, g = m(function(w, x) {
					if (n && x) {
						var C = x.context, T = w.x, E = w.row, S = T, D = l * E;
						C.save(), C.translate(S, D), C.scale(f, f), n(C, a), C.restore();
					}
				}, "drawAt"), h = [null, null], m$49 = m(function() {
				...
				}, "drawWrapped"), y = m(function() {
					i.freePointer.x = 0, i.freePointer.row++;
				}, "moveToStartOfNextRow");
				if (this.freePointer.x + c <= s) m$49();
				else {
					if (this.freePointer.row >= o - 1) return !1;
					this.freePointer.x === s ? (y(), m$49()) : this.enableWrapping ? p() : (y(), m$49());
				}
		...
		},
		{
			...
			value: m(function(t) {
				...
				var a = this.texSize, n = this.texRows, s = this.getScale(t).texW;
	...
	function r(e, t, a, n) {
		gt(this, r), this.r = e, this.texSize = t, this.texRows = a, this.createTextureCanvas = n, this.atlases = [], this.styleKeyToAtlas = /* @__PURE__ */ new Map(), this.markedKeys = /* @__PURE__ */ new Set();
	}
	return m(r, "AtlasCollection"), pt(r, [
		{
			key: "getKeys",
			value: m(function() {
		...
		},
		{
			...
			value: m(function() {
				...
				var n = [], i = /* @__PURE__ */ new Map(), s = null, o = Dr(this.atlases), l;
				try {
					var u = m(function() {
						var c = l.value, d = c.getKeys(), g = im(a, d);
						...
						try {
							for (h.s(); !(m = h.n()).done;) {
								var p = m.value;
								if (!g.has(p)) {
									var b = je(c.getOffsets(p), 2), w = b[0], x = b[1];
									s.canFit({
										w: w.w + x.w,
										h: w.h
									}) || (s.lock(), s = t._createAtlas(), n.push(s)), c.canvas && (t._copyTextureToNewAtlas(p, c, s), i.set(p, s));
								}
							}
						} catch (C) {
							h.e(C);
		...
		},
		{
			...
			value: m(function(t, a, n) {
				var s = je(a.getOffsets(t), 2), o = s[0], l = s[1];
...
var sm = (function() {
	function r(e, t) {
		gt(this, r), this.r = e, this.globalOptions = t, this.atlasSize = t.webglTexSize, this.maxAtlasesPerBatch = t.webglTexPerBatch, this.renderTypes = /* @__PURE__ */ new Map(), this.collections = /* @__PURE__ */ new Map(), this.typeAndIdToKey = /* @__PURE__ */ new Map();
	}
	return m(r, "AtlasManager"), pt(r, [
		{
			key: "getAtlasSize",
			value: m(function() {
		...
		},
		{
			...
			value: m(function(t, a) {
				var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows, l = this._cacheScratchCanvas(s), u = new nm(this.r, i, o, l);
			...
			value: m(function(t) {
				...
				try {
					for (g.s(); !(h = g.n()).done;) {
						var m$50 = h.value;
						if (l(m$50)) {
							var p = Dr(this.renderTypes.values()), y;
							try {
								var b = m(function() {
									var x = y.value, C = x.type;
									if (f(C)) {
										var T = a.collections.get(x.collection), E = x.getKey(m$50), S = Array.isArray(E) ? E : [E];
										if (s) S.forEach(function(A) {
											return T.markKeyForGC(A);
										}), d = !0;
										else {
											var D = x.getID ? x.getID(m$50) : m$50.id(), B = a._key(C, D), P = a.typeAndIdToKey.get(B);
				...
				return d && (this.gc(), c = !1), c;
			}, "invalidate")
		},
		{
			key: "gc",
			value: m(function() {
				var t = Dr(this.collections.values()), a;
				try {
					for (t.s(); !(a = t.n()).done;) a.value.gc();
				} catch (i) {
					t.e(i);
				} finally {
					t.f();
		...
		},
		{
			...
			value: m(function(t, a, n, i) {
				var s = this.renderTypes.get(a), o = this.collections.get(s.collection), l = !1, u = o.draw(i, n, function(d) {
					s.drawClipped ? (d.save(), d.beginPath(), d.rect(0, 0, n.w, n.h), d.clip(), s.drawElement(d, t, n, !0, !0), d.restore()) : s.drawElement(d, t, n, !0, !0), l = !0;
				});
				if (l) {
					var f = s.getID ? s.getID(t) : t.id(), c = this._key(a, f);
		...
		},
		{
			key: "getAtlasInfo",
			value: m(function(t, a) {
				var n = this, i = this.renderTypes.get(a), s = i.getKey(t);
				return (Array.isArray(s) ? s : [s]).map(function(l) {
					var u = i.getBoundingBox(t, l), f = n.getOrCreateAtlas(t, a, u, l), d = je(f.getOffsets(l), 2), g = d[0];
					return {
						atlas: f,
						tex: g,
						tex1: g,
		...
		},
		{
			key: "getDebugInfo",
			value: m(function() {
				var t = [], a = Dr(this.collections), n;
				try {
					for (a.s(); !(n = a.n()).done;) {
						var i = je(n.value, 2), s = i[0], l = i[1].getCounts(), u = l.keyCount, f = l.atlasCount;
						t.push({
							type: s,
							keyCount: u,
							atlasCount: f
	...
	return m(r, "AtlasBatchManager"), pt(r, [
		{
...
`, Ca = {
	...
	IGNORE: 1,
	USE_BB: 2
}, Ts = 0, Xl = 1, Yl = 2, Ss = 3, Ht = 4, on = 5, pa = 6, ya = 7, cm = (function() {
	function r(e, t, a) {
		gt(this, r), this.r = e, this.gl = t, this.maxInstances = a.webglBatchSize, this.atlasSize = a.webglTexSize, this.bgColor = a.bgColor, this.debug = a.webglDebug, this.batchDebugInfo = [], a.enableWrapping = !0, a.createTextureCanvas = Wy, this.atlasManager = new sm(e, a), this.batchManager = new om(a), this.simpleShapeOptions = /* @__PURE__ */ new Map(), this.program = this._createShaderProgram(Ca.SCREEN), this.pickingProgram = this._createShaderProgram(Ca.PICKING), this.vao = this._createVAO();
	}
	return m(r, "ElementDrawingWebGL"), pt(r, [
		{
			key: "addAtlasCollection",
			value: m(function(t, a) {
		...
		},
		{
			key: "invalidate",
			value: m(function(t) {
				var n = (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}).type, i = this.atlasManager;
				return n ? i.invalidate(t, {
					filterType: m(function(o) {
						return o === n;
					}, "filterType"),
					forceRedraw: !0
				}) : i.invalidate(t);
    ...
    `), i = this.batchManager.getIndexArray(), o = Hy(a, n, `#version 300 es
      precision highp float;
    ...
    `));
				...
				for (var l = 0; l < this.batchManager.getMaxAtlasesPerBatch(); l++) o.uTextures.push(a.getUniformLocation(o, "uTexture".concat(l)));
				return o;
		...
		},
		{
			...
			value: m(function(t, a, n, i) {
				...
				if (n.shapeProps && n.shapeProps.padding && (o = t.pstyle(n.shapeProps.padding).pfValue), i) {
					...
					s || (c = 1 - c);
					var d = this._getAdjustedBB(l, o, s, c);
					this._applyTransformMatrix(a, d, n, t);
				} else {
					var g = n.getBoundingBox(t), h = this._getAdjustedBB(g, o, !0, 1);
		...
		},
		{
			...
			value: m(function(t, a, n, i) {
				...
				if (l !== 0) {
					var u = n.getRotationPoint(i), f = u.x, c = u.y;
					mn(t, t, [f, c]), Kl(t, t, l);
					var d = n.getRotationOffset(i);
					s = d.x + (a.xOffset || 0), o = d.y + (a.yOffset || 0);
				} else s = a.x1, o = a.y1;
				mn(t, t, [s, o]), $s(t, t, [a.w, a.h]);
		...
		},
		{
			...
			value: m(function(t, a, n) {
				...
				Gt(a, this.indexBuffer.getView(s));
				Et([
					0,
					0,
					0
				], 1, this.colorBuffer.getView(s));
			...
			value: m(function(t, a, n) {
				...
				if (this._isVisible(t, i)) {
					...
					if (this.vertTypeBuffer.getView(l)[0] = o, o === on || o === pa) {
						var u = i.getBoundingBox(t), f = this._getCornerRadius(t, s.radius, u), c = this.cornerRadiusBuffer.getView(l);
						c[0] = f, c[1] = f, c[2] = f, c[3] = f, o === pa && (c[0] = 0, c[2] = 0);
					}
					Gt(a, this.indexBuffer.getView(l));
					var g = t.pstyle(s.color).value, h = t.pstyle(s.opacity).value;
					Et(g, h, this.colorBuffer.getView(l));
					var p = this.lineWidthBuffer.getView(l);
					if (p[0] = 0, p[1] = 0, s.border) {
						var y = t.pstyle("border-width").value;
						if (y > 0) {
							var b = t.pstyle("border-color").value, w = t.pstyle("border-opacity").value;
							Et(b, w, this.borderColorBuffer.getView(l));
					...
					var E = this.transformBuffer.getMatrixView(l);
		...
		},
		{
			...
			value: m(function(t, a) {
				switch (t.pstyle(a).value) {
					case "rectangle": return Ht;
					case "ellipse": return ya;
					case "roundrectangle":
					case "round-rectangle": return on;
					case "bottom-round-rectangle": return pa;
					default: return;
				}
			...
			value: m(function(t, a, n) {
				if (t.visible()) {
					...
					if (n === "source" ? (s = i.arrowStartX, o = i.arrowStartY, l = i.srcArrowAngle) : (s = i.arrowEndX, o = i.arrowEndY, l = i.tgtArrowAngle), !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(l) || l == null)) {
						if (t.pstyle(n + "-arrow-shape").value !== "none") {
							var f = t.pstyle(n + "-arrow-color").value, g = t.pstyle("opacity").value * t.pstyle("line-opacity").value, h = t.pstyle("width").pfValue, m = t.pstyle("arrow-scale").value, p = this.r.getArrowWidth(h, m), y = this.instanceCount, b = this.transformBuffer.getMatrixView(y);
							Ul(b), mn(b, b, [s, o]), $s(b, b, [p, p]), Kl(b, b, l), this.vertTypeBuffer.getView(y)[0] = Ss;
							Gt(a, this.indexBuffer.getView(y));
							Et(f, g, this.colorBuffer.getView(y)), this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch();
						}
					}
				}
			}, "drawEdgeArrow")
				...
				if (t.visible()) {
					...
					if (n) {
						...
						if (n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4) {
							...
							Gt(a, this.indexBuffer.getView(f));
							Et(l, u, this.colorBuffer.getView(f));
							...
							Gt(a, this.indexBuffer.getView(p));
							Et(l, u, this.colorBuffer.getView(p));
							var w = this.lineWidthBuffer.getView(p);
							w[0] = o;
							...
							var A = this.pointAPointBBuffer.getView(p);
							A[0] = x, A[1] = C, A[2] = T, A[3] = E;
							var R = this.pointCPointDBuffer.getView(p);
		...
		},
		{
			...
			value: m(function(t, a) {
				...
				for (var n = Array((a + 1) * 2), i = 0; i <= a; i++) if (i == 0) n[0] = t[0], n[1] = t[1];
		...
		},
		{
			...
			value: m(function() {
				...
				if (i !== 0) {
					...
					var o = Dr(this.buffers), l;
					try {
						for (o.s(); !(l = o.n()).done;) l.value.bufferSubData(i);
					} catch (h) {
						o.e(h);
					} finally {
						o.f();
					}
					for (var f = this.batchManager.getAtlases(), c = 0; c < f.length; c++) f[c].bufferIfNeeded(t);
...
Lf.initWebgl = function(r, e) {
	...
	}, "getLabelRotation"), i = m(function(c) {
		return function(d) {
			var g = d.pstyle(c);
			return g && g.value;
		};
	}, "isLabelVisible"), s = m(function(c) {
		return function(d) {
			return d.pstyle("".concat(c, "-opacity")).value > 0;
		};
	}, "isLayerVisible"), o = m(function(c) {
		return c.pstyle("text-events").strValue === "yes" ? Rn.USE_BB : Rn.IGNORE;
	}, "getTexPickingMode"), l = m(function(c) {
		var d = c.position(), g = d.x, h = d.y, m = c.outerWidth(), p = c.outerHeight();
		return {
			w: m,
			h: p,
			x1: g - m / 2,
	...
	t.drawing.addAtlasCollection("node", { texRows: r.webglTexRowsNodes }), t.drawing.addAtlasCollection("label", { texRows: r.webglTexRows }), t.drawing.addTextureAtlasRenderType("node-body", {
		collection: "node",
		...
		collection: "label",
		getTexPickingMode: o,
		getKey: ks(e.getLabelKey, null),
		getBoundingBox: Ds(e.getLabelBox, null),
		drawClipped: !0,
		...
		collection: "label",
		getTexPickingMode: o,
		getKey: ks(e.getSourceLabelKey, "source"),
		getBoundingBox: Ds(e.getSourceLabelBox, "source"),
		drawClipped: !0,
		...
		collection: "label",
		getTexPickingMode: o,
		getKey: ks(e.getTargetLabelKey, "target"),
		getBoundingBox: Ds(e.getTargetLabelBox, "target"),
		drawClipped: !0,
	...
	t.onUpdateEleCalcs(function(f, c) {
		var d = !1;
		c && c.length > 0 && (d |= t.drawing.invalidate(c)), d && u();
	}), hm(t);
};
function dm(r) {
	var e = r.cy.container();
	return sv(e && e.style && e.style.backgroundColor || "white");
}
m(dm, "getBGColor");
function If(r, e) {
	var t = r._private.rscratch;
...
}, "getStyleKeysForLabel"), Ds = m(function(e, t) {
	return function(a, n) {
		var i = e(a);
		if (typeof n == "string") {
			var s = n.indexOf("_");
			if (s > 0) {
				var o = Number(n.substring(s + 1)), l = If(a, t), u = i.h / l.length, f = u * o, c = i.y1 + f;
				return {
					x1: i.x1,
					w: i.w,
					y1: c,
...
function hm(r) {
	...
	r.notify = function(i, s) {
		n.call(r, i, s), i === "viewport" || i === "bounds" ? r.pickingFrameBuffer.needsDraw = !0 : i === "background" && r.drawing.invalidate(s, { type: "node-body" });
	};
}
m(hm, "overrideCanvasRendererFunctions");
function gm(r) {
...
m(pm, "clearCanvas");
function ym(r) {
	var e = r.canvasWidth, t = r.canvasHeight, a = wo(r), n = a.pan, i = a.zoom, s = Cs();
	mn(s, s, [n.x, n.y]), $s(s, s, [i, i]);
	var o = Cs();
	tm(o, e, t);
	var l = Cs();
	return rm(l, o, s), l;
}
m(ym, "createPanZoomMatrix");
function Of(r, e) {
	var t = r.canvasWidth, a = r.canvasHeight, n = wo(r), i = n.pan, s = n.zoom;
	e.setTransform(1, 0, 0, 1, 0, 0), e.clearRect(0, 0, t, a), e.translate(i.x, i.y), e.scale(s, s);
}
m(Of, "setContextTransform");
function mm(r, e) {
	r.drawSelectionRectangle(e, function(t) {
		return Of(r, t);
	});
}
m(mm, "drawSelectionRectangle");
function bm(r) {
...
m(bm, "drawAxes");
function wm(r) {
	var e = m(function(n, i, s) {
		for (var o = n.atlasManager.getAtlasCollection(i), l = r.data.contexts[r.NODE], u = o.atlases, f = 0; f < u.length; f++) {
			var d = u[f].canvas;
			if (d) {
...
function xm(r, e, t, a, n) {
	var i, s, o, l, u = wo(r), f = u.pan, c = u.zoom;
	var g = je(Uy(r, f, c, e, t), 2), h = g[0], m = g[1], p = 6;
	i = h - p / 2, s = m - p / 2, o = p, l = p;
	if (o === 0 || l === 0) return [];
	var y = r.data.contexts[r.WEBGL];
	y.bindFramebuffer(y.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (y.viewport(0, 0, y.canvas.width, y.canvas.height), Nf(r, null, Ca.PICKING), r.pickingFrameBuffer.needsDraw = !1);
	var b = o * l, w = new Uint8Array(b * 4);
	y.readPixels(i, s, o, l, y.RGBA, y.UNSIGNED_BYTE, w), y.bindFramebuffer(y.FRAMEBUFFER, null);
	for (var x = /* @__PURE__ */ new Set(), C = 0; C < b; C++) {
		var E = Yy(w.slice(C * 4, C * 4 + 4)) - 1;
		E >= 0 && x.add(E);
	}
	return x;
}
m(xm, "getPickingIndexes");
function Em(r, e, t) {
	var a = xm(r, e, t), n = r.getCachedZSortedEles(), i, s, o = Dr(a), l;
	try {
		for (o.s(); !(l = o.n()).done;) {
			var f = n[l.value];
...
function Nf(r, e, t) {
	...
	if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && mm(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
		...
		var o = ym(r), l = r.getCachedZSortedEles();
	...
	if (r.webglDebug) {
		var d = performance.now(), g = !1, h = Math.ceil(d - a), m = n.getDebugInfo(), p = [
			"".concat(i, " elements"),
			"".concat(m.totalInstances, " instances"),
			"".concat(m.batchCount, " batches"),
			"".concat(m.totalAtlases, " atlases"),
			"".concat(m.wrappedCount, " wrapped textures"),
			"".concat(m.simpleCount, " simple shapes")
		].join(", ");
		if (g) console.log("WebGL (".concat(t.name, ") - time ").concat(h, "ms, ").concat(p));
		else {
			console.log("WebGL (".concat(t.name, ") - frame time ").concat(h, "ms")), console.log("Totals:"), console.log("  ".concat(p)), console.log("Texture Atlases Used:");
			var y = m.atlasInfo, b = Dr(y), w;
			try {
				for (b.s(); !(w = b.n()).done;) {
					var x = w.value;
...
bt.drawBarrelPath = function(r, e, t, a, n) {
	var i = a / 2, s = n / 2, o = e - i, l = e + i, u = t - s, f = t + s, c = Rs(a, n), d = c.widthOffset, g = c.heightOffset, h = c.ctrlPtOffsetPct * d;
...
var Zl = Math.sin(0), Ql = Math.cos(0), Us = {}, Ks = {}, zf = Math.PI / 40;
for (Ct = 0 * Math.PI; Ct < 2 * Math.PI; Ct += zf) Us[Ct] = Math.sin(Ct), Ks[Ct] = Math.cos(Ct);
var Ct;
...
$a.bufferCanvasImage = function(r) {
	var e = this.cy, a = e.mutableElements().boundingBox(), n = this.findContainerClientCoords(), i = r.full ? Math.ceil(a.w) : n[2], s = r.full ? Math.ceil(a.h) : n[3], o = ne(r.maxWidth) || ne(r.maxHeight), l = this.getPixelRatio(), u = 1;
	if (r.scale !== void 0) i *= r.scale, s *= r.scale, u = r.scale;
	else if (o) {
		var f = Infinity, c = Infinity;
		ne(r.maxWidth) && (f = u * r.maxWidth / i), ne(r.maxHeight) && (c = u * r.maxHeight / s), u = Math.min(f, c), i *= u, s *= u;
	}
	o || (i *= l, s *= l, u *= l);
	...
	if (i > 0 && s > 0) {
		...
		if (r.full) g.translate(-a.x1 * u, -a.y1 * u), g.scale(u, u), this.drawElements(g, h), g.scale(1 / u, 1 / u), g.translate(a.x1 * u, a.y1 * u);
			...
			u *= e.zoom(), g.translate(p.x, p.y), g.scale(u, u), this.drawElements(g, h), g.scale(1 / u, 1 / u), g.translate(-p.x, -p.y);
		}
...
function Cm(r, e) {
	for (var t = atob(r), a = new ArrayBuffer(t.length), n = new Uint8Array(a), i = 0; i < t.length; i++) n[i] = t.charCodeAt(i);
...
function Ff(r, e, t) {
	...
	switch (r.output) {
		case "blob-promise": return new aa(function(n, i) {
			try {
				e.toBlob(function(s) {
					s != null ? n(s) : i(/* @__PURE__ */ new Error("`canvas.toBlob()` sent a null value in its callback"));
				}, t, r.quality);
			} catch (s) {
				i(s);
			}
		});
		case "blob": return Cm(Jl(a()), t);
		case "base64": return Jl(a());
		default: return a();
	}
}
m(Ff, "output");
...
Vf.nodeShapeImpl = function(r, e, t, a, n, i, s, o) {
	switch (r) {
		case "ellipse": return this.drawEllipsePath(e, t, a, n, i);
		case "polygon": return this.drawPolygonPath(e, t, a, n, i, s);
		case "round-polygon": return this.drawRoundPolygonPath(e, t, a, n, i, s, o);
		case "roundrectangle":
		case "round-rectangle": return this.drawRoundRectanglePath(e, t, a, n, i, o);
		case "cutrectangle":
		case "cut-rectangle": return this.drawCutRectanglePath(e, t, a, n, i, s, o);
		case "bottomroundrectangle":
		case "bottom-round-rectangle": return this.drawBottomRoundRectanglePath(e, t, a, n, i, o);
		case "barrel": return this.drawBarrelPath(e, t, a, n, i);
	}
};
...
function qf(r) {
	var e = this, a = e.cy.window().document;
	...
	for (var u = 0; u < De.CANVAS_LAYERS; u++) {
		var f = e.data.canvases[u] = a.createElement("canvas"), c = De.CANVAS_TYPES[u];
		e.data.contexts[u] = f.getContext(c), e.data.contexts[u] || Ue("Could not create canvas of type " + c), Object.keys(l).forEach(function(j) {
			f.style[j] = l[j];
		}), f.style.position = "absolute", f.setAttribute("data-id", "layer" + u), f.style.zIndex = String(De.CANVAS_LAYERS - u), e.data.canvasContainer.appendChild(f), e.data.canvasNeedsRedraw[u] = !1;
	}
	...
	for (var u = 0; u < De.BUFFER_COUNT; u++) e.data.bufferCanvases[u] = a.createElement("canvas"), e.data.bufferContexts[u] = e.data.bufferCanvases[u].getContext("2d"), e.data.bufferCanvases[u].style.position = "absolute", e.data.bufferCanvases[u].setAttribute("data-id", "buffer" + u), e.data.bufferCanvases[u].style.zIndex = String(-u - 1), e.data.bufferCanvases[u].style.visibility = "hidden";
	e.pathsEnabled = !0;
	var d = xr(), g = m(function(F) {
		return {
			x: (F.x1 + F.x2) / 2,
			y: (F.y1 + F.y2) / 2
		};
	}, "getBoxCenter"), h = m(function(F) {
		return {
			x: -F.w / 2,
			y: -F.h / 2
		};
	}, "getCenterOffset"), m$51 = m(function(F) {
		var _ = F[0]._private;
		return !(_.oldBackgroundTimestamp === _.backgroundTimestamp);
	}, "backgroundTimestampHasChanged"), p = m(function(F) {
		return F[0]._private.nodeKey;
	}, "getStyleKey"), y = m(function(F) {
		return F[0]._private.labelStyleKey;
	}, "getLabelKey"), b = m(function(F) {
		return F[0]._private.sourceLabelStyleKey;
	}, "getSourceLabelKey"), w = m(function(F) {
		return F[0]._private.targetLabelStyleKey;
	}, "getTargetLabelKey"), x = m(function(F, _, W, Z, ae) {
		return e.drawElement(F, _, W, !1, !1, ae);
	}, "drawElement"), C = m(function(F, _, W, Z, ae) {
		return e.drawElementText(F, _, W, Z, "main", ae);
	}, "drawLabel"), T = m(function(F, _, W, Z, ae) {
		return e.drawElementText(F, _, W, Z, "source", ae);
	}, "drawSourceLabel"), E = m(function(F, _, W, Z, ae) {
		return e.drawElementText(F, _, W, Z, "target", ae);
	}, "drawTargetLabel"), S = m(function(F) {
		return F.boundingBox(), F[0]._private.bodyBounds;
	}, "getElementBox"), D = m(function(F) {
		return F.boundingBox(), F[0]._private.labelBounds.main || d;
	}, "getLabelBox"), B = m(function(F) {
		return F.boundingBox(), F[0]._private.labelBounds.source || d;
	}, "getSourceLabelBox"), P = m(function(F) {
		return F.boundingBox(), F[0]._private.labelBounds.target || d;
	}, "getTargetLabelBox"), A = m(function(F, _) {
		return _;
	}, "isLabelVisibleAtScale"), R = m(function(F) {
		return g(S(F));
	}, "getElementRotationPoint"), M = m(function(F, _, W) {
		var Z = F ? F + "-" : "";
		return {
			x: _.x + W.pstyle(Z + "text-margin-x").pfValue,
			y: _.y + W.pstyle(Z + "text-margin-y").pfValue
		};
	}, "addTextMargin"), I = m(function(F, _, W) {
		var Z = F[0]._private.rscratch;
		return {
			x: Z[_],
			y: Z[W]
		};
	}, "getRsPt"), O = m(function(F) {
		return M("", I(F, "labelX", "labelY"), F);
	}, "getLabelRotationPoint"), L = m(function(F) {
		return M("source", I(F, "sourceLabelX", "sourceLabelY"), F);
	}, "getSourceLabelRotationPoint"), N = m(function(F) {
		return M("target", I(F, "targetLabelX", "targetLabelY"), F);
	}, "getTargetLabelRotationPoint"), q = m(function(F) {
		return h(S(F));
	}, "getElementRotationOffset"), H = m(function(F) {
		return h(B(F));
	}, "getSourceLabelRotationOffset"), z = m(function(F) {
		return h(P(F));
	}, "getTargetLabelRotationOffset"), V = m(function(F) {
		var _ = D(F), W = h(D(F));
		if (F.isNode()) {
	...
	e.onUpdateEleCalcs(m(function(F, _) {
...
De.makeOffscreenCanvas = function(r, e) {
	...
	else t = this.cy.window().document.createElement("canvas"), t.width = r, t.height = e;
	return t;
};
[
	Bf,
...
function Hf(r, e, t) {
	...
	if (r === "core") {
		...
		}, "Layout"), s = i.prototype = Object.create(t.prototype), o = [], l = 0; l < o.length; l++) {
			var u = o[l];
			s[u] = s[u] || function() {
				return this;
			};
		...
		var g = Wf("renderer", "base"), h = g.prototype, m$52 = t, p = t.prototype, y = m(function() {
			g.apply(this, arguments), m$52.apply(this, arguments);
		}, "Renderer"), b = y.prototype;
		for (var w in h) {
			var x = h[w];
			if (p[w] != null) return n(w);
			b[w] = x;
		}
		for (var T in p) b[T] = p[T];
...
Lt.css = function(r, e) {
	...
	else if (Ie(r)) for (var a = r, n = Object.keys(a), i = 0; i < n.length; i++) {
		var s = n[i], o = a[s];
		if (o != null) {
