...
import { V as ia, q as pt$1 } from "./chunk-7W6UQGC5-C150Mc68.js";
import { t as ra } from "./chunk-3SSMPTDK-CCu6Z1BJ.js";
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/cose-bilkent-UX7MHV2Q.mjs
var q = n((k, K) => {
	"use strict";
	m((function(M, v) {
		typeof k == "object" && typeof K == "object" ? K.exports = v() : typeof define == "function" && define.amd ? define([], v) : typeof k == "object" ? k.layoutBase = v() : M.layoutBase = v();
		...
		return (function(m$1) {
			...
			function v(n) {
				...
				return m$1[n].call(e.exports, e, e.exports, v), e.l = !0, e.exports;
			}
			return m(v, "__webpack_require__"), v.m = m$1, v.c = M, v.i = function(n) {
				return n;
			}, v.d = function(n, e, t) {
				...
				var e = n && n.__esModule ? m(function() {
					return n.default;
			...
			(function(m$2, M, v) {
				"use strict";
				function n() {}
				m(n, "LayoutConstants"), n.QUALITY = 1, n.DEFAULT_CREATE_BENDS_AS_NEEDED = !1, n.DEFAULT_INCREMENTAL = !1, n.DEFAULT_ANIMATION_ON_LAYOUT = !0, n.DEFAULT_ANIMATION_DURING_LAYOUT = !1, n.DEFAULT_ANIMATION_PERIOD = 50, n.DEFAULT_UNIFORM_LEAF_NODE_SIZES = !1, n.DEFAULT_GRAPH_MARGIN = 15, n.NODE_DIMENSIONS_INCLUDE_LABELS = !1, n.SIMPLE_NODE_SIZE = 40, n.SIMPLE_NODE_HALF_SIZE = n.SIMPLE_NODE_SIZE / 2, n.EMPTY_COMPOUND_NODE_SIZE = 40, n.MIN_EDGE_LENGTH = 1, n.WORLD_BOUNDARY = 1e6, n.INITIAL_WORLD_BOUNDARY = n.WORLD_BOUNDARY / 1e3, n.WORLD_CENTER_X = 1200, n.WORLD_CENTER_Y = 900, m$2.exports = n;
			}),
			(function(m$3, M, v) {
				"use strict";
				var n = v(2), e = v(8), t = v(9);
				function r(u, o, p) {
					n.call(this, p), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = p, this.bendpoints = [], this.source = u, this.target = o;
				}
				m(r, "LEdge"), r.prototype = Object.create(n.prototype);
				...
				r.prototype.getSource = function() {
					...
					for (var p = this.getOtherEnd(u), i = o.getGraphManager().getRoot();;) {
			...
			(function(m$4, M, v) {
				...
				m(n, "LGraphObject"), m$4.exports = n;
			}),
			(function(m$5, M, v) {
				"use strict";
				...
				m(o, "LNode"), o.prototype = Object.create(n.prototype);
				...
				o.prototype.getEdges = function() {
					...
					if (i.add(this), this.child != null) for (var d = this.child.getNodes(), y = 0; y < d.length; y++) h = d[y], l = h.withChildren(), l.forEach(function(T) {
						i.add(T);
					});
					return i;
					...
					else for (var l = this.child.getNodes(), d = 0; d < l.length; d++) h = l[d], i += h.getNoOfChildren();
					return i == 0 && (i = 1), i;
			...
			(function(m$6, M, v) {
				...
				m(n, "PointD"), n.prototype.getX = function() {
					return this.x;
			...
			(function(m$7, M, v) {
				"use strict";
				var n = v(2), e = v(10), t = v(0), r = v(6), a = v(3), u = v(1), o = v(13), p = v(12), i = v(11);
				function h(d, y, T) {
				...
				m(h, "LGraph"), h.prototype = Object.create(n.prototype);
				for (var l in n) h[l] = n[l];
				h.prototype.getNodes = function() {
					...
					if (d instanceof a) {
						...
						for (var T = y.edges.slice(), c, D = T.length, E = 0; E < D; E++) c = T[E], c.isInterGraph ? this.graphManager.remove(c) : c.source.owner.remove(c);
						...
						var s = c.source.edges.indexOf(c), g = c.target.edges.indexOf(c);
					...
					for (var d = e.MAX_VALUE, y = e.MAX_VALUE, T, c, D, E = this.getNodes(), O = E.length, s = 0; s < O; s++) {
						var g = E[s];
					...
					for (var y = e.MAX_VALUE, T = -e.MAX_VALUE, c = e.MAX_VALUE, D = -e.MAX_VALUE, E, O, s, g, f, L = this.nodes, N = L.length, I = 0; I < N; I++) {
						var R = L[I];
						d && R.child != null && R.updateBounds(), E = R.getLeft(), O = R.getRight(), s = R.getTop(), g = R.getBottom(), y > E && (y = E), T < O && (T = O), c > s && (c = s), D < g && (D = g);
					}
					var C = new o(y, c, T - y, D - c);
					y == e.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), L[0].getParent().paddingLeft != null ? f = L[0].getParent().paddingLeft : f = this.margin, this.left = C.x - f, this.right = C.x + C.width + f, this.top = C.y - f, this.bottom = C.y + C.height + f;
				}, h.calculateBounds = function(d) {
					for (var y = e.MAX_VALUE, T = -e.MAX_VALUE, c = e.MAX_VALUE, D = -e.MAX_VALUE, E, O, s, g, f = d.length, L = 0; L < f; L++) {
						var N = d[L];
						E = N.getLeft(), O = N.getRight(), s = N.getTop(), g = N.getBottom(), y > E && (y = E), T < O && (T = O), c > s && (c = s), D < g && (D = g);
					}
					...
					for (c.withChildren().forEach(function(I) {
						...
						for (var s = D.length, g = 0; g < s; g++) if (E = D[g].getOtherEndInGraph(c, this), E != null && !T.has(E)) E.withChildren().forEach(function(I) {
							y.push(I), T.add(I);
						});
					}
			...
			(function(m$8, M, v) {
				...
				m(t, "LGraphManager"), t.prototype.addRoot = function() {
					...
					if (r instanceof n) {
						...
						var d = o.source.edges.indexOf(o);
						if (o.source.edges.splice(d, 1), d = o.target.edges.indexOf(o), o.target.edges.splice(d, 1), !(o.source.owner != null && o.source.owner.getGraphManager() != null)) throw "Edge owner graph or owner graph manager is null!";
						if (o.source.owner.getGraphManager().edges.indexOf(o) == -1) throw "Not in owner graph manager's edge list!";
						var d = o.source.owner.getGraphManager().edges.indexOf(o);
					...
					if (this.allNodes == null) {
						for (var r = [], a = this.getGraphs(), u = a.length, o = 0; o < u; o++) r = r.concat(a[o].getNodes());
						this.allNodes = r;
					}
					...
					if (this.allEdges == null) {
						for (var r = [], a = this.getGraphs(), u = a.length, o = 0; o < a.length; o++) r = r.concat(a[o].getEdges());
					...
					this.rootGraph = r, r.parent ??= this.layout.newNode("Root node");
					...
					var u = r.getOwner(), o;
					do {
						if (o = u.getParent(), o == null) break;
						if (o == a) return !0;
						if (u = o.getOwner(), u == null) break;
					} while (!0);
					u = a.getOwner();
					do {
						if (o = u.getParent(), o == null) break;
					...
					for (var r, a, u, o, p, i = this.getAllEdges(), h = i.length, l = 0; l < h; l++) {
						...
						for (o = a.getOwner(); r.lca == null;) {
							...
							r.lca ?? (r.sourceInLca = o.getParent(), o = r.sourceInLca.getOwner());
						}
						if (r.lca == null) throw "assert failed";
					}
					...
					for (var u, o = r.getNodes(), p = o.length, i = 0; i < p; i++) u = o[i], u.inclusionTreeDepth = a, u.child != null && this.calcInclusionTreeDepths(u.child, a + 1);
			...
			(function(m$10, M, v) {
				...
				m(e, "IGeometry"), e.calcSeparationAmount = function(t, r, a, u) {
					...
					var o = new Array(2);
					this.decideDirectionsForOverlappingNodes(t, r, o), a[0] = Math.min(t.getRight(), r.getRight()) - Math.max(t.x, r.x), a[1] = Math.min(t.getBottom(), r.getBottom()) - Math.max(t.y, r.y), t.getX() <= r.getX() && t.getRight() >= r.getRight() ? a[0] += Math.min(r.getX() - t.getX(), t.getRight() - r.getRight()) : r.getX() <= t.getX() && r.getRight() >= t.getRight() && (a[0] += Math.min(t.getX() - r.getX(), r.getRight() - t.getRight())), t.getY() <= r.getY() && t.getBottom() >= r.getBottom() ? a[1] += Math.min(r.getY() - t.getY(), t.getBottom() - r.getBottom()) : r.getY() <= t.getY() && r.getBottom() >= t.getBottom() && (a[1] += Math.min(t.getY() - r.getY(), r.getBottom() - t.getBottom()));
					...
					var u = t.getCenterX(), o = t.getCenterY(), p = r.getCenterX(), i = r.getCenterY();
					if (t.intersects(r)) return a[0] = u, a[1] = o, a[2] = p, a[3] = i, !0;
					var h = t.getX(), l = t.getY(), d = t.getRight(), y = t.getX(), T = t.getBottom(), c = t.getRight(), D = t.getWidthHalf(), E = t.getHeightHalf(), O = r.getX(), s = r.getY(), g = r.getRight(), f = r.getX(), L = r.getBottom(), N = r.getRight(), I = r.getWidthHalf(), R = r.getHeightHalf(), C = !1, G = !1;
					if (u === p) {
						...
						if (u > p ? o > i ? (w = this.getCardinalDirection(S, F, 4), x = this.getCardinalDirection(_, F, 2)) : (w = this.getCardinalDirection(-S, F, 3), x = this.getCardinalDirection(-_, F, 1)) : o > i ? (w = this.getCardinalDirection(-S, F, 1), x = this.getCardinalDirection(-_, F, 3)) : (w = this.getCardinalDirection(S, F, 2), x = this.getCardinalDirection(_, F, 4)), !C) switch (w) {
							case 1:
					...
					return E = h - p, s = o - i, f = i * p - o * h, O = T - d, g = l - y, L = y * d - l * T, N = E * g - O * s, N === 0 ? null : (c = (s * L - g * f) / N, D = (O * f - E * L) / N, new n(c, D));
				}, e.angleOfVector = function(t, r, a, u) {
					var o = void 0;
					return t !== a ? (o = Math.atan((u - r) / (a - t)), a < t ? o += Math.PI : u < r && (o += this.TWO_PI)) : u < r ? o = this.ONE_AND_HALF_PI : o = this.HALF_PI, o;
				...
				}, e.HALF_PI = .5 * Math.PI, e.ONE_AND_HALF_PI = 1.5 * Math.PI, e.TWO_PI = 2 * Math.PI, e.THREE_PI = 3 * Math.PI, m$10.exports = e;
			}),
			(function(m$11, M, v) {
				"use strict";
				function n() {}
				m(n, "IMath"), n.sign = function(e) {
			...
			(function(m$12, M, v) {
				"use strict";
				function n() {}
				m(n, "Integer"), n.MAX_VALUE = 2147483647, n.MIN_VALUE = -2147483648, m$12.exports = n;
			}),
			(function(m$13, M, v) {
				"use strict";
				var n = (function() {
			...
			(function(m$14, M, v) {
				...
				m(n, "Point"), n.prototype.getX = function() {
					return this.x;
				}, n.prototype.getY = function() {
					return this.y;
					...
					e.constructor.name == "Point" && t == null && r == null ? (r = e, this.setLocation(r.x, r.y)) : typeof e == "number" && typeof t == "number" && r == null && (parseInt(e) == e && parseInt(t) == t ? this.move(e, t) : (this.x = Math.floor(e + .5), this.y = Math.floor(t + .5)));
			...
			(function(m$15, M, v) {
				...
				m(n, "RectangleD"), n.prototype.getX = function() {
					return this.x;
				}, n.prototype.setX = function(e) {
					this.x = e;
				}, n.prototype.getY = function() {
			...
			(function(m$16, M, v) {
				...
				m(e, "UniqueIDGeneretor"), e.lastID = 0, e.createID = function(t) {
					return e.isPrimitive(t) ? t : (t.uniqueID ?? (t.uniqueID = e.getString(), e.lastID++), t.uniqueID);
			...
			(function(m$17, M, v) {
				...
				function n(l) {
					if (Array.isArray(l)) {
						for (var d = 0, y = Array(l.length); d < l.length; d++) y[d] = l[d];
						return y;
					} else return Array.from(l);
				}
				m(n, "_toConsumableArray");
				var e = v(0), t = v(6), r = v(3), a = v(1), u = v(5), o = v(4), p = v(17), i = v(27);
				function h(l) {
				...
				m(h, "Layout"), h.RANDOM_SEED = 1, h.prototype = Object.create(i.prototype), h.prototype.getGraphManager = function() {
					return this.graphManager;
					...
					if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
						for (var d = this.graphManager.getAllEdges(), y = 0; y < d.length; y++) d[y];
						for (var c = this.graphManager.getRoot().getNodes(), y = 0; y < c.length; y++) c[y];
					...
					if (l == null) this.update2();
						...
						var d = l;
						if (d.getChild() != null) for (var y = d.getChild().getNodes(), T = 0; T < y.length; T++) update(y[T]);
					...
					if (l == null) this.transform(new o(0, 0));
						...
						if (y != null) {
							...
							for (var T = this.getAllNodes(), c, D = 0; D < T.length; D++) c = T[D], c.transform(d);
						}
					}
					...
					else for (var d, y, T = l.getNodes(), c = 0; c < T.length; c++) d = T[c], y = d.getChild(), y == null || y.getNodes().length == 0 ? d.scatter() : (this.positionNodesRandomly(y), d.updateBounds());
				}, h.prototype.getFlatForest = function() {
					for (var l = [], d = !0, y = this.graphManager.getRoot().getNodes(), T = !0, c = 0; c < y.length; c++) y[c].getChild() != null && (T = !1);
					if (!T) return l;
					var D = /* @__PURE__ */ new Set(), E = [], O = /* @__PURE__ */ new Map(), s = [];
					for (s = s.concat(y); s.length > 0 && d;) {
					...
					for (var d = 0; d < l.length; d++) {
						...
						if (y.bendpoints.length > 0) {
							for (var T = this.edgeToDummyNodes.get(y), c = 0; c < T.length; c++) {
								var D = T[c], E = new o(D.getCenterX(), D.getCenterY()), O = y.bendpoints.get(c);
			...
			(function(m$18, M, v) {
				"use strict";
				function n() {}
				m(n, "RandomSeed"), n.seed = 1, n.x = 0, n.nextDouble = function() {
			...
			(function(m$20, M, v) {
				...
				function n(i) {
					if (Array.isArray(i)) {
						for (var h = 0, l = Array(i.length); h < i.length; h++) l[h] = i[h];
						return l;
				...
				m(o, "FDLayout"), o.prototype = Object.create(e.prototype);
				...
				o.prototype.initParameters = function() {
					...
					for (var i = this.getAllEdges(), h, l = 0; l < i.length; l++) h = i[l], this.calcSpringForce(h, h.idealLength);
					...
					for (var i, h = this.getAllNodesToApplyGravitation(), l = 0; l < h.length; l++) i = h[l], this.calcGravitationalForce(i);
				}, o.prototype.moveNodes = function() {
					for (var i = this.getAllNodes(), h, l = 0; l < i.length; l++) h = i[l], h.move();
					...
					var l = i.getRect(), d = h.getRect(), y = new Array(2), T = new Array(4), c, D, E, O, s, g, f;
					if (l.intersects(d)) {
					...
					for (var i, h = this.graphManager.getAllNodes(), l = 0; l < h.length; l++) i = h[l], i.noOfChildren = i.getNoOfChildren();
					...
					for (this.grid = this.calcGrid(this.graphManager.getRoot()), i = 0; i < l.length; i++) h = l[i], this.addNodeToGrid(h, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
			...
			(function(m$21, M, v) {
				...
				var n = v(1), e = v(7);
				function t(a, u, o) {
					n.call(this, a, u, o), this.idealLength = e.DEFAULT_EDGE_LENGTH;
				}
				m(t, "FDLayoutEdge"), t.prototype = Object.create(n.prototype);
			...
			(function(m$22, M, v) {
				...
				var n = v(3);
				function e(r, a, u, o) {
					n.call(this, r, a, u, o), this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
				}
				m(e, "FDLayoutNode"), e.prototype = Object.create(n.prototype);
				for (var t in n) e[t] = n[t];
			...
			(function(m$23, M, v) {
				...
				m(n, "DimensionD"), n.prototype.getWidth = function() {
					return this.width;
				}, n.prototype.setWidth = function(e) {
					this.width = e;
				}, n.prototype.getHeight = function() {
			...
			(function(m$25, M, v) {
				...
				m(e, "HashSet"), e.prototype.add = function(t) {
					...
					for (var r = Object.keys(this.set), a = r.length, u = 0; u < a; u++) t.push(this.set[r[u]]);
				}, e.prototype.size = function() {
					return Object.keys(this.set).length;
			...
			(function(m$26, M, v) {
				...
				m$26.exports = (function() {
					...
					return m(a, "Quicksort"), n(a, [
						{
							key: "_quicksort",
							value: m(function(o, p, i) {
								if (p < i) {
									var h = this._partition(o, p, i);
						...
						},
						{
							key: "_partition",
							value: m(function(o, p, i) {
								for (var h = this._get(o, p), l = p, d = i;;) {
									for (; this.compareFunction(h, this._get(o, d));) d--;
									for (; this.compareFunction(this._get(o, l), h);) l++;
						...
						},
						{
							...
							value: m(function(o, p, i) {
								var h = this._get(o, p);
								this._set(o, p, this._get(o, i)), this._set(o, i, h);
							}, "_swap")
						},
						{
			...
			(function(m$27, M, v) {
				...
				m$27.exports = (function() {
					...
					return m(r, "NeedlemanWunsch"), n(r, [
						{
							key: "getScore",
							value: m(function() {
								return this.score;
						...
						{
							key: "getAllIndexes",
							value: m(function(u, o) {
								for (var p = [], i = -1; (i = u.indexOf(o, i + 1)) !== -1;) p.push(i);
								return p;
							}, "getAllIndexes")
						},
						{
...
var J = n((Z, z) => {
	"use strict";
	m((function(M, v) {
		typeof Z == "object" && typeof z == "object" ? z.exports = v(q()) : typeof define == "function" && define.amd ? define(["layout-base"], v) : typeof Z == "object" ? Z.coseBase = v(q()) : M.coseBase = v(M.layoutBase);
	}), "webpackUniversalModuleDefinition")(Z, function(m$30) {
		return (function(M) {
			var v = {};
			function n(e) {
				...
				return M[e].call(t.exports, t, t.exports, n), t.l = !0, t.exports;
			}
			return m(n, "__webpack_require__"), n.m = M, n.c = v, n.i = function(e) {
				return e;
			}, n.d = function(e, t, r) {
			...
			(function(M, v, n) {
				...
				m(t, "CoSEEdge"), t.prototype = Object.create(e.prototype);
				for (var r in e) t[r] = e[r];
				M.exports = t;
			}),
			(function(M, v, n) {
				...
				m(t, "CoSEGraph"), t.prototype = Object.create(e.prototype);
				for (var r in e) t[r] = e[r];
				M.exports = t;
			}),
			(function(M, v, n) {
				...
				m(t, "CoSEGraphManager"), t.prototype = Object.create(e.prototype);
				for (var r in e) t[r] = e[r];
				M.exports = t;
			}),
			(function(M, v, n) {
				...
				m(r, "CoSENode"), r.prototype = Object.create(e.prototype);
				...
				r.prototype.move = function() {
					...
					for (var p = this.getChild().getNodes(), i, h = 0; h < p.length; h++) i = p[h], i.getChild() == null ? (i.moveBy(u, o), i.displacementX += u, i.displacementY += o) : i.propogateDisplacementToChildren(u, o);
			...
			(function(M, v, n) {
				"use strict";
				var e = n(0).FDLayout, t = n(4), r = n(3), a = n(5), u = n(2), o = n(1), p = n(0).FDLayoutConstants, i = n(0).LayoutConstants, h = n(0).Point, l = n(0).PointD, d = n(0).Layout, y = n(0).Integer, T = n(0).IGeometry, c = n(0).LGraph, D = n(0).Transform;
				function E() {
					e.call(this), this.toBeTiled = {};
				}
				m(E, "CoSELayout"), E.prototype = Object.create(e.prototype);
				...
				E.prototype.newGraphManager = function() {
					...
					if (this.isTreeGrowing) {
						if (this.growTreeIterations % 10 == 0) if (this.prunedNodesAll.length > 0) {
							...
							var s = new Set(this.getAllNodes()), g = this.nodesWithGravity.filter(function(N) {
								return s.has(N);
							});
					...
					for (var s = this.graphManager.getAllNodes(), g = {}, f = 0; f < s.length; f++) {
					...
					var s = [], g, f = this.graphManager.getGraphs(), L = f.length, N;
					for (N = 0; N < L; N++) g = f[N], g.updateConnected(), g.isConnected || (s = s.concat(g.getNodes()));
					return s;
					...
					for (f = 0; f < s.length; f++) {
						var L = s[f];
						if (!g.has(L)) {
							var N = L.getSource(), I = L.getTarget();
							if (N == I) L.getBendpoints().push(new l()), L.getBendpoints().push(new l()), this.createDummyNodesForBendpoints(L), g.add(L);
							else {
								var R = [];
								if (R = R.concat(N.getEdgeListToNode(I)), R = R.concat(I.getEdgeListToNode(N)), !g.has(R[0])) {
									if (R.length > 1) {
										var C;
					...
					for (var g = new h(0, 0), f = Math.ceil(Math.sqrt(s.length)), L = 0, N = 0, I = 0, R = new l(0, 0), C = 0; C < s.length; C++) {
						C % f == 0 && (I = 0, N = L, C != 0 && (N += o.DEFAULT_COMPONENT_SEPERATION), L = 0);
						var G = s[C], S = d.findCenterOfTree(G);
						g.x = I, g.y = N, R = E.radialLayout(G, S, g), R.y > L && (L = Math.floor(R.y)), I = Math.floor(R.x + o.DEFAULT_COMPONENT_SEPERATION);
					}
					this.transform(new l(i.WORLD_CENTER_X - R.x / 2, i.WORLD_CENTER_Y - R.y / 2));
				}, E.radialLayout = function(s, g, f) {
					var L = Math.max(this.maxDiagonalInTree(s), o.DEFAULT_RADIAL_SEPARATION);
					E.branchRadialLayout(g, null, 0, 359, 0, L);
					var N = c.calculateBounds(s), I = new D();
					I.setDeviceOrgX(N.getMinX()), I.setDeviceOrgY(N.getMinY()), I.setWorldOrgX(f.x), I.setWorldOrgY(f.y);
					...
					var x = w.length;
					g != null && x--;
					for (var P = 0, Y = w.length, X, U = s.getEdgesBetween(g); U.length > 1;) {
						var b = U[0];
						U.splice(0, 1);
						var V = w.indexOf(b);
					...
					Object.keys(g).forEach(function(G) {
						if (g[G].length > 1) {
							...
							var w = s.getGraphManager().add(s.newGraph(), F), x = _.getChild();
							x.add(F);
					...
					for (var f = 0; f < this.compoundOrder.length; f++) g[this.compoundOrder[f].id] = this.compoundOrder[f], s[this.compoundOrder[f].id] = [].concat(this.compoundOrder[f].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[f].getChild()), this.compoundOrder[f].child = null;
					...
					Object.keys(this.memberGroups).forEach(function(f) {
						...
						g[f] = s.tileNodes(s.memberGroups[f], L.paddingLeft + L.paddingRight), L.rect.width = g[f].width, L.rect.height = g[f].height;
					});
					...
					for (var L = f.getNodes(), N = 0; N < L.length; N++) {
						var I = L[N];
					...
					for (var g = s.id, f = s.getEdges(), L = 0, N = 0; N < f.length; N++) {
						var I = f[N];
						I.getSource().id !== I.getTarget().id && (L = L + 1);
					}
					return L;
				}, E.prototype.getNodeDegreeWithChildren = function(s) {
					var g = this.getNodeDegree(s);
					if (s.getChild() == null) return g;
					for (var f = s.getChild().getNodes(), L = 0; L < f.length; L++) {
						var N = f[L];
						g += this.getNodeDegreeWithChildren(N);
					}
					return g;
					...
					this.tiledMemberPack = [], Object.keys(s).forEach(function(L) {
						var N = g[L];
						f.tiledMemberPack[L] = f.tileNodes(s[L], N.paddingLeft + N.paddingRight), N.rect.width = f.tiledMemberPack[L].width, N.rect.height = f.tiledMemberPack[L].height;
					});
					...
					for (var I = 0; I < s.length; I++) {
						var R = s[I];
						N.rows.length == 0 ? this.insertNodeToRow(N, R, 0, g) : this.canAddHorizontal(N, R.rect.width, R.rect.height) ? this.insertNodeToRow(N, R, this.getShortestRowIndex(N), g) : this.insertNodeToRow(N, R, N.rows.length, g), this.shiftToLastRow(N);
					}
					return N;
					...
					var g = this.getLongestRowIndex(s), f = s.rowWidth.length - 1, L = s.rows[g], N = L[L.length - 1], I = N.width + s.horizontalPadding;
					...
					for (var s = [], g = !0, f; g;) {
						var L = this.graphManager.getAllNodes(), N = [];
						g = !1;
			...
			(function(M, v, n) {
				"use strict";
				var e = {};
				e.layoutBase = n(0), e.CoSEConstants = n(1), e.CoSEEdge = n(2), e.CoSEGraph = n(3), e.CoSEGraphManager = n(4), e.CoSELayout = n(6), e.CoSENode = n(5), M.exports = e;
			})
		]);
	});
});
var ot = p(n((j, tt) => {
	"use strict";
	m((function(M, v) {
		typeof j == "object" && typeof tt == "object" ? tt.exports = v(J()) : typeof define == "function" && define.amd ? define(["cose-base"], v) : typeof j == "object" ? j.cytoscapeCoseBilkent = v(J()) : M.cytoscapeCoseBilkent = v(M.coseBase);
	}), "webpackUniversalModuleDefinition")(j, function(m$31) {
		return (function(M) {
			var v = {};
			function n(e) {
				if (v[e]) return v[e].exports;
			...
			"use strict";
			var e = n(0).layoutBase.LayoutConstants, t = n(0).layoutBase.FDLayoutConstants, r = n(0).CoSEConstants, a = n(0).CoSELayout, u = n(0).CoSENode, o = n(0).layoutBase.PointD, p = n(0).layoutBase.DimensionD, i = {
			...
			l.prototype.run = function() {
				...
				for (var N = 0; N < L.length; N++) {
					...
					if (R !== C && R.getEdgesBetween(C).length == 0) {
						var G = g.add(O.newEdge(), R, C);
						G.id = I.id();
					}
				}
				var S = m(function(w, x) {
					typeof w == "number" && (w = x);
					var P = w.data("id"), Y = s.idToLNode[P];
					return {
						x: Y.getRect().getCenterX(),
						y: Y.getRect().getCenterY()
					};
				}, "getPositions"), _ = m(function F() {
					for (var w = m(function() {
					...
					var X = s.layout.getPositionsData();
					D.eles.nodes().positions(function(U, b) {
						if (typeof U == "number" && (U = b), !U.isParent()) {
							for (var V = U.id(), H = X[V], W = U; H == null && (H = X[W.data("parent")] || X["DummyCompound_" + W.data("parent")], X[V] = H, W = W.parent()[0], W != null););
							return H != null ? {
								x: H.x,
								y: H.y
							} : {
					...
					}), w(), c = requestAnimationFrame(F);
				}, "iterateAnimated");
				return O.addListener("layoutstarted", function() {
					s.options.animate === "during" && (c = requestAnimationFrame(_));
				...
				for (var E = c.length, O = 0; O < E; O++) {
					var s = c[O], g = s.children(), f, L = s.layoutDimensions({ nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels });
					if (s.outerWidth() != null && s.outerHeight() != null ? f = T.add(new u(D.graphManager, new o(s.position("x") - L.w / 2, s.position("y") - L.h / 2), new p(parseFloat(L.w), parseFloat(L.h)))) : f = T.add(new u(this.graphManager)), f.id = s.data("id"), f.paddingLeft = parseInt(s.css("padding")), f.paddingTop = parseInt(s.css("padding")), f.paddingRight = parseInt(s.css("padding")), f.paddingBottom = parseInt(s.css("padding")), this.options.nodeDimensionsIncludeLabels && s.isParent()) {
						var N = s.boundingBox({
							includeLabels: !0,
							includeNodes: !1
						}).w, I = s.boundingBox({
					...
					if (this.idToLNode[s.data("id")] = f, isNaN(f.rect.x) && (f.rect.x = 0), isNaN(f.rect.y) && (f.rect.y = 0), g != null && g.length > 0) {
						var C = D.getGraphManager().add(D.newGraph(), f);
...
function st(m) {
	return new Promise((M) => {
		let v = ia("body").append("div").attr("id", "cy").attr("style", "display:none"), n = ra({
		...
		v.remove(), ct(m.nodes, n), pt(m.edges, n), n.nodes().forEach(function(t) {
			t.layoutDimensions = () => {
				let r = t.data();
				return {
					w: r.width,
		...
		n.layout({
			...
			pt$1.info("Cytoscape ready", t), M(n);
		});
	});
}
m(st, "createCytoscapeInstance");
function at(m) {
	return m.nodes().map((M) => {
		let v = M.data(), n = M.position(), e = {
			id: v.id,
			x: n.x,
			y: n.y
		};
...
function ht(m) {
	return m.edges().map((M) => {
		let v = M.data(), n = M._private.rscratch, e = {
			id: v.id,
			source: v.source,
			target: v.target,
			startX: n.startX,
...
async function lt(m, M) {
	pt$1.debug("Starting cose-bilkent layout algorithm");
	try {
		dt(m);
		let v = await st(m), n = at(v), e = ht(v);
		return pt$1.debug(`Layout completed: ${n.length} nodes, ${e.length} edges`), {
			nodes: n,
			edges: e
		};
	} catch (v) {
		throw pt$1.error("Error in cose-bilkent layout algorithm:", v), v;
	}
}
m(lt, "executeCoseBilkentLayout");
function dt(m) {
	if (!m) throw new Error("Layout data is required");
	if (!m.config) throw new Error("Configuration is required in layout data");
	if (!m.rootNode) throw new Error("Root node is required");
	if (!m.nodes || !Array.isArray(m.nodes)) throw new Error("No nodes found in layout data");
	if (!Array.isArray(m.edges)) throw new Error("Edges array is required in layout data");
	return !0;
}
m(dt, "validateLayoutData");
var xt = m(async (m, M, { insertCluster: v, insertEdge: n, insertEdgeLabel: e, insertMarkers: t, insertNode: r, log: a, positionEdgeLabel: u }, { algorithm: o }) => {
	let p = {}, i = {}, h = M.select("g");
	t(h, m.markers, m.type, m.diagramId);
	...
	a.debug("Inserting nodes into DOM for dimension calculation"), await Promise.all(m.nodes.map(async (E) => {
		if (E.isGroup) {
			let O = { ...E };
	...
	a.debug("Positioning nodes based on layout results"), D.nodes.forEach((E) => {
		...
		let O = m.edges.find((s) => s.id === E.id);
		O && (O.points = [
			{
				x: E.startX,
				y: E.startY
	...
	}), a.debug("Inserting and positioning edges"), await Promise.all(m.edges.map(async (E) => {
		await e(y, E);
		...
		if (s && g) {
			...
			if (f) {
				...
				let L = { ...E };
				u(L, n(d, L, i, m.type, s, g, m.diagramId));
			} else {
				let L = {
					...E,
					points: [{
