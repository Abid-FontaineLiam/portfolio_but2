...
import { D as Vc, L as Zc, O as Vn, Q as zc, V as ia, _ as Lc, a as As, b as Qc, g as Kc, h as Jc, o as Bc, q as pt, r as $s, x as Qs, z as Zs } from "./chunk-7W6UQGC5-C150Mc68.js";
import { D as co, Z as qo, l as It$1 } from "./chunk-67TQ5CYL-BGuir8Be.js";
import { i as Lo, o as Mo } from "./chunk-QA3QBVWF-BSQ0fMk9.js";
import { n as Lr } from "./chunk-INKRHTLW-D1tzj-ij.js";
import { i as s, n as T$1, r as d, t as E } from "./chunk-5VCL7Z4A-B90neaMh.js";
import { n as d$1 } from "./chunk-UY5QBCOK-CwI-dlRa.js";
import { t as Vt$1 } from "./chunk-5IMINLNL-CMXhugjx.js";
import { n as g, r as m$1 } from "./chunk-T2UQINTJ-D3w-GKPC.js";
import { u as vt$1 } from "./chunk-KGFNY3KK-CuDVV7Uv.js";
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-7J6CGLKN.mjs
var bt = m((r, t, a, s, o, n = !1, e) => {
	t.arrowTypeStart && wt(r, "start", t.arrowTypeStart, a, s, o, n, e), t.arrowTypeEnd && wt(r, "end", t.arrowTypeEnd, a, s, o, n, e);
}, "addEdgeMarkers"), Ut = {
	arrow_cross: {
		type: "cross",
		fill: !1
	...
	"dependency",
	"barb"
], wt = m((r, t, a, s, o, n, e = !1, i) => {
	let c = Ut[a], l = c && Et.includes(c.type);
	if (!c) {
		pt.warn(`Unknown arrow type: ${a}`);
		return;
	}
	let p = `${o}_${n}-${c.type}${t === "start" ? "Start" : "End"}${e && l ? "-margin" : ""}`;
	if (i && i.trim() !== "") {
		let h = `${p}_${i.replace(/[^\dA-Za-z]/g, "_")}`;
		if (!document.getElementById(h)) {
			let k = document.getElementById(p);
			if (k) {
				let u = k.cloneNode(!0);
				u.id = h, u.querySelectorAll("path, circle, line").forEach((X) => {
					X.setAttribute("stroke", i), c.fill && X.setAttribute("fill", i);
				}), k.parentNode?.appendChild(u);
			}
		}
		r.attr(`marker-${t}`, `url(${s}#${h})`);
	} else r.attr(`marker-${t}`, `url(${s}#${p})`);
}, "addEdgeMarker");
var Wt = m((r) => typeof r == "string" ? r : qo()?.flowchart?.curve, "resolveEdgeCurveType"), I = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), _r = m(() => {
	I.clear(), M.clear();
}, "clear"), T = m((r) => r ? typeof r == "string" ? r : r.reduce((t, a) => t + ";" + a, "") : "", "getLabelStyles"), Sr = m(async (r, t) => {
	let a = qo(), s = co(a), { labelStyles: o } = m$1(t);
	t.labelStyle = o;
	let n = r.insert("g").attr("class", "edgeLabel"), e = n.insert("g").attr("class", "label").attr("data-id", t.id), i = t.labelType === "markdown", l = await Lr(r, t.label, {
		style: T(t.labelStyle),
		useHtmlLabels: s,
		addSvgBackground: !0,
		isNode: !1,
		markdown: i,
	...
	if (s) {
		...
		m = p.getBoundingClientRect(), g = m, x.attr("width", m.width), x.attr("height", m.height);
	} else {
		let p = ia(l).select("text").node();
		p && typeof p.getBBox == "function" && (g = p.getBBox());
	}
	e.attr("transform", d(g, s)), I.set(t.id, n), t.width = m.width, t.height = m.height;
	let f;
	if (t.startLabelLeft) {
		let p = r.insert("g").attr("class", "edgeTerminals"), x = p.insert("g").attr("class", "inner"), h = await vt$1(x, t.startLabelLeft, T(t.labelStyle) || "", !1, !1);
		f = h;
		let k = h.getBBox();
		if (s) {
			let u = h.children[0], b = ia(h);
			k = u.getBoundingClientRect(), b.attr("width", k.width), b.attr("height", k.height);
		}
		x.attr("transform", d(k, s)), M.get(t.id) || M.set(t.id, {}), M.get(t.id).startLeft = p, V(f, t.startLabelLeft);
	}
	if (t.startLabelRight) {
		let p = r.insert("g").attr("class", "edgeTerminals"), x = p.insert("g").attr("class", "inner"), h = await vt$1(x, t.startLabelRight, T(t.labelStyle) || "", !1, !1);
		f = h;
		let k = h.getBBox();
		if (s) {
			let u = h.children[0], b = ia(h);
		...
		x.attr("transform", d(k, s)), M.get(t.id) || M.set(t.id, {}), M.get(t.id).startRight = p, V(f, t.startLabelRight);
	}
	if (t.endLabelLeft) {
		let p = r.insert("g").attr("class", "edgeTerminals"), x = p.insert("g").attr("class", "inner"), h = await vt$1(p, t.endLabelLeft, T(t.labelStyle) || "", !1, !1);
		f = h;
		let k = h.getBBox();
		if (s) {
			let u = h.children[0], b = ia(h);
		...
		x.attr("transform", d(k, s)), M.get(t.id) || M.set(t.id, {}), M.get(t.id).endLeft = p, V(f, t.endLabelLeft);
	}
	if (t.endLabelRight) {
		let p = r.insert("g").attr("class", "edgeTerminals"), x = p.insert("g").attr("class", "inner"), h = await vt$1(p, t.endLabelRight, T(t.labelStyle) || "", !1, !1);
		f = h;
		let k = h.getBBox();
		if (s) {
			let u = h.children[0], b = ia(h);
		...
		x.attr("transform", d(k, s)), M.get(t.id) || M.set(t.id, {}), M.get(t.id).endRight = p, V(f, t.endLabelRight);
	}
	return l;
}, "insertEdgeLabel");
function V(r, t) {
	co(qo()) && r && (r.style.width = t.length * 9 + "px", r.style.height = "12px");
}
m(V, "setTerminalWidth");
var Or = m((r, t) => {
	pt.debug("Moving label abc88 ", r.id, r.label, I.get(r.id), t);
	let a = t.updatedPath ? t.updatedPath : t.originalPath, { subGraphTitleTotalMargin: o } = d$1(qo());
	if (r.label) {
	...
	if (r.startLabelLeft) {
		...
		if (a) {
			let c = Mo.calcTerminalLabelPosition(r.arrowTypeStart ? 10 : 0, "start_left", a);
			e = c.x, i = c.y;
		}
	...
	if (r.startLabelRight) {
		...
		if (a) {
			let c = Mo.calcTerminalLabelPosition(r.arrowTypeStart ? 10 : 0, "start_right", a);
			e = c.x, i = c.y;
		}
		n.attr("transform", `translate(${e}, ${i})`);
	}
	if (r.endLabelLeft) {
		...
		if (a) {
			let c = Mo.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_left", a);
			e = c.x, i = c.y;
		}
		n.attr("transform", `translate(${e}, ${i})`);
	}
	if (r.endLabelRight) {
		...
		if (a) {
			let c = Mo.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_right", a);
			e = c.x, i = c.y;
		}
		n.attr("transform", `translate(${e}, ${i})`);
	}
}, "positionEdgeLabel"), Xt = m((r, t) => {
	let a = r.x, s = r.y, o = Math.abs(t.x - a), n = Math.abs(t.y - s), e = r.width / 2, i = r.height / 2;
	return o >= e || n >= i;
}, "outsideNode"), Yt = m((r, t, a) => {
	pt.debug(`intersection calc abc89:
  outsidePoint: ${JSON.stringify(t)}
  insidePoint : ${JSON.stringify(a)}
  node        : x:${r.x} y:${r.y} w:${r.width} h:${r.height}`);
	let s = r.x, o = r.y, n = Math.abs(s - a.x), e = r.width / 2, i = a.x < t.x ? e - n : e + n, c = r.height / 2, l = Math.abs(t.y - a.y), m = Math.abs(t.x - a.x);
	if (Math.abs(o - t.y) * e > Math.abs(s - t.x) * c) {
		let g = a.y < t.y ? t.y - c - o : o - c - t.y;
		i = m * g / l;
		let f = {
			x: a.x < t.x ? a.x + i : a.x - m + i,
			y: a.y < t.y ? a.y + l - g : a.y - l + g
		};
		return i === 0 && (f.x = t.x, f.y = t.y), m === 0 && (f.x = t.x), l === 0 && (f.y = t.y), pt.debug(`abc89 top/bottom calc, Q ${l}, q ${g}, R ${m}, r ${i}`, f), f;
	} else {
		a.x < t.x ? i = t.x - e - s : i = s - e - t.x;
		let g = l * i / m, f = a.x < t.x ? a.x + m - i : a.x - m + i, p = a.y < t.y ? a.y + g : a.y - g;
		return pt.debug(`sides calc abc89, Q ${l}, q ${g}, R ${m}, r ${i}`, {
			_x: f,
			_y: p
		}), i === 0 && (f = t.x, p = t.y), m === 0 && (f = t.x), l === 0 && (p = t.y), {
			x: f,
			y: p
		};
	}
}, "intersection"), Mt = m((r, t) => {
	...
	return r.forEach((n) => {
		if (pt.info("abc88 checking point", n, t), !Xt(t, n) && !o) {
			...
			a.forEach((c) => {
				i = i || c.x === e.x && c.y === e.y;
			}), a.some((c) => c.x === e.x && c.y === e.y) ? pt.warn("abc88 no intersect", e, a) : a.push(e), o = !0;
		} else pt.warn("abc88 outside", n, s), s = n, o || a.push(n);
	}), pt.debug("returning points", a), a;
}, "cutPathAtIntersect");
function vt(r) {
	let t = [], a = [];
	for (let s = 1; s < r.length - 1; s++) {
		let o = r[s - 1], n = r[s], e = r[s + 1];
		(o.x === n.x && n.y === e.y && Math.abs(n.x - e.x) > 5 && Math.abs(n.y - o.y) > 5 || o.y === n.y && n.x === e.x && Math.abs(n.x - o.x) > 5 && Math.abs(n.y - e.y) > 5) && (t.push(n), a.push(s));
	}
	return {
		cornerPoints: t,
...
m(vt, "extractCornerPoints");
var Lt = m(function(r, t, a) {
	let s = t.x - r.x, o = t.y - r.y, e = a / Math.sqrt(s * s + o * o);
	return {
		x: t.x - e * s,
		y: t.y - e * o
	};
}, "findAdjacentPoint"), Ht = m(function(r) {
	let { cornerPointPositions: t } = vt(r), a = [];
	for (let s = 0; s < r.length; s++) if (t.includes(s)) {
		let o = r[s - 1], n = r[s + 1], e = r[s], i = Lt(o, e, 5), c = Lt(n, e, 5), l = c.x - i.x, m = c.y - i.y;
		a.push(i);
		let g = Math.sqrt(2) * 2, f = {
			x: e.x,
			y: e.y
		};
		if (Math.abs(n.x - o.x) > 10 && Math.abs(n.y - o.y) >= 10) {
			...
			let p = 5;
			e.x === i.x ? f = {
				x: l < 0 ? i.x - p + g : i.x + p - g,
				y: m < 0 ? i.y - g : i.y + g
			} : f = {
				x: l < 0 ? i.x - g : i.x + g,
				y: m < 0 ? i.y - p + g : i.y + p - g
			};
		} else pt.debug("Corner point skipping fixing", Math.abs(n.x - o.x), Math.abs(n.y - o.y));
		a.push(f, c);
	} else a.push(r[s]);
	return a;
}, "fixCorners"), Bt = m((r, t, a) => {
	let s = r - t - a, o = 2, n = 2, i = Math.floor(s / 4);
	return `0 ${t} ${Array(i).fill(`${o} ${n}`).join(" ")} ${a}`;
}, "generateDashArray"), $r = m(function(r, t, a, s, o, n, e, i = !1) {
	if (!e) throw new Error(`insertEdge: missing diagramId for edge "${t.id}" \u2014 edge IDs require a diagram prefix for uniqueness`);
	let { handDrawnSeed: c } = qo(), l = t.points, m = !1, g$1 = o;
	var f = n;
	let p = [];
	for (let _ in t.cssCompiledStyles) g(_) || p.push(t.cssCompiledStyles[_]);
	pt.debug("UIO intersect check", t.points, f.x, g$1.x), f.intersect && g$1.intersect && !i && (l = l.slice(1, t.points.length - 1), l.unshift(g$1.intersect(l[0])), pt.debug("Last point UIO", t.start, "-->", t.end, l[l.length - 1], f, f.intersect(l[l.length - 1])), l.push(f.intersect(l[l.length - 1])));
	let x = btoa(JSON.stringify(l));
	t.toCluster && (pt.info("to cluster abc88", a.get(t.toCluster)), l = Mt(t.points, a.get(t.toCluster).node), m = !0), t.fromCluster && (pt.debug("from cluster abc88", a.get(t.fromCluster), JSON.stringify(l, null, 2)), l = Mt(l.reverse(), a.get(t.fromCluster).node).reverse(), m = !0);
	let h = l.filter((_) => !Number.isNaN(_.y)), k = Wt(t.curve);
	k !== "rounded" && (h = Ht(h));
	let u = Vn;
	switch (k) {
		case "linear":
	...
	switch (t.thickness) {
		...
		case "invisible":
			...
			break;
		default: L = "edge-thickness-normal";
	}
	switch (t.pattern) {
		case "solid":
		...
		case "dashed":
			...
			break;
		default: L += " edge-pattern-solid";
	}
	let w, C = k === "rounded" ? Tt(Ct(h, t), 5) : j(h), S = Array.isArray(t.style) ? t.style : [t.style], z = S.find((_) => _?.startsWith("stroke:")), O = "";
	...
	if (t.look === "handDrawn") {
		...
		w = r.append("path").attr("d", C).attr("id", `${e}-${t.id}`).attr("class", " " + L + (t.classes ? " " + t.classes : "") + (O ? " " + O : "")).attr("style", q), z = q.match(/stroke:([^;]+)/)?.[1], D = t.animate === !0 || !!t.animation || _.includes("animation");
		let Q = w.node(), Z = typeof Q.getTotalLength == "function" ? Q.getTotalLength() : 0, J = T$1[t.arrowTypeStart] || 0, F = T$1[t.arrowTypeEnd] || 0;
		if (t.look === "neo" && !D) {
	...
	w.attr("data-edge", !0), w.attr("data-et", "edge"), w.attr("data-id", t.id), w.attr("data-points", x), w.attr("data-look", Lo(t.look)), t.showPoints && h.forEach((_) => {
	...
	let St = !D && t?.look === "neo";
	bt(w, t, A, e, s, St, z);
	let Ot = Math.floor(l.length / 2), $t = l[Ot];
	Mo.isLabelCoordinateInPath($t, w.attr("d")) || (m = !0);
	let G = {};
	return m && (G.updatedPath = l), G.originalPath = t.points, G;
}, "insertEdge");
function Tt(r, t) {
	if (r.length < 2) return "";
	let a = "", s = r.length, o = 1e-5;
	for (let n = 0; n < s; n++) {
		let e = r[n], i = r[n - 1], c = r[n + 1];
		if (n === 0) a += `M${e.x},${e.y}`;
		else if (n === s - 1) a += `L${e.x},${e.y}`;
		else {
			let l = e.x - i.x, m = e.y - i.y, g = c.x - e.x, f = c.y - e.y, p = Math.hypot(l, m), x = Math.hypot(g, f);
			if (p < o || x < o) {
				a += `L${e.x},${e.y}`;
				continue;
			}
			let h = l / p, k = m / p, u = g / x, b = f / x, X = h * u + k * b, L = Math.acos(Math.max(-1, Math.min(1, X)));
			if (L < o || Math.abs(Math.PI - L) < o) {
				a += `L${e.x},${e.y}`;
				continue;
			}
			let w = Math.min(t / Math.sin(L / 2), p / 2, x / 2), C = e.x - h * w, S = e.y - k * w, z = e.x + u * w, O = e.y + b * w;
...
function Ct(r, t) {
	...
	if (s$1 >= 2 && s[t.arrowTypeEnd]) {
		let o = s[t.arrowTypeEnd], n = r[s$1 - 1], e = r[s$1 - 2], { angle: i } = _t(e, n), c = o * Math.cos(i), l = o * Math.sin(i);
...
var zt = m((r, t, a, s) => {
	...
	let { themeVariables: o } = It$1(), { transitionColor: n } = o;
...
}, "zero_or_more"), Kt = m((r, t, a) => {
	let { themeVariables: o } = It$1(), { strokeWidth: n } = o;
...
}, "only_one_neo"), tr = m((r, t, a) => {
	let { themeVariables: o } = It$1(), { strokeWidth: n, mainBkg: e } = o, i = r.append("defs").append("marker").attr("id", a + "_" + t + "-zeroOrOneStart").attr("class", "marker zeroOrOne " + t).attr("refX", 0).attr("refY", 9).attr("markerWidth", 30).attr("markerHeight", 18).attr("orient", "auto").attr("markerUnits", "userSpaceOnUse");
...
}, "one_or_more_neo"), ar = m((r, t, a) => {
	let { themeVariables: o } = It$1(), { strokeWidth: n, mainBkg: e } = o, i = r.append("defs").append("marker").attr("id", a + "_" + t + "-zeroOrMoreStart").attr("class", "marker zeroOrMore " + t).attr("refX", 18).attr("refY", 18).attr("markerWidth", 57).attr("markerHeight", 36).attr("markerUnits", "userSpaceOnUse").attr("orient", "auto");
	...
	one_or_more_neo: rr,
	zero_or_more_neo: ar,
	requirement_arrow: er,
	requirement_contains: m((r, t, a) => {
	...
	requirement_arrow_neo: nr,
	requirement_contains_neo: m((r, t, a) => {
		let { themeVariables: o } = It$1(), { strokeWidth: n } = o, e = r.append("defs").append("marker").attr("id", a + "_" + t + "-requirement_containsStart").attr("refX", 0).attr("refY", 10).attr("markerWidth", 20).attr("markerHeight", 20).attr("orient", "auto").attr("markerUnits", "userSpaceOnUse").append("g");
...
//#endregion
export { _r as a, Yr as i, Or as n, Sr as r, $r as t };
