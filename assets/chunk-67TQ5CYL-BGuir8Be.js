const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/katex-K3KEBU37-CG2KMnVQ.js","assets/chunk-AQ6EADP3-qIXSNQLA.js"])))=>i.map(i=>d[i]);
import { u as __vitePreload } from "./app-B7sz6Vtc.js";
import { r as o$1, t as m } from "./chunk-AQ6EADP3-qIXSNQLA.js";
import { M as Wh, q as pt } from "./chunk-7W6UQGC5-C150Mc68.js";
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-67TQ5CYL.mjs
...
var ti = {}, ks = m(function(r, t) {
	r = r.replace(Mr, "").replace(qr, "").replace(wr, `
`);
	for (let [i, { detector: e }] of Object.entries(ti)) if (e(r, t)) return i;
	throw new Qt(`No diagram type detected matching given configuration for text: ${r}`);
}, "detectType"), Ts = m((...r) => {
	for (let { id: t, detector: i, loader: e } of r) _i(t, i, e);
}, "registerLazyLoadedDiagrams"), _i = m((r, t, i) => {
	ti[r] && pt.warn(`Detector with key ${r} already exists. Overwriting.`), ti[r] = {
		detector: t,
		loader: i
	}, pt.debug(`Detector with key ${r} added${i ? " with loader" : ""}`);
}, "addDetector"), bs = m((r) => ti[r].loader, "getDiagramLoader");
var Ai = m((r, t, { depth: i = 2, clobber: e = !1 } = {}) => {
	let d = {
		depth: i,
		clobber: e
	};
	return Array.isArray(t) && !Array.isArray(r) ? (t.forEach((h) => Ai(r, h, d)), r) : Array.isArray(t) && Array.isArray(r) ? (t.forEach((h) => {
		...
		typeof t[h] == "object" && t[h] !== null && (r[h] === void 0 || typeof r[h] == "object") ? (r[h] === void 0 && (r[h] = Array.isArray(t[h]) ? [] : {}), r[h] = Ai(r[h], t[h], {
			depth: i - 1,
			clobber: e
		})) : (e || typeof r[h] != "object" && typeof t[h] != "object") && (r[h] = t[h]);
	}), r);
}, "assignWithDepth"), D = Ai;
var ii = {
	min: {
		r: 0,
		g: 0,
	...
	clamp: {
		r: m((r) => r >= 255 ? 255 : r < 0 ? 0 : r, "r"),
		g: m((r) => r >= 255 ? 255 : r < 0 ? 0 : r, "g"),
		b: m((r) => r >= 255 ? 255 : r < 0 ? 0 : r, "b"),
		h: m((r) => r % 360, "h"),
		s: m((r) => r >= 100 ? 100 : r < 0 ? 0 : r, "s"),
		l: m((r) => r >= 100 ? 100 : r < 0 ? 0 : r, "l"),
		a: m((r) => r >= 1 ? 1 : r < 0 ? 0 : r, "a")
	},
	toLinear: m((r) => {
		let t = r / 255;
		return r > .03928 ? Math.pow((t + .055) / 1.055, 2.4) : t / 12.92;
	}, "toLinear"),
	hue2rgb: m((r, t, i) => (i < 0 && (i += 1), i > 1 && (i -= 1), i < .16666666666666666 ? r + (t - r) * 6 * i : i < .5 ? t : i < .6666666666666666 ? r + (t - r) * (.6666666666666666 - i) * 6 : r), "hue2rgb"),
	hsl2rgb: m(({ h: r, s: t, l: i }, e) => {
		if (!t) return i * 2.55;
		r /= 360, t /= 100, i /= 100;
		let d = i < .5 ? i * (1 + t) : i + t - i * t, h = 2 * i - d;
		switch (e) {
			case "r": return ii.hue2rgb(h, d, r + .3333333333333333) * 255;
			case "g": return ii.hue2rgb(h, d, r) * 255;
			case "b": return ii.hue2rgb(h, d, r - .3333333333333333) * 255;
		}
	}, "hsl2rgb"),
	rgb2hsl: m(({ r, g: t, b: i }, e) => {
		r /= 255, t /= 255, i /= 255;
		let d = Math.max(r, t, i), h = Math.min(r, t, i), y = (d + h) / 2;
		if (e === "l") return y * 100;
		if (d === h) return 0;
		let f = d - h, M = y > .5 ? f / (2 - d - h) : f / (d + h);
		if (e === "s") return M * 100;
		switch (d) {
			case r: return ((t - i) / f + (t < i ? 6 : 0)) * 60;
			case t: return ((i - r) / f + 2) * 60;
			case i: return ((r - t) / f + 4) * 60;
			default: return -1;
		}
	}, "rgb2hsl")
};
var u = {
	channel: ii,
	lang: {
		clamp: m((r, t, i) => t > i ? Math.min(t, Math.max(i, r)) : Math.min(i, Math.max(t, r)), "clamp"),
		round: m((r) => Math.round(r * 1e10) / 1e10, "round")
	},
	unit: { dec2hex: m((r) => {
...
var Mi = class {
	...
	constructor(t, i) {
		this.color = i, this.changed = !1, this.data = t, this.type = new zr();
	}
	set(t, i) {
		return this.color = i, this.changed = !1, this.data = t, this.type.type = _.ALL, this;
	}
	_ensureHSL() {
	...
	set r(t) {
		this.type.set(_.RGB), this.changed = !0, this.data.r = t;
	}
	set g(t) {
		this.type.set(_.RGB), this.changed = !0, this.data.g = t;
	}
	set b(t) {
		this.type.set(_.RGB), this.changed = !0, this.data.b = t;
	}
	set h(t) {
		this.type.set(_.HSL), this.changed = !0, this.data.h = t;
	}
	set s(t) {
		this.type.set(_.HSL), this.changed = !0, this.data.s = t;
	}
	set l(t) {
		this.type.set(_.HSL), this.changed = !0, this.data.l = t;
	}
	set a(t) {
...
var Wr = {
	...
	parse: m((r) => {
		...
		let t = r.match(Wr.re);
		if (!t) return;
		let i = t[1], e = parseInt(i, 16), d = i.length, h = d % 4 === 0, y = d > 4, f = y ? 1 : 17, M = y ? 8 : 4, q = h ? 0 : -1, Y = y ? 255 : 15;
		return st.set({
			r: (e >> M * (q + 3) & Y) * f,
			g: (e >> M * (q + 2) & Y) * f,
			b: (e >> M * (q + 1) & Y) * f,
...
var ri = {
	...
	_hue2deg: m((r) => {
		let t = r.match(ri.hueRe);
		if (t) {
			let [, i, e] = t;
			switch (e) {
				case "grad": return u.channel.clamp.h(parseFloat(i) * .9);
				case "rad": return u.channel.clamp.h(parseFloat(i) * 180 / Math.PI);
				case "turn": return u.channel.clamp.h(parseFloat(i) * 360);
			}
		}
	...
	parse: m((r) => {
		...
		return st.set({
			h: ri._hue2deg(e),
			s: u.channel.clamp.s(parseFloat(d)),
			l: u.channel.clamp.l(parseFloat(h)),
			a: y ? u.channel.clamp.a(f ? parseFloat(y) / 100 : parseFloat(y)) : 1
		}, r);
	}, "parse"),
	stringify: m((r) => {
...
var oi = {
	...
	parse: m((r) => {
		r = r.toLowerCase();
		let t = oi.colors[r];
		if (t) return dt.parse(t);
	}, "parse"),
	stringify: m((r) => {
		let t = dt.stringify(r);
		for (let i in oi.colors) if (oi.colors[i] === t) return i;
	}, "stringify")
}, qi = oi;
var Pr = {
	...
	parse: m((r) => {
		...
		let i = r.match(Pr.re);
		if (!i) return;
		let [, e, d, h, y, f, M, q, Y] = i;
		return st.set({
			r: u.channel.clamp.r(d ? parseFloat(e) * 2.55 : parseFloat(e)),
			g: u.channel.clamp.g(y ? parseFloat(h) * 2.55 : parseFloat(h)),
			b: u.channel.clamp.b(M ? parseFloat(f) * 2.55 : parseFloat(f)),
			a: q ? u.channel.clamp.a(Y ? parseFloat(q) / 100 : parseFloat(q)) : 1
		}, r);
	}, "parse"),
	stringify: m((r) => {
		let { r: t, g: i, b: e, a: d } = r;
...
var A = {
	...
	parse: m((r) => {
		...
		let t = dt.parse(r) || qt.parse(r) || Mt.parse(r) || qi.parse(r);
		if (t) return t;
		throw new Error(`Unsupported color format: "${r}"`);
	}, "parse"),
	stringify: m((r) => !r.changed && r.color ? r.color : r.type.is(_.HSL) || r.data.r === void 0 ? Mt.stringify(r) : r.a < 1 || !Number.isInteger(r.r) || !Number.isInteger(r.g) || !Number.isInteger(r.b) ? qt.stringify(r) : dt.stringify(r), "stringify")
};
var ei = m((r, t) => {
	let i = A.parse(r);
...
var P = m((r, t, i = 0, e = 1) => {
	if (typeof r != "number") return ei(r, { a: t });
	let d = st.set({
		r: u.channel.clamp.r(r),
		g: u.channel.clamp.g(t),
		b: u.channel.clamp.b(i),
		a: u.channel.clamp.a(e)
	});
	return A.stringify(d);
}, "rgba");
var oe = m((r, t) => u.lang.round(A.parse(r)[t]), "channel");
var Nr = m((r) => {
	let { r: t, g: i, b: e } = A.parse(r), d = .2126 * u.channel.toLinear(t) + .7152 * u.channel.toLinear(i) + .0722 * u.channel.toLinear(e);
	return u.lang.round(d);
}, "luminance");
var Hr = m((r) => Nr(r) >= .5, "isLight");
var T = m((r) => !Hr(r), "isDark");
var Tt = m((r, t, i) => {
	let e = A.parse(r), d = e[t], h = u.channel.clamp[t](d + i);
	return d !== h && (e[t] = h), A.stringify(e);
}, "adjustChannel");
var n = m((r, t) => Tt(r, "l", t), "lighten");
var c = m((r, t) => Tt(r, "l", -t), "darken");
var de = m((r, t) => Tt(r, "a", -t), "transparentize");
var o = m((r, t) => {
	let i = A.parse(r), e = {};
...
var Ur = m((r, t, i = 50) => {
	let { r: e, g: d, b: h, a: y } = A.parse(r), { r: f, g: M, b: q, a: Y } = A.parse(t), St = i / 100, gt = St * 2 - 1, rt = y - Y, ut = ((gt * rt === -1 ? gt : (gt + rt) / (1 + gt * rt)) + 1) / 2, Ft = 1 - ut;
	return P(e * ut + f * Ft, d * ut + M * Ft, h * ut + q * Ft, y * St + Y * (1 - St));
}, "mix");
var a = m((r, t = 100) => {
	let i = A.parse(r);
	return i.r = 255 - i.r, i.g = 255 - i.g, i.b = 255 - i.b, Ur(i, r, t);
}, "invert");
var F = "#ffffff", L = "#f2f2f2";
var p = m((r, t) => t ? o(r, {
	s: -40,
	l: 10
}) : o(r, {
...
var wi = class {
	...
	updateColors() {
		...
		for (let i = 0; i < 5; i++) this["surface" + i] = this["surface" + i] || o(this.mainBkg, {
			h: 180,
			s: -15,
			l: t * (5 + i * 3)
		}), this["surfacePeer" + i] = this["surfacePeer" + i] || o(this.mainBkg, {
			h: 180,
			s: -15,
			l: t * (8 + i * 3)
		});
		this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || o(this.primaryColor, { h: 64 }), this.fillType3 = this.fillType3 || o(this.secondaryColor, { h: 64 }), this.fillType4 = this.fillType4 || o(this.primaryColor, { h: -64 }), this.fillType5 = this.fillType5 || o(this.secondaryColor, { h: -64 }), this.fillType6 = this.fillType6 || o(this.primaryColor, { h: 128 }), this.fillType7 = this.fillType7 || o(this.secondaryColor, { h: 128 }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || this.tertiaryColor, this.pie4 = this.pie4 || o(this.primaryColor, { l: -10 }), this.pie5 = this.pie5 || o(this.secondaryColor, { l: -10 }), this.pie6 = this.pie6 || o(this.tertiaryColor, { l: -10 }), this.pie7 = this.pie7 || o(this.primaryColor, {
			h: 60,
			l: -10
		}), this.pie8 = this.pie8 || o(this.primaryColor, {
			h: -60,
			l: -10
		}), this.pie9 = this.pie9 || o(this.primaryColor, {
			h: 120,
			l: 0
		}), this.pie10 = this.pie10 || o(this.primaryColor, {
			h: 60,
			l: -20
		}), this.pie11 = this.pie11 || o(this.primaryColor, {
			h: -60,
			l: -20
		}), this.pie12 = this.pie12 || o(this.primaryColor, {
			h: 120,
			l: -10
		}), this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.venn1 = this.venn1 ?? o(this.primaryColor, { l: -30 }), this.venn2 = this.venn2 ?? o(this.secondaryColor, { l: -30 }), this.venn3 = this.venn3 ?? o(this.tertiaryColor, { l: -30 }), this.venn4 = this.venn4 ?? o(this.primaryColor, {
			h: 60,
			l: -30
		}), this.venn5 = this.venn5 ?? o(this.primaryColor, {
			h: -60,
			l: -30
		}), this.venn6 = this.venn6 ?? o(this.secondaryColor, {
			h: 60,
			l: -30
		}), this.venn7 = this.venn7 ?? o(this.primaryColor, {
			h: 120,
			l: -30
		}), this.venn8 = this.venn8 ?? o(this.secondaryColor, {
			h: 120,
			l: -30
		...
		}, this.archEdgeColor = this.archEdgeColor || "#777", this.archEdgeArrowColor = this.archEdgeArrowColor || "#777", this.archEdgeWidth = this.archEdgeWidth || "3", this.archGroupBorderColor = this.archGroupBorderColor || "#000", this.archGroupBorderWidth = this.archGroupBorderWidth || "2px", this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || o(this.primaryColor, {
			r: 5,
			g: 5,
			b: 5
		}), this.quadrant3Fill = this.quadrant3Fill || o(this.primaryColor, {
			r: 10,
			g: 10,
			b: 10
		}), this.quadrant4Fill = this.quadrant4Fill || o(this.primaryColor, {
			r: 15,
			g: 15,
			b: 15
		}), this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor, this.quadrant2TextFill = this.quadrant2TextFill || o(this.primaryTextColor, {
			r: -5,
			g: -5,
			b: -5
		}), this.quadrant3TextFill = this.quadrant3TextFill || o(this.primaryTextColor, {
			r: -10,
			g: -10,
			b: -10
		}), this.quadrant4TextFill = this.quadrant4TextFill || o(this.primaryTextColor, {
			r: -15,
			g: -15,
			b: -15
		}), this.quadrantPointFill = this.quadrantPointFill || T(this.quadrant1Fill) ? n(this.quadrant1Fill) : c(this.quadrant1Fill), this.quadrantPointTextFill = this.quadrantPointTextFill || this.primaryTextColor, this.quadrantXAxisTextFill = this.quadrantXAxisTextFill || this.primaryTextColor, this.quadrantYAxisTextFill = this.quadrantYAxisTextFill || this.primaryTextColor, this.quadrantInternalBorderStrokeFill = this.quadrantInternalBorderStrokeFill || this.primaryBorderColor, this.quadrantExternalBorderStrokeFill = this.quadrantExternalBorderStrokeFill || this.primaryBorderColor, this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor, this.xyChart = {
...
var Oi = class {
	...
	updateColors() {
		...
		for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) this["cScalePeer" + t] = this["cScalePeer" + t] || n(this["cScale" + t], 10);
		for (let t = 0; t < 5; t++) this["surface" + t] = this["surface" + t] || o(this.mainBkg, {
			h: 30,
			s: -30,
			l: -(-10 + t * 4)
		}), this["surfacePeer" + t] = this["surfacePeer" + t] || o(this.mainBkg, {
			h: 30,
			s: -30,
			l: -(-7 + t * 4)
		});
		...
		for (let t = 0; t < 8; t++) this["venn" + (t + 1)] = this["venn" + (t + 1)] ?? n(this["cScale" + t], 30);
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || o(this.primaryColor, {
			r: 5,
			g: 5,
			b: 5
		}), this.quadrant3Fill = this.quadrant3Fill || o(this.primaryColor, {
...
var Ii = class {
	...
	updateColors() {
		...
		for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) this["cScale" + t] = c(this["cScale" + t], 10), this["cScalePeer" + t] = this["cScalePeer" + t] || c(this["cScale" + t], 25);
		...
		this.nodeBkg = this.mainBkg, this.nodeBorder = this.border1, this.clusterBkg = this.secondBkg, this.clusterBorder = this.border2, this.defaultLinkColor = this.lineColor, this.titleColor = this.textColor, this.edgeLabelBackground = this.labelBackground, this.actorBorder = this.border1, this.actorBkg = this.mainBkg, this.labelBoxBkgColor = this.actorBkg, this.signalColor = this.textColor, this.signalTextColor = this.textColor, this.labelBoxBorderColor = this.actorBorder, this.labelTextColor = this.actorTextColor, this.loopTextColor = this.actorTextColor, this.noteBorderColor = this.border2, this.noteTextColor = this.actorTextColor, this.actorLineColor = this.actorBorder, this.taskTextColor = this.taskTextLightColor, this.taskTextOutsideColor = this.taskTextDarkColor, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.rowOdd = this.rowOdd || n(this.primaryColor, 75) || "#ffffff", this.rowEven = this.rowEven || n(this.primaryColor, 1), this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.specialStateColor = this.lineColor, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.classText = this.primaryTextColor, this.fillType0 = this.primaryColor, this.fillType1 = this.secondaryColor, this.fillType2 = o(this.primaryColor, { h: 64 }), this.fillType3 = o(this.secondaryColor, { h: 64 }), this.fillType4 = o(this.primaryColor, { h: -64 }), this.fillType5 = o(this.secondaryColor, { h: -64 }), this.fillType6 = o(this.primaryColor, { h: 128 }), this.fillType7 = o(this.secondaryColor, { h: 128 }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || o(this.tertiaryColor, { l: -40 }), this.pie4 = this.pie4 || o(this.primaryColor, { l: -10 }), this.pie5 = this.pie5 || o(this.secondaryColor, { l: -30 }), this.pie6 = this.pie6 || o(this.tertiaryColor, { l: -20 }), this.pie7 = this.pie7 || o(this.primaryColor, {
			...
			h: 120,
			l: -30
		}), this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.venn1 = this.venn1 ?? o(this.primaryColor, { l: -30 }), this.venn2 = this.venn2 ?? o(this.secondaryColor, { l: -30 }), this.venn3 = this.venn3 ?? o(this.tertiaryColor, { l: -40 }), this.venn4 = this.venn4 ?? o(this.primaryColor, {
			h: 60,
			l: -30
		}), this.venn5 = this.venn5 ?? o(this.primaryColor, {
			h: -60,
		...
		}, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.labelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || this.primaryColor, this.git1 = this.git1 || this.secondaryColor, this.git2 = this.git2 || this.tertiaryColor, this.git3 = this.git3 || o(this.primaryColor, { h: -30 }), this.git4 = this.git4 || o(this.primaryColor, { h: -60 }), this.git5 = this.git5 || o(this.primaryColor, { h: -90 }), this.git6 = this.git6 || o(this.primaryColor, { h: 60 }), this.git7 = this.git7 || o(this.primaryColor, { h: 120 }), this.darkMode ? (this.git0 = n(this.git0, 25), this.git1 = n(this.git1, 25), this.git2 = n(this.git2, 25), this.git3 = n(this.git3, 25), this.git4 = n(this.git4, 25), this.git5 = n(this.git5, 25), this.git6 = n(this.git6, 25), this.git7 = n(this.git7, 25)) : (this.git0 = c(this.git0, 25), this.git1 = c(this.git1, 25), this.git2 = c(this.git2, 25), this.git3 = c(this.git3, 25), this.git4 = c(this.git4, 25), this.git5 = c(this.git5, 25), this.git6 = c(this.git6, 25), this.git7 = c(this.git7, 25)), this.gitInv0 = this.gitInv0 || c(a(this.git0), 25), this.gitInv1 = this.gitInv1 || a(this.git1), this.gitInv2 = this.gitInv2 || a(this.git2), this.gitInv3 = this.gitInv3 || a(this.git3), this.gitInv4 = this.gitInv4 || a(this.git4), this.gitInv5 = this.gitInv5 || a(this.git5), this.gitInv6 = this.gitInv6 || a(this.git6), this.gitInv7 = this.gitInv7 || a(this.git7), this.gitBranchLabel0 = this.gitBranchLabel0 || a(this.labelTextColor), this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor, this.gitBranchLabel3 = this.gitBranchLabel3 || a(this.labelTextColor), this.gitBranchLabel4 = this.gitBranchLabel4 || this.labelTextColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.labelTextColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.labelTextColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.labelTextColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.emUiFill = this.emUiFill || "white", this.emUiStroke = this.emUiStroke || "#dbdada", this.emProcessorFill = this.emProcessorFill || "#edb3f6", this.emProcessorStroke = this.emProcessorStroke || "#b88cbf", this.emReadModelFill = this.emReadModelFill || "#d3f1a2", this.emReadModelStroke = this.emReadModelStroke || "#a3b732", this.emCommandFill = this.emCommandFill || "#bcd6fe", this.emCommandStroke = this.emCommandStroke || "#679ac3", this.emEventFill = this.emEventFill || "#ffb778", this.emEventStroke = this.emEventStroke || "#c19a0f", this.emSwimlaneBackgroundOdd = this.emSwimlaneBackgroundOdd || "rgb(250,250,250)", this.emSwimlaneBackgroundStroke = this.emSwimlaneBackgroundStroke || "rgb(240,240,240)", this.emArrowhead = this.emArrowhead || this.lineColor, this.emRelationStroke = this.emRelationStroke || this.lineColor, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || F, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || L;
	}
	calculate(t) {
...
var Di = class {
	...
	updateColors() {
		...
		this.nodeBkg = this.mainBkg, this.nodeBorder = this.border1, this.clusterBkg = this.secondBkg, this.clusterBorder = this.border2, this.defaultLinkColor = this.lineColor, this.taskBorderColor = this.border1, this.taskTextColor = this.taskTextLightColor, this.taskTextOutsideColor = this.taskTextDarkColor, this.activeTaskBorderColor = this.taskBorderColor, this.activeTaskBkgColor = this.mainBkg, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.rowOdd = this.rowOdd || n(this.mainBkg, 75) || "#ffffff", this.rowEven = this.rowEven || n(this.mainBkg, 20), this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.primaryBorderColor, this.specialStateColor = this.lineColor, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.classText = this.primaryTextColor, this.fillType0 = this.primaryColor, this.fillType1 = this.secondaryColor, this.fillType2 = o(this.primaryColor, { h: 64 }), this.fillType3 = o(this.secondaryColor, { h: 64 }), this.fillType4 = o(this.primaryColor, { h: -64 }), this.fillType5 = o(this.secondaryColor, { h: -64 }), this.fillType6 = o(this.primaryColor, { h: 128 }), this.fillType7 = o(this.secondaryColor, { h: 128 }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || this.tertiaryColor, this.pie4 = this.pie4 || o(this.primaryColor, { l: -30 }), this.pie5 = this.pie5 || o(this.secondaryColor, { l: -30 }), this.pie6 = this.pie6 || o(this.tertiaryColor, {
			h: 40,
			l: -40
		}), this.pie7 = this.pie7 || o(this.primaryColor, {
			h: 60,
			l: -10
		}), this.pie8 = this.pie8 || o(this.primaryColor, {
			h: -60,
...
var zi = class {
	...
	updateColors() {
		...
		for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) this["cScaleInv" + t] = this["cScaleInv" + t] || a(this["cScale" + t]);
		for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) this.darkMode ? this["cScalePeer" + t] = this["cScalePeer" + t] || n(this["cScale" + t], 10) : this["cScalePeer" + t] = this["cScalePeer" + t] || c(this["cScale" + t], 10);
		...
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || o(this.primaryColor, {
			...
			annotationTextColor: this.wardley?.annotationTextColor || this.primaryTextColor,
			annotationFill: this.wardley?.annotationFill || this.background
		}, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.edgeLabelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = c(this.pie1, 25) || this.primaryColor, this.git1 = this.pie2 || this.secondaryColor, this.git2 = this.pie3 || this.tertiaryColor, this.git3 = this.pie4 || o(this.primaryColor, { h: -30 }), this.git4 = this.pie5 || o(this.primaryColor, { h: -60 }), this.git5 = this.pie6 || o(this.primaryColor, { h: -90 }), this.git6 = this.pie7 || o(this.primaryColor, { h: 60 }), this.git7 = this.pie8 || o(this.primaryColor, { h: 120 }), this.gitInv0 = this.gitInv0 || a(this.git0), this.gitInv1 = this.gitInv1 || a(this.git1), this.gitInv2 = this.gitInv2 || a(this.git2), this.gitInv3 = this.gitInv3 || a(this.git3), this.gitInv4 = this.gitInv4 || a(this.git4), this.gitInv5 = this.gitInv5 || a(this.git5), this.gitInv6 = this.gitInv6 || a(this.git6), this.gitInv7 = this.gitInv7 || a(this.git7), this.branchLabelColor = this.branchLabelColor || this.labelTextColor, this.gitBranchLabel0 = this.branchLabelColor, this.gitBranchLabel1 = "white", this.gitBranchLabel2 = this.branchLabelColor, this.gitBranchLabel3 = "white", this.gitBranchLabel4 = this.branchLabelColor, this.gitBranchLabel5 = this.branchLabelColor, this.gitBranchLabel6 = this.branchLabelColor, this.gitBranchLabel7 = this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.emUiFill = this.emUiFill || "white", this.emUiStroke = this.emUiStroke || "#dbdada", this.emProcessorFill = this.emProcessorFill || "#edb3f6", this.emProcessorStroke = this.emProcessorStroke || "#b88cbf", this.emReadModelFill = this.emReadModelFill || "#d3f1a2", this.emReadModelStroke = this.emReadModelStroke || "#a3b732", this.emCommandFill = this.emCommandFill || "#bcd6fe", this.emCommandStroke = this.emCommandStroke || "#679ac3", this.emEventFill = this.emEventFill || "#ffb778", this.emEventStroke = this.emEventStroke || "#c19a0f", this.emSwimlaneBackgroundOdd = this.emSwimlaneBackgroundOdd || "rgb(250,250,250)", this.emSwimlaneBackgroundStroke = this.emSwimlaneBackgroundStroke || "rgb(240,240,240)", this.emArrowhead = this.emArrowhead || this.lineColor, this.emRelationStroke = this.emRelationStroke || this.lineColor, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || F, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || L;
	}
	calculate(t) {
		if (typeof t != "object") {
			this.updateColors();
...
var Ri = class {
	...
	updateColors() {
		this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#333"), this.secondaryColor = this.secondaryColor || o(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || o(this.primaryColor, {
			h: 180,
			l: 5
		}), this.primaryBorderColor = this.primaryBorderColor || p(this.primaryColor, this.darkMode), this.secondaryBorderColor = this.secondaryBorderColor || p(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = this.tertiaryBorderColor || p(this.tertiaryColor, this.darkMode), this.noteBorderColor = this.noteBorderColor || p(this.noteBkgColor, this.darkMode), this.noteBkgColor = this.noteBkgColor || "#fff5ad", this.noteTextColor = this.noteTextColor || "#333", this.secondaryTextColor = this.secondaryTextColor || a(this.secondaryColor), this.tertiaryTextColor = this.tertiaryTextColor || a(this.tertiaryColor), this.lineColor = this.lineColor || a(this.background), this.arrowheadColor = this.arrowheadColor || a(this.background), this.textColor = this.textColor || this.primaryTextColor, this.border2 = this.border2 || this.tertiaryBorderColor, this.nodeBkg = this.nodeBkg || this.primaryColor, this.mainBkg = this.mainBkg || this.primaryColor, this.nodeBorder = this.nodeBorder || this.primaryBorderColor, this.clusterBkg = this.clusterBkg || this.tertiaryColor, this.clusterBorder = this.clusterBorder || this.tertiaryBorderColor, this.defaultLinkColor = this.defaultLinkColor || this.lineColor, this.titleColor = this.titleColor || this.tertiaryTextColor, this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? c(this.secondaryColor, 30) : this.secondaryColor), this.nodeTextColor = this.nodeTextColor || this.primaryTextColor, this.actorBorder = this.actorBorder || this.primaryBorderColor, this.actorBkg = this.actorBkg || this.mainBkg, this.actorTextColor = this.actorTextColor || this.primaryTextColor, this.actorLineColor = this.actorLineColor || this.actorBorder, this.labelBoxBkgColor = this.labelBoxBkgColor || this.actorBkg, this.signalColor = this.signalColor || this.textColor, this.signalTextColor = this.signalTextColor || this.textColor, this.labelBoxBorderColor = this.labelBoxBorderColor || this.actorBorder, this.labelTextColor = this.labelTextColor || this.actorTextColor, this.loopTextColor = this.loopTextColor || this.actorTextColor, this.activationBorderColor = this.activationBorderColor || c(this.secondaryColor, 10), this.activationBkgColor = this.activationBkgColor || this.secondaryColor, this.sequenceNumberColor = this.sequenceNumberColor || a(this.lineColor);
		let t = "#ECECFE", i = "#E9E9F1", e = o(t, {
			h: 180,
			l: 5
		});
		if (this.sectionBkgColor = this.sectionBkgColor || e, this.altSectionBkgColor = this.altSectionBkgColor || "white", this.sectionBkgColor = this.sectionBkgColor || i, this.sectionBkgColor2 = this.sectionBkgColor2 || t, this.excludeBkgColor = this.excludeBkgColor || "#eeeeee", this.taskBorderColor = this.taskBorderColor || this.primaryBorderColor, this.taskBkgColor = this.taskBkgColor || t, this.activeTaskBorderColor = this.activeTaskBorderColor || t, this.activeTaskBkgColor = this.activeTaskBkgColor || n(t, 23), this.gridColor = this.gridColor || "lightgrey", this.doneTaskBkgColor = this.doneTaskBkgColor || "lightgrey", this.doneTaskBorderColor = this.doneTaskBorderColor || "grey", this.critBorderColor = this.critBorderColor || "#ff8888", this.critBkgColor = this.critBkgColor || "red", this.todayLineColor = this.todayLineColor || "red", this.taskTextColor = this.taskTextColor || this.textColor, this.taskTextOutsideColor = this.taskTextOutsideColor || this.textColor, this.vertLineColor = this.vertLineColor || this.primaryBorderColor, this.taskTextLightColor = this.taskTextLightColor || this.textColor, this.taskTextColor = this.taskTextColor || this.primaryTextColor, this.taskTextDarkColor = this.taskTextDarkColor || this.textColor, this.taskTextClickableColor = this.taskTextClickableColor || "#003163", this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.personBorder = this.personBorder || this.primaryBorderColor, this.personBkg = this.personBkg || this.mainBkg, this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.specialStateColor = this.lineColor, this.cScale0 = this.cScale0 || t, this.cScale1 = this.cScale1 || i, this.cScale2 = this.cScale2 || e, this.cScale3 = this.cScale3 || o(t, { h: 30 }), this.cScale4 = this.cScale4 || o(t, { h: 60 }), this.cScale5 = this.cScale5 || o(t, { h: 90 }), this.cScale6 = this.cScale6 || o(t, { h: 120 }), this.cScale7 = this.cScale7 || o(t, { h: 150 }), this.cScale8 = this.cScale8 || o(t, {
			h: 210,
			l: 150
		}), this.cScale9 = this.cScale9 || o(t, { h: 270 }), this.cScale10 = this.cScale10 || o(t, { h: 300 }), this.cScale11 = this.cScale11 || o(t, { h: 330 }), this.darkMode) for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScale" + h] = c(this["cScale" + h], 75);
		else for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScale" + h] = c(this["cScale" + h], 25);
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScaleInv" + h] = this["cScaleInv" + h] || a(this["cScale" + h]);
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this.darkMode ? this["cScalePeer" + h] = this["cScalePeer" + h] || n(this["cScale" + h], 10) : this["cScalePeer" + h] = this["cScalePeer" + h] || c(this["cScale" + h], 10);
		this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScaleLabel" + h] = this["cScaleLabel" + h] || this.scaleLabelColor;
		let d = this.darkMode ? -4 : -1;
		for (let h = 0; h < 5; h++) this["surface" + h] = this["surface" + h] || o(this.mainBkg, {
			h: 180,
			s: -15,
			l: d * (5 + h * 3)
		}), this["surfacePeer" + h] = this["surfacePeer" + h] || o(this.mainBkg, {
			h: 180,
			s: -15,
			l: d * (8 + h * 3)
		});
		this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || t, this.fillType1 = this.fillType1 || i, this.fillType2 = this.fillType2 || o(t, { h: 64 }), this.fillType3 = this.fillType3 || o(i, { h: 64 }), this.fillType4 = this.fillType4 || o(t, { h: -64 }), this.fillType5 = this.fillType5 || o(i, { h: -64 }), this.fillType6 = this.fillType6 || o(t, { h: 128 }), this.fillType7 = this.fillType7 || o(i, { h: 128 }), this.pie1 = this.pie1 || t, this.pie2 = this.pie2 || i, this.pie3 = this.pie3 || e, this.pie4 = this.pie4 || o(t, { l: -10 }), this.pie5 = this.pie5 || o(i, { l: -10 }), this.pie6 = this.pie6 || o(e, { l: -10 }), this.pie7 = this.pie7 || o(t, {
			h: 60,
			l: -10
		}), this.pie8 = this.pie8 || o(t, {
			h: -60,
			l: -10
		}), this.pie9 = this.pie9 || o(t, {
			h: 120,
			l: 0
		}), this.pie10 = this.pie10 || o(t, {
			h: 60,
			l: -20
		}), this.pie11 = this.pie11 || o(t, {
			h: -60,
			l: -20
		}), this.pie12 = this.pie12 || o(t, {
			h: 120,
			l: -10
		}), this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || t, this.quadrant2Fill = this.quadrant2Fill || o(t, {
			r: 5,
			g: 5,
			b: 5
		}), this.quadrant3Fill = this.quadrant3Fill || o(t, {
			r: 10,
			g: 10,
			b: 10
		}), this.quadrant4Fill = this.quadrant4Fill || o(t, {
			r: 15,
			g: 15,
			b: 15
		}), this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor, this.quadrant2TextFill = this.quadrant2TextFill || o(this.primaryTextColor, {
			...
			yAxisLineColor: this.xyChart?.yAxisLineColor || this.primaryTextColor,
			plotColorPalette: this.xyChart?.plotColorPalette || "#FFF4DD,#FFD8B1,#FFA07A,#ECEFF1,#D6DBDF,#C3E0A8,#FFB6A4,#FFD74D,#738FA7,#FFFFF0"
		}, this.requirementBackground = this.requirementBackground || t, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? c(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || t, this.git1 = this.git1 || i, this.git2 = this.git2 || e, this.git3 = this.git3 || o(t, { h: -30 }), this.git4 = this.git4 || o(t, { h: -60 }), this.git5 = this.git5 || o(t, { h: -90 }), this.git6 = this.git6 || o(t, { h: 60 }), this.git7 = this.git7 || o(t, { h: 120 }), this.darkMode ? (this.git0 = n(this.git0, 25), this.git1 = n(this.git1, 25), this.git2 = n(this.git2, 25), this.git3 = n(this.git3, 25), this.git4 = n(this.git4, 25), this.git5 = n(this.git5, 25), this.git6 = n(this.git6, 25), this.git7 = n(this.git7, 25)) : (this.git0 = c(this.git0, 25), this.git1 = c(this.git1, 25), this.git2 = c(this.git2, 25), this.git3 = c(this.git3, 25), this.git4 = c(this.git4, 25), this.git5 = c(this.git5, 25), this.git6 = c(this.git6, 25), this.git7 = c(this.git7, 25)), this.gitInv0 = this.gitInv0 || a(this.git0), this.gitInv1 = this.gitInv1 || a(this.git1), this.gitInv2 = this.gitInv2 || a(this.git2), this.gitInv3 = this.gitInv3 || a(this.git3), this.gitInv4 = this.gitInv4 || a(this.git4), this.gitInv5 = this.gitInv5 || a(this.git5), this.gitInv6 = this.gitInv6 || a(this.git6), this.gitInv7 = this.gitInv7 || a(this.git7), this.branchLabelColor = this.branchLabelColor || (this.darkMode ? "black" : this.labelTextColor), this.gitBranchLabel0 = this.gitBranchLabel0 || this.branchLabelColor, this.gitBranchLabel1 = this.gitBranchLabel1 || this.branchLabelColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.branchLabelColor, this.gitBranchLabel3 = this.gitBranchLabel3 || this.branchLabelColor, this.gitBranchLabel4 = this.gitBranchLabel4 || this.branchLabelColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.branchLabelColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.branchLabelColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || F, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || L;
	}
	calculate(t) {
		if (typeof t != "object") {
			this.updateColors();
...
var Wi = class {
	...
	updateColors() {
		...
		this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || o(this.primaryColor, { h: 64 }), this.fillType3 = this.fillType3 || o(this.secondaryColor, { h: 64 }), this.fillType4 = this.fillType4 || o(this.primaryColor, { h: -64 }), this.fillType5 = this.fillType5 || o(this.secondaryColor, { h: -64 }), this.fillType6 = this.fillType6 || o(this.primaryColor, { h: 128 }), this.fillType7 = this.fillType7 || o(this.secondaryColor, { h: 128 }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || this.tertiaryColor, this.pie4 = this.pie4 || o(this.primaryColor, { l: -10 }), this.pie5 = this.pie5 || o(this.secondaryColor, { l: -10 }), this.pie6 = this.pie6 || o(this.tertiaryColor, { l: -10 }), this.pie7 = this.pie7 || o(this.primaryColor, {
			...
			h: 120,
			l: -10
		}), this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || o(this.primaryColor, {
			r: 5,
			g: 5,
			b: 5
		}), this.quadrant3Fill = this.quadrant3Fill || o(this.primaryColor, {
...
var Pi = class {
	...
	updateColors() {
		this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#28253D"), this.secondaryColor = this.secondaryColor || o(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || o(this.primaryColor, {
			h: 180,
			l: 5
		...
		this.sectionBkgColor = this.sectionBkgColor || e, this.altSectionBkgColor = this.altSectionBkgColor || "white", this.sectionBkgColor = this.sectionBkgColor || i, this.sectionBkgColor2 = this.sectionBkgColor2 || t, this.excludeBkgColor = this.excludeBkgColor || "#eeeeee", this.taskBorderColor = this.taskBorderColor || this.primaryBorderColor, this.taskBkgColor = this.taskBkgColor || t, this.activeTaskBorderColor = this.activeTaskBorderColor || t, this.activeTaskBkgColor = this.activeTaskBkgColor || n(t, 23), this.gridColor = this.gridColor || "lightgrey", this.doneTaskBkgColor = this.doneTaskBkgColor || "lightgrey", this.doneTaskBorderColor = this.doneTaskBorderColor || "grey", this.critBorderColor = this.critBorderColor || "#ff8888", this.critBkgColor = this.critBkgColor || "red", this.todayLineColor = this.todayLineColor || "red", this.taskTextColor = this.taskTextColor || this.textColor, this.vertLineColor = this.vertLineColor || this.primaryBorderColor, this.taskTextOutsideColor = this.taskTextOutsideColor || this.textColor, this.taskTextLightColor = this.taskTextLightColor || this.textColor, this.taskTextColor = this.taskTextColor || this.primaryTextColor, this.taskTextDarkColor = this.taskTextDarkColor || this.textColor, this.taskTextClickableColor = this.taskTextClickableColor || "#003163", this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.personBorder = this.personBorder || this.primaryBorderColor, this.personBkg = this.personBkg || this.mainBkg, this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.compositeTitleBackground = "#F9F9FB", this.altBackground = "#F9F9FB", this.stateEdgeLabelBackground = "#FFFFFF", this.fontWeight = 600, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.specialStateColor = this.lineColor;
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScale" + h] = this.mainBkg;
		if (this.darkMode) for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScale" + h] = c(this["cScale" + h], 75);
		else for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScale" + h] = c(this["cScale" + h], 25);
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this["cScaleInv" + h] = this["cScaleInv" + h] || a(this["cScale" + h]);
		for (let h = 0; h < this.THEME_COLOR_LIMIT; h++) this.darkMode ? this["cScalePeer" + h] = this["cScalePeer" + h] || n(this["cScale" + h], 10) : this["cScalePeer" + h] = this["cScalePeer" + h] || c(this["cScale" + h], 10);
		this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
...
var Ni = class {
	...
	updateColors() {
		if (this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#FFFFFF"), this.secondaryColor = this.secondaryColor || o(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || o(this.primaryColor, {
			h: 180,
			l: 5
...
var Ui = class {
	...
	updateColors() {
		this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#FFFFFF"), this.secondaryColor = this.secondaryColor || o(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || o(this.primaryColor, {
			h: 180,
			l: 5
		...
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this.darkMode ? this["cScalePeer" + i] = this["cScalePeer" + i] || n(this["cScale" + i], 10) : this["cScalePeer" + i] = this["cScalePeer" + i] || c(this["cScale" + i], 10);
		this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleLabel" + i] = c(this["cScale" + i], 75);
		let t = this.darkMode ? -4 : -1;
		for (let i = 0; i < 5; i++) this["surface" + i] = this["surface" + i] || o(this.mainBkg, {
			h: 180,
			s: -15,
...
var lt = {
	base: { getThemeVariables: Gr },
	dark: { getThemeVariables: $r },
	default: { getThemeVariables: jr },
	forest: { getThemeVariables: Vr },
	neutral: { getThemeVariables: Yr },
	neo: { getThemeVariables: Xr },
	"neo-dark": { getThemeVariables: Kr },
	redux: { getThemeVariables: Zr },
	"redux-dark": { getThemeVariables: Jr },
	"redux-color": { getThemeVariables: Qr },
	"redux-dark-color": { getThemeVariables: to }
};
var R = {
	flowchart: {
		useMaxWidth: !0,
...
var io = {
	...
	c4: {
		...
		external_personFont: m(function() {
			return {
		...
		external_systemFont: m(function() {
			return {
		...
		external_system_dbFont: m(function() {
			return {
		...
		external_system_queueFont: m(function() {
			return {
		...
		external_containerFont: m(function() {
			return {
		...
		external_container_dbFont: m(function() {
			return {
		...
		container_queueFont: m(function() {
			return {
		...
		external_container_queueFont: m(function() {
			return {
		...
		external_componentFont: m(function() {
			return {
		...
		external_component_dbFont: m(function() {
			return {
		...
		component_queueFont: m(function() {
			return {
		...
		external_component_queueFont: m(function() {
			return {
	...
	venn: { ...R.venn }
}, ro = m((r, t = "") => Object.keys(r).reduce((i, e) => Array.isArray(r[e]) ? i : typeof r[e] == "object" && r[e] !== null ? [
	...i,
	t + e,
	...ro(r[e], "")
] : [...i, t + e], []), "keyify"), oo = new Set(ro(io, "")), eo = io;
var si = m((r) => {
	if (pt.debug("sanitizeDirective called with", r), !(typeof r != "object" || r == null)) {
		...
		for (let t of Object.keys(r)) {
			if (pt.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !oo.has(t) || r[t] == null) {
				pt.debug("sanitize deleting key: ", t), delete r[t];
				continue;
			}
			if (typeof r[t] == "object") {
				if (t === "nodeColors") {
					let e = /^#[\da-f]{3,8}$|^rgb\([\d\s%,.]+\)$|^hsl\([\d\s%,.]+\)$|^[a-z]+$/i;
					for (let d of Object.keys(r[t])) (typeof r[t][d] != "string" || !e.test(r[t][d])) && (pt.debug("sanitize deleting invalid color:", d, r[t][d]), delete r[t][d]);
				} else pt.debug("sanitizing object", t), si(r[t]);
				continue;
			}
			for (let e of [
				"themeCSS",
				"fontFamily",
				"altFontFamily"
			]) t.includes(e) && (pt.debug("sanitizing css option", t), r[t] = ue(r[t]));
		}
...
var Ot = Object.freeze(eo), Gi = m((r) => !(r === !1 || [
	"false",
	"null",
	"0"
].includes(String(r).trim().toLowerCase())), "evaluate"), $ = D({}, Ot), li, Ct = [], wt = D({}, Ot), ai = m((r, t) => {
	let i = D({}, r), e = {};
	for (let d of t) ao(d), e = D(e, d);
	if (i = D(i, e), e.theme && e.theme in lt) {
		let h = D(D({}, li).themeVariables || {}, e.themeVariables);
		i.theme && i.theme in lt && (i.themeVariables = lt[i.theme].getThemeVariables(h));
	}
	return wt = i, no(wt), wt;
}, "updateCurrentConfig"), me = m((r) => ($ = D({}, Ot), $ = D($, r), r.theme && lt[r.theme] && ($.themeVariables = lt[r.theme].getThemeVariables(r.themeVariables)), ai($, Ct), $), "setSiteConfig"), Zh = m((r) => {
	li = D({}, r);
}, "saveConfigFromInitialize"), Jh = m((r) => ($ = D($, r), ai($, Ct), $), "updateSiteConfig"), Qh = m(() => D({}, $), "getSiteConfig"), lo = m((r) => (no(r), D(wt, r), It()), "setConfig"), It = m(() => D({}, wt), "getConfig"), ao = m((r) => {
	r && (["secure", ...$.secure ?? []].forEach((t) => {
	...
	si(r), r.fontFamily && !r.themeVariables?.fontFamily && (r.themeVariables = {
		...r.themeVariables,
	...
	so[r] || (pt.warn(xe[r]), so[r] = !0);
}, "issueWarning"), no = m((r) => {
	r && (r.lazyLoadedDiagrams || r.loadExternalDiagramsAtStartup) && ho("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), on = m(() => {
	let r = {};
	li && (r = D(r, li));
	for (let t of Ct) r = D(r, t);
	return r;
}, "getUserDefinedConfig"), co = m((r) => (r.flowchart?.htmlLabels != null && ho("FLOWCHART_HTML_LABELS_DEPRECATED"), Gi(r.htmlLabels ?? r.flowchart?.htmlLabels ?? !0)), "getEffectiveHtmlLabels");
var { entries: ko, setPrototypeOf: Co, isFrozen: ye, getPrototypeOf: fe, getOwnPropertyDescriptor: ke } = Object, { freeze: H, seal: V, create: Nt } = Object, { apply: Zi, construct: Ji } = typeof Reflect < "u" && Reflect;
H || (H = m(function(t) {
	return t;
}, "freeze"));
V || (V = m(function(t) {
...
var Dt = U(Array.prototype.forEach), Te = U(Array.prototype.lastIndexOf), go = U(Array.prototype.pop), zt = U(Array.prototype.push), be = U(Array.prototype.splice), ni = U(String.prototype.toLowerCase), $i = U(String.prototype.toString), ji = U(String.prototype.match), bt = U(String.prototype.replace), Be = U(String.prototype.indexOf), Se = U(String.prototype.trim), K = U(Object.prototype.hasOwnProperty), N = U(RegExp.prototype.test), Rt = Fe(TypeError);
function U(r) {
	return function(t) {
...
m(x, "addToSet");
function Le(r) {
	for (let t = 0; t < r.length; t++) K(r, t) || (r[t] = null);
	return r;
}
m(Le, "cleanArray");
function Q(r) {
	let t = Nt(null);
	for (let [i, e] of ko(r)) K(r, i) && (Array.isArray(e) ? t[i] = Le(e) : e && typeof e == "object" && e.constructor === Object ? t[i] = Q(e) : t[i] = e);
	return t;
}
m(Q, "clone");
function Wt(r, t) {
	for (; r !== null;) {
		let e = ke(r, t);
		if (e) {
			if (e.get) return U(e.get);
			if (typeof e.value == "function") return U(e.value);
		}
		r = fe(r);
	}
	function i() {
...
var po = H([
	...
	"xml:space",
	"xmlns:xlink"
]), Ae = V(/\{\{[\w\W]*|[\w\W]*\}\}/gm), ve = V(/<%[\w\W]*|[\w\W]*%>/gm), Me = V(/\$\{[\w\W]*/gm), qe = V(/^data-[\-\w.\u00B7-\uFFFF]+$/), we = V(/^aria-[\-\w]+$/), To = V(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), Oe = V(/^(?:\w+script|data):/i), Ie = V(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), bo = V(/^html$/i), De = V(/^[a-z][.\w]*(-[.\w]+)+$/i), yo = Object.freeze({
	__proto__: null,
	ARIA_ATTR: we,
	ATTR_WHITESPACE: Ie,
	CUSTOM_ELEMENT: De,
...
}, "_createTrustedTypesPolicy"), fo = m(function() {
	return {
...
function Bo() {
	let r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ze(), t = m((m) => Bo(m), "DOMPurify");
	if (t.version = "3.4.0", t.removed = [], !r || !r.document || r.document.nodeType !== Pt.document || !r.Element) return t.isSupported = !1, t;
	let { document: i } = r, e = i, d = e.currentScript, { DocumentFragment: h, HTMLTemplateElement: y, Node: f, Element: M, NodeFilter: q, NamedNodeMap: Y = r.NamedNodeMap || r.MozNamedAttrMap, HTMLFormElement: St, DOMParser: gt, trustedTypes: rt } = r, pt = M.prototype, ut = Wt(pt, "cloneNode"), Ft = Wt(pt, "remove"), gi = Wt(pt, "nextSibling"), pi = Wt(pt, "childNodes"), mt = Wt(pt, "parentNode");
	if (typeof y == "function") {
		let m = i.createElement("template");
		m.content && m.content.ownerDocument && (i = m.content.ownerDocument);
	}
	let w, Lt = "", { implementation: ui, createNodeIterator: wo, createDocumentFragment: Oo, getElementsByTagName: Io } = i, { importNode: Do } = e, W = fo();
	t.isSupported = typeof ko == "function" && typeof mt == "function" && ui && ui.createHTMLDocument !== void 0;
	let { MUSTACHE_EXPR: Ut, ERB_EXPR: Gt, TMPLIT_EXPR: $t, DATA_ATTR: zo, ARIA_ATTR: Ro, IS_SCRIPT_OR_DATA: Wo, ATTR_WHITESPACE: lr, CUSTOM_ELEMENT: Po } = yo, { IS_ALLOWED_URI: ar } = yo, v = null, hr = x({}, [
		...po,
		...Vi,
		...Yi,
		...Xi,
	...
	})), Et = null, jt = null, ot = Object.seal(Nt(null, {
		tagCheck: {
			writable: !0,
			configurable: !1,
			enumerable: !0,
	...
	})), cr = !0, mi = !0, dr = !1, Cr = !0, ht = !1, _t = !0, nt = !1, xi = !1, yi = !1, xt = !1, Vt = !1, Yt = !1, gr = !0, pr = !1, No = "user-content-", fi = !0, At = !1, yt = {}, Z = null, ki = x({}, [
		"annotation-xml",
		"audio",
		"colgroup",
		"desc",
		...
		"style",
		"xmlns"
	]), Xt = "http://www.w3.org/1998/Math/MathML", Kt = "http://www.w3.org/2000/svg", J = "http://www.w3.org/1999/xhtml", ft = J, bi = !1, Bi = null, Ho = x({}, [
		Xt,
		Kt,
		J
	], $i), Zt = x({}, [
		...
		"ms",
		"mtext"
	]), Jt = x({}, ["annotation-xml"]), Uo = x({}, [
		"title",
		"style",
		"font",
		"a",
		"script"
	]), vt = null, Go = ["application/xhtml+xml", "text/html"], $o = "text/html", E = null, kt = null, jo = i.createElement("form"), yr = m(function(l) {
		return l instanceof RegExp || l instanceof Function;
	}, "isRegexOrFunction"), Si = m(function() {
		let l = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
		if (!(kt && kt === l)) {
			if ((!l || typeof l != "object") && (l = {}), l = Q(l), vt = Go.indexOf(l.PARSER_MEDIA_TYPE) === -1 ? $o : l.PARSER_MEDIA_TYPE, E = vt === "application/xhtml+xml" ? $i : ni, v = K(l, "ALLOWED_TAGS") ? x({}, l.ALLOWED_TAGS, E) : hr, O = K(l, "ALLOWED_ATTR") ? x({}, l.ALLOWED_ATTR, E) : nr, Bi = K(l, "ALLOWED_NAMESPACES") ? x({}, l.ALLOWED_NAMESPACES, $i) : Ho, Ti = K(l, "ADD_URI_SAFE_ATTR") ? x(Q(xr), l.ADD_URI_SAFE_ATTR, E) : xr, ur = K(l, "ADD_DATA_URI_TAGS") ? x(Q(mr), l.ADD_DATA_URI_TAGS, E) : mr, Z = K(l, "FORBID_CONTENTS") ? x({}, l.FORBID_CONTENTS, E) : ki, Et = K(l, "FORBID_TAGS") ? x({}, l.FORBID_TAGS, E) : Q({}), jt = K(l, "FORBID_ATTR") ? x({}, l.FORBID_ATTR, E) : Q({}), yt = K(l, "USE_PROFILES") ? l.USE_PROFILES : !1, cr = l.ALLOW_ARIA_ATTR !== !1, mi = l.ALLOW_DATA_ATTR !== !1, dr = l.ALLOW_UNKNOWN_PROTOCOLS || !1, Cr = l.ALLOW_SELF_CLOSE_IN_ATTR !== !1, ht = l.SAFE_FOR_TEMPLATES || !1, _t = l.SAFE_FOR_XML !== !1, nt = l.WHOLE_DOCUMENT || !1, xt = l.RETURN_DOM || !1, Vt = l.RETURN_DOM_FRAGMENT || !1, Yt = l.RETURN_TRUSTED_TYPE || !1, yi = l.FORCE_BODY || !1, gr = l.SANITIZE_DOM !== !1, pr = l.SANITIZE_NAMED_PROPS || !1, fi = l.KEEP_CONTENT !== !1, At = l.IN_PLACE || !1, ar = l.ALLOWED_URI_REGEXP || To, ft = l.NAMESPACE || J, Zt = l.MATHML_TEXT_INTEGRATION_POINTS || Zt, Jt = l.HTML_INTEGRATION_POINTS || Jt, B = l.CUSTOM_ELEMENT_HANDLING || Nt(null), l.CUSTOM_ELEMENT_HANDLING && yr(l.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (B.tagNameCheck = l.CUSTOM_ELEMENT_HANDLING.tagNameCheck), l.CUSTOM_ELEMENT_HANDLING && yr(l.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (B.attributeNameCheck = l.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), l.CUSTOM_ELEMENT_HANDLING && typeof l.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (B.allowCustomizedBuiltInElements = l.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), ht && (mi = !1), Vt && (xt = !0), yt && (v = x({}, uo), O = Nt(null), yt.html === !0 && (x(v, po), x(O, mo)), yt.svg === !0 && (x(v, Vi), x(O, Ki), x(O, hi)), yt.svgFilters === !0 && (x(v, Yi), x(O, Ki), x(O, hi)), yt.mathMl === !0 && (x(v, Xi), x(O, xo), x(O, hi))), ot.tagCheck = null, ot.attributeCheck = null, l.ADD_TAGS && (typeof l.ADD_TAGS == "function" ? ot.tagCheck = l.ADD_TAGS : (v === hr && (v = Q(v)), x(v, l.ADD_TAGS, E))), l.ADD_ATTR && (typeof l.ADD_ATTR == "function" ? ot.attributeCheck = l.ADD_ATTR : (O === nr && (O = Q(O)), x(O, l.ADD_ATTR, E))), l.ADD_URI_SAFE_ATTR && x(Ti, l.ADD_URI_SAFE_ATTR, E), l.FORBID_CONTENTS && (Z === ki && (Z = Q(Z)), x(Z, l.FORBID_CONTENTS, E)), l.ADD_FORBID_CONTENTS && (Z === ki && (Z = Q(Z)), x(Z, l.ADD_FORBID_CONTENTS, E)), fi && (v["#text"] = !0), nt && x(v, [
				"html",
				"head",
				"body"
			]), v.table && (x(v, ["tbody"]), delete Et.tbody), l.TRUSTED_TYPES_POLICY) {
				if (typeof l.TRUSTED_TYPES_POLICY.createHTML != "function") throw Rt("TRUSTED_TYPES_POLICY configuration option must provide a \"createHTML\" hook.");
				if (typeof l.TRUSTED_TYPES_POLICY.createScriptURL != "function") throw Rt("TRUSTED_TYPES_POLICY configuration option must provide a \"createScriptURL\" hook.");
				w = l.TRUSTED_TYPES_POLICY, Lt = w.createHTML("");
			} else w === void 0 && (w = Re(rt, d)), w !== null && typeof Lt == "string" && (Lt = w.createHTML(""));
			H && H(l), kt = l;
		}
	}, "_parseConfig"), fr = x({}, [
		...Vi,
		...Yi,
		...Ee
	]), kr = x({}, [...Xi, ..._e]), Vo = m(function(l) {
		let C = mt(l);
		(!C || !C.tagName) && (C = {
			namespaceURI: ft,
			tagName: "template"
		});
		let g = ni(l.tagName), k = ni(C.tagName);
		return Bi[l.namespaceURI] ? l.namespaceURI === Kt ? C.namespaceURI === J ? g === "svg" : C.namespaceURI === Xt ? g === "svg" && (k === "annotation-xml" || Zt[k]) : !!fr[g] : l.namespaceURI === Xt ? C.namespaceURI === J ? g === "math" : C.namespaceURI === Kt ? g === "math" && Jt[k] : !!kr[g] : l.namespaceURI === J ? C.namespaceURI === Kt && !Jt[k] || C.namespaceURI === Xt && !Zt[k] ? !1 : !kr[g] && (Uo[g] || !fr[g]) : !!(vt === "application/xhtml+xml" && Bi[l.namespaceURI]) : !1;
	}, "_checkValidNamespace"), X = m(function(l) {
		zt(t.removed, { element: l });
		try {
			mt(l).removeChild(l);
		} catch {
			Ft(l);
		}
	}, "_forceRemove"), ct = m(function(l, C) {
		try {
			zt(t.removed, {
				attribute: C.getAttributeNode(l),
				from: C
			});
		} catch {
			zt(t.removed, {
		...
		if (C.removeAttribute(l), l === "is") if (xt || Vt) try {
			X(C);
		} catch {}
		else try {
			C.setAttribute(l, "");
		} catch {}
	}, "_removeAttribute"), Tr = m(function(l) {
		let C = null, g = null;
		if (yi) l = "<remove></remove>" + l;
		else {
			let S = ji(l, /^[\r\n\t ]+/);
			g = S && S[0];
		}
		vt === "application/xhtml+xml" && ft === J && (l = "<html xmlns=\"http://www.w3.org/1999/xhtml\"><head></head><body>" + l + "</body></html>");
		let k = w ? w.createHTML(l) : l;
		if (ft === J) try {
			C = new gt().parseFromString(k, vt);
		} catch {}
		if (!C || !C.documentElement) {
			C = ui.createDocument(ft, "template", null);
			try {
				C.documentElement.innerHTML = bi ? Lt : k;
			} catch {}
		}
		let z = C.body || C.documentElement;
		return l && g && z.insertBefore(i.createTextNode(g), z.childNodes[0] || null), ft === J ? Io.call(C, nt ? "html" : "body")[0] : nt ? C.documentElement : z;
	}, "_initDocument"), br = m(function(l) {
		return wo.call(l.ownerDocument || l, l, q.SHOW_ELEMENT | q.SHOW_COMMENT | q.SHOW_TEXT | q.SHOW_PROCESSING_INSTRUCTION | q.SHOW_CDATA_SECTION, null);
	}, "_createNodeIterator"), Fi = m(function(l) {
		return l instanceof St && (typeof l.nodeName != "string" || typeof l.textContent != "string" || typeof l.removeChild != "function" || !(l.attributes instanceof Y) || typeof l.removeAttribute != "function" || typeof l.setAttribute != "function" || typeof l.namespaceURI != "string" || typeof l.insertBefore != "function" || typeof l.hasChildNodes != "function");
	}, "_isClobbered"), Li = m(function(l) {
		return typeof f == "function" && l instanceof f;
	}, "_isNode");
	function tt(m, l, C) {
		Dt(m, (g) => {
			g.call(t, l, C, kt);
	...
	let Br = m(function(l) {
		let C = null;
		if (tt(W.beforeSanitizeElements, l, null), Fi(l)) return X(l), !0;
		let g = E(l.nodeName);
		if (tt(W.uponSanitizeElement, l, {
			tagName: g,
			allowedTags: v
		}), _t && l.hasChildNodes() && !Li(l.firstElementChild) && N(/<[/\w!]/g, l.innerHTML) && N(/<[/\w!]/g, l.textContent) || _t && l.namespaceURI === J && g === "style" && Li(l.firstElementChild) || l.nodeType === Pt.progressingInstruction || _t && l.nodeType === Pt.comment && N(/<[/\w]/g, l.data)) return X(l), !0;
		if (Et[g] || !(ot.tagCheck instanceof Function && ot.tagCheck(g)) && !v[g]) {
			if (!Et[g] && Fr(g) && (B.tagNameCheck instanceof RegExp && N(B.tagNameCheck, g) || B.tagNameCheck instanceof Function && B.tagNameCheck(g))) return !1;
			if (fi && !Z[g]) {
				let k = mt(l) || l.parentNode, z = pi(l) || l.childNodes;
				if (z && k) {
					let S = z.length;
					for (let G = S - 1; G >= 0; --G) {
						let j = ut(z[G], !0);
						j.__removalCount = (l.__removalCount || 0) + 1, k.insertBefore(j, gi(l));
					}
				}
			}
			return X(l), !0;
		}
		return l instanceof M && !Vo(l) || (g === "noscript" || g === "noembed" || g === "noframes") && N(/<\/no(script|embed|frames)/i, l.innerHTML) ? (X(l), !0) : (ht && l.nodeType === Pt.text && (C = l.textContent, Dt([
			Ut,
			Gt,
			$t
		], (k) => {
			C = bt(C, k, " ");
		}), l.textContent !== C && (zt(t.removed, { element: l.cloneNode() }), l.textContent = C)), tt(W.afterSanitizeElements, l, null), !1);
	}, "_sanitizeElements"), Sr = m(function(l, C, g) {
		if (jt[C] || gr && (C === "id" || C === "name") && (g in i || g in jo)) return !1;
		if (!(mi && !jt[C] && N(zo, C))) {
			if (!(cr && N(Ro, C))) {
				if (!(ot.attributeCheck instanceof Function && ot.attributeCheck(C, l))) {
					if (!O[C] || jt[C]) {
						if (!(Fr(l) && (B.tagNameCheck instanceof RegExp && N(B.tagNameCheck, l) || B.tagNameCheck instanceof Function && B.tagNameCheck(l)) && (B.attributeNameCheck instanceof RegExp && N(B.attributeNameCheck, C) || B.attributeNameCheck instanceof Function && B.attributeNameCheck(C, l)) || C === "is" && B.allowCustomizedBuiltInElements && (B.tagNameCheck instanceof RegExp && N(B.tagNameCheck, g) || B.tagNameCheck instanceof Function && B.tagNameCheck(g)))) return !1;
					} else if (!Ti[C]) {
						if (!N(ar, bt(g, lr, ""))) {
							if (!((C === "src" || C === "xlink:href" || C === "href") && l !== "script" && Be(g, "data:") === 0 && ur[l])) {
								if (!(dr && !N(Wo, bt(g, lr, "")))) {
									if (g) return !1;
								}
							}
		...
		return !0;
	}, "_isValidAttribute"), Fr = m(function(l) {
		return l !== "annotation-xml" && ji(l, Po);
	}, "_isBasicCustomElement"), Lr = m(function(l) {
		tt(W.beforeSanitizeAttributes, l, null);
		let { attributes: C } = l;
		if (!C || Fi(l)) return;
		let g = {
			attrName: "",
		...
		for (; k--;) {
			let { name: S, namespaceURI: G, value: j } = C[k], et = E(S), Ei = j, I = S === "value" ? Ei : Se(Ei);
			if (g.attrName = et, g.attrValue = I, g.keepAttr = !0, g.forceKeepAttr = void 0, tt(W.uponSanitizeAttribute, l, g), I = g.attrValue, pr && (et === "id" || et === "name") && (ct(S, l), I = No + I), _t && N(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, I)) {
				ct(S, l);
				continue;
			}
			if (et === "attributename" && ji(I, "href")) {
				ct(S, l);
				continue;
			}
			...
			if (w && typeof rt == "object" && typeof rt.getAttributeType == "function" && !G) switch (rt.getAttributeType(_r, et)) {
				case "TrustedHTML":
					I = w.createHTML(I);
					break;
			...
			if (I !== Ei) try {
				G ? l.setAttributeNS(G, S, I) : l.setAttribute(S, I), Fi(l) ? X(l) : go(t.removed);
			} catch {
				ct(S, l);
			}
		}
		tt(W.afterSanitizeAttributes, l, null);
	}, "_sanitizeAttributes"), Er = m(function(l) {
		let C = null, g = br(l);
		for (tt(W.beforeSanitizeShadowDOM, l, null); C = g.nextNode();) tt(W.uponSanitizeShadowNode, C, null), Br(C), Lr(C), C.content instanceof h && Er(C.content);
		tt(W.afterSanitizeShadowDOM, l, null);
	}, "_sanitizeShadowDOM");
	return t.sanitize = function(m) {
		let l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, C = null, g = null, k = null, z = null;
		if (bi = !m, bi && (m = "<!-->"), typeof m != "string" && !Li(m)) if (typeof m.toString == "function") {
			if (m = m.toString(), typeof m != "string") throw Rt("dirty is not a string, aborting");
		} else throw Rt("toString is not a function");
		if (!t.isSupported) return m;
		if (xi || Si(l), t.removed = [], typeof m == "string" && (At = !1), At) {
			if (m.nodeName) {
				let j = E(m.nodeName);
				if (!v[j] || Et[j]) throw Rt("root node is forbidden and cannot be sanitized in-place");
			}
		} else if (m instanceof f) C = Tr("<!---->"), g = C.ownerDocument.importNode(m, !0), g.nodeType === Pt.element && g.nodeName === "BODY" || g.nodeName === "HTML" ? C = g : C.appendChild(g);
		else {
			if (!xt && !ht && !nt && m.indexOf("<") === -1) return w && Yt ? w.createHTML(m) : m;
			if (C = Tr(m), !C) return xt ? null : Yt ? Lt : "";
		}
		C && yi && X(C.firstChild);
		let S = br(At ? m : C);
		for (; k = S.nextNode();) Br(k), Lr(k), k.content instanceof h && Er(k.content);
		if (At) return m;
		if (xt) {
			if (ht) {
				C.normalize();
			...
			if (Vt) for (z = Oo.call(C.ownerDocument); C.firstChild;) z.appendChild(C.firstChild);
			else z = C;
			return (O.shadowroot || O.shadowrootmode) && (z = Do.call(e, z, !0)), z;
		}
		let G = nt ? C.outerHTML : C.innerHTML;
		return nt && v["!doctype"] && C.ownerDocument && C.ownerDocument.doctype && C.ownerDocument.doctype.name && N(bo, C.ownerDocument.doctype.name) && (G = "<!DOCTYPE " + C.ownerDocument.doctype.name + `>
` + G), ht && Dt([
			Ut,
			Gt,
			$t
			...
			G = bt(G, j, " ");
		}), w && Yt ? w.createHTML(G) : G;
	}, t.setConfig = function() {
		Si(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), xi = !0;
	}, t.clearConfig = function() {
		kt = null, xi = !1;
	}, t.isValidAttribute = function(m, l, C) {
		kt || Si({});
		return Sr(E(m), E(l), C);
	}, t.addHook = function(m, l) {
		typeof l == "function" && zt(W[m], l);
	}, t.removeHook = function(m, l) {
		if (l !== void 0) {
			let C = Te(W[m], l);
			return C === -1 ? void 0 : be(W[m], C, 1)[0];
		}
		return go(W[m]);
...
var Bt = Bo();
var Ht = /<br\s*\/?>/gi, We = m((r) => r ? _o(r).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), Pe = (() => {
	let r = !1;
	return () => {
		r || (Ne(), r = !0);
	};
...
var Eo = m((r) => (Pe(), Bt.sanitize(r)), "removeScript"), So = m((r, t) => {
	if (co(t)) {
		let i = t.securityLevel;
		i === "antiscript" || i === "strict" || i === "sandbox" ? r = Eo(r) : i !== "loose" && (r = _o(r), r = r.replace(/</g, "&lt;").replace(/>/g, "&gt;"), r = r.replace(/=/g, "&equals;"), r = $e(r));
	}
	return r;
}, "sanitizeMore"), at = m((r, t) => r && (t.dompurifyConfig ? r = Bt.sanitize(So(r, t), t.dompurifyConfig).toString() : r = Bt.sanitize(So(r, t), { FORBID_TAGS: ["style"] }).toString(), r), "sanitizeText"), He = m((r, t) => typeof r == "string" ? at(r, t) : r.flat().map((i) => at(i, t)), "sanitizeTextOrArray"), Ue = m((r) => Ht.test(r), "hasBreaks"), Ge = m((r) => r.split(Ht), "splitBreaks"), $e = m((r) => r.replace(/#br#/g, "<br/>"), "placeholderToBreak"), _o = m((r) => r.replace(Ht, "#br#"), "breakToPlaceholder"), je = m((r) => {
	let t = "";
...
var Ve = m(function(...r) {
	...
	return Math.max(...t);
}, "getMax"), Ye = m(function(...r) {
	let t = r.filter((i) => !isNaN(i));
	return Math.min(...t);
}, "getMin"), cn = m(function(r) {
	let t = r.split(/(,)/), i = [];
	...
	return i.join("");
}, "parseGenericTypes"), Qi = m((r, t) => Math.max(0, r.split(t).length - 1), "countOccurrence"), Xe = m((r, t) => {
	let i = Qi(r, "~"), e = Qi(t, "~");
	return i === 1 && e === 1;
}, "shouldCombineSets"), Ke = m((r) => {
	let t = Qi(r, "~"), i = !1;
	if (t <= 1) return r;
...
}, "processSet"), Fo = m(() => window.MathMLElement !== void 0, "isMathMLSupported"), ci = /\$\$(.*)\$\$/g, Lo = m((r) => (r.match(ci)?.length ?? 0) > 0, "hasKatex"), dn = m(async (r, t) => {
	let i = document.createElement("div");
	i.innerHTML = await Je(r, t), i.id = "katex-temp", i.style.visibility = "hidden", i.style.position = "absolute", i.style.top = "0", document.querySelector("body")?.insertAdjacentElement("beforeend", i);
	let d = {
		width: i.clientWidth,
		height: i.clientHeight
	};
	return i.remove(), d;
}, "calculateMathMLDimensions"), Ze = m(async (r, t) => {
	if (!Lo(r)) return r;
	if (!(Fo() || t.legacyMathML || t.forceLegacyMathML)) return r.replace(ci, "MathML is unsupported in this environment.");
	{
		let { default: i } = await __vitePreload(async () => {
			const { default: i } = await import("./katex-K3KEBU37-CG2KMnVQ.js");
			return { default: i };
		}, __vite__mapDeps([0,1])), e = t.forceLegacyMathML || !Fo() && t.legacyMathML ? "htmlAndMathml" : "mathml";
		return r.split(Ht).map((d) => Lo(d) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${d}</div>` : `<div>${d}</div>`).join("").replace(ci, (d, h) => i.renderToString(h, {
			throwOnError: !0,
			displayMode: !0,
			output: e
		}).replace(/\n/g, " ").replace(/<annotation.*<\/annotation>/g, ""));
	}
	return r.replace(ci, "Katex is not supported in @mermaid-js/tiny. Please use the full mermaid library.");
}, "renderKatexUnsanitized"), Je = m(async (r, t) => at(await Ze(r, t), t), "renderKatexSanitized"), Cn = {
	getRows: We,
	sanitizeText: at,
...
}, "d3Attrs"), ts = m(function(r, t, i) {
	let e = /* @__PURE__ */ new Map();
	return i ? (e.set("width", "100%"), e.set("style", `max-width: ${t}px;`)) : (e.set("height", r), e.set("width", t)), e;
}, "calculateSvgSizeAttrs"), is = m(function(r, t, i, e) {
	Qe(r, ts(t, i, e));
}, "configureSvgSize"), Ao = m(function(r, t, i, e) {
	let d = t.node().getBBox(), h = d.width, y = d.height;
	pt.info(`SVG bounds: ${h}x${y}`, d);
	let f = 0, M = 0;
	pt.info(`Graph bounds: ${f}x${M}`, r), f = h + i * 2, M = y + i * 2, pt.info(`Calculated bounds: ${f}x${M}`), is(t, M, f, e);
	let q = `${d.x - i} ${d.y - i} ${d.width + 2 * i} ${d.height + 2 * i}`;
	t.attr("viewBox", q);
}, "setupGraphViewbox");
var di = {};
function fn(r) {
...
m(fn, "cssStyleSheetToString");
var rs = m((r, t, i, e) => {
	let d = "";
	return r in di && di[r] ? d = di[r]({
		...i,
		svgId: e
	}) : pt.warn(`No theme found for ${r}`), ` & {
...
var tr = "", ir = "", rr = "", or = m((r) => at(r, It()), "sanitizeText"), os = m(() => {
	tr = "", rr = "", ir = "";
}, "clear"), es = m((r) => {
	tr = or(r).replace(/^\s+/g, "");
}, "setAccTitle"), ss = m(() => tr, "getAccTitle"), ls = m((r) => {
	rr = or(r).replace(/\n\s+/g, `
`);
}, "setAccDescription"), as = m(() => rr, "getAccDescription"), hs = m((r) => {
	ir = or(r);
}, "setDiagramTitle"), ns = m(() => ir, "getDiagramTitle");
var Mo = pt, cs = Wh, qo = It, qn = lo, wn = Ot;
var ds = m((r) => at(r, qo()), "sanitizeText"), Cs = Ao, gs = m(() => er, "getCommonDb"), Ci = {}, On = m((r, t, i) => {
	Ci[r] && Mo.warn(`Diagram with id ${r} already registered. Overwriting.`), Ci[r] = t, i && _i(r, i), vo(r, t.styles), t.injectUtils?.(Mo, cs, qo, ds, Cs, gs(), () => {});
}, "registerDiagram"), In = m((r) => {
	if (r in Ci) return Ci[r];
	throw new sr(r);
}, "getDiagram"), sr = class extends Error {
	static {
...
*/
//#endregion
export { rn as $, ds as A, ks as B, at as C, co as D, cn as E, hs as F, n as G, ls as H, is as I, on as J, ns as K, je as L, er as M, es as N, de as O, fn as P, qr as Q, jr as R, as as S, c as T, lt as U, lo as V, me as W, qn as X, os as Y, qo as Z, Qh as _, D as a, wn as at, Ts as b, In as c, Jh as d, si as et, Lo as f, P as g, Ot as h, Cs as i, ue as it, eo as j, dn as k, It as l, On as m, Bt as n, ti as nt, Gi as o, Mr as p, oe as q, Cn as r, tn as rt, Ht as s, Ao as t, ss as tt, Je as u, Qt as v, bs as w, Zh as x, T as y, kn as z };
