...
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/chunk-7W6UQGC5.mjs
var Bo = n((fr, lr) => {
	"use strict";
	(function(t, e) {
		typeof fr == "object" && typeof lr < "u" ? lr.exports = e() : typeof define == "function" && define.amd ? define(e) : (t = typeof globalThis < "u" ? globalThis : t || self).dayjs = e();
	})(fr, (function() {
		"use strict";
		var t = 1e3, e = 6e4, n = 36e5, i = "millisecond", o = "second", a = "minute", s = "hour", u = "day", l = "week", f = "month", h = "quarter", p = "year", c = "date", m$1 = "Invalid Date", _ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, M = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, T = {
			name: "en",
			weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
			months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
			ordinal: m(function(v) {
				var d = [
					"th",
					"st",
					"nd",
			...
			s: k,
			z: m(function(v) {
				var d = -v.utcOffset(), x = Math.abs(d), S = Math.floor(x / 60), y = x % 60;
				return (d <= 0 ? "+" : "-") + k(S, 2, "0") + ":" + k(y, 2, "0");
			}, "z"),
			m: m(function v(d, x) {
				if (d.date() < x.date()) return -v(x, d);
				var S = 12 * (x.year() - d.year()) + (x.month() - d.month()), y = d.clone().add(S, f), D = x - y < 0, $ = d.clone().add(S + (D ? -1 : 1), f);
		...
		A[C] = T;
		var O = "$isDayjsObject", w = m(function(v) {
			return v instanceof B || !(!v || !v[O]);
		}, "S"), Y = m(function v(d, x, S) {
			var y;
			if (!d) return C;
			if (typeof d == "string") {
				var D = d.toLowerCase();
		...
		var B = (function() {
			...
			return d.parse = function(x) {
				...
				var y = this, D = !!E.u(S) || S, $ = E.p(x), P = m(function(st, Z) {
					var b = E.w(y.$u ? Date.UTC(y.$y, Z, st) : new Date(y.$y, Z, st), y);
					return D ? b : b.endOf(u);
				}, "l"), z = m(function(st, Z) {
					return E.w(y.toDate()[st].apply(y.toDate("s"), (D ? [
						0,
						0,
						0,
						0
				...
				var y, D = E.p(x), $ = "set" + (this.$u ? "UTC" : ""), P = (y = {}, y[u] = $ + "Date", y[c] = $ + "Date", y[f] = $ + "Month", y[p] = $ + "FullYear", y[s] = $ + "Hours", y[a] = $ + "Minutes", y[o] = $ + "Seconds", y[i] = $ + "Milliseconds", y)[D], z = D === u ? this.$D + (S - this.$W) : S;
				if (D === f || D === p) {
					var W = this.clone().set(c, 1);
					W.$d[P](z), W.init(), this.$d = W.set(c, Math.min(this.$D, W.daysInMonth())).$d;
				} else P && this.$d[P](z);
				...
				var y, D = this;
				x = Number(x);
				var $ = E.p(S), P = m(function(X) {
					var J = U(D);
					return E.w(J.date(J.date() + Math.round(X * x)), D);
				}, "y");
				...
				var D = x || "YYYY-MM-DDTHH:mm:ssZ", $ = E.z(this), P = this.$H, z = this.$m, W = this.$M, X = y.weekdays, J = y.months, ht = y.meridiem, Q = m(function(Z, b, R, F) {
				...
				var D, $ = this, P = E.p(S), z = U(x), W = (z.utcOffset() - this.utcOffset()) * e, X = this - z, J = m(function() {
					return E.m($, z);
				}, "D");
				switch (P) {
					case p:
...
function Xt(t) {
	let e, n, i;
	t.length !== 2 ? (e = Vt, n = m((u, l) => Vt(t(u), l), "compare2"), i = m((u, l) => t(u) - l, "delta")) : (e = t === Vt || t === cr ? t : cu, n = t, i = t);
...
var fe = class extends Map {
	...
	set(e, n) {
		return super.set(mu(this, e), n);
	}
	delete(e) {
		return super.delete(du(this, e));
	}
};
...
m(xu, "keyof");
var _u = Math.sqrt(50), gu = Math.sqrt(10), yu = Math.sqrt(2);
function cn(t, e, n) {
	let i = (e - t) / Math.max(0, n), o = Math.floor(Math.log10(i)), a = i / Math.pow(10, o), s = a >= _u ? 10 : a >= gu ? 5 : a >= yu ? 2 : 1, u, l, f;
	return o < 0 ? (f = Math.pow(10, -o) / s, u = Math.round(t * f), l = Math.round(e * f), u / f < t && ++u, l / f > e && --l, f = -f) : (f = Math.pow(10, o) * s, u = Math.round(t / f), l = Math.round(e / f), u * f < t && ++u, l * f > e && --l), l < u && .5 <= n && n < 2 ? cn(t, e, n * 2) : [
		u,
		l,
		f
	];
...
function pn(t, e, n) {
	...
	for (var i = -1, o = Math.max(0, Math.ceil((e - t) / n)) | 0, a = new Array(o); ++i < o;) a[i] = t + i * n;
	return a;
}
m(pn, "range");
function mr(t) {
...
function Ko(t, e) {
	...
	function c(m) {
		var _ = i ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()), M = o ?? (e.tickFormat ? e.tickFormat.apply(e, n) : mr), T = Math.max(a, 0) + u, k = e.range(), I = +k[0] + l, C = +k[k.length - 1] + l, A = (e.bandwidth ? Mu : bu)(e.copy(), l), O = m.selection ? m.selection() : m, w = O.selectAll(".domain").data([null]), Y = O.selectAll(".tick").data(_, e).order(), U = Y.exit(), E = Y.enter().append("g").attr("class", "tick"), B = Y.select("line"), N = Y.select("text");
		w = w.merge(w.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), Y = Y.merge(E), B = B.merge(E.append("line").attr("stroke", "currentColor").attr(h + "2", f * a)), N = N.merge(E.append("text").attr("fill", "currentColor").attr(h, f * T).attr("dy", t === dn ? "0em" : t === xr ? "0.71em" : "0.32em")), m !== O && (w = w.transition(m), Y = Y.transition(m), B = B.transition(m), N = N.transition(m), U = U.transition(m).attr("opacity", Qo).attr("transform", function(v) {
			return isFinite(v = A(v)) ? p(v + l) : this.getAttribute("transform");
		}), E.attr("opacity", Qo).attr("transform", function(v) {
			var d = this.parentNode.__axis;
			return p((d && isFinite(d = d(v)) ? d : A(v)) + l);
	...
	return m(c, "axis"), c.scale = function(m) {
...
function _r(t) {
	...
	for (var e = this._groups, n = e.length, i = new Array(n), o = 0; o < n; ++o) for (var a = e[o], s = a.length, u = i[o] = new Array(s), l, f, h = 0; h < s; ++h) (l = a[h]) && (f = t.call(l, l.__data__, h, a)) && ("__data__" in l && (f.__data__ = l.__data__), u[h] = f);
...
function Au(t) {
	return function() {
		return gr(t.apply(this, arguments));
	};
}
m(Au, "arrayAll");
function yr(t) {
	typeof t == "function" ? t = Au(t) : t = ce(t);
	for (var e = this._groups, n = e.length, i = [], o = [], a = 0; a < n; ++a) for (var s = e[a], u = s.length, l, f = 0; f < u; ++f) (l = s[f]) && (i.push(t.call(l, l.__data__, f, s)), o.push(l));
	return new G(i, o);
}
m(yr, "default");
function he(t) {
...
Re.prototype = {
	constructor: Re,
	appendChild: m(function(t) {
		return this._parent.insertBefore(t, this._next);
	}, "appendChild"),
	insertBefore: m(function(t, e) {
		return this._parent.insertBefore(t, e);
	}, "insertBefore"),
	querySelector: m(function(t) {
		return this._parent.querySelector(t);
	}, "querySelector"),
	querySelectorAll: m(function(t) {
...
function Yu(t, e, n, i, o, a, s) {
	var u, l, f = /* @__PURE__ */ new Map(), h = e.length, p = a.length, c = new Array(h), m;
	for (u = 0; u < h; ++u) (l = e[u]) && (c[u] = m = s.call(l, l.__data__, u, e) + "", f.has(m) ? o[u] = l : f.set(m, l));
	for (u = 0; u < p; ++u) m = s.call(t, a[u], u, a) + "", (l = f.get(m)) ? (i[u] = l, l.__data__ = a[u], f.delete(m)) : n[u] = new Re(t, a[u]);
...
function kr(t, e) {
	...
	for (var a = o.length, s = new Array(a), u = new Array(a), l = new Array(a), f = 0; f < a; ++f) {
		var h = i[f], p = o[f], c = p.length, m = Uu(t.call(h, h && h.__data__, f, i)), _ = m.length, M = u[f] = new Array(_), T = s[f] = new Array(_);
		n(h, p, M, T, l[f] = new Array(c), m, e);
...
m(Cr, "default");
function Nr(t) {
	for (var e = t.selection ? t.selection() : t, n = this._groups, i = e._groups, o = n.length, a = i.length, s = Math.min(o, a), u = new Array(o), l = 0; l < s; ++l) for (var f = n[l], h = i[l], p = f.length, c = u[l] = new Array(p), m, _ = 0; _ < p; ++_) (m = f[_] || h[_]) && (c[_] = m);
	for (; l < o; ++l) u[l] = n[l];
...
function wt(t) {
	var e = t += "", n = e.indexOf(":");
	return n >= 0 && (e = t.slice(0, n)) !== "xmlns" && (t = t.slice(n + 1)), Yr.hasOwnProperty(e) ? {
		space: Yr[e],
		local: t
	} : t;
}
...
function Fr(t, e) {
	...
	return this.each((e == null ? n.local ? Hu : zu : typeof e == "function" ? n.local ? Vu : Wu : n.local ? qu : Bu)(n, e));
}
m(Fr, "default");
function Pe(t) {
...
m(Zu, "styleFunction");
function Ur(t, e, n) {
	return arguments.length > 1 ? this.each((e == null ? Xu : typeof e == "function" ? Zu : Gu)(t, e, n ?? "")) : Rt(this.node(), t);
}
m(Ur, "default");
function Rt(t, e) {
...
function Lr(t, e) {
	return arguments.length > 1 ? this.each((e == null ? Qu : typeof e == "function" ? Ju : Ku)(t, e)) : this.node()[t];
}
m(Lr, "default");
function Jo(t) {
...
m(zr, "classList");
function jo(t) {
	this._node = t, this._names = Jo(t.getAttribute("class") || "");
}
m(jo, "ClassList");
jo.prototype = {
	add: m(function(t) {
...
function ta(t, e) {
	for (var n = zr(t), i = -1, o = e.length; ++i < o;) n.add(e[i]);
}
m(ta, "classedAdd");
function ea(t, e) {
	for (var n = zr(t), i = -1, o = e.length; ++i < o;) n.remove(e[i]);
}
m(ea, "classedRemove");
function ju(t) {
	return function() {
...
function Hr(t, e) {
	var n = Jo(t + "");
	if (arguments.length < 2) {
		for (var i = zr(this.node()), o = -1, a = n.length; ++o < a;) if (!i.contains(n[o])) return !1;
		return !0;
	}
	return this.each((typeof e == "function" ? ef : e ? ju : tf)(n, e));
}
m(Hr, "default");
function nf() {
	this.textContent = "";
...
function Jr(t, e, n) {
	...
	for (u = e ? vf : yf, o = 0; o < a; ++o) this.each(u(i[o], e, n));
	return this;
}
m(Jr, "default");
function na(t, e, n) {
	var i = Pe(t), o = i.CustomEvent;
...
function bf(t, e) {
	return function() {
		return na(this, t, e.apply(this, arguments));
	};
}
m(bf, "dispatchFunction");
function jr(t, e) {
	return this.each((typeof e == "function" ? bf : wf)(t, e));
}
m(jr, "default");
function* ti() {
...
var Ct = ra;
function ia(t) {
	return typeof t == "string" ? new G([[document.querySelector(t)]], [document.documentElement]) : new G([[t]], ei);
}
m(ia, "default");
function Pt(t, e, n) {
...
function _t(t) {
	var e, n;
	return t = (t + "").trim().toLowerCase(), (e = Tf.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? ua(e) : n === 3 ? new nt(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? gn(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? gn(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = kf.exec(t)) ? new nt(e[1], e[2], e[3], 1) : (e = Sf.exec(t)) ? new nt(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = Cf.exec(t)) ? gn(e[1], e[2], e[3], e[4]) : (e = Nf.exec(t)) ? gn(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Af.exec(t)) ? ca(e[1], e[2] / 100, e[3] / 100, 1) : (e = Df.exec(t)) ? ca(e[1], e[2] / 100, e[3] / 100, e[4]) : oa.hasOwnProperty(t) ? ua(oa[t]) : t === "transparent" ? new nt(NaN, NaN, NaN, 0) : null;
}
m(_t, "color");
function ua(t) {
...
m(gn, "rgba");
function ri(t) {
	return t instanceof Yt || (t = _t(t)), t ? (t = t.rgb(), new nt(t.r, t.g, t.b, t.opacity)) : new nt();
}
m(ri, "rgbConvert");
function de(t, e, n, i) {
...
function pa(t) {
	...
	if (t instanceof Yt || (t = _t(t)), !t) return new xt();
	if (t instanceof xt) return t;
	t = t.rgb();
	var e = t.r / 255, n = t.g / 255, i = t.b / 255, o = Math.min(e, n, i), a = Math.max(e, n, i), s = NaN, u = a - o, l = (a + o) / 2;
...
function ba(t) {
	...
	t instanceof nt || (t = ri(t));
	var e = si(t.r), n = si(t.g), i = si(t.b), o = ii((.2225045 * e + .7168786 * n + .0606169 * i) / ga), a, s;
	return e === n && n === i ? a = s = o : (a = ii((.4360747 * e + .3850649 * n + .1430804 * i) / _a), s = ii((.0139322 * e + .0971045 * n + .7141733 * i) / ya)), new Mt(116 * o - 16, 500 * (a - o), 200 * (o - s), t.opacity);
}
m(ba, "labConvert");
function ui(t, e, n, i) {
...
Pt(Mt, ui, pe(Yt, {
	...
	rgb() {
		...
		return e = _a * oi(e), t = ga * oi(t), n = ya * oi(n), new nt(ai(3.1338561 * e - 1.6168667 * t - .4906146 * n), ai(-.9787684 * e + 1.9161415 * t + .033454 * n), ai(.0719453 * e - .2289914 * t + 1.4052427 * n), this.opacity);
	}
}));
function ii(t) {
...
function Rf(t) {
	...
	if (t instanceof Mt || (t = ba(t)), t.a === 0 && t.b === 0) return new Nt(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
...
function Ca(t) {
	return function(e, n) {
		var i = t((e = Le(e)).h, (n = Le(n)).h), o = At(e.c, n.c), a = At(e.l, n.l), s = At(e.opacity, n.opacity);
		return function(u) {
			return e.h = i(u), e.c = o(u), e.l = a(u), e.opacity = s(u), e + "";
		};
	};
}
m(Ca, "hcl");
...
function ci(t) {
	var e = t.length;
	return function(n) {
		var i = Math.floor(((n %= 1) < 0 ? ++n : n) * e), o = t[(i + e - 1) % e], a = t[i % e], s = t[(i + 1) % e], u = t[(i + 2) % e];
...
var Qt = m((function t(e) {
	var n = Sa(e);
	function i(o, a) {
		var s = n((o = de(o)).r, (a = de(a)).r), u = n(o.g, a.g), l = n(o.b, a.b), f = At(o.opacity, a.opacity);
		return function(h) {
...
function Na(t) {
	return function(e) {
		...
		for (s = 0; s < n; ++s) u = de(e[s]), i[s] = u.r || 0, o[s] = u.g || 0, a[s] = u.b || 0;
		return i = t(i), o = t(o), a = t(a), u.opacity = 1, function(l) {
			return u.r = i(l), u.g = o(l), u.b = a(l), u + "";
		};
	};
}
m(Na, "rgbSpline");
...
function Da(t, e) {
	...
	for (s = 0; s < i; ++s) o[s] = Ft(t[s], e[s]);
	for (; s < n; ++s) a[s] = e[s];
	return function(u) {
		for (s = 0; s < i; ++s) a[s] = o[s](u);
		return a;
	};
}
m(Da, "genericArray");
...
function mi(t, e) {
	...
	for (o in e) o in t ? n[o] = Ft(t[o], e[o]) : i[o] = e[o];
	return function(a) {
...
function ge(t, e) {
	...
	for (t = t + "", e = e + ""; (i = xi.exec(t)) && (o = di.exec(e));) (a = o.index) > n && (a = e.slice(n, a), u[s] ? u[s] += a : u[++s] = a), (i = i[0]) === (o = o[0]) ? u[s] ? u[s] += o : u[++s] = o : (u[++s] = null, l.push({
		i: s,
		x: j(i, o)
	})), n = di.lastIndex;
	return n < e.length && (a = e.slice(n), u[s] ? u[s] += a : u[++s] = a), u.length < 2 ? l[0] ? Hf(l[0].x) : zf(e) : (e = l.length, function(f) {
		for (var h = 0, p; h < e; ++h) u[(p = l[h]).i] = p.x(f);
		return u.join("");
	});
}
m(ge, "default");
function Ft(t, e) {
	var n = typeof e, i;
	return e == null || n === "boolean" ? _e(e) : (n === "number" ? j : n === "string" ? (i = _t(e)) ? (e = i, Qt) : ge : e instanceof _t ? Qt : e instanceof Date ? pi : Aa(e) ? hi : Array.isArray(e) ? Da : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? mi : j)(t, e);
}
m(Ft, "default");
function Mn(t, e) {
	return t = +t, e = +e, function(n) {
...
function kn(t, e, n, i, o, a) {
	var s, u, l;
	return (s = Math.sqrt(t * t + e * e)) && (t /= s, e /= s), (l = t * n + e * i) && (n -= t * l, i -= e * l), (u = Math.sqrt(n * n + i * i)) && (n /= u, i /= u, l /= u), t * i < e * n && (t = -t, e = -e, l = -l, s = -s), {
		translateX: o,
		translateY: a,
...
m(Oa, "parseCss");
function Ea(t) {
	return t == null ? Tn : (Sn || (Sn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Sn.setAttribute("transform", t), (t = Sn.transform.baseVal.consolidate()) ? (t = t.matrix, kn(t.a, t.b, t.c, t.d, t.e, t.f)) : Tn);
}
m(Ea, "parseSvg");
function Ia(t, e, n, i) {
	function o(f) {
	...
	function a(f, h, p, c, m, _) {
		if (f !== p || h !== c) {
			var M = m.push("translate(", null, e, null, n);
			_.push({
				i: M - 4,
				x: j(f, p)
			}, {
	...
	function l(f, h, p, c, m, _) {
		if (f !== p || h !== c) {
			var M = m.push(o(m) + "scale(", null, ",", null, ")");
			_.push({
				i: M - 4,
				x: j(f, p)
			}, {
	...
	return m(l, "scale"), function(f, h) {
		var p = [], c = [];
		return f = t(f), h = t(h), a(f.translateX, f.translateY, h.translateX, h.translateY, p, c), s(f.rotate, h.rotate, p, c), u(f.skewX, h.skewX, p, c), l(f.scaleX, f.scaleY, h.scaleX, h.scaleY, p, c), f = h = null, function(m) {
			for (var _ = -1, M = c.length, T; ++_ < M;) p[(T = c[_]).i] = T.x(m);
			return p.join("");
		};
	};
}
m(Ia, "interpolateTransform");
var _i = Ia(Oa, "px, ", "px)", "deg)"), gi = Ia(Ea, ", ", ")", ")");
function yi(t) {
...
function vi(t, e) {
	return function(n, i) {
		for (var o = n.length, a = [], s = 0, u = t[0], l = 0; o > 0 && u > 0 && (l + u + 1 > i && (u = Math.max(1, i - l)), a.push(n.substring(o -= u, o + u)), !((l += u + 1) > i));) u = t[s = (s + 1) % t.length];
...
function Ti(t, e) {
	var n = Kt(t, e);
	if (!n) return t + "";
	var i = n[0], o = n[1], a = o - (Mi = Math.max(-8, Math.min(8, Math.floor(o / 3))) * 3) + 1, s = i.length;
	return a === s ? i : a > s ? i + new Array(a - s + 1).join("0") : a > 0 ? i.slice(0, a) + "." + i.slice(a) : "0." + new Array(1 - a).join("0") + Kt(t, Math.max(0, e + a - 1))[0];
}
m(Ti, "default");
function Nn(t, e) {
	var n = Kt(t, e);
...
m(Nn, "default");
var ki = {
	"%": m((t, e) => (t * 100).toFixed(e), "%"),
	b: m((t) => Math.round(t).toString(2), "b"),
	c: m((t) => t + "", "c"),
	d: yi,
	e: m((t, e) => t.toExponential(e), "e"),
	f: m((t, e) => t.toFixed(e), "f"),
	g: m((t, e) => t.toPrecision(e), "g"),
	o: m((t) => Math.round(t).toString(8), "o"),
	p: m((t, e) => Nn(t * 100, e), "p"),
	r: Nn,
	s: Ti,
	X: m((t) => Math.round(t).toString(16).toUpperCase(), "X"),
	x: m((t) => Math.round(t).toString(16), "x")
};
function An(t) {
	return t;
}
...
function Si(t) {
	var e = t.grouping === void 0 || t.thousands === void 0 ? An : vi(Ra.call(t.grouping, Number), t.thousands + ""), n = t.currency === void 0 ? "" : t.currency[0] + "", i = t.currency === void 0 ? "" : t.currency[1] + "", o = t.decimal === void 0 ? "." : t.decimal + "", a = t.numerals === void 0 ? An : wi(Ra.call(t.numerals, String)), s = t.percent === void 0 ? "%" : t.percent + "", u = t.minus === void 0 ? "−" : t.minus + "", l = t.nan === void 0 ? "NaN" : t.nan + "";
	function f(p) {
		p = Ut(p);
		var c = p.fill, m$2 = p.align, _ = p.sign, M = p.symbol, T = p.zero, k = p.width, I = p.comma, C = p.precision, A = p.trim, O = p.type;
		O === "n" ? (I = !0, O = "g") : ki[O] || (C === void 0 && (C = 12), A = !0, O = "g"), (T || c === "0" && m$2 === "=") && (T = !0, c = "0", m$2 = "=");
		var w = M === "$" ? n : M === "#" && /[boxX]/.test(O) ? "0" + O.toLowerCase() : "", Y = M === "$" ? i : /[%p]/.test(O) ? s : "", U = ki[O], E = /[defgprs%]/.test(O);
		...
		function B(N) {
			...
			if (O === "c") d = U(N) + d, N = "";
				...
				N = +N;
				var D = N < 0 || 1 / N < 0;
				if (N = isNaN(N) ? l : U(Math.abs(N), C), A && (N = bi(N)), D && +N == 0 && _ !== "+" && (D = !1), v = (D ? _ === "(" ? _ : u : _ === "-" || _ === "(" ? "" : _) + v, d = (O === "s" ? Pa[8 + Mi / 3] : "") + d + (D && _ === "(" ? ")" : ""), E) {
					for (x = -1, S = N.length; ++x < S;) if (y = N.charCodeAt(x), 48 > y || y > 57) {
						d = (y === 46 ? o + N.slice(x + 1) : N.slice(x)) + d, N = N.slice(0, x);
						break;
					}
				}
			}
			...
			switch (I && T && (N = e(P + N, P.length ? k - d.length : Infinity), P = ""), m$2) {
				case "<":
					N = v + N + d + P;
					break;
				case "=":
	...
	m(f, "newFormat");
	function h(p, c) {
		var m = f((p = Ut(p), p.type = "f", p)), _ = Math.max(-8, Math.min(8, Math.floor(gt(c) / 3))) * 3, M = Math.pow(10, -_), T = Pa[8 + _ / 3];
		return function(k) {
			return m(M * k) + T;
		};
	}
...
function Ci(t) {
	return Dn = Si(t), $n = Dn.format, On = Dn.formatPrefix, Dn;
}
m(Ci, "defaultLocale");
function En(t) {
...
m(En, "default");
function In(t, e) {
	return Math.max(0, Math.max(-8, Math.min(8, Math.floor(gt(e) / 3))) * 3 - gt(Math.abs(t)));
}
m(In, "default");
function Rn(t, e) {
...
m(Ai, "default");
function Di(t, e) {
	for (var n = this, i = [n], o, a, s = -1; n = i.pop();) if (t.call(e, n, ++s, this), o = n.children) for (a = o.length - 1; a >= 0; --a) i.push(o[a]);
	return this;
}
m(Di, "default");
function $i(t, e) {
	for (var n = this, i = [n], o = [], a, s, u, l = -1; n = i.pop();) if (o.push(n), a = n.children) for (s = 0, u = a.length; s < u; ++s) i.push(a[s]);
	for (; n = o.pop();) t.call(e, n, ++l, this);
	return this;
}
m($i, "default");
function Oi(t, e) {
...
m(Ii, "default");
function Ri(t) {
	for (var e = this, n = Wf(e, t), i = [e]; e !== n;) e = e.parent, i.push(e);
...
function Wf(t, e) {
	...
	for (t = n.pop(), e = i.pop(); t === e;) o = t, t = n.pop(), e = i.pop();
	return o;
}
...
m(Ui, "default");
function* Li() {
	var t = this, e, n = [t], i, o, a;
	do
		for (e = n.reverse(), n = []; t = e.pop();) if (yield t, i = t.children) for (o = 0, a = i.length; o < a; ++o) n.push(i[o]);
	while (n.length);
}
m(Li, "default");
function Pn(t, e) {
	t instanceof Map ? (t = [void 0, t], e === void 0 && (e = Gf)) : e === void 0 && (e = Xf);
	for (var n = new ze(t), i, o = [n], a, s, u, l; i = o.pop();) if ((s = e(i.data)) && (l = (s = Array.from(s)).length)) for (i.children = s, u = l - 1; u >= 0; --u) o.push(a = s[u] = new ze(s[u])), a.parent = i, a.depth = i.depth + 1;
...
function Jf(t, e, n, i, o, a) {
	for (var s = [], u = e.children, l, f, h = 0, p = 0, c = u.length, m, _, M = e.value, T, k, I, C, A, O, w; h < c;) {
		...
		do
			T = u[p++].value;
		while (!T && p < c);
		for (k = I = T, O = Math.max(_ / m, m / _) / (M * t), w = T * T * O, A = Math.max(I / w, w / k); p < c; ++p) {
			if (T += f = u[p].value, f < k && (k = f), f > I && (I = f), w = T * T * O, C = Math.max(I / w, w / k), C > A) {
				T -= f;
				break;
			}
			A = C;
...
m(Jt, "default");
function Ua() {
	var t = Ya, e = !1, n = 1, i = 1, o = [0], a = ye, s = ye, u = ye, l = ye, f = ye;
	function h(c) {
		return c.x0 = c.y0 = 0, c.x1 = n, c.y1 = i, c.eachBefore(p), o = [0], e && c.eachBefore(zi), c;
	}
	m(h, "treemap");
	function p(c) {
	...
	return m(p, "positionNode"), h.round = function(c) {
		...
		return arguments.length ? (n = +c[0], i = +c[1], h) : [n, i];
	}, h.tile = function(c) {
		return arguments.length ? (t = Fa(c), h) : t;
...
function tl(t, e, n) {
	...
	return o < i ? (i = Xi(o, i), a = n(s, a)) : (i = Xi(i, o), a = n(a, s)), function(u) {
		return a(i(u));
	};
}
m(tl, "bimap");
function el(t, e, n) {
	...
	for (t[i] < t[0] && (t = t.slice().reverse(), e = e.slice().reverse()); ++s < i;) o[s] = Xi(t[s], t[s + 1]), a[s] = n(e[s], e[s + 1]);
	return function(u) {
		var l = pr(t, u, 1, i) - 1;
		return a[l](o[l](u));
	};
...
function nl() {
	...
	function h() {
		...
		return s !== ve && (s = jf(t[0], t[c - 1])), u = c > 2 ? el : tl, l = f = null, p;
	}
	m(h, "rescale");
	function p(c) {
		return c == null || isNaN(c = +c) ? a : (l || (l = u(t.map(i), e, n)))(i(s(c)));
	}
	return m(p, "scale"), p.invert = function(c) {
		return s(o((f || (f = u(e, t.map(i), j)))(c)));
	}, p.domain = function(c) {
		return arguments.length ? (t = Array.from(c, Vi), h()) : t.slice();
	}, p.range = function(c) {
		return arguments.length ? (e = Array.from(c), h()) : e.slice();
	}, p.rangeRound = function(c) {
		return e = Array.from(c), n = Mn, h();
	}, p.clamp = function(c) {
...
function Gi(t, e, n, i) {
	var o = le(t, e, n), a;
	switch (i = Ut(i ?? ",f"), i.type) {
		case "s":
			var s = Math.max(Math.abs(t), Math.abs(e));
			return i.precision == null && !isNaN(a = In(o, s)) && (i.precision = a), On(i, s);
		case "":
		case "e":
		case "g":
		case "p":
		case "r":
			i.precision == null && !isNaN(a = Rn(o, Math.max(Math.abs(t), Math.abs(e)))) && (i.precision = a - (i.type === "e"));
			break;
		case "f":
		case "%":
			i.precision == null && !isNaN(a = En(o)) && (i.precision = a - (i.type === "%") * 2);
			break;
	}
	return $n(i);
}
...
function rl(t) {
	...
	return t.ticks = function(n) {
		...
		n ??= 10;
		var i = e(), o = 0, a = i.length - 1, s = i[o], u = i[a], l, f, h = 10;
		for (u < s && (f = s, s = u, u = f, f = o, o = a, a = f); h-- > 0;) {
			if (f = Ee(s, u, n), f === l) return i[o] = s, i[a] = u, e(i);
...
function H(t, e, n, i) {
	...
	return m(o, "interval"), o.floor = (a) => (t(a = /* @__PURE__ */ new Date(+a)), a), o.ceil = (a) => (t(a = /* @__PURE__ */ new Date(a - 1)), e(a, 1), t(a), a), o.round = (a) => {
		let s = o(a), u = o.ceil(a);
		return a - s < u - a ? s : u;
	}, o.offset = (a, s) => (e(a = /* @__PURE__ */ new Date(+a), s == null ? 1 : Math.floor(s)), a), o.range = (a, s, u) => {
		let l = [];
		if (a = o.ceil(a), u = u == null ? 1 : Math.floor(u), !(a < s) || !(u > 0)) return l;
		let f;
		do
	...
	}), n && (o.count = (a, s) => (Qi.setTime(+a), Ki.setTime(+s), t(Qi), t(Ki), Math.floor(n(Qi, Ki))), o.every = (a) => (a = Math.floor(a), !isFinite(a) || !(a > 0) ? null : a > 1 ? o.filter(i ? (s) => i(s) % a === 0 : (s) => o.count(0, s) % a === 0) : o)), o;
}
m(H, "timeInterval");
var jt = H(() => {}, (t, e) => {
	t.setTime(+t + e);
}, (t, e) => e - t);
jt.every = (t) => (t = Math.floor(t), !isFinite(t) || !(t > 0) ? null : t > 1 ? H((e) => {
...
Un.range;
var Dt = H((t) => t.setHours(0, 0, 0, 0), (t, e) => t.setDate(t.getDate() + e), (t, e) => (e - t - (e.getTimezoneOffset() - t.getTimezoneOffset()) * 6e4) / 864e5, (t) => t.getDate() - 1);
Dt.range;
var We = H((t) => {
...
m(ne, "timeWeekday");
var $t = ne(0), Me = ne(1), qa = ne(2), Wa = ne(3), zt = ne(4), Va = ne(5), Xa = ne(6);
$t.range;
Me.range;
qa.range;
Wa.range;
...
m(re, "utcWeekday");
var ie = re(0), Te = re(1), Za = re(2), Qa = re(3), Ht = re(4), Ka = re(5), Ja = re(6);
ie.range;
Te.range;
Za.range;
Qa.range;
...
lt.every = (t) => !isFinite(t = Math.floor(t)) || !(t > 0) ? null : H((e) => {
...
yt.every = (t) => !isFinite(t = Math.floor(t)) || !(t > 0) ? null : H((e) => {
...
function es(t, e, n, i, o, a) {
	...
	m(u, "ticks");
	function l(f, h, p) {
		let c = Math.abs(h - f) / p, m = Xt(([, , T]) => T).right(s, c);
		if (m === s.length) return t.every(le(f / 31536e6, h / 31536e6, p));
		if (m === 0) return jt.every(Math.max(le(f, h, p), 1));
...
m(Ve, "newDate");
function no(t) {
	var e = t.dateTime, n = t.date, i = t.time, o = t.periods, a = t.days, s = t.shortDays, u = t.months, l = t.shortMonths, f = Xe(o), h = Ge(o), p = Xe(a), c = Ge(a), m$3 = Xe(s), _ = Ge(s), M = Xe(u), T = Ge(u), k = Xe(l), I = Ge(l), C = {
		a: D,
		A: $,
		b: P,
		B: z,
	...
	C.x = w(n, C), C.X = w(i, C), C.c = w(e, C), A.x = w(n, A), A.X = w(i, A), A.c = w(e, A);
	function w(b, R) {
		return function(F) {
			var g = [], at = -1, q = 0, ut = b.length, ft, Wt, Ho;
			for (F instanceof Date || (F = /* @__PURE__ */ new Date(+F)); ++at < ut;) b.charCodeAt(at) === 37 && (g.push(b.slice(q, at)), (Wt = ns[ft = b.charAt(++at)]) != null ? ft = b.charAt(++at) : Wt = ft === "e" ? " " : "0", (Ho = R[ft]) && (ft = Ho(F, Wt)), g.push(ft), q = at + 1);
			return g.push(b.slice(q, at)), g.join("");
		};
	}
	m(w, "newFormat");
	function Y(b, R) {
		return function(F) {
			var g = Ve(1900, void 0, 1), at = U(g, b, F += "", 0), q, ut;
			...
			if (R && !("Z" in g) && (g.Z = 0), "p" in g && (g.H = g.H % 12 + g.p * 12), g.m === void 0 && (g.m = "q" in g ? g.q : 0), "V" in g) {
				...
				"w" in g || (g.w = 1), "Z" in g ? (q = eo(Ve(g.y, 0, 1)), ut = q.getUTCDay(), q = ut > 4 || ut === 0 ? Te.ceil(q) : Te(q), q = We.offset(q, (g.V - 1) * 7), g.y = q.getUTCFullYear(), g.m = q.getUTCMonth(), g.d = q.getUTCDate() + (g.w + 6) % 7) : (q = to(Ve(g.y, 0, 1)), ut = q.getDay(), q = ut > 4 || ut === 0 ? Me.ceil(q) : Me(q), q = Dt.offset(q, (g.V - 1) * 7), g.y = q.getFullYear(), g.m = q.getMonth(), g.d = q.getDate() + (g.w + 6) % 7);
			} else ("W" in g || "U" in g) && ("w" in g || (g.w = "u" in g ? g.u % 7 : "W" in g ? 1 : 0), ut = "Z" in g ? eo(Ve(g.y, 0, 1)).getUTCDay() : to(Ve(g.y, 0, 1)).getDay(), g.m = 0, g.d = "W" in g ? (g.w + 6) % 7 + g.W * 7 - (ut + 5) % 7 : g.w + g.U * 7 - (ut + 6) % 7);
	...
	function U(b, R, F, g) {
		for (var at = 0, q = R.length, ut = F.length, ft, Wt; at < q;) {
			if (g >= ut) return -1;
			if (ft = R.charCodeAt(at++), ft === 37) {
				if (ft = R.charAt(at++), Wt = O[ft in ns ? R.charAt(at++) : ft], !Wt || (g = Wt(b, F, g)) < 0) return -1;
	...
	m(U, "parseSpecifier");
	function E(b, R, F) {
		var g = f.exec(R.slice(F));
		return g ? (b.p = h.get(g[0].toLowerCase()), F + g[0].length) : -1;
	}
	m(E, "parsePeriod");
	function B(b, R, F) {
		var g = m$3.exec(R.slice(F));
		return g ? (b.w = _.get(g[0].toLowerCase()), F + g[0].length) : -1;
	}
	m(B, "parseShortWeekday");
	function N(b, R, F) {
		var g = p.exec(R.slice(F));
		return g ? (b.w = c.get(g[0].toLowerCase()), F + g[0].length) : -1;
	}
	m(N, "parseWeekday");
	function v(b, R, F) {
		var g = k.exec(R.slice(F));
		return g ? (b.m = I.get(g[0].toLowerCase()), F + g[0].length) : -1;
	}
	m(v, "parseShortMonth");
	function d(b, R, F) {
		var g = M.exec(R.slice(F));
		return g ? (b.m = T.get(g[0].toLowerCase()), F + g[0].length) : -1;
	}
	m(d, "parseMonth");
	function x(b, R, F) {
		return U(b, e, R, F);
	...
	return m(Z, "formatUTCQuarter"), {
		...
		utcFormat: m(function(b) {
			var R = w(b += "", A);
			return R.toString = function() {
				return b;
			}, R;
		}, "utcFormat"),
		utcParse: m(function(b) {
			var R = Y(b += "", !0);
			return R.toString = function() {
				return b;
			}, R;
...
m(Ql, "formatHour12");
function Kl(t, e) {
	return L(1 + Dt.count(lt(t), t), e, 3);
}
...
m(ps, "dISO");
function ic(t, e) {
	return t = ps(t), L(zt.count(lt(t), t) + (lt(t).getDay() === 4), e, 2);
}
...
function ac(t, e) {
	return L(Me.count(lt(t) - 1, t), e, 2);
}
...
m(sc, "formatYear");
function uc(t, e) {
	return t = ps(t), L(t.getFullYear() % 100, e, 2);
}
m(uc, "formatYearISO");
function fc(t, e) {
...
function mc(t, e) {
	return L(1 + We.count(yt(t), t), e, 3);
}
...
function vc(t, e) {
	return L(ie.count(yt(t) - 1, t), e, 2);
}
...
m(ds, "UTCdISO");
function wc(t, e) {
	return t = ds(t), L(Ht.count(yt(t), t) + (yt(t).getUTCDay() === 4), e, 2);
}
...
function Mc(t, e) {
	return L(Te.count(yt(t) - 1, t), e, 2);
}
...
m(Tc, "formatUTCYear");
function kc(t, e) {
	return t = ds(t), L(t.getUTCFullYear() % 100, e, 2);
}
...
function ro(t) {
	return Se = no(t), Hn = Se.format, Se.parse, Se.utcFormat, Se.utcParse, Se;
}
m(ro, "defaultLocale");
function io(t, e) {
	t = t.slice();
	var n = 0, i = t.length - 1, o = t[n], a = t[i], s;
	return a < o && (s = n, n = i, i = s, s = o, o = a, a = s), t[n] = e.floor(o), t[i] = e.ceil(a), t;
}
m(io, "nice");
function Ac(t) {
	return new Date(t);
...
function ys(t, e, n, i, o, a, s, u, l, f) {
	var h = Be(), p = h.invert, c = h.domain, m$4 = f(".%L"), _ = f(":%S"), M = f("%I:%M"), T = f("%I %p"), k = f("%a %d"), I = f("%b %d"), C = f("%B"), A = f("%Y");
	function O(w) {
		return (l(w) < w ? m$4 : u(w) < w ? _ : s(w) < w ? M : a(w) < w ? T : i(w) < w ? o(w) < w ? k : I : n(w) < w ? C : A)(w);
	}
	return m(O, "tickFormat"), h.invert = function(w) {
		return new Date(p(w));
	}, h.domain = function(w) {
		return arguments.length ? c(Array.from(w, Dc)) : c().map(Ac);
	}, h.ticks = function(w) {
		var Y = c();
		...
		var Y = c();
		return (!w || typeof w.range != "function") && (w = e(Y[0], Y[Y.length - 1], w ?? 10)), w ? c(io(Y, w)) : h;
	}, h.copy = function() {
		return Yn(h, ys(t, e, n, i, o, a, s, u, l, f));
	}, h;
}
m(ys, "calendar");
function vs() {
	return Lt.apply(ys(Ji, ji, lt, ke, $t, Dt, be, we, Tt, Hn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
m(vs, "time");
function oo() {
	var t = He().unknown(void 0), e = t.domain, n = t.range, i = 0, o = 1, a, s, u = !1, l = 0, f = 0, h = .5;
	delete t.unknown;
	function p() {
		var c = e().length, m = o < i, _ = m ? o : i, M = m ? i : o;
		a = (M - _) / Math.max(1, c - l + f * 2), u && (a = Math.floor(a)), _ += (M - _ - a * (c - l)) * h, s = a * (1 - l), u && (_ = Math.round(_), s = Math.round(s));
		var T = pn(c).map(function(k) {
			return _ + a * k;
		});
	...
	return m(p, "rescale"), t.domain = function(c) {
		...
		return arguments.length ? (l = Math.min(1, f = +c), p()) : l;
	}, t.paddingInner = function(c) {
		return arguments.length ? (l = Math.min(1, c), p()) : l;
	}, t.paddingOuter = function(c) {
		return arguments.length ? (f = +c, p()) : f;
	}, t.align = function(c) {
		return arguments.length ? (h = Math.max(0, Math.min(1, c)), p()) : h;
	}, t.copy = function() {
		return oo(e(), [i, o]).round(u).paddingInner(l).paddingOuter(f).align(h);
	}, Lt.apply(p(), arguments);
}
m(oo, "band");
function ao(t) {
...
m(ao, "default");
var $c = ao("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
function V(t) {
	return m(function() {
		return t;
	}, "constant");
...
var se = class {
	...
	arcTo(e, n, i, o, a) {
		...
		if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = n}`;
			...
			let m = i - s, _ = o - u, M = l * l + f * f, T = m * m + _ * _, k = Math.sqrt(M), I = Math.sqrt(c), C = a * Math.tan((fo - Math.acos((M + c - T) / (2 * k * I))) / 2), A = C / I, O = C / k;
...
function Wn(t, e, n, i, o, a, s) {
	var u = t - n, l = e - i, f = (s ? a : -a) / oe(u * u + l * l), h = f * l, p = -f * u, c = t + h, m = e + p, _ = n + h, M = i + p, T = (c + _) / 2, k = (m + M) / 2, I = _ - c, C = M - m, A = I * I + C * C, O = o - a, w = c * M - _ * m, Y = (C < 0 ? -1 : 1) * oe(ws(0, O * O * A - w * w)), U = (w * C - I * Y) / A, E = (-w * I - C * Y) / A, B = (w * C + I * Y) / A, N = (-w * I + C * Y) / A, v = U - T, d = E - k, x = B - T, S = N - k;
...
m(Wn, "cornerTangents");
function ks() {
	var t = Ic, e = Rc, n = V(0), i = null, o = Pc, a = Yc, s = Fc, u = null, l = qn(f);
	function f() {
		var h, p, c = +t.apply(this, arguments), m = +e.apply(this, arguments), _ = o.apply(this, arguments) - Ze, M = a.apply(this, arguments) - Ze, T = so(M - _), k = M > _;
		if (u || (u = h = l()), m < c && (p = m, m = c, c = p), !(m > et)) u.moveTo(0, 0);
		else if (T > Ne - et) u.moveTo(m * Bt(_), m * vt(_)), u.arc(0, 0, m, _, M, !k), c > et && (u.moveTo(c * Bt(M), c * vt(M)), u.arc(0, 0, c, M, _, k));
		else {
			var I = _, C = M, A = _, O = M, w = T, Y = T, U = s.apply(this, arguments) / 2, E = U > et && (i ? +i.apply(this, arguments) : oe(c * c + m * m)), B = Bn(so(m - c) / 2, +n.apply(this, arguments)), N = B, v = B, d, x;
			if (E > et) {
				var S = uo(E / c * vt(U)), y = uo(E / m * vt(U));
			...
			if (B > et) {
				...
				if (T < Ce) if (Q = Uc(D, $, J, ht, W, X, P, z)) {
					var dt = D - Q[0], st = $ - Q[1], Z = W - Q[0], b = X - Q[1], R = 1 / vt(bs((dt * Z + st * b) / (oe(dt * dt + st * st) * oe(Z * Z + b * b))) / 2), F = oe(Q[0] * Q[0] + Q[1] * Q[1]);
					N = Bn(B, (c - F) / (R - 1)), v = Bn(B, (m - F) / (R + 1));
				} else N = v = 0;
			}
			Y > et ? v > et ? (d = Wn(J, ht, D, $, m, v, k), x = Wn(W, X, P, z, m, v, k), u.moveTo(d.cx + d.x01, d.cy + d.y01), v < B ? u.arc(d.cx, d.cy, v, rt(d.y01, d.x01), rt(x.y01, x.x01), !k) : (u.arc(d.cx, d.cy, v, rt(d.y01, d.x01), rt(d.y11, d.x11), !k), u.arc(0, 0, m, rt(d.cy + d.y11, d.cx + d.x11), rt(x.cy + x.y11, x.cx + x.x11), !k), u.arc(x.cx, x.cy, v, rt(x.y11, x.x11), rt(x.y01, x.x01), !k))) : (u.moveTo(D, $), u.arc(0, 0, m, I, C, !k)) : u.moveTo(D, $), !(c > et) || !(w > et) ? u.lineTo(P, z) : N > et ? (d = Wn(P, z, W, X, c, -N, k), x = Wn(D, $, J, ht, c, -N, k), u.lineTo(d.cx + d.x01, d.cy + d.y01), N < B ? u.arc(d.cx, d.cy, N, rt(d.y01, d.x01), rt(x.y01, x.x01), !k) : (u.arc(d.cx, d.cy, N, rt(d.y01, d.x01), rt(d.y11, d.x11), !k), u.arc(0, 0, c, rt(d.cy + d.y11, d.cx + d.x11), rt(x.cy + x.y11, x.cx + x.x11), k), u.arc(x.cx, x.cy, N, rt(x.y11, x.x11), rt(x.y01, x.x01), !k))) : u.arc(0, 0, c, O, A, k);
		}
...
m(Ss, "Linear");
Ss.prototype = {
	areaStart: m(function() {
		this._line = 0;
	}, "areaStart"),
	areaEnd: m(function() {
		this._line = NaN;
	}, "areaEnd"),
	lineStart: m(function() {
		this._point = 0;
	}, "lineStart"),
	lineEnd: m(function() {
		(this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
	}, "lineEnd"),
	point: m(function(t, e) {
...
m(Ns, "y");
function As(t, e) {
	var n = V(!0), i = null, o = Vn, a = null, s = qn(u);
	t = typeof t == "function" ? t : t === void 0 ? Cs : V(t), e = typeof e == "function" ? e : e === void 0 ? Ns : V(e);
	function u(l) {
		var f, h = (l = Qe(l)).length, p, c = !1, m;
		for (i ?? (a = o(m = s())), f = 0; f <= h; ++f) !(f < h && n(p = l[f], f, l)) === c && ((c = !c) ? a.lineStart() : a.lineEnd()), c && a.point(+t(p, f, l), +e(p, f, l));
	...
	return m(u, "line"), u.x = function(l) {
		...
		return arguments.length ? (o = l, i != null && (a = o(i)), u) : o;
	}, u.context = function(l) {
		return arguments.length ? (l == null ? i = a = null : a = o(i = l), u) : i;
	}, u;
}
m(As, "default");
function co(t, e) {
...
m(ho, "default");
function Ds() {
	var t = ho, e = co, n = null, i = V(0), o = V(Ne), a = V(0);
	function s(u) {
		var l, f = (u = Qe(u)).length, h, p, c = 0, m = new Array(f), _ = new Array(f), M = +i.apply(this, arguments), T = Math.min(Ne, Math.max(-Ne, o.apply(this, arguments) - M)), k, I = Math.min(Math.abs(T) / f, a.apply(this, arguments)), C = I * (T < 0 ? -1 : 1), A;
...
var Hc = m((function t(e) {
	function n(i) {
		return e === 1 ? new Ke(i) : new Ps(i, e);
	}
	return m(n, "bundle"), n.beta = function(i) {
		return t(+i);
	}, n;
}), "custom")(.85);
function De(t, e, n) {
...
var Bc = m((function t(e) {
	function n(i) {
		return new Gn(i, e);
	}
	return m(n, "cardinal"), n.tension = function(i) {
		return t(+i);
	}, n;
}), "custom")(0);
function Zn(t, e) {
...
var Vc = m((function t(e) {
	function n(i) {
		return e ? new Ys(i, e) : new Gn(i, 0);
	}
	return m(n, "catmullRom"), n.alpha = function(i) {
		return t(+i);
	}, n;
}), "custom")(.5);
function Fs(t, e) {
...
function Bs(t, e, n) {
	...
	return (Hs(a) + Hs(s)) * Math.min(Math.abs(a), Math.abs(s), .5 * Math.abs(u)) || 0;
}
m(Bs, "slope3");
function qs(t, e) {
	var n = t._x1 - t._x0;
	...
	lineEnd: m(function() {
		switch (this._point) {
			case 2:
				...
				break;
			case 3:
				po(this, this._t0, qs(this, this._t0));
				break;
		}
		(this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
	}, "lineEnd"),
		...
		if (t = +t, e = +e, !(t === this._x1 && e === this._y1)) {
			switch (this._point) {
				...
				case 1:
					...
					break;
				case 2:
					this._point = 3, po(this, qs(this, n = Bs(this, t, e)), n);
					break;
				default:
					po(this, this._t0, n = Bs(this, t, e));
					break;
			}
...
m(Ws, "MonotoneY");
(Ws.prototype = Object.create(Kn.prototype)).point = function(t, e) {
...
m(Vs, "ReflectContext");
Vs.prototype = {
	moveTo: m(function(t, e) {
		this._context.moveTo(e, t);
	}, "moveTo"),
	closePath: m(function() {
		this._context.closePath();
	}, "closePath"),
	lineTo: m(function(t, e) {
		this._context.lineTo(e, t);
	}, "lineTo"),
	bezierCurveTo: m(function(t, e, n, i, o, a) {
...
Gs.prototype = {
	...
	lineEnd: m(function() {
		...
		else for (var i = Xs(t), o = Xs(e), a = 0, s = 1; s < n; ++a, ++s) this._context.bezierCurveTo(i[0][a], o[0][a], i[1][a], o[1][a], t[s], e[s]);
...
jn.prototype = Js.prototype = {
	constructor: jn,
	on: m(function(t, e) {
		var n = this._, i = th(t + "", n), o, a = -1, s = i.length;
		if (arguments.length < 2) {
			for (; ++a < s;) if ((o = (t = i[a]).type) && (o = eh(n[o], t.name))) return o;
			return;
		}
		if (e != null && typeof e != "function") throw new Error("invalid callback: " + e);
		for (; ++a < s;) if (o = (t = i[a]).type) n[o] = Ks(n[o], t.name, e);
		else if (e == null) for (o in n) n[o] = Ks(n[o], t.name, null);
		return this;
	}, "on"),
	copy: m(function() {
		var t = {}, e = this._;
...
function Ks(t, e, n) {
	for (var i = 0, o = t.length; i < o; ++i) if (t[i].name === e) {
		t[i] = jc, t = t.slice(0, i).concat(t.slice(i + 1));
		break;
	}
...
m(rh, "poke");
function ih() {
	for (var t, e = tr, n, i = Infinity; e;) e._call ? (i > e._time && (i = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : tr = n);
	en = t, xo(i);
}
m(ih, "nap");
function xo(t) {
	if (!$e) {
		...
		t - ue > 24 ? (t < Infinity && (tn = setTimeout(js, t - nn.now() - nr)), je && (je = clearInterval(je))) : (je || (er = nn.now(), je = setInterval(rh, tu)), $e = 1, eu(js));
	}
}
m(xo, "sleep");
function an(t, e, n) {
...
m(an, "default");
var oh = mo("start", "end", "cancel", "interrupt"), ah = [], ou = 0, ru = 1, or = 2, ir = 3, iu = 4, ar = 5, sn = 6;
...
function sh(t, e, n) {
	...
	function s(f) {
		...
		if (an(function() {
			...
			for (n.state = ir, o = new Array(c = n.tween.length), h = 0, p = -1; h < c; ++h) (m = n.tween[h].value.call(t, t.__data__, n.index, n.group)) && (o[++p] = m);
			o.length = p + 1;
		}
	}
	m(s, "start");
...
m(sh, "create");
function fn(t, e) {
	var n = t.__transition, i, o, a = !0, s;
	if (n) {
		e = e == null ? null : e + "";
		for (s in n) {
			if ((i = n[s]).name !== e) {
...
function go(t, e) {
	...
	if (t += "", arguments.length < 2) {
		for (var i = K(this.node(), n).tween, o = 0, a = i.length, s; o < a; ++o) if ((s = i[o]).name === t) return s.value;
		return null;
	}
...
function ln(t, e) {
	var n;
	return (typeof e == "number" ? j : e instanceof _t ? Qt : (n = _t(e)) ? (e = n, Qt) : ge)(t, e);
}
m(ln, "default");
function lh(t) {
	return function() {
...
function hh(t, e, n) {
	...
	return function() {
		...
		return s === o ? null : s === i ? a : a = e(i = s, n);
	};
}
m(hh, "attrConstant");
function ph(t, e, n) {
...
function mh(t, e, n) {
	...
	return function() {
		var s, u = n(this), l;
		return u == null ? void this.removeAttribute(t) : (s = this.getAttribute(t), l = u + "", s === l ? null : s === i && l === o ? a : (o = l, a = e(i = s, u)));
	};
}
m(mh, "attrFunction");
function dh(t, e, n) {
	...
	return function() {
		var s, u = n(this), l;
		return u == null ? void this.removeAttributeNS(t.space, t.local) : (s = this.getAttributeNS(t.space, t.local), l = u + "", s === l ? null : s === i && l === o ? a : (o = l, a = e(i = s, u)));
	};
}
m(dh, "attrFunctionNS");
function yo(t, e) {
	var n = wt(t), i = n === "transform" ? gi : ln;
	return this.attrTween(t, typeof e == "function" ? (n.local ? dh : mh)(n, i, Oe(this, "attr." + t, e)) : e == null ? (n.local ? ch : lh)(n) : (n.local ? ph : hh)(n, i, e));
}
m(yo, "default");
function xh(t, e) {
	return function(n) {
...
function vo(t, e) {
	...
	var i = wt(t);
	return this.tween(n, (i.local ? gh : yh)(i, e));
}
m(vo, "default");
function vh(t, e) {
	return function() {
...
function wo(t) {
	var e = this._id;
	return arguments.length ? this.each((typeof t == "function" ? vh : wh)(e, t)) : K(this.node(), e).delay;
}
m(wo, "default");
function bh(t, e) {
	return function() {
...
function bo(t) {
	var e = this._id;
	return arguments.length ? this.each((typeof t == "function" ? bh : Mh)(e, t)) : K(this.node(), e).duration;
}
m(bo, "default");
function Th(t, e) {
	if (typeof e != "function") throw new Error();
...
function Mo(t) {
	var e = this._id;
	return arguments.length ? this.each(Th(e, t)) : K(this.node(), e).ease;
}
m(Mo, "default");
function kh(t, e) {
	return function() {
...
function So(t) {
	...
	for (var e = this._groups, n = t._groups, i = e.length, o = n.length, a = Math.min(i, o), s = new Array(i), u = 0; u < a; ++u) for (var l = e[u], f = n[u], h = l.length, p = s[u] = new Array(h), c, m = 0; m < h; ++m) (c = l[m] || f[m]) && (p[m] = c);
	for (; u < i; ++u) s[u] = e[u];
...
function Co(t, e) {
	var n = this._id;
	return arguments.length < 2 ? K(this.node(), n).on.on(t) : this.each(Ch(n, t, e));
}
m(Co, "default");
function Nh(t) {
	return function() {
...
function Ao(t) {
	...
	typeof t != "function" && (t = It(t));
	for (var i = this._groups, o = i.length, a = new Array(o), s = 0; s < o; ++s) for (var u = i[s], l = u.length, f = a[s] = new Array(l), h, p, c = 0; c < l; ++c) (h = u[c]) && (p = t.call(h, h.__data__, c, u)) && ("__data__" in h && (p.__data__ = h.__data__), f[c] = p, Ot(f[c], e, n, c, f, K(h, n)));
...
function Do(t) {
	...
	for (var i = this._groups, o = i.length, a = [], s = [], u = 0; u < o; ++u) for (var l = i[u], f = l.length, h, p = 0; p < f; ++p) if (h = l[p]) {
		for (var c = t.call(h, h.__data__, p, l), m, _ = K(h, n), M = 0, T = c.length; M < T; ++M) (m = c[M]) && Ot(m, e, n, M, c, _);
		a.push(c), s.push(h);
	}
...
function Dh(t, e) {
	var n, i, o;
	return function() {
		var a = Rt(this, t), s = (this.style.removeProperty(t), Rt(this, t));
		return a === s ? null : a === n && s === i ? o : o = e(n = a, i = s);
	};
}
m(Dh, "styleNull");
function au(t) {
...
function Oh(t, e, n) {
	var i, o, a;
	return function() {
		var s = Rt(this, t), u = n(this), l = u + "";
		return u ?? (l = u = (this.style.removeProperty(t), Rt(this, t))), s === l ? null : s === i && l === o ? a : (o = l, a = e(i = s, u));
	};
}
m(Oh, "styleFunction");
function Eh(t, e) {
	...
	return function() {
		var l = it(this, t), f = l.on, h = l.value[a] == null ? u || (u = au(e)) : void 0;
		(f !== n || o !== h) && (i = (n = f).copy()).on(s, o = h), l.on = i;
	};
}
m(Eh, "styleMaybeRemove");
function Oo(t, e, n) {
	var i = (t += "") == "transform" ? _i : ln;
	return e == null ? this.styleTween(t, Dh(t, i)).on("end.style." + t, au(t)) : typeof e == "function" ? this.styleTween(t, Oh(t, i, Oe(this, "style." + t, e))).each(Eh(this._id, t)) : this.styleTween(t, $h(t, i, e), n).on("end.style." + t, null);
}
m(Oo, "default");
function Ih(t, e, n) {
	return function(i) {
...
m(Yh, "textFunction");
function Io(t) {
	return this.tween("text", typeof t == "function" ? Yh(Oe(this, "text", t)) : Ph(t == null ? "" : t + ""));
}
m(Io, "default");
function Fh(t) {
	return function(e) {
...
m(Ro, "default");
function Po() {
	for (var t = this._name, e = this._id, n = sr(), i = this._groups, o = i.length, a = 0; a < o; ++a) for (var s = i[a], u = s.length, l, f = 0; f < u; ++f) if (l = s[f]) {
		var h = K(l, e);
		Ot(l, t, n, f, s, {
...
function Yo() {
	...
	return new Promise(function(a, s) {
		var u = { value: s }, l = { value: m(function() {
			--o === 0 && a();
		}, "value") };
		n.each(function() {
			var f = it(this, i), h = f.on;
			h !== t && (e = (t = h).copy(), e._.cancel.push(u), e._.interrupt.push(u), e._.end.push(l)), f.on = e;
		}), o === 0 && a();
	});
}
m(Yo, "default");
...
function Fo(t) {
	var e, n;
	t instanceof ot ? (e = t._id, t = t._name) : (e = sr(), (n = zh).time = on(), t = t == null ? null : t + "");
...
qt.prototype = {
	...
	invertX: m(function(t) {
		return (t - this.x) / this.k;
	}, "invertX"),
	invertY: m(function(t) {
		return (t - this.y) / this.k;
	}, "invertY"),
	rescaleX: m(function(t) {
		return t.copy().domain(t.range().map(this.invertX, this).map(t.invert, t));
	}, "rescaleX"),
	rescaleY: m(function(t) {
