...
import { R as Zi, V as ia, q as pt } from "./chunk-7W6UQGC5-C150Mc68.js";
import { C as at, F as hs, H as ls, I as is, K as ns, N as es, R as jr, S as as, Y as os, Z as qo, j as eo, tt as ss } from "./chunk-67TQ5CYL-BGuir8Be.js";
//#region node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.esm.min/quadrantDiagram-VICAPDV7.mjs
var Et = (function() {
	var t = m(function(M, o, l, x) {
		for (l = l || {}, x = M.length; x--; l[M[x]] = o);
		return l;
	}, "o"), n = [1, 3], f = [1, 4], u = [1, 5], c = [1, 6], g = [1, 7], y = [
		1,
		4,
		5,
		10,
		...
		56,
		57
	], P = [2, 36], h = [1, 37], T = [1, 36], b = [1, 38], m$1 = [1, 35], q = [1, 43], p = [1, 41], A = [1, 45], dt = [1, 14], ft = [1, 23], pt = [1, 18], gt = [1, 19], ut = [1, 20], kt = [1, 21], ct = [1, 22], a = [1, 24], Bt = [1, 25], wt = [1, 26], It = [1, 27], Ot = [1, 28], Wt = [1, 29], N = [1, 32], R = [1, 33], _ = [1, 34], F = [1, 39], Q = [1, 40], C = [1, 42], L = [1, 44], H = [1, 63], U = [1, 62], v = [
		4,
		5,
		8,
		10,
		...
		66,
		67
	], Nt = [1, 66], Rt = [1, 67], Ht = [1, 68], Ut = [1, 69], jt = [1, 70], Xt = [1, 71], Mt = [1, 72], Yt = [1, 73], Gt = [1, 74], Kt = [1, 75], Zt = [1, 76], Jt = [1, 77], w = [
		4,
		5,
		6,
		7,
		...
		15,
		18
	], Z = [1, 91], J = [1, 92], $ = [1, 93], tt = [1, 100], et = [1, 94], at = [1, 97], it = [1, 95], nt = [1, 96], rt = [1, 98], st = [1, 99], St = [1, 103], $t = [
		10,
		55,
		56,
		57
		...
		performAction: m(function(o, l, x, d, k, e, ht) {
			var s = e.length - 1;
			switch (k) {
				case 23:
					this.$ = e[s];
		...
		parse: m(function(o) {
			var l = this, x = [0], d = [], k = [null], e = [], ht = this.table, s = "", yt = 0, te = 0, ee = 0, be = 2, ae = 1, me = e.slice.call(arguments, 1), E = Object.create(this.lexer), Y = { yy: {} };
			for (var _t in this.yy) Object.prototype.hasOwnProperty.call(this.yy, _t) && (Y.yy[_t] = this.yy[_t]);
			E.setInput(o, Y.yy), Y.yy.lexer = E, Y.yy.parser = this, typeof E.yylloc > "u" && (E.yylloc = {});
			var Ft = E.yylloc;
			e.push(Ft);
			...
			function Oe(I) {
				x.length = x.length - 2 * I, k.length = k.length - I, e.length = e.length - I;
			}
			m(Oe, "popStack");
			function ke() {
				var I;
				return I = d.pop() || E.lex() || ae, typeof I != "number" && (I instanceof Array && (d = I, I = d.pop()), I = l.symbols_[I] || I), I;
			}
			m(ke, "lex");
			for (var V, Qt, G, W, Ct, ot = {}, Tt, j, ie, bt;;) {
				if (G = x[x.length - 1], this.defaultActions[G] ? W = this.defaultActions[G] : ((V === null || typeof V > "u") && (V = ke()), W = ht[G] && ht[G][V]), typeof W > "u" || !W.length || !W[0]) {
					var Lt = "";
					bt = [];
					for (Tt in ht[G]) this.terminals_[Tt] && Tt > be && bt.push("'" + this.terminals_[Tt] + "'");
					E.showPosition ? Lt = "Parse error on line " + (yt + 1) + `:
` + E.showPosition() + `
Expecting ` + bt.join(", ") + ", got '" + (this.terminals_[V] || V) + "'" : Lt = "Parse error on line " + (yt + 1) + ": Unexpected " + (V == ae ? "end of input" : "'" + (this.terminals_[V] || V) + "'"), this.parseError(Lt, {
						text: E.match,
				...
				if (W[0] instanceof Array && W.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + G + ", token: " + V);
				switch (W[0]) {
					case 1:
						x.push(V), k.push(E.yytext), e.push(E.yylloc), x.push(W[1]), V = null, Qt ? (V = Qt, Qt = null) : (te = E.yyleng, s = E.yytext, yt = E.yylineno, Ft = E.yylloc, ee > 0 && ee--);
						break;
					case 2:
						if (j = this.productions_[W[1]][1], ot.$ = k[k.length - j], ot._$ = {
							first_line: e[e.length - (j || 1)].first_line,
							last_line: e[e.length - 1].last_line,
							first_column: e[e.length - (j || 1)].first_column,
							last_column: e[e.length - 1].last_column
						}, qe && (ot._$.range = [e[e.length - (j || 1)].range[0], e[e.length - 1].range[1]]), Ct = this.performAction.apply(ot, [
							s,
							te,
							yt,
							Y.yy,
						...
						j && (x = x.slice(0, -1 * j * 2), k = k.slice(0, -1 * j), e = e.slice(0, -1 * j)), x.push(this.productions_[W[1]][0]), k.push(ot.$), e.push(ot._$), ie = ht[x[x.length - 2]][x[x.length - 1]], x.push(ie);
						break;
					case 3: return !0;
				}
			}
...
` + l + "^";
			...
			test_match: m(function(o, l) {
				...
				}, this.yytext += o[0], this.match += o[0], this.matches = o, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(o[0].length), this.matched += o[0], x = this.performAction.call(this, this.yy, this, l, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), x) return x;
				if (this._backtrack) {
...
` + this.showPosition(), {
			...
			performAction: m(function(l, x, d, k) {
				switch (d) {
					case 0: break;
					case 1: break;
					case 2: return 55;
...
var B = jr(), qt = class {
	...
	getDefaultConfig() {
		return {
			...
			showYAxis: !0,
			showTitle: !0,
			chartHeight: eo.quadrantChart?.chartWidth || 500,
			chartWidth: eo.quadrantChart?.chartHeight || 500,
			titlePadding: eo.quadrantChart?.titlePadding || 10,
			titleFontSize: eo.quadrantChart?.titleFontSize || 20,
			quadrantPadding: eo.quadrantChart?.quadrantPadding || 5,
			xAxisLabelPadding: eo.quadrantChart?.xAxisLabelPadding || 5,
			yAxisLabelPadding: eo.quadrantChart?.yAxisLabelPadding || 5,
			xAxisLabelFontSize: eo.quadrantChart?.xAxisLabelFontSize || 16,
			yAxisLabelFontSize: eo.quadrantChart?.yAxisLabelFontSize || 16,
			quadrantLabelFontSize: eo.quadrantChart?.quadrantLabelFontSize || 16,
			quadrantTextTopPadding: eo.quadrantChart?.quadrantTextTopPadding || 5,
			pointTextPadding: eo.quadrantChart?.pointTextPadding || 5,
			pointLabelFontSize: eo.quadrantChart?.pointLabelFontSize || 12,
			pointRadius: eo.quadrantChart?.pointRadius || 5,
			xAxisPosition: eo.quadrantChart?.xAxisPosition || "top",
			yAxisPosition: eo.quadrantChart?.yAxisPosition || "left",
			quadrantInternalBorderStrokeWidth: eo.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
			quadrantExternalBorderStrokeWidth: eo.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
		};
	}
	...
	setConfig(n) {
		pt.trace("setConfig called with: ", n), this.config = {
			...this.config,
			...n
		};
	}
	setThemeConfig(n) {
		pt.trace("setThemeConfig called with: ", n), this.themeConfig = {
			...this.themeConfig,
			...n
		};
	}
	calculateSpace(n, f, u, c) {
		...
		}, P = this.config.titleFontSize + this.config.titlePadding * 2, h = { top: c ? P : 0 }, T = this.config.quadrantPadding + i.left, b = this.config.quadrantPadding + y.top + h.top, m = this.config.chartWidth - this.config.quadrantPadding * 2 - i.left - i.right, q = this.config.chartHeight - this.config.quadrantPadding * 2 - y.top - y.bottom - h.top;
		return {
			xAxisSpace: y,
			yAxisSpace: i,
			titleSpace: h,
			quadrantSpace: {
				...
				quadrantTop: b,
				quadrantWidth: m,
				quadrantHalfWidth: m / 2,
				quadrantHeight: q,
				quadrantHalfHeight: q / 2
			}
		};
	}
	getAxisLabels(n, f, u, c) {
		let { quadrantSpace: g, titleSpace: y } = c, { quadrantHalfHeight: S, quadrantHeight: i, quadrantLeft: P, quadrantHalfWidth: h, quadrantTop: T, quadrantWidth: b } = g, m = !!this.data.xAxisRightText, q = !!this.data.yAxisTopText, p = [];
		return this.data.xAxisLeftText && f && p.push({
			...
			x: this.config.yAxisPosition === "left" ? this.config.yAxisLabelPadding : this.config.yAxisLabelPadding + P + b + this.config.quadrantPadding,
			y: T + i - (q ? S / 2 : 0),
	...
	getBorders(n) {
		let f = this.config.quadrantExternalBorderStrokeWidth / 2, { quadrantSpace: u } = n, { quadrantHalfHeight: c, quadrantHeight: g, quadrantLeft: y, quadrantHalfWidth: S, quadrantTop: i, quadrantWidth: P } = u;
		return [
			{
...
m(Ve, "setHeight");
function Be() {
	let { themeVariables: n, quadrantChart: f } = qo();
	...
	}), z.setData({ titleText: ns() }), z.build();
}
m(Be, "getQuadrantData");
var xa = {
	parser: xe,
	db: {
		setWidth: ze,
...
` + t);
		let i = S.securityLevel, P;
		i === "sandbox" && (P = ia("#i" + n));
		let T = (i === "sandbox" ? ia(P.nodes()[0].contentDocument.body) : ia("body")).select(`[id="${n}"]`), b = T.append("g").attr("class", "main"), m$2 = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
		is(T, q, m$2, S.quadrantChart?.useMaxWidth ?? !0), T.attr("viewBox", "0 0 " + m$2 + " " + q), u.db.setHeight(q), u.db.setWidth(m$2);
		let p = u.db.getQuadrantData(), A = b.append("g").attr("class", "quadrants"), dt = b.append("g").attr("class", "border"), ft = b.append("g").attr("class", "data-points"), pt$1 = b.append("g").attr("class", "labels"), gt = b.append("g").attr("class", "title");
